...
export const notifications_42_0_definition = {
...
export const notifications_42_1_definition = {
  domain: "notifications",
  sequence: 43,
  capability: "service",
  enabled: true,
...
export const notifications_42_2_definition = {
  domain: "notifications",
  sequence: 44,
  capability: "service",
  enabled: true,
...
export const notifications_42_3_definition = {
  domain: "notifications",
  sequence: 45,
  capability: "service",
  enabled: true,
...
export const notifications_42_4_definition = {
  domain: "notifications",
  sequence: 46,
  capability: "service",
  enabled: true,
...
export const notifications_42_5_definition = {
  domain: "notifications",
  sequence: 47,
  capability: "service",
  enabled: true,
...
export const notifications_42_6_definition = {
  domain: "notifications",
  sequence: 48,
  capability: "service",
  enabled: true,
...
export const notifications_42_7_definition = {
  domain: "notifications",
  sequence: 49,
  capability: "service",
  enabled: true,
