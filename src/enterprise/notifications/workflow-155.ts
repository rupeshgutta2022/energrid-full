...
export const notifications_155_0_definition = {
...
export const notifications_155_1_definition = {
  domain: "notifications",
  sequence: 156,
  capability: "workflow",
  enabled: true,
...
export const notifications_155_2_definition = {
  domain: "notifications",
  sequence: 157,
  capability: "workflow",
  enabled: true,
...
export const notifications_155_3_definition = {
  domain: "notifications",
  sequence: 158,
  capability: "workflow",
  enabled: true,
...
export const notifications_155_4_definition = {
  domain: "notifications",
  sequence: 159,
  capability: "workflow",
  enabled: true,
...
export const notifications_155_5_definition = {
  domain: "notifications",
  sequence: 160,
  capability: "workflow",
  enabled: true,
