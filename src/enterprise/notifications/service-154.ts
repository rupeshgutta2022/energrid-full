...
export const notifications_154_0_definition = {
...
export const notifications_154_1_definition = {
  domain: "notifications",
  sequence: 155,
  capability: "service",
  enabled: true,
...
export const notifications_154_2_definition = {
  domain: "notifications",
  sequence: 156,
  capability: "service",
  enabled: true,
...
export const notifications_154_3_definition = {
  domain: "notifications",
  sequence: 157,
  capability: "service",
  enabled: true,
...
export const notifications_154_4_definition = {
  domain: "notifications",
  sequence: 158,
  capability: "service",
  enabled: true,
...
export const notifications_154_5_definition = {
  domain: "notifications",
  sequence: 159,
  capability: "service",
  enabled: true,
