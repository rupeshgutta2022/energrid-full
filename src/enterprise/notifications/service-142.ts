...
export const notifications_142_0_definition = {
...
export const notifications_142_1_definition = {
  domain: "notifications",
  sequence: 143,
  capability: "service",
  enabled: true,
...
export const notifications_142_2_definition = {
  domain: "notifications",
  sequence: 144,
  capability: "service",
  enabled: true,
...
export const notifications_142_3_definition = {
  domain: "notifications",
  sequence: 145,
  capability: "service",
  enabled: true,
...
export const notifications_142_4_definition = {
  domain: "notifications",
  sequence: 146,
  capability: "service",
  enabled: true,
...
export const notifications_142_5_definition = {
  domain: "notifications",
  sequence: 147,
  capability: "service",
  enabled: true,
...
export const notifications_142_6_definition = {
  domain: "notifications",
  sequence: 148,
  capability: "service",
  enabled: true,
...
export const notifications_142_7_definition = {
  domain: "notifications",
  sequence: 149,
  capability: "service",
  enabled: true,
