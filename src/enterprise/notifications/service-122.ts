...
export const notifications_122_0_definition = {
...
export const notifications_122_1_definition = {
  domain: "notifications",
  sequence: 123,
  capability: "service",
  enabled: true,
...
export const notifications_122_2_definition = {
  domain: "notifications",
  sequence: 124,
  capability: "service",
  enabled: true,
...
export const notifications_122_3_definition = {
  domain: "notifications",
  sequence: 125,
  capability: "service",
  enabled: true,
...
export const notifications_122_4_definition = {
  domain: "notifications",
  sequence: 126,
  capability: "service",
  enabled: true,
...
export const notifications_122_5_definition = {
  domain: "notifications",
  sequence: 127,
  capability: "service",
  enabled: true,
...
export const notifications_122_6_definition = {
  domain: "notifications",
  sequence: 128,
  capability: "service",
  enabled: true,
...
export const notifications_122_7_definition = {
  domain: "notifications",
  sequence: 129,
  capability: "service",
  enabled: true,
