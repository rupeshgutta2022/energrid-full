...
export const notifications_102_0_definition = {
...
export const notifications_102_1_definition = {
  domain: "notifications",
  sequence: 103,
  capability: "service",
  enabled: true,
...
export const notifications_102_2_definition = {
  domain: "notifications",
  sequence: 104,
  capability: "service",
  enabled: true,
...
export const notifications_102_3_definition = {
  domain: "notifications",
  sequence: 105,
  capability: "service",
  enabled: true,
...
export const notifications_102_4_definition = {
  domain: "notifications",
  sequence: 106,
  capability: "service",
  enabled: true,
...
export const notifications_102_5_definition = {
  domain: "notifications",
  sequence: 107,
  capability: "service",
  enabled: true,
...
export const notifications_102_6_definition = {
  domain: "notifications",
  sequence: 108,
  capability: "service",
  enabled: true,
...
export const notifications_102_7_definition = {
  domain: "notifications",
  sequence: 109,
  capability: "service",
  enabled: true,
