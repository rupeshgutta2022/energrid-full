...
export const notifications_34_0_definition = {
...
export const notifications_34_1_definition = {
  domain: "notifications",
  sequence: 35,
  capability: "service",
  enabled: true,
...
export const notifications_34_2_definition = {
  domain: "notifications",
  sequence: 36,
  capability: "service",
  enabled: true,
...
export const notifications_34_3_definition = {
  domain: "notifications",
  sequence: 37,
  capability: "service",
  enabled: true,
...
export const notifications_34_4_definition = {
  domain: "notifications",
  sequence: 38,
  capability: "service",
  enabled: true,
...
export const notifications_34_5_definition = {
  domain: "notifications",
  sequence: 39,
  capability: "service",
  enabled: true,
...
export const notifications_34_6_definition = {
  domain: "notifications",
  sequence: 40,
  capability: "service",
  enabled: true,
...
export const notifications_34_7_definition = {
  domain: "notifications",
  sequence: 41,
  capability: "service",
  enabled: true,
