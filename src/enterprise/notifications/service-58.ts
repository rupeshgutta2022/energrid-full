...
export const notifications_58_0_definition = {
...
export const notifications_58_1_definition = {
  domain: "notifications",
  sequence: 59,
  capability: "service",
  enabled: true,
...
export const notifications_58_2_definition = {
  domain: "notifications",
  sequence: 60,
  capability: "service",
  enabled: true,
...
export const notifications_58_3_definition = {
  domain: "notifications",
  sequence: 61,
  capability: "service",
  enabled: true,
...
export const notifications_58_4_definition = {
  domain: "notifications",
  sequence: 62,
  capability: "service",
  enabled: true,
...
export const notifications_58_5_definition = {
  domain: "notifications",
  sequence: 63,
  capability: "service",
  enabled: true,
...
export const notifications_58_6_definition = {
  domain: "notifications",
  sequence: 64,
  capability: "service",
  enabled: true,
...
export const notifications_58_7_definition = {
  domain: "notifications",
  sequence: 65,
  capability: "service",
  enabled: true,
