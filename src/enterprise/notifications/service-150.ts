...
export const notifications_150_0_definition = {
...
export const notifications_150_1_definition = {
  domain: "notifications",
  sequence: 151,
  capability: "service",
  enabled: true,
...
export const notifications_150_2_definition = {
  domain: "notifications",
  sequence: 152,
  capability: "service",
  enabled: true,
...
export const notifications_150_3_definition = {
  domain: "notifications",
  sequence: 153,
  capability: "service",
  enabled: true,
...
export const notifications_150_4_definition = {
  domain: "notifications",
  sequence: 154,
  capability: "service",
  enabled: true,
...
export const notifications_150_5_definition = {
  domain: "notifications",
  sequence: 155,
  capability: "service",
  enabled: true,
...
export const notifications_150_6_definition = {
  domain: "notifications",
  sequence: 156,
  capability: "service",
  enabled: true,
...
export const notifications_150_7_definition = {
  domain: "notifications",
  sequence: 157,
  capability: "service",
  enabled: true,
