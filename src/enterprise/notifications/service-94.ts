...
export const notifications_94_0_definition = {
...
export const notifications_94_1_definition = {
  domain: "notifications",
  sequence: 95,
  capability: "service",
  enabled: true,
...
export const notifications_94_2_definition = {
  domain: "notifications",
  sequence: 96,
  capability: "service",
  enabled: true,
...
export const notifications_94_3_definition = {
  domain: "notifications",
  sequence: 97,
  capability: "service",
  enabled: true,
...
export const notifications_94_4_definition = {
  domain: "notifications",
  sequence: 98,
  capability: "service",
  enabled: true,
...
export const notifications_94_5_definition = {
  domain: "notifications",
  sequence: 99,
  capability: "service",
  enabled: true,
...
export const notifications_94_6_definition = {
  domain: "notifications",
  sequence: 100,
  capability: "service",
  enabled: true,
...
export const notifications_94_7_definition = {
  domain: "notifications",
  sequence: 101,
  capability: "service",
  enabled: true,
