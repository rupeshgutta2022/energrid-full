...
export const notifications_90_0_definition = {
...
export const notifications_90_1_definition = {
  domain: "notifications",
  sequence: 91,
  capability: "service",
  enabled: true,
...
export const notifications_90_2_definition = {
  domain: "notifications",
  sequence: 92,
  capability: "service",
  enabled: true,
...
export const notifications_90_3_definition = {
  domain: "notifications",
  sequence: 93,
  capability: "service",
  enabled: true,
...
export const notifications_90_4_definition = {
  domain: "notifications",
  sequence: 94,
  capability: "service",
  enabled: true,
...
export const notifications_90_5_definition = {
  domain: "notifications",
  sequence: 95,
  capability: "service",
  enabled: true,
...
export const notifications_90_6_definition = {
  domain: "notifications",
  sequence: 96,
  capability: "service",
  enabled: true,
...
export const notifications_90_7_definition = {
  domain: "notifications",
  sequence: 97,
  capability: "service",
  enabled: true,
