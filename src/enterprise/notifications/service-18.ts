...
export const notifications_18_0_definition = {
...
export const notifications_18_1_definition = {
  domain: "notifications",
  sequence: 19,
  capability: "service",
  enabled: true,
...
export const notifications_18_2_definition = {
  domain: "notifications",
  sequence: 20,
  capability: "service",
  enabled: true,
...
export const notifications_18_3_definition = {
  domain: "notifications",
  sequence: 21,
  capability: "service",
  enabled: true,
...
export const notifications_18_4_definition = {
  domain: "notifications",
  sequence: 22,
  capability: "service",
  enabled: true,
...
export const notifications_18_5_definition = {
  domain: "notifications",
  sequence: 23,
  capability: "service",
  enabled: true,
...
export const notifications_18_6_definition = {
  domain: "notifications",
  sequence: 24,
  capability: "service",
  enabled: true,
...
export const notifications_18_7_definition = {
  domain: "notifications",
  sequence: 25,
  capability: "service",
  enabled: true,
