...
export const notifications_62_0_definition = {
...
export const notifications_62_1_definition = {
  domain: "notifications",
  sequence: 63,
  capability: "service",
  enabled: true,
...
export const notifications_62_2_definition = {
  domain: "notifications",
  sequence: 64,
  capability: "service",
  enabled: true,
...
export const notifications_62_3_definition = {
  domain: "notifications",
  sequence: 65,
  capability: "service",
  enabled: true,
...
export const notifications_62_4_definition = {
  domain: "notifications",
  sequence: 66,
  capability: "service",
  enabled: true,
...
export const notifications_62_5_definition = {
  domain: "notifications",
  sequence: 67,
  capability: "service",
  enabled: true,
...
export const notifications_62_6_definition = {
  domain: "notifications",
  sequence: 68,
  capability: "service",
  enabled: true,
...
export const notifications_62_7_definition = {
  domain: "notifications",
  sequence: 69,
  capability: "service",
  enabled: true,
