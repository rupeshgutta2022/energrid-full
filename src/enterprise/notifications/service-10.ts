...
export const notifications_10_0_definition = {
...
export const notifications_10_1_definition = {
  domain: "notifications",
  sequence: 11,
  capability: "service",
  enabled: true,
...
export const notifications_10_2_definition = {
  domain: "notifications",
  sequence: 12,
  capability: "service",
  enabled: true,
...
export const notifications_10_3_definition = {
  domain: "notifications",
  sequence: 13,
  capability: "service",
  enabled: true,
...
export const notifications_10_4_definition = {
  domain: "notifications",
  sequence: 14,
  capability: "service",
  enabled: true,
...
export const notifications_10_5_definition = {
  domain: "notifications",
  sequence: 15,
  capability: "service",
  enabled: true,
...
export const notifications_10_6_definition = {
  domain: "notifications",
  sequence: 16,
  capability: "service",
  enabled: true,
...
export const notifications_10_7_definition = {
  domain: "notifications",
  sequence: 17,
  capability: "service",
  enabled: true,
