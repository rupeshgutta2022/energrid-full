...
export const notifications_74_0_definition = {
...
export const notifications_74_1_definition = {
  domain: "notifications",
  sequence: 75,
  capability: "service",
  enabled: true,
...
export const notifications_74_2_definition = {
  domain: "notifications",
  sequence: 76,
  capability: "service",
  enabled: true,
...
export const notifications_74_3_definition = {
  domain: "notifications",
  sequence: 77,
  capability: "service",
  enabled: true,
...
export const notifications_74_4_definition = {
  domain: "notifications",
  sequence: 78,
  capability: "service",
  enabled: true,
...
export const notifications_74_5_definition = {
  domain: "notifications",
  sequence: 79,
  capability: "service",
  enabled: true,
...
export const notifications_74_6_definition = {
  domain: "notifications",
  sequence: 80,
  capability: "service",
  enabled: true,
...
export const notifications_74_7_definition = {
  domain: "notifications",
  sequence: 81,
  capability: "service",
  enabled: true,
