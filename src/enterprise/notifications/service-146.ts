...
export const notifications_146_0_definition = {
...
export const notifications_146_1_definition = {
  domain: "notifications",
  sequence: 147,
  capability: "service",
  enabled: true,
...
export const notifications_146_2_definition = {
  domain: "notifications",
  sequence: 148,
  capability: "service",
  enabled: true,
...
export const notifications_146_3_definition = {
  domain: "notifications",
  sequence: 149,
  capability: "service",
  enabled: true,
...
export const notifications_146_4_definition = {
  domain: "notifications",
  sequence: 150,
  capability: "service",
  enabled: true,
...
export const notifications_146_5_definition = {
  domain: "notifications",
  sequence: 151,
  capability: "service",
  enabled: true,
...
export const notifications_146_6_definition = {
  domain: "notifications",
  sequence: 152,
  capability: "service",
  enabled: true,
...
export const notifications_146_7_definition = {
  domain: "notifications",
  sequence: 153,
  capability: "service",
  enabled: true,
