...
export const notifications_138_0_definition = {
...
export const notifications_138_1_definition = {
  domain: "notifications",
  sequence: 139,
  capability: "service",
  enabled: true,
...
export const notifications_138_2_definition = {
  domain: "notifications",
  sequence: 140,
  capability: "service",
  enabled: true,
...
export const notifications_138_3_definition = {
  domain: "notifications",
  sequence: 141,
  capability: "service",
  enabled: true,
...
export const notifications_138_4_definition = {
  domain: "notifications",
  sequence: 142,
  capability: "service",
  enabled: true,
...
export const notifications_138_5_definition = {
  domain: "notifications",
  sequence: 143,
  capability: "service",
  enabled: true,
...
export const notifications_138_6_definition = {
  domain: "notifications",
  sequence: 144,
  capability: "service",
  enabled: true,
...
export const notifications_138_7_definition = {
  domain: "notifications",
  sequence: 145,
  capability: "service",
  enabled: true,
