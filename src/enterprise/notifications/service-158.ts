...
export const notifications_158_0_definition = {
...
export const notifications_158_1_definition = {
  domain: "notifications",
  sequence: 159,
  capability: "service",
  enabled: true,
...
export const notifications_158_2_definition = {
  domain: "notifications",
  sequence: 160,
  capability: "service",
  enabled: true,
...
export const notifications_158_3_definition = {
  domain: "notifications",
  sequence: 161,
  capability: "service",
  enabled: true,
