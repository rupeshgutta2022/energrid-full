...
export const notifications_38_0_definition = {
...
export const notifications_38_1_definition = {
  domain: "notifications",
  sequence: 39,
  capability: "service",
  enabled: true,
...
export const notifications_38_2_definition = {
  domain: "notifications",
  sequence: 40,
  capability: "service",
  enabled: true,
...
export const notifications_38_3_definition = {
  domain: "notifications",
  sequence: 41,
  capability: "service",
  enabled: true,
...
export const notifications_38_4_definition = {
  domain: "notifications",
  sequence: 42,
  capability: "service",
  enabled: true,
...
export const notifications_38_5_definition = {
  domain: "notifications",
  sequence: 43,
  capability: "service",
  enabled: true,
...
export const notifications_38_6_definition = {
  domain: "notifications",
  sequence: 44,
  capability: "service",
  enabled: true,
...
export const notifications_38_7_definition = {
  domain: "notifications",
  sequence: 45,
  capability: "service",
  enabled: true,
