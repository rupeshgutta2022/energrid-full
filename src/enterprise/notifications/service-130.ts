...
export const notifications_130_0_definition = {
...
export const notifications_130_1_definition = {
  domain: "notifications",
  sequence: 131,
  capability: "service",
  enabled: true,
...
export const notifications_130_2_definition = {
  domain: "notifications",
  sequence: 132,
  capability: "service",
  enabled: true,
...
export const notifications_130_3_definition = {
  domain: "notifications",
  sequence: 133,
  capability: "service",
  enabled: true,
...
export const notifications_130_4_definition = {
  domain: "notifications",
  sequence: 134,
  capability: "service",
  enabled: true,
...
export const notifications_130_5_definition = {
  domain: "notifications",
  sequence: 135,
  capability: "service",
  enabled: true,
...
export const notifications_130_6_definition = {
  domain: "notifications",
  sequence: 136,
  capability: "service",
  enabled: true,
...
export const notifications_130_7_definition = {
  domain: "notifications",
  sequence: 137,
  capability: "service",
  enabled: true,
