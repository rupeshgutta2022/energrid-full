...
export const notifications_2_0_definition = {
...
export const notifications_2_1_definition = {
  domain: "notifications",
  sequence: 3,
  capability: "service",
  enabled: true,
...
export const notifications_2_2_definition = {
  domain: "notifications",
  sequence: 4,
  capability: "service",
  enabled: true,
...
export const notifications_2_3_definition = {
  domain: "notifications",
  sequence: 5,
  capability: "service",
  enabled: true,
...
export const notifications_2_4_definition = {
  domain: "notifications",
  sequence: 6,
  capability: "service",
  enabled: true,
...
export const notifications_2_5_definition = {
  domain: "notifications",
  sequence: 7,
  capability: "service",
  enabled: true,
...
export const notifications_2_6_definition = {
  domain: "notifications",
  sequence: 8,
  capability: "service",
  enabled: true,
...
export const notifications_2_7_definition = {
  domain: "notifications",
  sequence: 9,
  capability: "service",
  enabled: true,
