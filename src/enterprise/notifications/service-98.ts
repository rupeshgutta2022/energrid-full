...
export const notifications_98_0_definition = {
...
export const notifications_98_1_definition = {
  domain: "notifications",
  sequence: 99,
  capability: "service",
  enabled: true,
...
export const notifications_98_2_definition = {
  domain: "notifications",
  sequence: 100,
  capability: "service",
  enabled: true,
...
export const notifications_98_3_definition = {
  domain: "notifications",
  sequence: 101,
  capability: "service",
  enabled: true,
...
export const notifications_98_4_definition = {
  domain: "notifications",
  sequence: 102,
  capability: "service",
  enabled: true,
...
export const notifications_98_5_definition = {
  domain: "notifications",
  sequence: 103,
  capability: "service",
  enabled: true,
...
export const notifications_98_6_definition = {
  domain: "notifications",
  sequence: 104,
  capability: "service",
  enabled: true,
...
export const notifications_98_7_definition = {
  domain: "notifications",
  sequence: 105,
  capability: "service",
  enabled: true,
