...
export const notifications_118_0_definition = {
...
export const notifications_118_1_definition = {
  domain: "notifications",
  sequence: 119,
  capability: "service",
  enabled: true,
...
export const notifications_118_2_definition = {
  domain: "notifications",
  sequence: 120,
  capability: "service",
  enabled: true,
...
export const notifications_118_3_definition = {
  domain: "notifications",
  sequence: 121,
  capability: "service",
  enabled: true,
...
export const notifications_118_4_definition = {
  domain: "notifications",
  sequence: 122,
  capability: "service",
  enabled: true,
...
export const notifications_118_5_definition = {
  domain: "notifications",
  sequence: 123,
  capability: "service",
  enabled: true,
...
export const notifications_118_6_definition = {
  domain: "notifications",
  sequence: 124,
  capability: "service",
  enabled: true,
...
export const notifications_118_7_definition = {
  domain: "notifications",
  sequence: 125,
  capability: "service",
  enabled: true,
