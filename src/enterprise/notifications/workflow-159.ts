...
export const notifications_159_0_definition = {
...
export const notifications_159_1_definition = {
  domain: "notifications",
  sequence: 160,
  capability: "workflow",
  enabled: true,
...
export const notifications_159_2_definition = {
  domain: "notifications",
  sequence: 161,
  capability: "workflow",
  enabled: true,
...
export const notifications_159_3_definition = {
  domain: "notifications",
  sequence: 162,
  capability: "workflow",
  enabled: true,
