...
export const notifications_26_0_definition = {
...
export const notifications_26_1_definition = {
  domain: "notifications",
  sequence: 27,
  capability: "service",
  enabled: true,
...
export const notifications_26_2_definition = {
  domain: "notifications",
  sequence: 28,
  capability: "service",
  enabled: true,
...
export const notifications_26_3_definition = {
  domain: "notifications",
  sequence: 29,
  capability: "service",
  enabled: true,
...
export const notifications_26_4_definition = {
  domain: "notifications",
  sequence: 30,
  capability: "service",
  enabled: true,
...
export const notifications_26_5_definition = {
  domain: "notifications",
  sequence: 31,
  capability: "service",
  enabled: true,
...
export const notifications_26_6_definition = {
  domain: "notifications",
  sequence: 32,
  capability: "service",
  enabled: true,
...
export const notifications_26_7_definition = {
  domain: "notifications",
  sequence: 33,
  capability: "service",
  enabled: true,
