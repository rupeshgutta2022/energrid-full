...
export const notifications_106_0_definition = {
...
export const notifications_106_1_definition = {
  domain: "notifications",
  sequence: 107,
  capability: "service",
  enabled: true,
...
export const notifications_106_2_definition = {
  domain: "notifications",
  sequence: 108,
  capability: "service",
  enabled: true,
...
export const notifications_106_3_definition = {
  domain: "notifications",
  sequence: 109,
  capability: "service",
  enabled: true,
...
export const notifications_106_4_definition = {
  domain: "notifications",
  sequence: 110,
  capability: "service",
  enabled: true,
...
export const notifications_106_5_definition = {
  domain: "notifications",
  sequence: 111,
  capability: "service",
  enabled: true,
...
export const notifications_106_6_definition = {
  domain: "notifications",
  sequence: 112,
  capability: "service",
  enabled: true,
...
export const notifications_106_7_definition = {
  domain: "notifications",
  sequence: 113,
  capability: "service",
  enabled: true,
