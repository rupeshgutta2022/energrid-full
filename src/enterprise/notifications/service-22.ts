...
export const notifications_22_0_definition = {
...
export const notifications_22_1_definition = {
  domain: "notifications",
  sequence: 23,
  capability: "service",
  enabled: true,
...
export const notifications_22_2_definition = {
  domain: "notifications",
  sequence: 24,
  capability: "service",
  enabled: true,
...
export const notifications_22_3_definition = {
  domain: "notifications",
  sequence: 25,
  capability: "service",
  enabled: true,
...
export const notifications_22_4_definition = {
  domain: "notifications",
  sequence: 26,
  capability: "service",
  enabled: true,
...
export const notifications_22_5_definition = {
  domain: "notifications",
  sequence: 27,
  capability: "service",
  enabled: true,
...
export const notifications_22_6_definition = {
  domain: "notifications",
  sequence: 28,
  capability: "service",
  enabled: true,
...
export const notifications_22_7_definition = {
  domain: "notifications",
  sequence: 29,
  capability: "service",
  enabled: true,
