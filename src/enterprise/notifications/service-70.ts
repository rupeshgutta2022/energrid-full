...
export const notifications_70_0_definition = {
...
export const notifications_70_1_definition = {
  domain: "notifications",
  sequence: 71,
  capability: "service",
  enabled: true,
...
export const notifications_70_2_definition = {
  domain: "notifications",
  sequence: 72,
  capability: "service",
  enabled: true,
...
export const notifications_70_3_definition = {
  domain: "notifications",
  sequence: 73,
  capability: "service",
  enabled: true,
...
export const notifications_70_4_definition = {
  domain: "notifications",
  sequence: 74,
  capability: "service",
  enabled: true,
...
export const notifications_70_5_definition = {
  domain: "notifications",
  sequence: 75,
  capability: "service",
  enabled: true,
...
export const notifications_70_6_definition = {
  domain: "notifications",
  sequence: 76,
  capability: "service",
  enabled: true,
...
export const notifications_70_7_definition = {
  domain: "notifications",
  sequence: 77,
  capability: "service",
  enabled: true,
