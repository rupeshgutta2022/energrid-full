...
export const notifications_54_0_definition = {
...
export const notifications_54_1_definition = {
  domain: "notifications",
  sequence: 55,
  capability: "service",
  enabled: true,
...
export const notifications_54_2_definition = {
  domain: "notifications",
  sequence: 56,
  capability: "service",
  enabled: true,
...
export const notifications_54_3_definition = {
  domain: "notifications",
  sequence: 57,
  capability: "service",
  enabled: true,
...
export const notifications_54_4_definition = {
  domain: "notifications",
  sequence: 58,
  capability: "service",
  enabled: true,
...
export const notifications_54_5_definition = {
  domain: "notifications",
  sequence: 59,
  capability: "service",
  enabled: true,
...
export const notifications_54_6_definition = {
  domain: "notifications",
  sequence: 60,
  capability: "service",
  enabled: true,
...
export const notifications_54_7_definition = {
  domain: "notifications",
  sequence: 61,
  capability: "service",
  enabled: true,
