...
export const notifications_82_0_definition = {
...
export const notifications_82_1_definition = {
  domain: "notifications",
  sequence: 83,
  capability: "service",
  enabled: true,
...
export const notifications_82_2_definition = {
  domain: "notifications",
  sequence: 84,
  capability: "service",
  enabled: true,
...
export const notifications_82_3_definition = {
  domain: "notifications",
  sequence: 85,
  capability: "service",
  enabled: true,
...
export const notifications_82_4_definition = {
  domain: "notifications",
  sequence: 86,
  capability: "service",
  enabled: true,
...
export const notifications_82_5_definition = {
  domain: "notifications",
  sequence: 87,
  capability: "service",
  enabled: true,
...
export const notifications_82_6_definition = {
  domain: "notifications",
  sequence: 88,
  capability: "service",
  enabled: true,
...
export const notifications_82_7_definition = {
  domain: "notifications",
  sequence: 89,
  capability: "service",
  enabled: true,
