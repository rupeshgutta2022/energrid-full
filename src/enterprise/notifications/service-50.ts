...
export const notifications_50_0_definition = {
...
export const notifications_50_1_definition = {
  domain: "notifications",
  sequence: 51,
  capability: "service",
  enabled: true,
...
export const notifications_50_2_definition = {
  domain: "notifications",
  sequence: 52,
  capability: "service",
  enabled: true,
...
export const notifications_50_3_definition = {
  domain: "notifications",
  sequence: 53,
  capability: "service",
  enabled: true,
...
export const notifications_50_4_definition = {
  domain: "notifications",
  sequence: 54,
  capability: "service",
  enabled: true,
...
export const notifications_50_5_definition = {
  domain: "notifications",
  sequence: 55,
  capability: "service",
  enabled: true,
...
export const notifications_50_6_definition = {
  domain: "notifications",
  sequence: 56,
  capability: "service",
  enabled: true,
...
export const notifications_50_7_definition = {
  domain: "notifications",
  sequence: 57,
  capability: "service",
  enabled: true,
