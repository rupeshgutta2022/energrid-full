...
export const notifications_110_0_definition = {
...
export const notifications_110_1_definition = {
  domain: "notifications",
  sequence: 111,
  capability: "service",
  enabled: true,
...
export const notifications_110_2_definition = {
  domain: "notifications",
  sequence: 112,
  capability: "service",
  enabled: true,
...
export const notifications_110_3_definition = {
  domain: "notifications",
  sequence: 113,
  capability: "service",
  enabled: true,
...
export const notifications_110_4_definition = {
  domain: "notifications",
  sequence: 114,
  capability: "service",
  enabled: true,
...
export const notifications_110_5_definition = {
  domain: "notifications",
  sequence: 115,
  capability: "service",
  enabled: true,
...
export const notifications_110_6_definition = {
  domain: "notifications",
  sequence: 116,
  capability: "service",
  enabled: true,
...
export const notifications_110_7_definition = {
  domain: "notifications",
  sequence: 117,
  capability: "service",
  enabled: true,
