...
export const notifications_66_0_definition = {
...
export const notifications_66_1_definition = {
  domain: "notifications",
  sequence: 67,
  capability: "service",
  enabled: true,
...
export const notifications_66_2_definition = {
  domain: "notifications",
  sequence: 68,
  capability: "service",
  enabled: true,
...
export const notifications_66_3_definition = {
  domain: "notifications",
  sequence: 69,
  capability: "service",
  enabled: true,
...
export const notifications_66_4_definition = {
  domain: "notifications",
  sequence: 70,
  capability: "service",
  enabled: true,
...
export const notifications_66_5_definition = {
  domain: "notifications",
  sequence: 71,
  capability: "service",
  enabled: true,
...
export const notifications_66_6_definition = {
  domain: "notifications",
  sequence: 72,
  capability: "service",
  enabled: true,
...
export const notifications_66_7_definition = {
  domain: "notifications",
  sequence: 73,
  capability: "service",
  enabled: true,
