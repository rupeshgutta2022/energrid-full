...
export const notifications_30_0_definition = {
...
export const notifications_30_1_definition = {
  domain: "notifications",
  sequence: 31,
  capability: "service",
  enabled: true,
...
export const notifications_30_2_definition = {
  domain: "notifications",
  sequence: 32,
  capability: "service",
  enabled: true,
...
export const notifications_30_3_definition = {
  domain: "notifications",
  sequence: 33,
  capability: "service",
  enabled: true,
...
export const notifications_30_4_definition = {
  domain: "notifications",
  sequence: 34,
  capability: "service",
  enabled: true,
...
export const notifications_30_5_definition = {
  domain: "notifications",
  sequence: 35,
  capability: "service",
  enabled: true,
...
export const notifications_30_6_definition = {
  domain: "notifications",
  sequence: 36,
  capability: "service",
  enabled: true,
...
export const notifications_30_7_definition = {
  domain: "notifications",
  sequence: 37,
  capability: "service",
  enabled: true,
