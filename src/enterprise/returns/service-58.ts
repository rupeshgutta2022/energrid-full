...
export const returns_58_0_definition = {
  domain: "returns",
  sequence: 58,
  capability: "service",
  enabled: true,
...
export const returns_58_1_definition = {
  domain: "returns",
  sequence: 59,
  capability: "service",
  enabled: true,
...
export const returns_58_2_definition = {
  domain: "returns",
  sequence: 60,
  capability: "service",
  enabled: true,
...
export const returns_58_3_definition = {
  domain: "returns",
  sequence: 61,
  capability: "service",
  enabled: true,
...
export const returns_58_4_definition = {
  domain: "returns",
  sequence: 62,
  capability: "service",
  enabled: true,
...
export const returns_58_5_definition = {
  domain: "returns",
  sequence: 63,
  capability: "service",
  enabled: true,
...
export const returns_58_6_definition = {
  domain: "returns",
  sequence: 64,
  capability: "service",
  enabled: true,
...
export const returns_58_7_definition = {
  domain: "returns",
  sequence: 65,
  capability: "service",
  enabled: true,
