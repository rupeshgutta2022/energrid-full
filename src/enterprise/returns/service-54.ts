...
export const returns_54_0_definition = {
  domain: "returns",
  sequence: 54,
  capability: "service",
  enabled: true,
...
export const returns_54_1_definition = {
  domain: "returns",
  sequence: 55,
  capability: "service",
  enabled: true,
...
export const returns_54_2_definition = {
  domain: "returns",
  sequence: 56,
  capability: "service",
  enabled: true,
...
export const returns_54_3_definition = {
  domain: "returns",
  sequence: 57,
  capability: "service",
  enabled: true,
...
export const returns_54_4_definition = {
  domain: "returns",
  sequence: 58,
  capability: "service",
  enabled: true,
...
export const returns_54_5_definition = {
  domain: "returns",
  sequence: 59,
  capability: "service",
  enabled: true,
...
export const returns_54_6_definition = {
  domain: "returns",
  sequence: 60,
  capability: "service",
  enabled: true,
...
export const returns_54_7_definition = {
  domain: "returns",
  sequence: 61,
  capability: "service",
  enabled: true,
