...
export const returns_86_0_definition = {
  domain: "returns",
  sequence: 86,
  capability: "service",
  enabled: true,
...
export const returns_86_1_definition = {
  domain: "returns",
  sequence: 87,
  capability: "service",
  enabled: true,
...
export const returns_86_2_definition = {
  domain: "returns",
  sequence: 88,
  capability: "service",
  enabled: true,
...
export const returns_86_3_definition = {
  domain: "returns",
  sequence: 89,
  capability: "service",
  enabled: true,
...
export const returns_86_4_definition = {
  domain: "returns",
  sequence: 90,
  capability: "service",
  enabled: true,
...
export const returns_86_5_definition = {
  domain: "returns",
  sequence: 91,
  capability: "service",
  enabled: true,
...
export const returns_86_6_definition = {
  domain: "returns",
  sequence: 92,
  capability: "service",
  enabled: true,
...
export const returns_86_7_definition = {
  domain: "returns",
  sequence: 93,
  capability: "service",
  enabled: true,
