...
export const returns_110_0_definition = {
  domain: "returns",
  sequence: 110,
  capability: "service",
  enabled: true,
...
export const returns_110_1_definition = {
  domain: "returns",
  sequence: 111,
  capability: "service",
  enabled: true,
...
export const returns_110_2_definition = {
  domain: "returns",
  sequence: 112,
  capability: "service",
  enabled: true,
...
export const returns_110_3_definition = {
  domain: "returns",
  sequence: 113,
  capability: "service",
  enabled: true,
...
export const returns_110_4_definition = {
  domain: "returns",
  sequence: 114,
  capability: "service",
  enabled: true,
...
export const returns_110_5_definition = {
  domain: "returns",
  sequence: 115,
  capability: "service",
  enabled: true,
...
export const returns_110_6_definition = {
  domain: "returns",
  sequence: 116,
  capability: "service",
  enabled: true,
...
export const returns_110_7_definition = {
  domain: "returns",
  sequence: 117,
  capability: "service",
  enabled: true,
