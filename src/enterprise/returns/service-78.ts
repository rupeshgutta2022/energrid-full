...
export const returns_78_0_definition = {
  domain: "returns",
  sequence: 78,
  capability: "service",
  enabled: true,
...
export const returns_78_1_definition = {
  domain: "returns",
  sequence: 79,
  capability: "service",
  enabled: true,
...
export const returns_78_2_definition = {
  domain: "returns",
  sequence: 80,
  capability: "service",
  enabled: true,
...
export const returns_78_3_definition = {
  domain: "returns",
  sequence: 81,
  capability: "service",
  enabled: true,
...
export const returns_78_4_definition = {
  domain: "returns",
  sequence: 82,
  capability: "service",
  enabled: true,
...
export const returns_78_5_definition = {
  domain: "returns",
  sequence: 83,
  capability: "service",
  enabled: true,
...
export const returns_78_6_definition = {
  domain: "returns",
  sequence: 84,
  capability: "service",
  enabled: true,
...
export const returns_78_7_definition = {
  domain: "returns",
  sequence: 85,
  capability: "service",
  enabled: true,
