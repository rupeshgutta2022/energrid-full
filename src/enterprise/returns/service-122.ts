...
export const returns_122_0_definition = {
  domain: "returns",
  sequence: 122,
  capability: "service",
  enabled: true,
...
export const returns_122_1_definition = {
  domain: "returns",
  sequence: 123,
  capability: "service",
  enabled: true,
...
export const returns_122_2_definition = {
  domain: "returns",
  sequence: 124,
  capability: "service",
  enabled: true,
...
export const returns_122_3_definition = {
  domain: "returns",
  sequence: 125,
  capability: "service",
  enabled: true,
...
export const returns_122_4_definition = {
  domain: "returns",
  sequence: 126,
  capability: "service",
  enabled: true,
...
export const returns_122_5_definition = {
  domain: "returns",
  sequence: 127,
  capability: "service",
  enabled: true,
...
export const returns_122_6_definition = {
  domain: "returns",
  sequence: 128,
  capability: "service",
  enabled: true,
...
export const returns_122_7_definition = {
  domain: "returns",
  sequence: 129,
  capability: "service",
  enabled: true,
