...
export const returns_102_0_definition = {
  domain: "returns",
  sequence: 102,
  capability: "service",
  enabled: true,
...
export const returns_102_1_definition = {
  domain: "returns",
  sequence: 103,
  capability: "service",
  enabled: true,
...
export const returns_102_2_definition = {
  domain: "returns",
  sequence: 104,
  capability: "service",
  enabled: true,
...
export const returns_102_3_definition = {
  domain: "returns",
  sequence: 105,
  capability: "service",
  enabled: true,
...
export const returns_102_4_definition = {
  domain: "returns",
  sequence: 106,
  capability: "service",
  enabled: true,
...
export const returns_102_5_definition = {
  domain: "returns",
  sequence: 107,
  capability: "service",
  enabled: true,
...
export const returns_102_6_definition = {
  domain: "returns",
  sequence: 108,
  capability: "service",
  enabled: true,
...
export const returns_102_7_definition = {
  domain: "returns",
  sequence: 109,
  capability: "service",
  enabled: true,
