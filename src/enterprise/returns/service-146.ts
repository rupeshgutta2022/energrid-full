...
export const returns_146_0_definition = {
  domain: "returns",
  sequence: 146,
  capability: "service",
  enabled: true,
...
export const returns_146_1_definition = {
  domain: "returns",
  sequence: 147,
  capability: "service",
  enabled: true,
...
export const returns_146_2_definition = {
  domain: "returns",
  sequence: 148,
  capability: "service",
  enabled: true,
...
export const returns_146_3_definition = {
  domain: "returns",
  sequence: 149,
  capability: "service",
  enabled: true,
...
export const returns_146_4_definition = {
  domain: "returns",
  sequence: 150,
  capability: "service",
  enabled: true,
...
export const returns_146_5_definition = {
  domain: "returns",
  sequence: 151,
  capability: "service",
  enabled: true,
...
export const returns_146_6_definition = {
  domain: "returns",
  sequence: 152,
  capability: "service",
  enabled: true,
...
export const returns_146_7_definition = {
  domain: "returns",
  sequence: 153,
  capability: "service",
  enabled: true,
