...
export const returns_42_0_definition = {
  domain: "returns",
  sequence: 42,
  capability: "service",
  enabled: true,
...
export const returns_42_1_definition = {
  domain: "returns",
  sequence: 43,
  capability: "service",
  enabled: true,
...
export const returns_42_2_definition = {
  domain: "returns",
  sequence: 44,
  capability: "service",
  enabled: true,
...
export const returns_42_3_definition = {
  domain: "returns",
  sequence: 45,
  capability: "service",
  enabled: true,
...
export const returns_42_4_definition = {
  domain: "returns",
  sequence: 46,
  capability: "service",
  enabled: true,
...
export const returns_42_5_definition = {
  domain: "returns",
  sequence: 47,
  capability: "service",
  enabled: true,
...
export const returns_42_6_definition = {
  domain: "returns",
  sequence: 48,
  capability: "service",
  enabled: true,
...
export const returns_42_7_definition = {
  domain: "returns",
  sequence: 49,
  capability: "service",
  enabled: true,
