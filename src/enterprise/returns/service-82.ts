...
export const returns_82_0_definition = {
  domain: "returns",
  sequence: 82,
  capability: "service",
  enabled: true,
...
export const returns_82_1_definition = {
  domain: "returns",
  sequence: 83,
  capability: "service",
  enabled: true,
...
export const returns_82_2_definition = {
  domain: "returns",
  sequence: 84,
  capability: "service",
  enabled: true,
...
export const returns_82_3_definition = {
  domain: "returns",
  sequence: 85,
  capability: "service",
  enabled: true,
...
export const returns_82_4_definition = {
  domain: "returns",
  sequence: 86,
  capability: "service",
  enabled: true,
...
export const returns_82_5_definition = {
  domain: "returns",
  sequence: 87,
  capability: "service",
  enabled: true,
...
export const returns_82_6_definition = {
  domain: "returns",
  sequence: 88,
  capability: "service",
  enabled: true,
...
export const returns_82_7_definition = {
  domain: "returns",
  sequence: 89,
  capability: "service",
  enabled: true,
