...
export const returns_62_0_definition = {
  domain: "returns",
  sequence: 62,
  capability: "service",
  enabled: true,
...
export const returns_62_1_definition = {
  domain: "returns",
  sequence: 63,
  capability: "service",
  enabled: true,
...
export const returns_62_2_definition = {
  domain: "returns",
  sequence: 64,
  capability: "service",
  enabled: true,
...
export const returns_62_3_definition = {
  domain: "returns",
  sequence: 65,
  capability: "service",
  enabled: true,
...
export const returns_62_4_definition = {
  domain: "returns",
  sequence: 66,
  capability: "service",
  enabled: true,
...
export const returns_62_5_definition = {
  domain: "returns",
  sequence: 67,
  capability: "service",
  enabled: true,
...
export const returns_62_6_definition = {
  domain: "returns",
  sequence: 68,
  capability: "service",
  enabled: true,
...
export const returns_62_7_definition = {
  domain: "returns",
  sequence: 69,
  capability: "service",
  enabled: true,
