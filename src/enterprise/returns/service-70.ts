...
export const returns_70_0_definition = {
  domain: "returns",
  sequence: 70,
  capability: "service",
  enabled: true,
...
export const returns_70_1_definition = {
  domain: "returns",
  sequence: 71,
  capability: "service",
  enabled: true,
...
export const returns_70_2_definition = {
  domain: "returns",
  sequence: 72,
  capability: "service",
  enabled: true,
...
export const returns_70_3_definition = {
  domain: "returns",
  sequence: 73,
  capability: "service",
  enabled: true,
...
export const returns_70_4_definition = {
  domain: "returns",
  sequence: 74,
  capability: "service",
  enabled: true,
...
export const returns_70_5_definition = {
  domain: "returns",
  sequence: 75,
  capability: "service",
  enabled: true,
...
export const returns_70_6_definition = {
  domain: "returns",
  sequence: 76,
  capability: "service",
  enabled: true,
...
export const returns_70_7_definition = {
  domain: "returns",
  sequence: 77,
  capability: "service",
  enabled: true,
