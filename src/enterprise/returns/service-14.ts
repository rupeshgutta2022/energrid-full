...
export const returns_14_0_definition = {
  domain: "returns",
  sequence: 14,
  capability: "service",
  enabled: true,
...
export const returns_14_1_definition = {
  domain: "returns",
  sequence: 15,
  capability: "service",
  enabled: true,
...
export const returns_14_2_definition = {
  domain: "returns",
  sequence: 16,
  capability: "service",
  enabled: true,
...
export const returns_14_3_definition = {
  domain: "returns",
  sequence: 17,
  capability: "service",
  enabled: true,
...
export const returns_14_4_definition = {
  domain: "returns",
  sequence: 18,
  capability: "service",
  enabled: true,
...
export const returns_14_5_definition = {
  domain: "returns",
  sequence: 19,
  capability: "service",
  enabled: true,
...
export const returns_14_6_definition = {
  domain: "returns",
  sequence: 20,
  capability: "service",
  enabled: true,
...
export const returns_14_7_definition = {
  domain: "returns",
  sequence: 21,
  capability: "service",
  enabled: true,
