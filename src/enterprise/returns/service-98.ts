...
export const returns_98_0_definition = {
  domain: "returns",
  sequence: 98,
  capability: "service",
  enabled: true,
...
export const returns_98_1_definition = {
  domain: "returns",
  sequence: 99,
  capability: "service",
  enabled: true,
...
export const returns_98_2_definition = {
  domain: "returns",
  sequence: 100,
  capability: "service",
  enabled: true,
...
export const returns_98_3_definition = {
  domain: "returns",
  sequence: 101,
  capability: "service",
  enabled: true,
...
export const returns_98_4_definition = {
  domain: "returns",
  sequence: 102,
  capability: "service",
  enabled: true,
...
export const returns_98_5_definition = {
  domain: "returns",
  sequence: 103,
  capability: "service",
  enabled: true,
...
export const returns_98_6_definition = {
  domain: "returns",
  sequence: 104,
  capability: "service",
  enabled: true,
...
export const returns_98_7_definition = {
  domain: "returns",
  sequence: 105,
  capability: "service",
  enabled: true,
