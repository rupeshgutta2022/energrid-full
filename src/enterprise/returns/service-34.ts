...
export const returns_34_0_definition = {
  domain: "returns",
  sequence: 34,
  capability: "service",
  enabled: true,
...
export const returns_34_1_definition = {
  domain: "returns",
  sequence: 35,
  capability: "service",
  enabled: true,
...
export const returns_34_2_definition = {
  domain: "returns",
  sequence: 36,
  capability: "service",
  enabled: true,
...
export const returns_34_3_definition = {
  domain: "returns",
  sequence: 37,
  capability: "service",
  enabled: true,
...
export const returns_34_4_definition = {
  domain: "returns",
  sequence: 38,
  capability: "service",
  enabled: true,
...
export const returns_34_5_definition = {
  domain: "returns",
  sequence: 39,
  capability: "service",
  enabled: true,
...
export const returns_34_6_definition = {
  domain: "returns",
  sequence: 40,
  capability: "service",
  enabled: true,
...
export const returns_34_7_definition = {
  domain: "returns",
  sequence: 41,
  capability: "service",
  enabled: true,
