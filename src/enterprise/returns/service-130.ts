...
export const returns_130_0_definition = {
  domain: "returns",
  sequence: 130,
  capability: "service",
  enabled: true,
...
export const returns_130_1_definition = {
  domain: "returns",
  sequence: 131,
  capability: "service",
  enabled: true,
...
export const returns_130_2_definition = {
  domain: "returns",
  sequence: 132,
  capability: "service",
  enabled: true,
...
export const returns_130_3_definition = {
  domain: "returns",
  sequence: 133,
  capability: "service",
  enabled: true,
...
export const returns_130_4_definition = {
  domain: "returns",
  sequence: 134,
  capability: "service",
  enabled: true,
...
export const returns_130_5_definition = {
  domain: "returns",
  sequence: 135,
  capability: "service",
  enabled: true,
...
export const returns_130_6_definition = {
  domain: "returns",
  sequence: 136,
  capability: "service",
  enabled: true,
...
export const returns_130_7_definition = {
  domain: "returns",
  sequence: 137,
  capability: "service",
  enabled: true,
