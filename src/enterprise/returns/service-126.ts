...
export const returns_126_0_definition = {
  domain: "returns",
  sequence: 126,
  capability: "service",
  enabled: true,
...
export const returns_126_1_definition = {
  domain: "returns",
  sequence: 127,
  capability: "service",
  enabled: true,
...
export const returns_126_2_definition = {
  domain: "returns",
  sequence: 128,
  capability: "service",
  enabled: true,
...
export const returns_126_3_definition = {
  domain: "returns",
  sequence: 129,
  capability: "service",
  enabled: true,
...
export const returns_126_4_definition = {
  domain: "returns",
  sequence: 130,
  capability: "service",
  enabled: true,
...
export const returns_126_5_definition = {
  domain: "returns",
  sequence: 131,
  capability: "service",
  enabled: true,
...
export const returns_126_6_definition = {
  domain: "returns",
  sequence: 132,
  capability: "service",
  enabled: true,
...
export const returns_126_7_definition = {
  domain: "returns",
  sequence: 133,
  capability: "service",
  enabled: true,
