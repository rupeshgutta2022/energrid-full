...
export const returns_22_0_definition = {
  domain: "returns",
  sequence: 22,
  capability: "service",
  enabled: true,
...
export const returns_22_1_definition = {
  domain: "returns",
  sequence: 23,
  capability: "service",
  enabled: true,
...
export const returns_22_2_definition = {
  domain: "returns",
  sequence: 24,
  capability: "service",
  enabled: true,
...
export const returns_22_3_definition = {
  domain: "returns",
  sequence: 25,
  capability: "service",
  enabled: true,
...
export const returns_22_4_definition = {
  domain: "returns",
  sequence: 26,
  capability: "service",
  enabled: true,
...
export const returns_22_5_definition = {
  domain: "returns",
  sequence: 27,
  capability: "service",
  enabled: true,
...
export const returns_22_6_definition = {
  domain: "returns",
  sequence: 28,
  capability: "service",
  enabled: true,
...
export const returns_22_7_definition = {
  domain: "returns",
  sequence: 29,
  capability: "service",
  enabled: true,
