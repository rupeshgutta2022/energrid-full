...
export const returns_6_0_definition = {
  domain: "returns",
  sequence: 6,
  capability: "service",
  enabled: true,
...
export const returns_6_1_definition = {
  domain: "returns",
  sequence: 7,
  capability: "service",
  enabled: true,
...
export const returns_6_2_definition = {
  domain: "returns",
  sequence: 8,
  capability: "service",
  enabled: true,
...
export const returns_6_3_definition = {
  domain: "returns",
  sequence: 9,
  capability: "service",
  enabled: true,
...
export const returns_6_4_definition = {
  domain: "returns",
  sequence: 10,
  capability: "service",
  enabled: true,
...
export const returns_6_5_definition = {
  domain: "returns",
  sequence: 11,
  capability: "service",
  enabled: true,
...
export const returns_6_6_definition = {
  domain: "returns",
  sequence: 12,
  capability: "service",
  enabled: true,
...
export const returns_6_7_definition = {
  domain: "returns",
  sequence: 13,
  capability: "service",
  enabled: true,
