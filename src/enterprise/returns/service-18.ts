...
export const returns_18_0_definition = {
  domain: "returns",
  sequence: 18,
  capability: "service",
  enabled: true,
...
export const returns_18_1_definition = {
  domain: "returns",
  sequence: 19,
  capability: "service",
  enabled: true,
...
export const returns_18_2_definition = {
  domain: "returns",
  sequence: 20,
  capability: "service",
  enabled: true,
...
export const returns_18_3_definition = {
  domain: "returns",
  sequence: 21,
  capability: "service",
  enabled: true,
...
export const returns_18_4_definition = {
  domain: "returns",
  sequence: 22,
  capability: "service",
  enabled: true,
...
export const returns_18_5_definition = {
  domain: "returns",
  sequence: 23,
  capability: "service",
  enabled: true,
...
export const returns_18_6_definition = {
  domain: "returns",
  sequence: 24,
  capability: "service",
  enabled: true,
...
export const returns_18_7_definition = {
  domain: "returns",
  sequence: 25,
  capability: "service",
  enabled: true,
