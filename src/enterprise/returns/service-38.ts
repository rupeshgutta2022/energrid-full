...
export const returns_38_0_definition = {
  domain: "returns",
  sequence: 38,
  capability: "service",
  enabled: true,
...
export const returns_38_1_definition = {
  domain: "returns",
  sequence: 39,
  capability: "service",
  enabled: true,
...
export const returns_38_2_definition = {
  domain: "returns",
  sequence: 40,
  capability: "service",
  enabled: true,
...
export const returns_38_3_definition = {
  domain: "returns",
  sequence: 41,
  capability: "service",
  enabled: true,
...
export const returns_38_4_definition = {
  domain: "returns",
  sequence: 42,
  capability: "service",
  enabled: true,
...
export const returns_38_5_definition = {
  domain: "returns",
  sequence: 43,
  capability: "service",
  enabled: true,
...
export const returns_38_6_definition = {
  domain: "returns",
  sequence: 44,
  capability: "service",
  enabled: true,
...
export const returns_38_7_definition = {
  domain: "returns",
  sequence: 45,
  capability: "service",
  enabled: true,
