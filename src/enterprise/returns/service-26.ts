...
export const returns_26_0_definition = {
  domain: "returns",
  sequence: 26,
  capability: "service",
  enabled: true,
...
export const returns_26_1_definition = {
  domain: "returns",
  sequence: 27,
  capability: "service",
  enabled: true,
...
export const returns_26_2_definition = {
  domain: "returns",
  sequence: 28,
  capability: "service",
  enabled: true,
...
export const returns_26_3_definition = {
  domain: "returns",
  sequence: 29,
  capability: "service",
  enabled: true,
...
export const returns_26_4_definition = {
  domain: "returns",
  sequence: 30,
  capability: "service",
  enabled: true,
...
export const returns_26_5_definition = {
  domain: "returns",
  sequence: 31,
  capability: "service",
  enabled: true,
...
export const returns_26_6_definition = {
  domain: "returns",
  sequence: 32,
  capability: "service",
  enabled: true,
...
export const returns_26_7_definition = {
  domain: "returns",
  sequence: 33,
  capability: "service",
  enabled: true,
