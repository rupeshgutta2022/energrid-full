...
export const returns_138_0_definition = {
  domain: "returns",
  sequence: 138,
  capability: "service",
  enabled: true,
...
export const returns_138_1_definition = {
  domain: "returns",
  sequence: 139,
  capability: "service",
  enabled: true,
...
export const returns_138_2_definition = {
  domain: "returns",
  sequence: 140,
  capability: "service",
  enabled: true,
...
export const returns_138_3_definition = {
  domain: "returns",
  sequence: 141,
  capability: "service",
  enabled: true,
...
export const returns_138_4_definition = {
  domain: "returns",
  sequence: 142,
  capability: "service",
  enabled: true,
...
export const returns_138_5_definition = {
  domain: "returns",
  sequence: 143,
  capability: "service",
  enabled: true,
...
export const returns_138_6_definition = {
  domain: "returns",
  sequence: 144,
  capability: "service",
  enabled: true,
...
export const returns_138_7_definition = {
  domain: "returns",
  sequence: 145,
  capability: "service",
  enabled: true,
