...
export const returns_74_0_definition = {
  domain: "returns",
  sequence: 74,
  capability: "service",
  enabled: true,
...
export const returns_74_1_definition = {
  domain: "returns",
  sequence: 75,
  capability: "service",
  enabled: true,
...
export const returns_74_2_definition = {
  domain: "returns",
  sequence: 76,
  capability: "service",
  enabled: true,
...
export const returns_74_3_definition = {
  domain: "returns",
  sequence: 77,
  capability: "service",
  enabled: true,
...
export const returns_74_4_definition = {
  domain: "returns",
  sequence: 78,
  capability: "service",
  enabled: true,
...
export const returns_74_5_definition = {
  domain: "returns",
  sequence: 79,
  capability: "service",
  enabled: true,
...
export const returns_74_6_definition = {
  domain: "returns",
  sequence: 80,
  capability: "service",
  enabled: true,
...
export const returns_74_7_definition = {
  domain: "returns",
  sequence: 81,
  capability: "service",
  enabled: true,
