...
export const returns_10_0_definition = {
  domain: "returns",
  sequence: 10,
  capability: "service",
  enabled: true,
...
export const returns_10_1_definition = {
  domain: "returns",
  sequence: 11,
  capability: "service",
  enabled: true,
...
export const returns_10_2_definition = {
  domain: "returns",
  sequence: 12,
  capability: "service",
  enabled: true,
...
export const returns_10_3_definition = {
  domain: "returns",
  sequence: 13,
  capability: "service",
  enabled: true,
...
export const returns_10_4_definition = {
  domain: "returns",
  sequence: 14,
  capability: "service",
  enabled: true,
...
export const returns_10_5_definition = {
  domain: "returns",
  sequence: 15,
  capability: "service",
  enabled: true,
...
export const returns_10_6_definition = {
  domain: "returns",
  sequence: 16,
  capability: "service",
  enabled: true,
...
export const returns_10_7_definition = {
  domain: "returns",
  sequence: 17,
  capability: "service",
  enabled: true,
