...
export const returns_46_0_definition = {
  domain: "returns",
  sequence: 46,
  capability: "service",
  enabled: true,
...
export const returns_46_1_definition = {
  domain: "returns",
  sequence: 47,
  capability: "service",
  enabled: true,
...
export const returns_46_2_definition = {
  domain: "returns",
  sequence: 48,
  capability: "service",
  enabled: true,
...
export const returns_46_3_definition = {
  domain: "returns",
  sequence: 49,
  capability: "service",
  enabled: true,
...
export const returns_46_4_definition = {
  domain: "returns",
  sequence: 50,
  capability: "service",
  enabled: true,
...
export const returns_46_5_definition = {
  domain: "returns",
  sequence: 51,
  capability: "service",
  enabled: true,
...
export const returns_46_6_definition = {
  domain: "returns",
  sequence: 52,
  capability: "service",
  enabled: true,
...
export const returns_46_7_definition = {
  domain: "returns",
  sequence: 53,
  capability: "service",
  enabled: true,
