...
export const returns_154_0_definition = {
  domain: "returns",
  sequence: 154,
  capability: "service",
  enabled: true,
...
export const returns_154_1_definition = {
  domain: "returns",
  sequence: 155,
  capability: "service",
  enabled: true,
...
export const returns_154_2_definition = {
  domain: "returns",
  sequence: 156,
  capability: "service",
  enabled: true,
...
export const returns_154_3_definition = {
  domain: "returns",
  sequence: 157,
  capability: "service",
  enabled: true,
...
export const returns_154_4_definition = {
  domain: "returns",
  sequence: 158,
  capability: "service",
  enabled: true,
...
export const returns_154_5_definition = {
  domain: "returns",
  sequence: 159,
  capability: "service",
  enabled: true,
