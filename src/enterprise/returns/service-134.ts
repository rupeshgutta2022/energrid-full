...
export const returns_134_0_definition = {
  domain: "returns",
  sequence: 134,
  capability: "service",
  enabled: true,
...
export const returns_134_1_definition = {
  domain: "returns",
  sequence: 135,
  capability: "service",
  enabled: true,
...
export const returns_134_2_definition = {
  domain: "returns",
  sequence: 136,
  capability: "service",
  enabled: true,
...
export const returns_134_3_definition = {
  domain: "returns",
  sequence: 137,
  capability: "service",
  enabled: true,
...
export const returns_134_4_definition = {
  domain: "returns",
  sequence: 138,
  capability: "service",
  enabled: true,
...
export const returns_134_5_definition = {
  domain: "returns",
  sequence: 139,
  capability: "service",
  enabled: true,
...
export const returns_134_6_definition = {
  domain: "returns",
  sequence: 140,
  capability: "service",
  enabled: true,
...
export const returns_134_7_definition = {
  domain: "returns",
  sequence: 141,
  capability: "service",
  enabled: true,
