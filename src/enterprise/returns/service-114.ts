...
export const returns_114_0_definition = {
  domain: "returns",
  sequence: 114,
  capability: "service",
  enabled: true,
...
export const returns_114_1_definition = {
  domain: "returns",
  sequence: 115,
  capability: "service",
  enabled: true,
...
export const returns_114_2_definition = {
  domain: "returns",
  sequence: 116,
  capability: "service",
  enabled: true,
...
export const returns_114_3_definition = {
  domain: "returns",
  sequence: 117,
  capability: "service",
  enabled: true,
...
export const returns_114_4_definition = {
  domain: "returns",
  sequence: 118,
  capability: "service",
  enabled: true,
...
export const returns_114_5_definition = {
  domain: "returns",
  sequence: 119,
  capability: "service",
  enabled: true,
...
export const returns_114_6_definition = {
  domain: "returns",
  sequence: 120,
  capability: "service",
  enabled: true,
...
export const returns_114_7_definition = {
  domain: "returns",
  sequence: 121,
  capability: "service",
  enabled: true,
