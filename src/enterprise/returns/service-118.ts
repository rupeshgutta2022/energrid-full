...
export const returns_118_0_definition = {
  domain: "returns",
  sequence: 118,
  capability: "service",
  enabled: true,
...
export const returns_118_1_definition = {
  domain: "returns",
  sequence: 119,
  capability: "service",
  enabled: true,
...
export const returns_118_2_definition = {
  domain: "returns",
  sequence: 120,
  capability: "service",
  enabled: true,
...
export const returns_118_3_definition = {
  domain: "returns",
  sequence: 121,
  capability: "service",
  enabled: true,
...
export const returns_118_4_definition = {
  domain: "returns",
  sequence: 122,
  capability: "service",
  enabled: true,
...
export const returns_118_5_definition = {
  domain: "returns",
  sequence: 123,
  capability: "service",
  enabled: true,
...
export const returns_118_6_definition = {
  domain: "returns",
  sequence: 124,
  capability: "service",
  enabled: true,
...
export const returns_118_7_definition = {
  domain: "returns",
  sequence: 125,
  capability: "service",
  enabled: true,
