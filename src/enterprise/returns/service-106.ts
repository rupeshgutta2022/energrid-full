...
export const returns_106_0_definition = {
  domain: "returns",
  sequence: 106,
  capability: "service",
  enabled: true,
...
export const returns_106_1_definition = {
  domain: "returns",
  sequence: 107,
  capability: "service",
  enabled: true,
...
export const returns_106_2_definition = {
  domain: "returns",
  sequence: 108,
  capability: "service",
  enabled: true,
...
export const returns_106_3_definition = {
  domain: "returns",
  sequence: 109,
  capability: "service",
  enabled: true,
...
export const returns_106_4_definition = {
  domain: "returns",
  sequence: 110,
  capability: "service",
  enabled: true,
...
export const returns_106_5_definition = {
  domain: "returns",
  sequence: 111,
  capability: "service",
  enabled: true,
...
export const returns_106_6_definition = {
  domain: "returns",
  sequence: 112,
  capability: "service",
  enabled: true,
...
export const returns_106_7_definition = {
  domain: "returns",
  sequence: 113,
  capability: "service",
  enabled: true,
