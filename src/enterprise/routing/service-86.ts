...
export const routing_86_0_definition = {
  domain: "routing",
  sequence: 86,
  capability: "service",
  enabled: true,
...
export const routing_86_1_definition = {
  domain: "routing",
  sequence: 87,
  capability: "service",
  enabled: true,
...
export const routing_86_2_definition = {
  domain: "routing",
  sequence: 88,
  capability: "service",
  enabled: true,
...
export const routing_86_3_definition = {
  domain: "routing",
  sequence: 89,
  capability: "service",
  enabled: true,
...
export const routing_86_4_definition = {
  domain: "routing",
  sequence: 90,
  capability: "service",
  enabled: true,
...
export const routing_86_5_definition = {
  domain: "routing",
  sequence: 91,
  capability: "service",
  enabled: true,
...
export const routing_86_6_definition = {
  domain: "routing",
  sequence: 92,
  capability: "service",
  enabled: true,
...
export const routing_86_7_definition = {
  domain: "routing",
  sequence: 93,
  capability: "service",
  enabled: true,
