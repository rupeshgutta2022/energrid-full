...
export const routing_70_0_definition = {
  domain: "routing",
  sequence: 70,
  capability: "service",
  enabled: true,
...
export const routing_70_1_definition = {
  domain: "routing",
  sequence: 71,
  capability: "service",
  enabled: true,
...
export const routing_70_2_definition = {
  domain: "routing",
  sequence: 72,
  capability: "service",
  enabled: true,
...
export const routing_70_3_definition = {
  domain: "routing",
  sequence: 73,
  capability: "service",
  enabled: true,
...
export const routing_70_4_definition = {
  domain: "routing",
  sequence: 74,
  capability: "service",
  enabled: true,
...
export const routing_70_5_definition = {
  domain: "routing",
  sequence: 75,
  capability: "service",
  enabled: true,
...
export const routing_70_6_definition = {
  domain: "routing",
  sequence: 76,
  capability: "service",
  enabled: true,
...
export const routing_70_7_definition = {
  domain: "routing",
  sequence: 77,
  capability: "service",
  enabled: true,
