...
export const routing_2_0_definition = {
  domain: "routing",
  sequence: 2,
  capability: "service",
  enabled: true,
...
export const routing_2_1_definition = {
  domain: "routing",
  sequence: 3,
  capability: "service",
  enabled: true,
...
export const routing_2_2_definition = {
  domain: "routing",
  sequence: 4,
  capability: "service",
  enabled: true,
...
export const routing_2_3_definition = {
  domain: "routing",
  sequence: 5,
  capability: "service",
  enabled: true,
...
export const routing_2_4_definition = {
  domain: "routing",
  sequence: 6,
  capability: "service",
  enabled: true,
...
export const routing_2_5_definition = {
  domain: "routing",
  sequence: 7,
  capability: "service",
  enabled: true,
...
export const routing_2_6_definition = {
  domain: "routing",
  sequence: 8,
  capability: "service",
  enabled: true,
...
export const routing_2_7_definition = {
  domain: "routing",
  sequence: 9,
  capability: "service",
  enabled: true,
