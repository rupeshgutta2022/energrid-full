...
export const routing_6_0_definition = {
  domain: "routing",
  sequence: 6,
  capability: "service",
  enabled: true,
...
export const routing_6_1_definition = {
  domain: "routing",
  sequence: 7,
  capability: "service",
  enabled: true,
...
export const routing_6_2_definition = {
  domain: "routing",
  sequence: 8,
  capability: "service",
  enabled: true,
...
export const routing_6_3_definition = {
  domain: "routing",
  sequence: 9,
  capability: "service",
  enabled: true,
...
export const routing_6_4_definition = {
  domain: "routing",
  sequence: 10,
  capability: "service",
  enabled: true,
...
export const routing_6_5_definition = {
  domain: "routing",
  sequence: 11,
  capability: "service",
  enabled: true,
...
export const routing_6_6_definition = {
  domain: "routing",
  sequence: 12,
  capability: "service",
  enabled: true,
...
export const routing_6_7_definition = {
  domain: "routing",
  sequence: 13,
  capability: "service",
  enabled: true,
