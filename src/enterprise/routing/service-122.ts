...
export const routing_122_0_definition = {
  domain: "routing",
  sequence: 122,
  capability: "service",
  enabled: true,
...
export const routing_122_1_definition = {
  domain: "routing",
  sequence: 123,
  capability: "service",
  enabled: true,
...
export const routing_122_2_definition = {
  domain: "routing",
  sequence: 124,
  capability: "service",
  enabled: true,
...
export const routing_122_3_definition = {
  domain: "routing",
  sequence: 125,
  capability: "service",
  enabled: true,
...
export const routing_122_4_definition = {
  domain: "routing",
  sequence: 126,
  capability: "service",
  enabled: true,
...
export const routing_122_5_definition = {
  domain: "routing",
  sequence: 127,
  capability: "service",
  enabled: true,
...
export const routing_122_6_definition = {
  domain: "routing",
  sequence: 128,
  capability: "service",
  enabled: true,
...
export const routing_122_7_definition = {
  domain: "routing",
  sequence: 129,
  capability: "service",
  enabled: true,
