...
export const routing_14_0_definition = {
  domain: "routing",
  sequence: 14,
  capability: "service",
  enabled: true,
...
export const routing_14_1_definition = {
  domain: "routing",
  sequence: 15,
  capability: "service",
  enabled: true,
...
export const routing_14_2_definition = {
  domain: "routing",
  sequence: 16,
  capability: "service",
  enabled: true,
...
export const routing_14_3_definition = {
  domain: "routing",
  sequence: 17,
  capability: "service",
  enabled: true,
...
export const routing_14_4_definition = {
  domain: "routing",
  sequence: 18,
  capability: "service",
  enabled: true,
...
export const routing_14_5_definition = {
  domain: "routing",
  sequence: 19,
  capability: "service",
  enabled: true,
...
export const routing_14_6_definition = {
  domain: "routing",
  sequence: 20,
  capability: "service",
  enabled: true,
...
export const routing_14_7_definition = {
  domain: "routing",
  sequence: 21,
  capability: "service",
  enabled: true,
