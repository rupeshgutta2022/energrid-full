...
export const routing_34_0_definition = {
  domain: "routing",
  sequence: 34,
  capability: "service",
  enabled: true,
...
export const routing_34_1_definition = {
  domain: "routing",
  sequence: 35,
  capability: "service",
  enabled: true,
...
export const routing_34_2_definition = {
  domain: "routing",
  sequence: 36,
  capability: "service",
  enabled: true,
...
export const routing_34_3_definition = {
  domain: "routing",
  sequence: 37,
  capability: "service",
  enabled: true,
...
export const routing_34_4_definition = {
  domain: "routing",
  sequence: 38,
  capability: "service",
  enabled: true,
...
export const routing_34_5_definition = {
  domain: "routing",
  sequence: 39,
  capability: "service",
  enabled: true,
...
export const routing_34_6_definition = {
  domain: "routing",
  sequence: 40,
  capability: "service",
  enabled: true,
...
export const routing_34_7_definition = {
  domain: "routing",
  sequence: 41,
  capability: "service",
  enabled: true,
