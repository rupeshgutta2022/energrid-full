...
export const routing_50_0_definition = {
  domain: "routing",
  sequence: 50,
  capability: "service",
  enabled: true,
...
export const routing_50_1_definition = {
  domain: "routing",
  sequence: 51,
  capability: "service",
  enabled: true,
...
export const routing_50_2_definition = {
  domain: "routing",
  sequence: 52,
  capability: "service",
  enabled: true,
...
export const routing_50_3_definition = {
  domain: "routing",
  sequence: 53,
  capability: "service",
  enabled: true,
...
export const routing_50_4_definition = {
  domain: "routing",
  sequence: 54,
  capability: "service",
  enabled: true,
...
export const routing_50_5_definition = {
  domain: "routing",
  sequence: 55,
  capability: "service",
  enabled: true,
...
export const routing_50_6_definition = {
  domain: "routing",
  sequence: 56,
  capability: "service",
  enabled: true,
...
export const routing_50_7_definition = {
  domain: "routing",
  sequence: 57,
  capability: "service",
  enabled: true,
