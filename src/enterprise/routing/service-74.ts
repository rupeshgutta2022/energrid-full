...
export const routing_74_0_definition = {
  domain: "routing",
  sequence: 74,
  capability: "service",
  enabled: true,
...
export const routing_74_1_definition = {
  domain: "routing",
  sequence: 75,
  capability: "service",
  enabled: true,
...
export const routing_74_2_definition = {
  domain: "routing",
  sequence: 76,
  capability: "service",
  enabled: true,
...
export const routing_74_3_definition = {
  domain: "routing",
  sequence: 77,
  capability: "service",
  enabled: true,
...
export const routing_74_4_definition = {
  domain: "routing",
  sequence: 78,
  capability: "service",
  enabled: true,
...
export const routing_74_5_definition = {
  domain: "routing",
  sequence: 79,
  capability: "service",
  enabled: true,
...
export const routing_74_6_definition = {
  domain: "routing",
  sequence: 80,
  capability: "service",
  enabled: true,
...
export const routing_74_7_definition = {
  domain: "routing",
  sequence: 81,
  capability: "service",
  enabled: true,
