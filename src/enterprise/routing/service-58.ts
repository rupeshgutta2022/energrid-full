...
export const routing_58_0_definition = {
  domain: "routing",
  sequence: 58,
  capability: "service",
  enabled: true,
...
export const routing_58_1_definition = {
  domain: "routing",
  sequence: 59,
  capability: "service",
  enabled: true,
...
export const routing_58_2_definition = {
  domain: "routing",
  sequence: 60,
  capability: "service",
  enabled: true,
...
export const routing_58_3_definition = {
  domain: "routing",
  sequence: 61,
  capability: "service",
  enabled: true,
...
export const routing_58_4_definition = {
  domain: "routing",
  sequence: 62,
  capability: "service",
  enabled: true,
...
export const routing_58_5_definition = {
  domain: "routing",
  sequence: 63,
  capability: "service",
  enabled: true,
...
export const routing_58_6_definition = {
  domain: "routing",
  sequence: 64,
  capability: "service",
  enabled: true,
...
export const routing_58_7_definition = {
  domain: "routing",
  sequence: 65,
  capability: "service",
  enabled: true,
