...
export const routing_78_0_definition = {
  domain: "routing",
  sequence: 78,
  capability: "service",
  enabled: true,
...
export const routing_78_1_definition = {
  domain: "routing",
  sequence: 79,
  capability: "service",
  enabled: true,
...
export const routing_78_2_definition = {
  domain: "routing",
  sequence: 80,
  capability: "service",
  enabled: true,
...
export const routing_78_3_definition = {
  domain: "routing",
  sequence: 81,
  capability: "service",
  enabled: true,
...
export const routing_78_4_definition = {
  domain: "routing",
  sequence: 82,
  capability: "service",
  enabled: true,
...
export const routing_78_5_definition = {
  domain: "routing",
  sequence: 83,
  capability: "service",
  enabled: true,
...
export const routing_78_6_definition = {
  domain: "routing",
  sequence: 84,
  capability: "service",
  enabled: true,
...
export const routing_78_7_definition = {
  domain: "routing",
  sequence: 85,
  capability: "service",
  enabled: true,
