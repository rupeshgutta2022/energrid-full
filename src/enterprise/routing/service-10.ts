...
export const routing_10_0_definition = {
  domain: "routing",
  sequence: 10,
  capability: "service",
  enabled: true,
...
export const routing_10_1_definition = {
  domain: "routing",
  sequence: 11,
  capability: "service",
  enabled: true,
...
export const routing_10_2_definition = {
  domain: "routing",
  sequence: 12,
  capability: "service",
  enabled: true,
...
export const routing_10_3_definition = {
  domain: "routing",
  sequence: 13,
  capability: "service",
  enabled: true,
...
export const routing_10_4_definition = {
  domain: "routing",
  sequence: 14,
  capability: "service",
  enabled: true,
...
export const routing_10_5_definition = {
  domain: "routing",
  sequence: 15,
  capability: "service",
  enabled: true,
...
export const routing_10_6_definition = {
  domain: "routing",
  sequence: 16,
  capability: "service",
  enabled: true,
...
export const routing_10_7_definition = {
  domain: "routing",
  sequence: 17,
  capability: "service",
  enabled: true,
