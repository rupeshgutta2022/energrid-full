...
export const routing_226_0_definition = {
  domain: "routing",
  sequence: 226,
  capability: "service",
  enabled: true,
...
export const routing_226_1_definition = {
  domain: "routing",
  sequence: 227,
  capability: "service",
  enabled: true,
...
export const routing_226_2_definition = {
  domain: "routing",
  sequence: 228,
  capability: "service",
  enabled: true,
...
export const routing_226_3_definition = {
  domain: "routing",
  sequence: 229,
  capability: "service",
  enabled: true,
...
export const routing_226_4_definition = {
  domain: "routing",
  sequence: 230,
  capability: "service",
  enabled: true,
...
export const routing_226_5_definition = {
  domain: "routing",
  sequence: 231,
  capability: "service",
  enabled: true,
