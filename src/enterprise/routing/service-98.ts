...
export const routing_98_0_definition = {
  domain: "routing",
  sequence: 98,
  capability: "service",
  enabled: true,
...
export const routing_98_1_definition = {
  domain: "routing",
  sequence: 99,
  capability: "service",
  enabled: true,
...
export const routing_98_2_definition = {
  domain: "routing",
  sequence: 100,
  capability: "service",
  enabled: true,
...
export const routing_98_3_definition = {
  domain: "routing",
  sequence: 101,
  capability: "service",
  enabled: true,
...
export const routing_98_4_definition = {
  domain: "routing",
  sequence: 102,
  capability: "service",
  enabled: true,
...
export const routing_98_5_definition = {
  domain: "routing",
  sequence: 103,
  capability: "service",
  enabled: true,
...
export const routing_98_6_definition = {
  domain: "routing",
  sequence: 104,
  capability: "service",
  enabled: true,
...
export const routing_98_7_definition = {
  domain: "routing",
  sequence: 105,
  capability: "service",
  enabled: true,
