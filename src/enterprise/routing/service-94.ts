...
export const routing_94_0_definition = {
  domain: "routing",
  sequence: 94,
  capability: "service",
  enabled: true,
...
export const routing_94_1_definition = {
  domain: "routing",
  sequence: 95,
  capability: "service",
  enabled: true,
...
export const routing_94_2_definition = {
  domain: "routing",
  sequence: 96,
  capability: "service",
  enabled: true,
...
export const routing_94_3_definition = {
  domain: "routing",
  sequence: 97,
  capability: "service",
  enabled: true,
...
export const routing_94_4_definition = {
  domain: "routing",
  sequence: 98,
  capability: "service",
  enabled: true,
...
export const routing_94_5_definition = {
  domain: "routing",
  sequence: 99,
  capability: "service",
  enabled: true,
...
export const routing_94_6_definition = {
  domain: "routing",
  sequence: 100,
  capability: "service",
  enabled: true,
...
export const routing_94_7_definition = {
  domain: "routing",
  sequence: 101,
  capability: "service",
  enabled: true,
