...
export const routing_166_0_definition = {
  domain: "routing",
  sequence: 166,
  capability: "service",
  enabled: true,
...
export const routing_166_1_definition = {
  domain: "routing",
  sequence: 167,
  capability: "service",
  enabled: true,
...
export const routing_166_2_definition = {
  domain: "routing",
  sequence: 168,
  capability: "service",
  enabled: true,
...
export const routing_166_3_definition = {
  domain: "routing",
  sequence: 169,
  capability: "service",
  enabled: true,
...
export const routing_166_4_definition = {
  domain: "routing",
  sequence: 170,
  capability: "service",
  enabled: true,
...
export const routing_166_5_definition = {
  domain: "routing",
  sequence: 171,
  capability: "service",
  enabled: true,
...
export const routing_166_6_definition = {
  domain: "routing",
  sequence: 172,
  capability: "service",
  enabled: true,
...
export const routing_166_7_definition = {
  domain: "routing",
  sequence: 173,
  capability: "service",
  enabled: true,
