...
export const routing_227_0_definition = {
  domain: "routing",
  sequence: 227,
  capability: "workflow",
  enabled: true,
...
export const routing_227_1_definition = {
  domain: "routing",
  sequence: 228,
  capability: "workflow",
  enabled: true,
...
export const routing_227_2_definition = {
  domain: "routing",
  sequence: 229,
  capability: "workflow",
  enabled: true,
...
export const routing_227_3_definition = {
  domain: "routing",
  sequence: 230,
  capability: "workflow",
  enabled: true,
...
export const routing_227_4_definition = {
  domain: "routing",
  sequence: 231,
  capability: "workflow",
  enabled: true,
...
export const routing_227_5_definition = {
  domain: "routing",
  sequence: 232,
  capability: "workflow",
  enabled: true,
...
export const routing_227_6_definition = {
  domain: "routing",
  sequence: 233,
  capability: "workflow",
  enabled: true,
