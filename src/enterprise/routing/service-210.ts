...
export const routing_210_0_definition = {
  domain: "routing",
  sequence: 210,
  capability: "service",
  enabled: true,
...
export const routing_210_1_definition = {
  domain: "routing",
  sequence: 211,
  capability: "service",
  enabled: true,
...
export const routing_210_2_definition = {
  domain: "routing",
  sequence: 212,
  capability: "service",
  enabled: true,
...
export const routing_210_3_definition = {
  domain: "routing",
  sequence: 213,
  capability: "service",
  enabled: true,
...
export const routing_210_4_definition = {
  domain: "routing",
  sequence: 214,
  capability: "service",
  enabled: true,
...
export const routing_210_5_definition = {
  domain: "routing",
  sequence: 215,
  capability: "service",
  enabled: true,
...
export const routing_210_6_definition = {
  domain: "routing",
  sequence: 216,
  capability: "service",
  enabled: true,
...
export const routing_210_7_definition = {
  domain: "routing",
  sequence: 217,
  capability: "service",
  enabled: true,
