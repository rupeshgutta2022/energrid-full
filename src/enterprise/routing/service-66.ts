...
export const routing_66_0_definition = {
  domain: "routing",
  sequence: 66,
  capability: "service",
  enabled: true,
...
export const routing_66_1_definition = {
  domain: "routing",
  sequence: 67,
  capability: "service",
  enabled: true,
...
export const routing_66_2_definition = {
  domain: "routing",
  sequence: 68,
  capability: "service",
  enabled: true,
...
export const routing_66_3_definition = {
  domain: "routing",
  sequence: 69,
  capability: "service",
  enabled: true,
...
export const routing_66_4_definition = {
  domain: "routing",
  sequence: 70,
  capability: "service",
  enabled: true,
...
export const routing_66_5_definition = {
  domain: "routing",
  sequence: 71,
  capability: "service",
  enabled: true,
...
export const routing_66_6_definition = {
  domain: "routing",
  sequence: 72,
  capability: "service",
  enabled: true,
...
export const routing_66_7_definition = {
  domain: "routing",
  sequence: 73,
  capability: "service",
  enabled: true,
