...
export const routing_26_0_definition = {
  domain: "routing",
  sequence: 26,
  capability: "service",
  enabled: true,
...
export const routing_26_1_definition = {
  domain: "routing",
  sequence: 27,
  capability: "service",
  enabled: true,
...
export const routing_26_2_definition = {
  domain: "routing",
  sequence: 28,
  capability: "service",
  enabled: true,
...
export const routing_26_3_definition = {
  domain: "routing",
  sequence: 29,
  capability: "service",
  enabled: true,
...
export const routing_26_4_definition = {
  domain: "routing",
  sequence: 30,
  capability: "service",
  enabled: true,
...
export const routing_26_5_definition = {
  domain: "routing",
  sequence: 31,
  capability: "service",
  enabled: true,
...
export const routing_26_6_definition = {
  domain: "routing",
  sequence: 32,
  capability: "service",
  enabled: true,
...
export const routing_26_7_definition = {
  domain: "routing",
  sequence: 33,
  capability: "service",
  enabled: true,
