...
export const routing_82_0_definition = {
  domain: "routing",
  sequence: 82,
  capability: "service",
  enabled: true,
...
export const routing_82_1_definition = {
  domain: "routing",
  sequence: 83,
  capability: "service",
  enabled: true,
...
export const routing_82_2_definition = {
  domain: "routing",
  sequence: 84,
  capability: "service",
  enabled: true,
...
export const routing_82_3_definition = {
  domain: "routing",
  sequence: 85,
  capability: "service",
  enabled: true,
...
export const routing_82_4_definition = {
  domain: "routing",
  sequence: 86,
  capability: "service",
  enabled: true,
...
export const routing_82_5_definition = {
  domain: "routing",
  sequence: 87,
  capability: "service",
  enabled: true,
...
export const routing_82_6_definition = {
  domain: "routing",
  sequence: 88,
  capability: "service",
  enabled: true,
...
export const routing_82_7_definition = {
  domain: "routing",
  sequence: 89,
  capability: "service",
  enabled: true,
