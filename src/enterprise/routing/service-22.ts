...
export const routing_22_0_definition = {
  domain: "routing",
  sequence: 22,
  capability: "service",
  enabled: true,
...
export const routing_22_1_definition = {
  domain: "routing",
  sequence: 23,
  capability: "service",
  enabled: true,
...
export const routing_22_2_definition = {
  domain: "routing",
  sequence: 24,
  capability: "service",
  enabled: true,
...
export const routing_22_3_definition = {
  domain: "routing",
  sequence: 25,
  capability: "service",
  enabled: true,
...
export const routing_22_4_definition = {
  domain: "routing",
  sequence: 26,
  capability: "service",
  enabled: true,
...
export const routing_22_5_definition = {
  domain: "routing",
  sequence: 27,
  capability: "service",
  enabled: true,
...
export const routing_22_6_definition = {
  domain: "routing",
  sequence: 28,
  capability: "service",
  enabled: true,
...
export const routing_22_7_definition = {
  domain: "routing",
  sequence: 29,
  capability: "service",
  enabled: true,
