...
export const routing_202_0_definition = {
  domain: "routing",
  sequence: 202,
  capability: "service",
  enabled: true,
...
export const routing_202_1_definition = {
  domain: "routing",
  sequence: 203,
  capability: "service",
  enabled: true,
...
export const routing_202_2_definition = {
  domain: "routing",
  sequence: 204,
  capability: "service",
  enabled: true,
...
export const routing_202_3_definition = {
  domain: "routing",
  sequence: 205,
  capability: "service",
  enabled: true,
...
export const routing_202_4_definition = {
  domain: "routing",
  sequence: 206,
  capability: "service",
  enabled: true,
...
export const routing_202_5_definition = {
  domain: "routing",
  sequence: 207,
  capability: "service",
  enabled: true,
...
export const routing_202_6_definition = {
  domain: "routing",
  sequence: 208,
  capability: "service",
  enabled: true,
...
export const routing_202_7_definition = {
  domain: "routing",
  sequence: 209,
  capability: "service",
  enabled: true,
