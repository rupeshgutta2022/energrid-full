...
export const routing_62_0_definition = {
  domain: "routing",
  sequence: 62,
  capability: "service",
  enabled: true,
...
export const routing_62_1_definition = {
  domain: "routing",
  sequence: 63,
  capability: "service",
  enabled: true,
...
export const routing_62_2_definition = {
  domain: "routing",
  sequence: 64,
  capability: "service",
  enabled: true,
...
export const routing_62_3_definition = {
  domain: "routing",
  sequence: 65,
  capability: "service",
  enabled: true,
...
export const routing_62_4_definition = {
  domain: "routing",
  sequence: 66,
  capability: "service",
  enabled: true,
...
export const routing_62_5_definition = {
  domain: "routing",
  sequence: 67,
  capability: "service",
  enabled: true,
...
export const routing_62_6_definition = {
  domain: "routing",
  sequence: 68,
  capability: "service",
  enabled: true,
...
export const routing_62_7_definition = {
  domain: "routing",
  sequence: 69,
  capability: "service",
  enabled: true,
