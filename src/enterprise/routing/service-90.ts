...
export const routing_90_0_definition = {
  domain: "routing",
  sequence: 90,
  capability: "service",
  enabled: true,
...
export const routing_90_1_definition = {
  domain: "routing",
  sequence: 91,
  capability: "service",
  enabled: true,
...
export const routing_90_2_definition = {
  domain: "routing",
  sequence: 92,
  capability: "service",
  enabled: true,
...
export const routing_90_3_definition = {
  domain: "routing",
  sequence: 93,
  capability: "service",
  enabled: true,
...
export const routing_90_4_definition = {
  domain: "routing",
  sequence: 94,
  capability: "service",
  enabled: true,
...
export const routing_90_5_definition = {
  domain: "routing",
  sequence: 95,
  capability: "service",
  enabled: true,
...
export const routing_90_6_definition = {
  domain: "routing",
  sequence: 96,
  capability: "service",
  enabled: true,
...
export const routing_90_7_definition = {
  domain: "routing",
  sequence: 97,
  capability: "service",
  enabled: true,
