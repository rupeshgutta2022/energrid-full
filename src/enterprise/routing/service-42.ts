...
export const routing_42_0_definition = {
  domain: "routing",
  sequence: 42,
  capability: "service",
  enabled: true,
...
export const routing_42_1_definition = {
  domain: "routing",
  sequence: 43,
  capability: "service",
  enabled: true,
...
export const routing_42_2_definition = {
  domain: "routing",
  sequence: 44,
  capability: "service",
  enabled: true,
...
export const routing_42_3_definition = {
  domain: "routing",
  sequence: 45,
  capability: "service",
  enabled: true,
...
export const routing_42_4_definition = {
  domain: "routing",
  sequence: 46,
  capability: "service",
  enabled: true,
...
export const routing_42_5_definition = {
  domain: "routing",
  sequence: 47,
  capability: "service",
  enabled: true,
...
export const routing_42_6_definition = {
  domain: "routing",
  sequence: 48,
  capability: "service",
  enabled: true,
...
export const routing_42_7_definition = {
  domain: "routing",
  sequence: 49,
  capability: "service",
  enabled: true,
