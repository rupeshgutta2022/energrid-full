...
export const routing_174_0_definition = {
  domain: "routing",
  sequence: 174,
  capability: "service",
  enabled: true,
...
export const routing_174_1_definition = {
  domain: "routing",
  sequence: 175,
  capability: "service",
  enabled: true,
...
export const routing_174_2_definition = {
  domain: "routing",
  sequence: 176,
  capability: "service",
  enabled: true,
...
export const routing_174_3_definition = {
  domain: "routing",
  sequence: 177,
  capability: "service",
  enabled: true,
...
export const routing_174_4_definition = {
  domain: "routing",
  sequence: 178,
  capability: "service",
  enabled: true,
...
export const routing_174_5_definition = {
  domain: "routing",
  sequence: 179,
  capability: "service",
  enabled: true,
...
export const routing_174_6_definition = {
  domain: "routing",
  sequence: 180,
  capability: "service",
  enabled: true,
...
export const routing_174_7_definition = {
  domain: "routing",
  sequence: 181,
  capability: "service",
  enabled: true,
