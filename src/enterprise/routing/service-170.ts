...
export const routing_170_0_definition = {
  domain: "routing",
  sequence: 170,
  capability: "service",
  enabled: true,
...
export const routing_170_1_definition = {
  domain: "routing",
  sequence: 171,
  capability: "service",
  enabled: true,
...
export const routing_170_2_definition = {
  domain: "routing",
  sequence: 172,
  capability: "service",
  enabled: true,
...
export const routing_170_3_definition = {
  domain: "routing",
  sequence: 173,
  capability: "service",
  enabled: true,
...
export const routing_170_4_definition = {
  domain: "routing",
  sequence: 174,
  capability: "service",
  enabled: true,
...
export const routing_170_5_definition = {
  domain: "routing",
  sequence: 175,
  capability: "service",
  enabled: true,
...
export const routing_170_6_definition = {
  domain: "routing",
  sequence: 176,
  capability: "service",
  enabled: true,
...
export const routing_170_7_definition = {
  domain: "routing",
  sequence: 177,
  capability: "service",
  enabled: true,
