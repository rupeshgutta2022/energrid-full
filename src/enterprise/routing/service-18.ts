...
export const routing_18_0_definition = {
  domain: "routing",
  sequence: 18,
  capability: "service",
  enabled: true,
...
export const routing_18_1_definition = {
  domain: "routing",
  sequence: 19,
  capability: "service",
  enabled: true,
...
export const routing_18_2_definition = {
  domain: "routing",
  sequence: 20,
  capability: "service",
  enabled: true,
...
export const routing_18_3_definition = {
  domain: "routing",
  sequence: 21,
  capability: "service",
  enabled: true,
...
export const routing_18_4_definition = {
  domain: "routing",
  sequence: 22,
  capability: "service",
  enabled: true,
...
export const routing_18_5_definition = {
  domain: "routing",
  sequence: 23,
  capability: "service",
  enabled: true,
...
export const routing_18_6_definition = {
  domain: "routing",
  sequence: 24,
  capability: "service",
  enabled: true,
...
export const routing_18_7_definition = {
  domain: "routing",
  sequence: 25,
  capability: "service",
  enabled: true,
