...
export const routing_206_0_definition = {
  domain: "routing",
  sequence: 206,
  capability: "service",
  enabled: true,
...
export const routing_206_1_definition = {
  domain: "routing",
  sequence: 207,
  capability: "service",
  enabled: true,
...
export const routing_206_2_definition = {
  domain: "routing",
  sequence: 208,
  capability: "service",
  enabled: true,
...
export const routing_206_3_definition = {
  domain: "routing",
  sequence: 209,
  capability: "service",
  enabled: true,
...
export const routing_206_4_definition = {
  domain: "routing",
  sequence: 210,
  capability: "service",
  enabled: true,
...
export const routing_206_5_definition = {
  domain: "routing",
  sequence: 211,
  capability: "service",
  enabled: true,
...
export const routing_206_6_definition = {
  domain: "routing",
  sequence: 212,
  capability: "service",
  enabled: true,
...
export const routing_206_7_definition = {
  domain: "routing",
  sequence: 213,
  capability: "service",
  enabled: true,
