...
export const routing_38_0_definition = {
  domain: "routing",
  sequence: 38,
  capability: "service",
  enabled: true,
...
export const routing_38_1_definition = {
  domain: "routing",
  sequence: 39,
  capability: "service",
  enabled: true,
...
export const routing_38_2_definition = {
  domain: "routing",
  sequence: 40,
  capability: "service",
  enabled: true,
...
export const routing_38_3_definition = {
  domain: "routing",
  sequence: 41,
  capability: "service",
  enabled: true,
...
export const routing_38_4_definition = {
  domain: "routing",
  sequence: 42,
  capability: "service",
  enabled: true,
...
export const routing_38_5_definition = {
  domain: "routing",
  sequence: 43,
  capability: "service",
  enabled: true,
...
export const routing_38_6_definition = {
  domain: "routing",
  sequence: 44,
  capability: "service",
  enabled: true,
...
export const routing_38_7_definition = {
  domain: "routing",
  sequence: 45,
  capability: "service",
  enabled: true,
