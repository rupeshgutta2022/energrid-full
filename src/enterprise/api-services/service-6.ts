...
export const api_services_6_0_definition = {
  domain: "api-services",
  sequence: 6,
  capability: "service",
  enabled: true,
...
export const api_services_6_1_definition = {
  domain: "api-services",
  sequence: 7,
  capability: "service",
  enabled: true,
...
export const api_services_6_2_definition = {
  domain: "api-services",
  sequence: 8,
  capability: "service",
  enabled: true,
...
export const api_services_6_3_definition = {
  domain: "api-services",
  sequence: 9,
  capability: "service",
  enabled: true,
...
export const api_services_6_4_definition = {
  domain: "api-services",
  sequence: 10,
  capability: "service",
  enabled: true,
...
export const api_services_6_5_definition = {
  domain: "api-services",
  sequence: 11,
  capability: "service",
  enabled: true,
...
export const api_services_6_6_definition = {
  domain: "api-services",
  sequence: 12,
  capability: "service",
  enabled: true,
...
export const api_services_6_7_definition = {
  domain: "api-services",
  sequence: 13,
  capability: "service",
  enabled: true,
