...
export const api_services_178_0_definition = {
  domain: "api-services",
  sequence: 178,
  capability: "service",
  enabled: true,
...
export const api_services_178_1_definition = {
  domain: "api-services",
  sequence: 179,
  capability: "service",
  enabled: true,
...
export const api_services_178_2_definition = {
  domain: "api-services",
  sequence: 180,
  capability: "service",
  enabled: true,
...
export const api_services_178_3_definition = {
  domain: "api-services",
  sequence: 181,
  capability: "service",
  enabled: true,
...
export const api_services_178_4_definition = {
  domain: "api-services",
  sequence: 182,
  capability: "service",
  enabled: true,
...
export const api_services_178_5_definition = {
  domain: "api-services",
  sequence: 183,
  capability: "service",
  enabled: true,
...
export const api_services_178_6_definition = {
  domain: "api-services",
  sequence: 184,
  capability: "service",
  enabled: true,
...
export const api_services_178_7_definition = {
  domain: "api-services",
  sequence: 185,
  capability: "service",
  enabled: true,
