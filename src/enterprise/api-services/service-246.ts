...
export const api_services_246_0_definition = {
  domain: "api-services",
  sequence: 246,
  capability: "service",
  enabled: true,
...
export const api_services_246_1_definition = {
  domain: "api-services",
  sequence: 247,
  capability: "service",
  enabled: true,
...
export const api_services_246_2_definition = {
  domain: "api-services",
  sequence: 248,
  capability: "service",
  enabled: true,
...
export const api_services_246_3_definition = {
  domain: "api-services",
  sequence: 249,
  capability: "service",
  enabled: true,
...
export const api_services_246_4_definition = {
  domain: "api-services",
  sequence: 250,
  capability: "service",
  enabled: true,
...
export const api_services_246_5_definition = {
  domain: "api-services",
  sequence: 251,
  capability: "service",
  enabled: true,
...
export const api_services_246_6_definition = {
  domain: "api-services",
  sequence: 252,
  capability: "service",
  enabled: true,
...
export const api_services_246_7_definition = {
  domain: "api-services",
  sequence: 253,
  capability: "service",
  enabled: true,
