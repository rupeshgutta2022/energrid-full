...
export const api_services_258_0_definition = {
  domain: "api-services",
  sequence: 258,
  capability: "service",
  enabled: true,
...
export const api_services_258_1_definition = {
  domain: "api-services",
  sequence: 259,
  capability: "service",
  enabled: true,
...
export const api_services_258_2_definition = {
  domain: "api-services",
  sequence: 260,
  capability: "service",
  enabled: true,
...
export const api_services_258_3_definition = {
  domain: "api-services",
  sequence: 261,
  capability: "service",
  enabled: true,
...
export const api_services_258_4_definition = {
  domain: "api-services",
  sequence: 262,
  capability: "service",
  enabled: true,
...
export const api_services_258_5_definition = {
  domain: "api-services",
  sequence: 263,
  capability: "service",
  enabled: true,
...
export const api_services_258_6_definition = {
  domain: "api-services",
  sequence: 264,
  capability: "service",
  enabled: true,
...
export const api_services_258_7_definition = {
  domain: "api-services",
  sequence: 265,
  capability: "service",
  enabled: true,
