...
export const api_services_2_0_definition = {
  domain: "api-services",
  sequence: 2,
  capability: "service",
  enabled: true,
...
export const api_services_2_1_definition = {
  domain: "api-services",
  sequence: 3,
  capability: "service",
  enabled: true,
...
export const api_services_2_2_definition = {
  domain: "api-services",
  sequence: 4,
  capability: "service",
  enabled: true,
...
export const api_services_2_3_definition = {
  domain: "api-services",
  sequence: 5,
  capability: "service",
  enabled: true,
...
export const api_services_2_4_definition = {
  domain: "api-services",
  sequence: 6,
  capability: "service",
  enabled: true,
...
export const api_services_2_5_definition = {
  domain: "api-services",
  sequence: 7,
  capability: "service",
  enabled: true,
...
export const api_services_2_6_definition = {
  domain: "api-services",
  sequence: 8,
  capability: "service",
  enabled: true,
...
export const api_services_2_7_definition = {
  domain: "api-services",
  sequence: 9,
  capability: "service",
  enabled: true,
