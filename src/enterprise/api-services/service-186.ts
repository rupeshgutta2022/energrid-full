...
export const api_services_186_0_definition = {
  domain: "api-services",
  sequence: 186,
  capability: "service",
  enabled: true,
...
export const api_services_186_1_definition = {
  domain: "api-services",
  sequence: 187,
  capability: "service",
  enabled: true,
...
export const api_services_186_2_definition = {
  domain: "api-services",
  sequence: 188,
  capability: "service",
  enabled: true,
...
export const api_services_186_3_definition = {
  domain: "api-services",
  sequence: 189,
  capability: "service",
  enabled: true,
...
export const api_services_186_4_definition = {
  domain: "api-services",
  sequence: 190,
  capability: "service",
  enabled: true,
...
export const api_services_186_5_definition = {
  domain: "api-services",
  sequence: 191,
  capability: "service",
  enabled: true,
...
export const api_services_186_6_definition = {
  domain: "api-services",
  sequence: 192,
  capability: "service",
  enabled: true,
...
export const api_services_186_7_definition = {
  domain: "api-services",
  sequence: 193,
  capability: "service",
  enabled: true,
