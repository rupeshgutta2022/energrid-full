...
export const api_services_262_0_definition = {
  domain: "api-services",
  sequence: 262,
  capability: "service",
  enabled: true,
...
export const api_services_262_1_definition = {
  domain: "api-services",
  sequence: 263,
  capability: "service",
  enabled: true,
...
export const api_services_262_2_definition = {
  domain: "api-services",
  sequence: 264,
  capability: "service",
  enabled: true,
...
export const api_services_262_3_definition = {
  domain: "api-services",
  sequence: 265,
  capability: "service",
  enabled: true,
...
export const api_services_262_4_definition = {
  domain: "api-services",
  sequence: 266,
  capability: "service",
  enabled: true,
...
export const api_services_262_5_definition = {
  domain: "api-services",
  sequence: 267,
  capability: "service",
  enabled: true,
