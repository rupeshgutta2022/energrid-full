...
export const api_services_198_0_definition = {
  domain: "api-services",
  sequence: 198,
  capability: "service",
  enabled: true,
...
export const api_services_198_1_definition = {
  domain: "api-services",
  sequence: 199,
  capability: "service",
  enabled: true,
...
export const api_services_198_2_definition = {
  domain: "api-services",
  sequence: 200,
  capability: "service",
  enabled: true,
...
export const api_services_198_3_definition = {
  domain: "api-services",
  sequence: 201,
  capability: "service",
  enabled: true,
...
export const api_services_198_4_definition = {
  domain: "api-services",
  sequence: 202,
  capability: "service",
  enabled: true,
...
export const api_services_198_5_definition = {
  domain: "api-services",
  sequence: 203,
  capability: "service",
  enabled: true,
...
export const api_services_198_6_definition = {
  domain: "api-services",
  sequence: 204,
  capability: "service",
  enabled: true,
...
export const api_services_198_7_definition = {
  domain: "api-services",
  sequence: 205,
  capability: "service",
  enabled: true,
