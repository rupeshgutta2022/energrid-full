...
export const api_services_142_0_definition = {
  domain: "api-services",
  sequence: 142,
  capability: "service",
  enabled: true,
...
export const api_services_142_1_definition = {
  domain: "api-services",
  sequence: 143,
  capability: "service",
  enabled: true,
...
export const api_services_142_2_definition = {
  domain: "api-services",
  sequence: 144,
  capability: "service",
  enabled: true,
...
export const api_services_142_3_definition = {
  domain: "api-services",
  sequence: 145,
  capability: "service",
  enabled: true,
...
export const api_services_142_4_definition = {
  domain: "api-services",
  sequence: 146,
  capability: "service",
  enabled: true,
...
export const api_services_142_5_definition = {
  domain: "api-services",
  sequence: 147,
  capability: "service",
  enabled: true,
...
export const api_services_142_6_definition = {
  domain: "api-services",
  sequence: 148,
  capability: "service",
  enabled: true,
...
export const api_services_142_7_definition = {
  domain: "api-services",
  sequence: 149,
  capability: "service",
  enabled: true,
