...
export const api_services_134_0_definition = {
  domain: "api-services",
  sequence: 134,
  capability: "service",
  enabled: true,
...
export const api_services_134_1_definition = {
  domain: "api-services",
  sequence: 135,
  capability: "service",
  enabled: true,
...
export const api_services_134_2_definition = {
  domain: "api-services",
  sequence: 136,
  capability: "service",
  enabled: true,
...
export const api_services_134_3_definition = {
  domain: "api-services",
  sequence: 137,
  capability: "service",
  enabled: true,
...
export const api_services_134_4_definition = {
  domain: "api-services",
  sequence: 138,
  capability: "service",
  enabled: true,
...
export const api_services_134_5_definition = {
  domain: "api-services",
  sequence: 139,
  capability: "service",
  enabled: true,
...
export const api_services_134_6_definition = {
  domain: "api-services",
  sequence: 140,
  capability: "service",
  enabled: true,
...
export const api_services_134_7_definition = {
  domain: "api-services",
  sequence: 141,
  capability: "service",
  enabled: true,
