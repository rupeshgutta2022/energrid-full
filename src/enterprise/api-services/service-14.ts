...
export const api_services_14_0_definition = {
  domain: "api-services",
  sequence: 14,
  capability: "service",
  enabled: true,
...
export const api_services_14_1_definition = {
  domain: "api-services",
  sequence: 15,
  capability: "service",
  enabled: true,
...
export const api_services_14_2_definition = {
  domain: "api-services",
  sequence: 16,
  capability: "service",
  enabled: true,
...
export const api_services_14_3_definition = {
  domain: "api-services",
  sequence: 17,
  capability: "service",
  enabled: true,
...
export const api_services_14_4_definition = {
  domain: "api-services",
  sequence: 18,
  capability: "service",
  enabled: true,
...
export const api_services_14_5_definition = {
  domain: "api-services",
  sequence: 19,
  capability: "service",
  enabled: true,
...
export const api_services_14_6_definition = {
  domain: "api-services",
  sequence: 20,
  capability: "service",
  enabled: true,
...
export const api_services_14_7_definition = {
  domain: "api-services",
  sequence: 21,
  capability: "service",
  enabled: true,
