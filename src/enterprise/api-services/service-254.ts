...
export const api_services_254_0_definition = {
  domain: "api-services",
  sequence: 254,
  capability: "service",
  enabled: true,
...
export const api_services_254_1_definition = {
  domain: "api-services",
  sequence: 255,
  capability: "service",
  enabled: true,
...
export const api_services_254_2_definition = {
  domain: "api-services",
  sequence: 256,
  capability: "service",
  enabled: true,
...
export const api_services_254_3_definition = {
  domain: "api-services",
  sequence: 257,
  capability: "service",
  enabled: true,
...
export const api_services_254_4_definition = {
  domain: "api-services",
  sequence: 258,
  capability: "service",
  enabled: true,
...
export const api_services_254_5_definition = {
  domain: "api-services",
  sequence: 259,
  capability: "service",
  enabled: true,
...
export const api_services_254_6_definition = {
  domain: "api-services",
  sequence: 260,
  capability: "service",
  enabled: true,
...
export const api_services_254_7_definition = {
  domain: "api-services",
  sequence: 261,
  capability: "service",
  enabled: true,
