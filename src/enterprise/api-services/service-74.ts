...
export const api_services_74_0_definition = {
  domain: "api-services",
  sequence: 74,
  capability: "service",
  enabled: true,
...
export const api_services_74_1_definition = {
  domain: "api-services",
  sequence: 75,
  capability: "service",
  enabled: true,
...
export const api_services_74_2_definition = {
  domain: "api-services",
  sequence: 76,
  capability: "service",
  enabled: true,
...
export const api_services_74_3_definition = {
  domain: "api-services",
  sequence: 77,
  capability: "service",
  enabled: true,
...
export const api_services_74_4_definition = {
  domain: "api-services",
  sequence: 78,
  capability: "service",
  enabled: true,
...
export const api_services_74_5_definition = {
  domain: "api-services",
  sequence: 79,
  capability: "service",
  enabled: true,
...
export const api_services_74_6_definition = {
  domain: "api-services",
  sequence: 80,
  capability: "service",
  enabled: true,
...
export const api_services_74_7_definition = {
  domain: "api-services",
  sequence: 81,
  capability: "service",
  enabled: true,
