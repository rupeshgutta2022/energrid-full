...
export const api_services_94_0_definition = {
  domain: "api-services",
  sequence: 94,
  capability: "service",
  enabled: true,
...
export const api_services_94_1_definition = {
  domain: "api-services",
  sequence: 95,
  capability: "service",
  enabled: true,
...
export const api_services_94_2_definition = {
  domain: "api-services",
  sequence: 96,
  capability: "service",
  enabled: true,
...
export const api_services_94_3_definition = {
  domain: "api-services",
  sequence: 97,
  capability: "service",
  enabled: true,
...
export const api_services_94_4_definition = {
  domain: "api-services",
  sequence: 98,
  capability: "service",
  enabled: true,
...
export const api_services_94_5_definition = {
  domain: "api-services",
  sequence: 99,
  capability: "service",
  enabled: true,
...
export const api_services_94_6_definition = {
  domain: "api-services",
  sequence: 100,
  capability: "service",
  enabled: true,
...
export const api_services_94_7_definition = {
  domain: "api-services",
  sequence: 101,
  capability: "service",
  enabled: true,
