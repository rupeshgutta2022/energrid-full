...
export const api_services_222_0_definition = {
  domain: "api-services",
  sequence: 222,
  capability: "service",
  enabled: true,
...
export const api_services_222_1_definition = {
  domain: "api-services",
  sequence: 223,
  capability: "service",
  enabled: true,
...
export const api_services_222_2_definition = {
  domain: "api-services",
  sequence: 224,
  capability: "service",
  enabled: true,
...
export const api_services_222_3_definition = {
  domain: "api-services",
  sequence: 225,
  capability: "service",
  enabled: true,
...
export const api_services_222_4_definition = {
  domain: "api-services",
  sequence: 226,
  capability: "service",
  enabled: true,
...
export const api_services_222_5_definition = {
  domain: "api-services",
  sequence: 227,
  capability: "service",
  enabled: true,
...
export const api_services_222_6_definition = {
  domain: "api-services",
  sequence: 228,
  capability: "service",
  enabled: true,
...
export const api_services_222_7_definition = {
  domain: "api-services",
  sequence: 229,
  capability: "service",
  enabled: true,
