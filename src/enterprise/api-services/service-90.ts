...
export const api_services_90_0_definition = {
  domain: "api-services",
  sequence: 90,
  capability: "service",
  enabled: true,
...
export const api_services_90_1_definition = {
  domain: "api-services",
  sequence: 91,
  capability: "service",
  enabled: true,
...
export const api_services_90_2_definition = {
  domain: "api-services",
  sequence: 92,
  capability: "service",
  enabled: true,
...
export const api_services_90_3_definition = {
  domain: "api-services",
  sequence: 93,
  capability: "service",
  enabled: true,
...
export const api_services_90_4_definition = {
  domain: "api-services",
  sequence: 94,
  capability: "service",
  enabled: true,
...
export const api_services_90_5_definition = {
  domain: "api-services",
  sequence: 95,
  capability: "service",
  enabled: true,
...
export const api_services_90_6_definition = {
  domain: "api-services",
  sequence: 96,
  capability: "service",
  enabled: true,
...
export const api_services_90_7_definition = {
  domain: "api-services",
  sequence: 97,
  capability: "service",
  enabled: true,
