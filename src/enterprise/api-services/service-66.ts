...
export const api_services_66_0_definition = {
  domain: "api-services",
  sequence: 66,
  capability: "service",
  enabled: true,
...
export const api_services_66_1_definition = {
  domain: "api-services",
  sequence: 67,
  capability: "service",
  enabled: true,
...
export const api_services_66_2_definition = {
  domain: "api-services",
  sequence: 68,
  capability: "service",
  enabled: true,
...
export const api_services_66_3_definition = {
  domain: "api-services",
  sequence: 69,
  capability: "service",
  enabled: true,
...
export const api_services_66_4_definition = {
  domain: "api-services",
  sequence: 70,
  capability: "service",
  enabled: true,
...
export const api_services_66_5_definition = {
  domain: "api-services",
  sequence: 71,
  capability: "service",
  enabled: true,
...
export const api_services_66_6_definition = {
  domain: "api-services",
  sequence: 72,
  capability: "service",
  enabled: true,
...
export const api_services_66_7_definition = {
  domain: "api-services",
  sequence: 73,
  capability: "service",
  enabled: true,
