...
export const api_services_234_0_definition = {
  domain: "api-services",
  sequence: 234,
  capability: "service",
  enabled: true,
...
export const api_services_234_1_definition = {
  domain: "api-services",
  sequence: 235,
  capability: "service",
  enabled: true,
...
export const api_services_234_2_definition = {
  domain: "api-services",
  sequence: 236,
  capability: "service",
  enabled: true,
...
export const api_services_234_3_definition = {
  domain: "api-services",
  sequence: 237,
  capability: "service",
  enabled: true,
...
export const api_services_234_4_definition = {
  domain: "api-services",
  sequence: 238,
  capability: "service",
  enabled: true,
...
export const api_services_234_5_definition = {
  domain: "api-services",
  sequence: 239,
  capability: "service",
  enabled: true,
...
export const api_services_234_6_definition = {
  domain: "api-services",
  sequence: 240,
  capability: "service",
  enabled: true,
...
export const api_services_234_7_definition = {
  domain: "api-services",
  sequence: 241,
  capability: "service",
  enabled: true,
