...
export const api_services_238_0_definition = {
  domain: "api-services",
  sequence: 238,
  capability: "service",
  enabled: true,
...
export const api_services_238_1_definition = {
  domain: "api-services",
  sequence: 239,
  capability: "service",
  enabled: true,
...
export const api_services_238_2_definition = {
  domain: "api-services",
  sequence: 240,
  capability: "service",
  enabled: true,
...
export const api_services_238_3_definition = {
  domain: "api-services",
  sequence: 241,
  capability: "service",
  enabled: true,
...
export const api_services_238_4_definition = {
  domain: "api-services",
  sequence: 242,
  capability: "service",
  enabled: true,
...
export const api_services_238_5_definition = {
  domain: "api-services",
  sequence: 243,
  capability: "service",
  enabled: true,
...
export const api_services_238_6_definition = {
  domain: "api-services",
  sequence: 244,
  capability: "service",
  enabled: true,
...
export const api_services_238_7_definition = {
  domain: "api-services",
  sequence: 245,
  capability: "service",
  enabled: true,
