...
export const api_services_242_0_definition = {
  domain: "api-services",
  sequence: 242,
  capability: "service",
  enabled: true,
...
export const api_services_242_1_definition = {
  domain: "api-services",
  sequence: 243,
  capability: "service",
  enabled: true,
...
export const api_services_242_2_definition = {
  domain: "api-services",
  sequence: 244,
  capability: "service",
  enabled: true,
...
export const api_services_242_3_definition = {
  domain: "api-services",
  sequence: 245,
  capability: "service",
  enabled: true,
...
export const api_services_242_4_definition = {
  domain: "api-services",
  sequence: 246,
  capability: "service",
  enabled: true,
...
export const api_services_242_5_definition = {
  domain: "api-services",
  sequence: 247,
  capability: "service",
  enabled: true,
...
export const api_services_242_6_definition = {
  domain: "api-services",
  sequence: 248,
  capability: "service",
  enabled: true,
...
export const api_services_242_7_definition = {
  domain: "api-services",
  sequence: 249,
  capability: "service",
  enabled: true,
