...
export const api_services_26_0_definition = {
  domain: "api-services",
  sequence: 26,
  capability: "service",
  enabled: true,
...
export const api_services_26_1_definition = {
  domain: "api-services",
  sequence: 27,
  capability: "service",
  enabled: true,
...
export const api_services_26_2_definition = {
  domain: "api-services",
  sequence: 28,
  capability: "service",
  enabled: true,
...
export const api_services_26_3_definition = {
  domain: "api-services",
  sequence: 29,
  capability: "service",
  enabled: true,
...
export const api_services_26_4_definition = {
  domain: "api-services",
  sequence: 30,
  capability: "service",
  enabled: true,
...
export const api_services_26_5_definition = {
  domain: "api-services",
  sequence: 31,
  capability: "service",
  enabled: true,
...
export const api_services_26_6_definition = {
  domain: "api-services",
  sequence: 32,
  capability: "service",
  enabled: true,
...
export const api_services_26_7_definition = {
  domain: "api-services",
  sequence: 33,
  capability: "service",
  enabled: true,
