...
export const api_services_182_0_definition = {
  domain: "api-services",
  sequence: 182,
  capability: "service",
  enabled: true,
...
export const api_services_182_1_definition = {
  domain: "api-services",
  sequence: 183,
  capability: "service",
  enabled: true,
...
export const api_services_182_2_definition = {
  domain: "api-services",
  sequence: 184,
  capability: "service",
  enabled: true,
...
export const api_services_182_3_definition = {
  domain: "api-services",
  sequence: 185,
  capability: "service",
  enabled: true,
...
export const api_services_182_4_definition = {
  domain: "api-services",
  sequence: 186,
  capability: "service",
  enabled: true,
...
export const api_services_182_5_definition = {
  domain: "api-services",
  sequence: 187,
  capability: "service",
  enabled: true,
...
export const api_services_182_6_definition = {
  domain: "api-services",
  sequence: 188,
  capability: "service",
  enabled: true,
...
export const api_services_182_7_definition = {
  domain: "api-services",
  sequence: 189,
  capability: "service",
  enabled: true,
