...
export const api_services_214_0_definition = {
  domain: "api-services",
  sequence: 214,
  capability: "service",
  enabled: true,
...
export const api_services_214_1_definition = {
  domain: "api-services",
  sequence: 215,
  capability: "service",
  enabled: true,
...
export const api_services_214_2_definition = {
  domain: "api-services",
  sequence: 216,
  capability: "service",
  enabled: true,
...
export const api_services_214_3_definition = {
  domain: "api-services",
  sequence: 217,
  capability: "service",
  enabled: true,
...
export const api_services_214_4_definition = {
  domain: "api-services",
  sequence: 218,
  capability: "service",
  enabled: true,
...
export const api_services_214_5_definition = {
  domain: "api-services",
  sequence: 219,
  capability: "service",
  enabled: true,
...
export const api_services_214_6_definition = {
  domain: "api-services",
  sequence: 220,
  capability: "service",
  enabled: true,
...
export const api_services_214_7_definition = {
  domain: "api-services",
  sequence: 221,
  capability: "service",
  enabled: true,
