...
export const api_services_126_0_definition = {
  domain: "api-services",
  sequence: 126,
  capability: "service",
  enabled: true,
...
export const api_services_126_1_definition = {
  domain: "api-services",
  sequence: 127,
  capability: "service",
  enabled: true,
...
export const api_services_126_2_definition = {
  domain: "api-services",
  sequence: 128,
  capability: "service",
  enabled: true,
...
export const api_services_126_3_definition = {
  domain: "api-services",
  sequence: 129,
  capability: "service",
  enabled: true,
...
export const api_services_126_4_definition = {
  domain: "api-services",
  sequence: 130,
  capability: "service",
  enabled: true,
...
export const api_services_126_5_definition = {
  domain: "api-services",
  sequence: 131,
  capability: "service",
  enabled: true,
...
export const api_services_126_6_definition = {
  domain: "api-services",
  sequence: 132,
  capability: "service",
  enabled: true,
...
export const api_services_126_7_definition = {
  domain: "api-services",
  sequence: 133,
  capability: "service",
  enabled: true,
