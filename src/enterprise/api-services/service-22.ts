...
export const api_services_22_0_definition = {
  domain: "api-services",
  sequence: 22,
  capability: "service",
  enabled: true,
...
export const api_services_22_1_definition = {
  domain: "api-services",
  sequence: 23,
  capability: "service",
  enabled: true,
...
export const api_services_22_2_definition = {
  domain: "api-services",
  sequence: 24,
  capability: "service",
  enabled: true,
...
export const api_services_22_3_definition = {
  domain: "api-services",
  sequence: 25,
  capability: "service",
  enabled: true,
...
export const api_services_22_4_definition = {
  domain: "api-services",
  sequence: 26,
  capability: "service",
  enabled: true,
...
export const api_services_22_5_definition = {
  domain: "api-services",
  sequence: 27,
  capability: "service",
  enabled: true,
...
export const api_services_22_6_definition = {
  domain: "api-services",
  sequence: 28,
  capability: "service",
  enabled: true,
...
export const api_services_22_7_definition = {
  domain: "api-services",
  sequence: 29,
  capability: "service",
  enabled: true,
