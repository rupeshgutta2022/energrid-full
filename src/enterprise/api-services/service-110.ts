...
export const api_services_110_0_definition = {
  domain: "api-services",
  sequence: 110,
  capability: "service",
  enabled: true,
...
export const api_services_110_1_definition = {
  domain: "api-services",
  sequence: 111,
  capability: "service",
  enabled: true,
...
export const api_services_110_2_definition = {
  domain: "api-services",
  sequence: 112,
  capability: "service",
  enabled: true,
...
export const api_services_110_3_definition = {
  domain: "api-services",
  sequence: 113,
  capability: "service",
  enabled: true,
...
export const api_services_110_4_definition = {
  domain: "api-services",
  sequence: 114,
  capability: "service",
  enabled: true,
...
export const api_services_110_5_definition = {
  domain: "api-services",
  sequence: 115,
  capability: "service",
  enabled: true,
...
export const api_services_110_6_definition = {
  domain: "api-services",
  sequence: 116,
  capability: "service",
  enabled: true,
...
export const api_services_110_7_definition = {
  domain: "api-services",
  sequence: 117,
  capability: "service",
  enabled: true,
