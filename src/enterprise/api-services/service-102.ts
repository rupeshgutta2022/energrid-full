...
export const api_services_102_0_definition = {
  domain: "api-services",
  sequence: 102,
  capability: "service",
  enabled: true,
...
export const api_services_102_1_definition = {
  domain: "api-services",
  sequence: 103,
  capability: "service",
  enabled: true,
...
export const api_services_102_2_definition = {
  domain: "api-services",
  sequence: 104,
  capability: "service",
  enabled: true,
...
export const api_services_102_3_definition = {
  domain: "api-services",
  sequence: 105,
  capability: "service",
  enabled: true,
...
export const api_services_102_4_definition = {
  domain: "api-services",
  sequence: 106,
  capability: "service",
  enabled: true,
...
export const api_services_102_5_definition = {
  domain: "api-services",
  sequence: 107,
  capability: "service",
  enabled: true,
...
export const api_services_102_6_definition = {
  domain: "api-services",
  sequence: 108,
  capability: "service",
  enabled: true,
...
export const api_services_102_7_definition = {
  domain: "api-services",
  sequence: 109,
  capability: "service",
  enabled: true,
