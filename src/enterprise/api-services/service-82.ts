...
export const api_services_82_0_definition = {
  domain: "api-services",
  sequence: 82,
  capability: "service",
  enabled: true,
...
export const api_services_82_1_definition = {
  domain: "api-services",
  sequence: 83,
  capability: "service",
  enabled: true,
...
export const api_services_82_2_definition = {
  domain: "api-services",
  sequence: 84,
  capability: "service",
  enabled: true,
...
export const api_services_82_3_definition = {
  domain: "api-services",
  sequence: 85,
  capability: "service",
  enabled: true,
...
export const api_services_82_4_definition = {
  domain: "api-services",
  sequence: 86,
  capability: "service",
  enabled: true,
...
export const api_services_82_5_definition = {
  domain: "api-services",
  sequence: 87,
  capability: "service",
  enabled: true,
...
export const api_services_82_6_definition = {
  domain: "api-services",
  sequence: 88,
  capability: "service",
  enabled: true,
...
export const api_services_82_7_definition = {
  domain: "api-services",
  sequence: 89,
  capability: "service",
  enabled: true,
