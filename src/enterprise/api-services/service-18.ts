...
export const api_services_18_0_definition = {
  domain: "api-services",
  sequence: 18,
  capability: "service",
  enabled: true,
...
export const api_services_18_1_definition = {
  domain: "api-services",
  sequence: 19,
  capability: "service",
  enabled: true,
...
export const api_services_18_2_definition = {
  domain: "api-services",
  sequence: 20,
  capability: "service",
  enabled: true,
...
export const api_services_18_3_definition = {
  domain: "api-services",
  sequence: 21,
  capability: "service",
  enabled: true,
...
export const api_services_18_4_definition = {
  domain: "api-services",
  sequence: 22,
  capability: "service",
  enabled: true,
...
export const api_services_18_5_definition = {
  domain: "api-services",
  sequence: 23,
  capability: "service",
  enabled: true,
...
export const api_services_18_6_definition = {
  domain: "api-services",
  sequence: 24,
  capability: "service",
  enabled: true,
...
export const api_services_18_7_definition = {
  domain: "api-services",
  sequence: 25,
  capability: "service",
  enabled: true,
