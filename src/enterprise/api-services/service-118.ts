...
export const api_services_118_0_definition = {
  domain: "api-services",
  sequence: 118,
  capability: "service",
  enabled: true,
...
export const api_services_118_1_definition = {
  domain: "api-services",
  sequence: 119,
  capability: "service",
  enabled: true,
...
export const api_services_118_2_definition = {
  domain: "api-services",
  sequence: 120,
  capability: "service",
  enabled: true,
...
export const api_services_118_3_definition = {
  domain: "api-services",
  sequence: 121,
  capability: "service",
  enabled: true,
...
export const api_services_118_4_definition = {
  domain: "api-services",
  sequence: 122,
  capability: "service",
  enabled: true,
...
export const api_services_118_5_definition = {
  domain: "api-services",
  sequence: 123,
  capability: "service",
  enabled: true,
...
export const api_services_118_6_definition = {
  domain: "api-services",
  sequence: 124,
  capability: "service",
  enabled: true,
...
export const api_services_118_7_definition = {
  domain: "api-services",
  sequence: 125,
  capability: "service",
  enabled: true,
