...
export const api_services_210_0_definition = {
  domain: "api-services",
  sequence: 210,
  capability: "service",
  enabled: true,
...
export const api_services_210_1_definition = {
  domain: "api-services",
  sequence: 211,
  capability: "service",
  enabled: true,
...
export const api_services_210_2_definition = {
  domain: "api-services",
  sequence: 212,
  capability: "service",
  enabled: true,
...
export const api_services_210_3_definition = {
  domain: "api-services",
  sequence: 213,
  capability: "service",
  enabled: true,
...
export const api_services_210_4_definition = {
  domain: "api-services",
  sequence: 214,
  capability: "service",
  enabled: true,
...
export const api_services_210_5_definition = {
  domain: "api-services",
  sequence: 215,
  capability: "service",
  enabled: true,
...
export const api_services_210_6_definition = {
  domain: "api-services",
  sequence: 216,
  capability: "service",
  enabled: true,
...
export const api_services_210_7_definition = {
  domain: "api-services",
  sequence: 217,
  capability: "service",
  enabled: true,
