...
export const api_services_62_0_definition = {
  domain: "api-services",
  sequence: 62,
  capability: "service",
  enabled: true,
...
export const api_services_62_1_definition = {
  domain: "api-services",
  sequence: 63,
  capability: "service",
  enabled: true,
...
export const api_services_62_2_definition = {
  domain: "api-services",
  sequence: 64,
  capability: "service",
  enabled: true,
...
export const api_services_62_3_definition = {
  domain: "api-services",
  sequence: 65,
  capability: "service",
  enabled: true,
...
export const api_services_62_4_definition = {
  domain: "api-services",
  sequence: 66,
  capability: "service",
  enabled: true,
...
export const api_services_62_5_definition = {
  domain: "api-services",
  sequence: 67,
  capability: "service",
  enabled: true,
...
export const api_services_62_6_definition = {
  domain: "api-services",
  sequence: 68,
  capability: "service",
  enabled: true,
...
export const api_services_62_7_definition = {
  domain: "api-services",
  sequence: 69,
  capability: "service",
  enabled: true,
