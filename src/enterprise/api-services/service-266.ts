...
export const api_services_266_0_definition = {
  domain: "api-services",
  sequence: 266,
  capability: "service",
  enabled: true,
...
export const api_services_266_1_definition = {
  domain: "api-services",
  sequence: 267,
  capability: "service",
  enabled: true,
...
export const api_services_266_2_definition = {
  domain: "api-services",
  sequence: 268,
  capability: "service",
  enabled: true,
...
export const api_services_266_3_definition = {
  domain: "api-services",
  sequence: 269,
  capability: "service",
  enabled: true,
