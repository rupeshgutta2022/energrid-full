...
export const api_services_154_0_definition = {
  domain: "api-services",
  sequence: 154,
  capability: "service",
  enabled: true,
...
export const api_services_154_1_definition = {
  domain: "api-services",
  sequence: 155,
  capability: "service",
  enabled: true,
...
export const api_services_154_2_definition = {
  domain: "api-services",
  sequence: 156,
  capability: "service",
  enabled: true,
...
export const api_services_154_3_definition = {
  domain: "api-services",
  sequence: 157,
  capability: "service",
  enabled: true,
...
export const api_services_154_4_definition = {
  domain: "api-services",
  sequence: 158,
  capability: "service",
  enabled: true,
...
export const api_services_154_5_definition = {
  domain: "api-services",
  sequence: 159,
  capability: "service",
  enabled: true,
...
export const api_services_154_6_definition = {
  domain: "api-services",
  sequence: 160,
  capability: "service",
  enabled: true,
...
export const api_services_154_7_definition = {
  domain: "api-services",
  sequence: 161,
  capability: "service",
  enabled: true,
