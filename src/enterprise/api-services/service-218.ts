...
export const api_services_218_0_definition = {
  domain: "api-services",
  sequence: 218,
  capability: "service",
  enabled: true,
...
export const api_services_218_1_definition = {
  domain: "api-services",
  sequence: 219,
  capability: "service",
  enabled: true,
...
export const api_services_218_2_definition = {
  domain: "api-services",
  sequence: 220,
  capability: "service",
  enabled: true,
...
export const api_services_218_3_definition = {
  domain: "api-services",
  sequence: 221,
  capability: "service",
  enabled: true,
...
export const api_services_218_4_definition = {
  domain: "api-services",
  sequence: 222,
  capability: "service",
  enabled: true,
...
export const api_services_218_5_definition = {
  domain: "api-services",
  sequence: 223,
  capability: "service",
  enabled: true,
...
export const api_services_218_6_definition = {
  domain: "api-services",
  sequence: 224,
  capability: "service",
  enabled: true,
...
export const api_services_218_7_definition = {
  domain: "api-services",
  sequence: 225,
  capability: "service",
  enabled: true,
