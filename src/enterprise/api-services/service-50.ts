...
export const api_services_50_0_definition = {
  domain: "api-services",
  sequence: 50,
  capability: "service",
  enabled: true,
...
export const api_services_50_1_definition = {
  domain: "api-services",
  sequence: 51,
  capability: "service",
  enabled: true,
...
export const api_services_50_2_definition = {
  domain: "api-services",
  sequence: 52,
  capability: "service",
  enabled: true,
...
export const api_services_50_3_definition = {
  domain: "api-services",
  sequence: 53,
  capability: "service",
  enabled: true,
...
export const api_services_50_4_definition = {
  domain: "api-services",
  sequence: 54,
  capability: "service",
  enabled: true,
...
export const api_services_50_5_definition = {
  domain: "api-services",
  sequence: 55,
  capability: "service",
  enabled: true,
...
export const api_services_50_6_definition = {
  domain: "api-services",
  sequence: 56,
  capability: "service",
  enabled: true,
...
export const api_services_50_7_definition = {
  domain: "api-services",
  sequence: 57,
  capability: "service",
  enabled: true,
