...
export const api_services_250_0_definition = {
  domain: "api-services",
  sequence: 250,
  capability: "service",
  enabled: true,
...
export const api_services_250_1_definition = {
  domain: "api-services",
  sequence: 251,
  capability: "service",
  enabled: true,
...
export const api_services_250_2_definition = {
  domain: "api-services",
  sequence: 252,
  capability: "service",
  enabled: true,
...
export const api_services_250_3_definition = {
  domain: "api-services",
  sequence: 253,
  capability: "service",
  enabled: true,
...
export const api_services_250_4_definition = {
  domain: "api-services",
  sequence: 254,
  capability: "service",
  enabled: true,
...
export const api_services_250_5_definition = {
  domain: "api-services",
  sequence: 255,
  capability: "service",
  enabled: true,
...
export const api_services_250_6_definition = {
  domain: "api-services",
  sequence: 256,
  capability: "service",
  enabled: true,
...
export const api_services_250_7_definition = {
  domain: "api-services",
  sequence: 257,
  capability: "service",
  enabled: true,
