...
export const api_services_190_0_definition = {
  domain: "api-services",
  sequence: 190,
  capability: "service",
  enabled: true,
...
export const api_services_190_1_definition = {
  domain: "api-services",
  sequence: 191,
  capability: "service",
  enabled: true,
...
export const api_services_190_2_definition = {
  domain: "api-services",
  sequence: 192,
  capability: "service",
  enabled: true,
...
export const api_services_190_3_definition = {
  domain: "api-services",
  sequence: 193,
  capability: "service",
  enabled: true,
...
export const api_services_190_4_definition = {
  domain: "api-services",
  sequence: 194,
  capability: "service",
  enabled: true,
...
export const api_services_190_5_definition = {
  domain: "api-services",
  sequence: 195,
  capability: "service",
  enabled: true,
...
export const api_services_190_6_definition = {
  domain: "api-services",
  sequence: 196,
  capability: "service",
  enabled: true,
...
export const api_services_190_7_definition = {
  domain: "api-services",
  sequence: 197,
  capability: "service",
  enabled: true,
