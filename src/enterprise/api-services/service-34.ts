...
export const api_services_34_0_definition = {
  domain: "api-services",
  sequence: 34,
  capability: "service",
  enabled: true,
...
export const api_services_34_1_definition = {
  domain: "api-services",
  sequence: 35,
  capability: "service",
  enabled: true,
...
export const api_services_34_2_definition = {
  domain: "api-services",
  sequence: 36,
  capability: "service",
  enabled: true,
...
export const api_services_34_3_definition = {
  domain: "api-services",
  sequence: 37,
  capability: "service",
  enabled: true,
...
export const api_services_34_4_definition = {
  domain: "api-services",
  sequence: 38,
  capability: "service",
  enabled: true,
...
export const api_services_34_5_definition = {
  domain: "api-services",
  sequence: 39,
  capability: "service",
  enabled: true,
...
export const api_services_34_6_definition = {
  domain: "api-services",
  sequence: 40,
  capability: "service",
  enabled: true,
...
export const api_services_34_7_definition = {
  domain: "api-services",
  sequence: 41,
  capability: "service",
  enabled: true,
