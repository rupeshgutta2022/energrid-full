...
export const api_services_269_0_definition = {
  domain: "api-services",
  sequence: 269,
  capability: "models",
  enabled: true,
...
export const api_services_269_1_definition = {
  domain: "api-services",
  sequence: 270,
  capability: "models",
  enabled: true,
...
export const api_services_269_2_definition = {
  domain: "api-services",
  sequence: 271,
  capability: "models",
  enabled: true,
...
export const api_services_269_3_definition = {
  domain: "api-services",
  sequence: 272,
  capability: "models",
  enabled: true,
