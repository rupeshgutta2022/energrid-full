...
export const api_services_58_0_definition = {
  domain: "api-services",
  sequence: 58,
  capability: "service",
  enabled: true,
...
export const api_services_58_1_definition = {
  domain: "api-services",
  sequence: 59,
  capability: "service",
  enabled: true,
...
export const api_services_58_2_definition = {
  domain: "api-services",
  sequence: 60,
  capability: "service",
  enabled: true,
...
export const api_services_58_3_definition = {
  domain: "api-services",
  sequence: 61,
  capability: "service",
  enabled: true,
...
export const api_services_58_4_definition = {
  domain: "api-services",
  sequence: 62,
  capability: "service",
  enabled: true,
...
export const api_services_58_5_definition = {
  domain: "api-services",
  sequence: 63,
  capability: "service",
  enabled: true,
...
export const api_services_58_6_definition = {
  domain: "api-services",
  sequence: 64,
  capability: "service",
  enabled: true,
...
export const api_services_58_7_definition = {
  domain: "api-services",
  sequence: 65,
  capability: "service",
  enabled: true,
