...
export const api_services_78_0_definition = {
  domain: "api-services",
  sequence: 78,
  capability: "service",
  enabled: true,
...
export const api_services_78_1_definition = {
  domain: "api-services",
  sequence: 79,
  capability: "service",
  enabled: true,
...
export const api_services_78_2_definition = {
  domain: "api-services",
  sequence: 80,
  capability: "service",
  enabled: true,
...
export const api_services_78_3_definition = {
  domain: "api-services",
  sequence: 81,
  capability: "service",
  enabled: true,
...
export const api_services_78_4_definition = {
  domain: "api-services",
  sequence: 82,
  capability: "service",
  enabled: true,
...
export const api_services_78_5_definition = {
  domain: "api-services",
  sequence: 83,
  capability: "service",
  enabled: true,
...
export const api_services_78_6_definition = {
  domain: "api-services",
  sequence: 84,
  capability: "service",
  enabled: true,
...
export const api_services_78_7_definition = {
  domain: "api-services",
  sequence: 85,
  capability: "service",
  enabled: true,
