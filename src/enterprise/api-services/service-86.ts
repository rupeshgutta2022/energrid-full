...
export const api_services_86_0_definition = {
  domain: "api-services",
  sequence: 86,
  capability: "service",
  enabled: true,
...
export const api_services_86_1_definition = {
  domain: "api-services",
  sequence: 87,
  capability: "service",
  enabled: true,
...
export const api_services_86_2_definition = {
  domain: "api-services",
  sequence: 88,
  capability: "service",
  enabled: true,
...
export const api_services_86_3_definition = {
  domain: "api-services",
  sequence: 89,
  capability: "service",
  enabled: true,
...
export const api_services_86_4_definition = {
  domain: "api-services",
  sequence: 90,
  capability: "service",
  enabled: true,
...
export const api_services_86_5_definition = {
  domain: "api-services",
  sequence: 91,
  capability: "service",
  enabled: true,
...
export const api_services_86_6_definition = {
  domain: "api-services",
  sequence: 92,
  capability: "service",
  enabled: true,
...
export const api_services_86_7_definition = {
  domain: "api-services",
  sequence: 93,
  capability: "service",
  enabled: true,
