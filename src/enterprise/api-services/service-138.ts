...
export const api_services_138_0_definition = {
  domain: "api-services",
  sequence: 138,
  capability: "service",
  enabled: true,
...
export const api_services_138_1_definition = {
  domain: "api-services",
  sequence: 139,
  capability: "service",
  enabled: true,
...
export const api_services_138_2_definition = {
  domain: "api-services",
  sequence: 140,
  capability: "service",
  enabled: true,
...
export const api_services_138_3_definition = {
  domain: "api-services",
  sequence: 141,
  capability: "service",
  enabled: true,
...
export const api_services_138_4_definition = {
  domain: "api-services",
  sequence: 142,
  capability: "service",
  enabled: true,
...
export const api_services_138_5_definition = {
  domain: "api-services",
  sequence: 143,
  capability: "service",
  enabled: true,
...
export const api_services_138_6_definition = {
  domain: "api-services",
  sequence: 144,
  capability: "service",
  enabled: true,
...
export const api_services_138_7_definition = {
  domain: "api-services",
  sequence: 145,
  capability: "service",
  enabled: true,
