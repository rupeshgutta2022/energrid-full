...
export const api_services_226_0_definition = {
  domain: "api-services",
  sequence: 226,
  capability: "service",
  enabled: true,
...
export const api_services_226_1_definition = {
  domain: "api-services",
  sequence: 227,
  capability: "service",
  enabled: true,
...
export const api_services_226_2_definition = {
  domain: "api-services",
  sequence: 228,
  capability: "service",
  enabled: true,
...
export const api_services_226_3_definition = {
  domain: "api-services",
  sequence: 229,
  capability: "service",
  enabled: true,
...
export const api_services_226_4_definition = {
  domain: "api-services",
  sequence: 230,
  capability: "service",
  enabled: true,
...
export const api_services_226_5_definition = {
  domain: "api-services",
  sequence: 231,
  capability: "service",
  enabled: true,
...
export const api_services_226_6_definition = {
  domain: "api-services",
  sequence: 232,
  capability: "service",
  enabled: true,
...
export const api_services_226_7_definition = {
  domain: "api-services",
  sequence: 233,
  capability: "service",
  enabled: true,
