...
export const api_services_194_0_definition = {
  domain: "api-services",
  sequence: 194,
  capability: "service",
  enabled: true,
...
export const api_services_194_1_definition = {
  domain: "api-services",
  sequence: 195,
  capability: "service",
  enabled: true,
...
export const api_services_194_2_definition = {
  domain: "api-services",
  sequence: 196,
  capability: "service",
  enabled: true,
...
export const api_services_194_3_definition = {
  domain: "api-services",
  sequence: 197,
  capability: "service",
  enabled: true,
...
export const api_services_194_4_definition = {
  domain: "api-services",
  sequence: 198,
  capability: "service",
  enabled: true,
...
export const api_services_194_5_definition = {
  domain: "api-services",
  sequence: 199,
  capability: "service",
  enabled: true,
...
export const api_services_194_6_definition = {
  domain: "api-services",
  sequence: 200,
  capability: "service",
  enabled: true,
...
export const api_services_194_7_definition = {
  domain: "api-services",
  sequence: 201,
  capability: "service",
  enabled: true,
