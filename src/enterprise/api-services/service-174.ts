...
export const api_services_174_0_definition = {
  domain: "api-services",
  sequence: 174,
  capability: "service",
  enabled: true,
...
export const api_services_174_1_definition = {
  domain: "api-services",
  sequence: 175,
  capability: "service",
  enabled: true,
...
export const api_services_174_2_definition = {
  domain: "api-services",
  sequence: 176,
  capability: "service",
  enabled: true,
...
export const api_services_174_3_definition = {
  domain: "api-services",
  sequence: 177,
  capability: "service",
  enabled: true,
...
export const api_services_174_4_definition = {
  domain: "api-services",
  sequence: 178,
  capability: "service",
  enabled: true,
...
export const api_services_174_5_definition = {
  domain: "api-services",
  sequence: 179,
  capability: "service",
  enabled: true,
...
export const api_services_174_6_definition = {
  domain: "api-services",
  sequence: 180,
  capability: "service",
  enabled: true,
...
export const api_services_174_7_definition = {
  domain: "api-services",
  sequence: 181,
  capability: "service",
  enabled: true,
