...
export const api_services_98_0_definition = {
  domain: "api-services",
  sequence: 98,
  capability: "service",
  enabled: true,
...
export const api_services_98_1_definition = {
  domain: "api-services",
  sequence: 99,
  capability: "service",
  enabled: true,
...
export const api_services_98_2_definition = {
  domain: "api-services",
  sequence: 100,
  capability: "service",
  enabled: true,
...
export const api_services_98_3_definition = {
  domain: "api-services",
  sequence: 101,
  capability: "service",
  enabled: true,
...
export const api_services_98_4_definition = {
  domain: "api-services",
  sequence: 102,
  capability: "service",
  enabled: true,
...
export const api_services_98_5_definition = {
  domain: "api-services",
  sequence: 103,
  capability: "service",
  enabled: true,
...
export const api_services_98_6_definition = {
  domain: "api-services",
  sequence: 104,
  capability: "service",
  enabled: true,
...
export const api_services_98_7_definition = {
  domain: "api-services",
  sequence: 105,
  capability: "service",
  enabled: true,
