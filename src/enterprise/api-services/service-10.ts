...
export const api_services_10_0_definition = {
  domain: "api-services",
  sequence: 10,
  capability: "service",
  enabled: true,
...
export const api_services_10_1_definition = {
  domain: "api-services",
  sequence: 11,
  capability: "service",
  enabled: true,
...
export const api_services_10_2_definition = {
  domain: "api-services",
  sequence: 12,
  capability: "service",
  enabled: true,
...
export const api_services_10_3_definition = {
  domain: "api-services",
  sequence: 13,
  capability: "service",
  enabled: true,
...
export const api_services_10_4_definition = {
  domain: "api-services",
  sequence: 14,
  capability: "service",
  enabled: true,
...
export const api_services_10_5_definition = {
  domain: "api-services",
  sequence: 15,
  capability: "service",
  enabled: true,
...
export const api_services_10_6_definition = {
  domain: "api-services",
  sequence: 16,
  capability: "service",
  enabled: true,
...
export const api_services_10_7_definition = {
  domain: "api-services",
  sequence: 17,
  capability: "service",
  enabled: true,
