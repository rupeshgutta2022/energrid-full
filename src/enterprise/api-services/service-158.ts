...
export const api_services_158_0_definition = {
  domain: "api-services",
  sequence: 158,
  capability: "service",
  enabled: true,
...
export const api_services_158_1_definition = {
  domain: "api-services",
  sequence: 159,
  capability: "service",
  enabled: true,
...
export const api_services_158_2_definition = {
  domain: "api-services",
  sequence: 160,
  capability: "service",
  enabled: true,
...
export const api_services_158_3_definition = {
  domain: "api-services",
  sequence: 161,
  capability: "service",
  enabled: true,
...
export const api_services_158_4_definition = {
  domain: "api-services",
  sequence: 162,
  capability: "service",
  enabled: true,
...
export const api_services_158_5_definition = {
  domain: "api-services",
  sequence: 163,
  capability: "service",
  enabled: true,
...
export const api_services_158_6_definition = {
  domain: "api-services",
  sequence: 164,
  capability: "service",
  enabled: true,
...
export const api_services_158_7_definition = {
  domain: "api-services",
  sequence: 165,
  capability: "service",
  enabled: true,
