...
export const api_services_42_0_definition = {
  domain: "api-services",
  sequence: 42,
  capability: "service",
  enabled: true,
...
export const api_services_42_1_definition = {
  domain: "api-services",
  sequence: 43,
  capability: "service",
  enabled: true,
...
export const api_services_42_2_definition = {
  domain: "api-services",
  sequence: 44,
  capability: "service",
  enabled: true,
...
export const api_services_42_3_definition = {
  domain: "api-services",
  sequence: 45,
  capability: "service",
  enabled: true,
...
export const api_services_42_4_definition = {
  domain: "api-services",
  sequence: 46,
  capability: "service",
  enabled: true,
...
export const api_services_42_5_definition = {
  domain: "api-services",
  sequence: 47,
  capability: "service",
  enabled: true,
...
export const api_services_42_6_definition = {
  domain: "api-services",
  sequence: 48,
  capability: "service",
  enabled: true,
...
export const api_services_42_7_definition = {
  domain: "api-services",
  sequence: 49,
  capability: "service",
  enabled: true,
