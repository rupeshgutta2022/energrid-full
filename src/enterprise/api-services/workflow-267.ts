...
export const api_services_267_0_definition = {
  domain: "api-services",
  sequence: 267,
  capability: "workflow",
  enabled: true,
...
export const api_services_267_1_definition = {
  domain: "api-services",
  sequence: 268,
  capability: "workflow",
  enabled: true,
...
export const api_services_267_2_definition = {
  domain: "api-services",
  sequence: 269,
  capability: "workflow",
  enabled: true,
...
export const api_services_267_3_definition = {
  domain: "api-services",
  sequence: 270,
  capability: "workflow",
  enabled: true,
...
export const api_services_267_4_definition = {
  domain: "api-services",
  sequence: 271,
  capability: "workflow",
  enabled: true,
