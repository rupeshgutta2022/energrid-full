...
export const api_services_114_0_definition = {
  domain: "api-services",
  sequence: 114,
  capability: "service",
  enabled: true,
...
export const api_services_114_1_definition = {
  domain: "api-services",
  sequence: 115,
  capability: "service",
  enabled: true,
...
export const api_services_114_2_definition = {
  domain: "api-services",
  sequence: 116,
  capability: "service",
  enabled: true,
...
export const api_services_114_3_definition = {
  domain: "api-services",
  sequence: 117,
  capability: "service",
  enabled: true,
...
export const api_services_114_4_definition = {
  domain: "api-services",
  sequence: 118,
  capability: "service",
  enabled: true,
...
export const api_services_114_5_definition = {
  domain: "api-services",
  sequence: 119,
  capability: "service",
  enabled: true,
...
export const api_services_114_6_definition = {
  domain: "api-services",
  sequence: 120,
  capability: "service",
  enabled: true,
...
export const api_services_114_7_definition = {
  domain: "api-services",
  sequence: 121,
  capability: "service",
  enabled: true,
