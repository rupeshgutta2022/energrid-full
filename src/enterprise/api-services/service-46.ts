...
export const api_services_46_0_definition = {
  domain: "api-services",
  sequence: 46,
  capability: "service",
  enabled: true,
...
export const api_services_46_1_definition = {
  domain: "api-services",
  sequence: 47,
  capability: "service",
  enabled: true,
...
export const api_services_46_2_definition = {
  domain: "api-services",
  sequence: 48,
  capability: "service",
  enabled: true,
...
export const api_services_46_3_definition = {
  domain: "api-services",
  sequence: 49,
  capability: "service",
  enabled: true,
...
export const api_services_46_4_definition = {
  domain: "api-services",
  sequence: 50,
  capability: "service",
  enabled: true,
...
export const api_services_46_5_definition = {
  domain: "api-services",
  sequence: 51,
  capability: "service",
  enabled: true,
...
export const api_services_46_6_definition = {
  domain: "api-services",
  sequence: 52,
  capability: "service",
  enabled: true,
...
export const api_services_46_7_definition = {
  domain: "api-services",
  sequence: 53,
  capability: "service",
  enabled: true,
