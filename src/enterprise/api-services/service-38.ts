...
export const api_services_38_0_definition = {
  domain: "api-services",
  sequence: 38,
  capability: "service",
  enabled: true,
...
export const api_services_38_1_definition = {
  domain: "api-services",
  sequence: 39,
  capability: "service",
  enabled: true,
...
export const api_services_38_2_definition = {
  domain: "api-services",
  sequence: 40,
  capability: "service",
  enabled: true,
...
export const api_services_38_3_definition = {
  domain: "api-services",
  sequence: 41,
  capability: "service",
  enabled: true,
...
export const api_services_38_4_definition = {
  domain: "api-services",
  sequence: 42,
  capability: "service",
  enabled: true,
...
export const api_services_38_5_definition = {
  domain: "api-services",
  sequence: 43,
  capability: "service",
  enabled: true,
...
export const api_services_38_6_definition = {
  domain: "api-services",
  sequence: 44,
  capability: "service",
  enabled: true,
...
export const api_services_38_7_definition = {
  domain: "api-services",
  sequence: 45,
  capability: "service",
  enabled: true,
