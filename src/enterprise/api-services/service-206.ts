...
export const api_services_206_0_definition = {
  domain: "api-services",
  sequence: 206,
  capability: "service",
  enabled: true,
...
export const api_services_206_1_definition = {
  domain: "api-services",
  sequence: 207,
  capability: "service",
  enabled: true,
...
export const api_services_206_2_definition = {
  domain: "api-services",
  sequence: 208,
  capability: "service",
  enabled: true,
...
export const api_services_206_3_definition = {
  domain: "api-services",
  sequence: 209,
  capability: "service",
  enabled: true,
...
export const api_services_206_4_definition = {
  domain: "api-services",
  sequence: 210,
  capability: "service",
  enabled: true,
...
export const api_services_206_5_definition = {
  domain: "api-services",
  sequence: 211,
  capability: "service",
  enabled: true,
...
export const api_services_206_6_definition = {
  domain: "api-services",
  sequence: 212,
  capability: "service",
  enabled: true,
...
export const api_services_206_7_definition = {
  domain: "api-services",
  sequence: 213,
  capability: "service",
  enabled: true,
