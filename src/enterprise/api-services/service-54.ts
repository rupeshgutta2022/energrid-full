...
export const api_services_54_0_definition = {
  domain: "api-services",
  sequence: 54,
  capability: "service",
  enabled: true,
...
export const api_services_54_1_definition = {
  domain: "api-services",
  sequence: 55,
  capability: "service",
  enabled: true,
...
export const api_services_54_2_definition = {
  domain: "api-services",
  sequence: 56,
  capability: "service",
  enabled: true,
...
export const api_services_54_3_definition = {
  domain: "api-services",
  sequence: 57,
  capability: "service",
  enabled: true,
...
export const api_services_54_4_definition = {
  domain: "api-services",
  sequence: 58,
  capability: "service",
  enabled: true,
...
export const api_services_54_5_definition = {
  domain: "api-services",
  sequence: 59,
  capability: "service",
  enabled: true,
...
export const api_services_54_6_definition = {
  domain: "api-services",
  sequence: 60,
  capability: "service",
  enabled: true,
...
export const api_services_54_7_definition = {
  domain: "api-services",
  sequence: 61,
  capability: "service",
  enabled: true,
