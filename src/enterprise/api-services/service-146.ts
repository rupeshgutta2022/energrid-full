...
export const api_services_146_0_definition = {
  domain: "api-services",
  sequence: 146,
  capability: "service",
  enabled: true,
...
export const api_services_146_1_definition = {
  domain: "api-services",
  sequence: 147,
  capability: "service",
  enabled: true,
...
export const api_services_146_2_definition = {
  domain: "api-services",
  sequence: 148,
  capability: "service",
  enabled: true,
...
export const api_services_146_3_definition = {
  domain: "api-services",
  sequence: 149,
  capability: "service",
  enabled: true,
...
export const api_services_146_4_definition = {
  domain: "api-services",
  sequence: 150,
  capability: "service",
  enabled: true,
...
export const api_services_146_5_definition = {
  domain: "api-services",
  sequence: 151,
  capability: "service",
  enabled: true,
...
export const api_services_146_6_definition = {
  domain: "api-services",
  sequence: 152,
  capability: "service",
  enabled: true,
...
export const api_services_146_7_definition = {
  domain: "api-services",
  sequence: 153,
  capability: "service",
  enabled: true,
