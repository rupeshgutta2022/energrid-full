...
export const api_services_230_0_definition = {
  domain: "api-services",
  sequence: 230,
  capability: "service",
  enabled: true,
...
export const api_services_230_1_definition = {
  domain: "api-services",
  sequence: 231,
  capability: "service",
  enabled: true,
...
export const api_services_230_2_definition = {
  domain: "api-services",
  sequence: 232,
  capability: "service",
  enabled: true,
...
export const api_services_230_3_definition = {
  domain: "api-services",
  sequence: 233,
  capability: "service",
  enabled: true,
...
export const api_services_230_4_definition = {
  domain: "api-services",
  sequence: 234,
  capability: "service",
  enabled: true,
...
export const api_services_230_5_definition = {
  domain: "api-services",
  sequence: 235,
  capability: "service",
  enabled: true,
...
export const api_services_230_6_definition = {
  domain: "api-services",
  sequence: 236,
  capability: "service",
  enabled: true,
...
export const api_services_230_7_definition = {
  domain: "api-services",
  sequence: 237,
  capability: "service",
  enabled: true,
