...
export const api_services_30_0_definition = {
  domain: "api-services",
  sequence: 30,
  capability: "service",
  enabled: true,
...
export const api_services_30_1_definition = {
  domain: "api-services",
  sequence: 31,
  capability: "service",
  enabled: true,
...
export const api_services_30_2_definition = {
  domain: "api-services",
  sequence: 32,
  capability: "service",
  enabled: true,
...
export const api_services_30_3_definition = {
  domain: "api-services",
  sequence: 33,
  capability: "service",
  enabled: true,
...
export const api_services_30_4_definition = {
  domain: "api-services",
  sequence: 34,
  capability: "service",
  enabled: true,
...
export const api_services_30_5_definition = {
  domain: "api-services",
  sequence: 35,
  capability: "service",
  enabled: true,
...
export const api_services_30_6_definition = {
  domain: "api-services",
  sequence: 36,
  capability: "service",
  enabled: true,
...
export const api_services_30_7_definition = {
  domain: "api-services",
  sequence: 37,
  capability: "service",
  enabled: true,
