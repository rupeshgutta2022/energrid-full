...
export const api_services_166_0_definition = {
  domain: "api-services",
  sequence: 166,
  capability: "service",
  enabled: true,
...
export const api_services_166_1_definition = {
  domain: "api-services",
  sequence: 167,
  capability: "service",
  enabled: true,
...
export const api_services_166_2_definition = {
  domain: "api-services",
  sequence: 168,
  capability: "service",
  enabled: true,
...
export const api_services_166_3_definition = {
  domain: "api-services",
  sequence: 169,
  capability: "service",
  enabled: true,
...
export const api_services_166_4_definition = {
  domain: "api-services",
  sequence: 170,
  capability: "service",
  enabled: true,
...
export const api_services_166_5_definition = {
  domain: "api-services",
  sequence: 171,
  capability: "service",
  enabled: true,
...
export const api_services_166_6_definition = {
  domain: "api-services",
  sequence: 172,
  capability: "service",
  enabled: true,
...
export const api_services_166_7_definition = {
  domain: "api-services",
  sequence: 173,
  capability: "service",
  enabled: true,
