...
export const api_services_106_0_definition = {
  domain: "api-services",
  sequence: 106,
  capability: "service",
  enabled: true,
...
export const api_services_106_1_definition = {
  domain: "api-services",
  sequence: 107,
  capability: "service",
  enabled: true,
...
export const api_services_106_2_definition = {
  domain: "api-services",
  sequence: 108,
  capability: "service",
  enabled: true,
...
export const api_services_106_3_definition = {
  domain: "api-services",
  sequence: 109,
  capability: "service",
  enabled: true,
...
export const api_services_106_4_definition = {
  domain: "api-services",
  sequence: 110,
  capability: "service",
  enabled: true,
...
export const api_services_106_5_definition = {
  domain: "api-services",
  sequence: 111,
  capability: "service",
  enabled: true,
...
export const api_services_106_6_definition = {
  domain: "api-services",
  sequence: 112,
  capability: "service",
  enabled: true,
...
export const api_services_106_7_definition = {
  domain: "api-services",
  sequence: 113,
  capability: "service",
  enabled: true,
