...
export const api_services_162_0_definition = {
  domain: "api-services",
  sequence: 162,
  capability: "service",
  enabled: true,
...
export const api_services_162_1_definition = {
  domain: "api-services",
  sequence: 163,
  capability: "service",
  enabled: true,
...
export const api_services_162_2_definition = {
  domain: "api-services",
  sequence: 164,
  capability: "service",
  enabled: true,
...
export const api_services_162_3_definition = {
  domain: "api-services",
  sequence: 165,
  capability: "service",
  enabled: true,
...
export const api_services_162_4_definition = {
  domain: "api-services",
  sequence: 166,
  capability: "service",
  enabled: true,
...
export const api_services_162_5_definition = {
  domain: "api-services",
  sequence: 167,
  capability: "service",
  enabled: true,
...
export const api_services_162_6_definition = {
  domain: "api-services",
  sequence: 168,
  capability: "service",
  enabled: true,
...
export const api_services_162_7_definition = {
  domain: "api-services",
  sequence: 169,
  capability: "service",
  enabled: true,
