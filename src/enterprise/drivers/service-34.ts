...
export const drivers_34_0_definition = {
  domain: "drivers",
  sequence: 34,
  capability: "service",
  enabled: true,
...
export const drivers_34_1_definition = {
  domain: "drivers",
  sequence: 35,
  capability: "service",
  enabled: true,
...
export const drivers_34_2_definition = {
  domain: "drivers",
  sequence: 36,
  capability: "service",
  enabled: true,
...
export const drivers_34_3_definition = {
  domain: "drivers",
  sequence: 37,
  capability: "service",
  enabled: true,
...
export const drivers_34_4_definition = {
  domain: "drivers",
  sequence: 38,
  capability: "service",
  enabled: true,
...
export const drivers_34_5_definition = {
  domain: "drivers",
  sequence: 39,
  capability: "service",
  enabled: true,
...
export const drivers_34_6_definition = {
  domain: "drivers",
  sequence: 40,
  capability: "service",
  enabled: true,
...
export const drivers_34_7_definition = {
  domain: "drivers",
  sequence: 41,
  capability: "service",
  enabled: true,
