...
export const drivers_98_0_definition = {
  domain: "drivers",
  sequence: 98,
  capability: "service",
  enabled: true,
...
export const drivers_98_1_definition = {
  domain: "drivers",
  sequence: 99,
  capability: "service",
  enabled: true,
...
export const drivers_98_2_definition = {
  domain: "drivers",
  sequence: 100,
  capability: "service",
  enabled: true,
...
export const drivers_98_3_definition = {
  domain: "drivers",
  sequence: 101,
  capability: "service",
  enabled: true,
...
export const drivers_98_4_definition = {
  domain: "drivers",
  sequence: 102,
  capability: "service",
  enabled: true,
...
export const drivers_98_5_definition = {
  domain: "drivers",
  sequence: 103,
  capability: "service",
  enabled: true,
...
export const drivers_98_6_definition = {
  domain: "drivers",
  sequence: 104,
  capability: "service",
  enabled: true,
...
export const drivers_98_7_definition = {
  domain: "drivers",
  sequence: 105,
  capability: "service",
  enabled: true,
