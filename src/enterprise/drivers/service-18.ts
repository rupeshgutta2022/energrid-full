...
export const drivers_18_0_definition = {
  domain: "drivers",
  sequence: 18,
  capability: "service",
  enabled: true,
...
export const drivers_18_1_definition = {
  domain: "drivers",
  sequence: 19,
  capability: "service",
  enabled: true,
...
export const drivers_18_2_definition = {
  domain: "drivers",
  sequence: 20,
  capability: "service",
  enabled: true,
...
export const drivers_18_3_definition = {
  domain: "drivers",
  sequence: 21,
  capability: "service",
  enabled: true,
...
export const drivers_18_4_definition = {
  domain: "drivers",
  sequence: 22,
  capability: "service",
  enabled: true,
...
export const drivers_18_5_definition = {
  domain: "drivers",
  sequence: 23,
  capability: "service",
  enabled: true,
...
export const drivers_18_6_definition = {
  domain: "drivers",
  sequence: 24,
  capability: "service",
  enabled: true,
...
export const drivers_18_7_definition = {
  domain: "drivers",
  sequence: 25,
  capability: "service",
  enabled: true,
