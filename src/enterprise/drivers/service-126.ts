...
export const drivers_126_0_definition = {
  domain: "drivers",
  sequence: 126,
  capability: "service",
  enabled: true,
...
export const drivers_126_1_definition = {
  domain: "drivers",
  sequence: 127,
  capability: "service",
  enabled: true,
...
export const drivers_126_2_definition = {
  domain: "drivers",
  sequence: 128,
  capability: "service",
  enabled: true,
...
export const drivers_126_3_definition = {
  domain: "drivers",
  sequence: 129,
  capability: "service",
  enabled: true,
...
export const drivers_126_4_definition = {
  domain: "drivers",
  sequence: 130,
  capability: "service",
  enabled: true,
...
export const drivers_126_5_definition = {
  domain: "drivers",
  sequence: 131,
  capability: "service",
  enabled: true,
...
export const drivers_126_6_definition = {
  domain: "drivers",
  sequence: 132,
  capability: "service",
  enabled: true,
...
export const drivers_126_7_definition = {
  domain: "drivers",
  sequence: 133,
  capability: "service",
  enabled: true,
