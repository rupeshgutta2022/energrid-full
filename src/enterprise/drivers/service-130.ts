...
export const drivers_130_0_definition = {
  domain: "drivers",
  sequence: 130,
  capability: "service",
  enabled: true,
...
export const drivers_130_1_definition = {
  domain: "drivers",
  sequence: 131,
  capability: "service",
  enabled: true,
...
export const drivers_130_2_definition = {
  domain: "drivers",
  sequence: 132,
  capability: "service",
  enabled: true,
...
export const drivers_130_3_definition = {
  domain: "drivers",
  sequence: 133,
  capability: "service",
  enabled: true,
...
export const drivers_130_4_definition = {
  domain: "drivers",
  sequence: 134,
  capability: "service",
  enabled: true,
...
export const drivers_130_5_definition = {
  domain: "drivers",
  sequence: 135,
  capability: "service",
  enabled: true,
...
export const drivers_130_6_definition = {
  domain: "drivers",
  sequence: 136,
  capability: "service",
  enabled: true,
...
export const drivers_130_7_definition = {
  domain: "drivers",
  sequence: 137,
  capability: "service",
  enabled: true,
