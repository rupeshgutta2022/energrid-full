...
export const drivers_14_0_definition = {
  domain: "drivers",
  sequence: 14,
  capability: "service",
  enabled: true,
...
export const drivers_14_1_definition = {
  domain: "drivers",
  sequence: 15,
  capability: "service",
  enabled: true,
...
export const drivers_14_2_definition = {
  domain: "drivers",
  sequence: 16,
  capability: "service",
  enabled: true,
...
export const drivers_14_3_definition = {
  domain: "drivers",
  sequence: 17,
  capability: "service",
  enabled: true,
...
export const drivers_14_4_definition = {
  domain: "drivers",
  sequence: 18,
  capability: "service",
  enabled: true,
...
export const drivers_14_5_definition = {
  domain: "drivers",
  sequence: 19,
  capability: "service",
  enabled: true,
...
export const drivers_14_6_definition = {
  domain: "drivers",
  sequence: 20,
  capability: "service",
  enabled: true,
...
export const drivers_14_7_definition = {
  domain: "drivers",
  sequence: 21,
  capability: "service",
  enabled: true,
