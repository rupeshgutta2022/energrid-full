...
export const drivers_78_0_definition = {
  domain: "drivers",
  sequence: 78,
  capability: "service",
  enabled: true,
...
export const drivers_78_1_definition = {
  domain: "drivers",
  sequence: 79,
  capability: "service",
  enabled: true,
...
export const drivers_78_2_definition = {
  domain: "drivers",
  sequence: 80,
  capability: "service",
  enabled: true,
...
export const drivers_78_3_definition = {
  domain: "drivers",
  sequence: 81,
  capability: "service",
  enabled: true,
...
export const drivers_78_4_definition = {
  domain: "drivers",
  sequence: 82,
  capability: "service",
  enabled: true,
...
export const drivers_78_5_definition = {
  domain: "drivers",
  sequence: 83,
  capability: "service",
  enabled: true,
...
export const drivers_78_6_definition = {
  domain: "drivers",
  sequence: 84,
  capability: "service",
  enabled: true,
...
export const drivers_78_7_definition = {
  domain: "drivers",
  sequence: 85,
  capability: "service",
  enabled: true,
