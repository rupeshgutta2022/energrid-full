...
export const drivers_138_0_definition = {
  domain: "drivers",
  sequence: 138,
  capability: "service",
  enabled: true,
...
export const drivers_138_1_definition = {
  domain: "drivers",
  sequence: 139,
  capability: "service",
  enabled: true,
...
export const drivers_138_2_definition = {
  domain: "drivers",
  sequence: 140,
  capability: "service",
  enabled: true,
...
export const drivers_138_3_definition = {
  domain: "drivers",
  sequence: 141,
  capability: "service",
  enabled: true,
...
export const drivers_138_4_definition = {
  domain: "drivers",
  sequence: 142,
  capability: "service",
  enabled: true,
...
export const drivers_138_5_definition = {
  domain: "drivers",
  sequence: 143,
  capability: "service",
  enabled: true,
...
export const drivers_138_6_definition = {
  domain: "drivers",
  sequence: 144,
  capability: "service",
  enabled: true,
...
export const drivers_138_7_definition = {
  domain: "drivers",
  sequence: 145,
  capability: "service",
  enabled: true,
