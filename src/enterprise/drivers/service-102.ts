...
export const drivers_102_0_definition = {
  domain: "drivers",
  sequence: 102,
  capability: "service",
  enabled: true,
...
export const drivers_102_1_definition = {
  domain: "drivers",
  sequence: 103,
  capability: "service",
  enabled: true,
...
export const drivers_102_2_definition = {
  domain: "drivers",
  sequence: 104,
  capability: "service",
  enabled: true,
...
export const drivers_102_3_definition = {
  domain: "drivers",
  sequence: 105,
  capability: "service",
  enabled: true,
...
export const drivers_102_4_definition = {
  domain: "drivers",
  sequence: 106,
  capability: "service",
  enabled: true,
...
export const drivers_102_5_definition = {
  domain: "drivers",
  sequence: 107,
  capability: "service",
  enabled: true,
...
export const drivers_102_6_definition = {
  domain: "drivers",
  sequence: 108,
  capability: "service",
  enabled: true,
...
export const drivers_102_7_definition = {
  domain: "drivers",
  sequence: 109,
  capability: "service",
  enabled: true,
