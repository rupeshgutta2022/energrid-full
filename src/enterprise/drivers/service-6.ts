...
export const drivers_6_0_definition = {
  domain: "drivers",
  sequence: 6,
  capability: "service",
  enabled: true,
...
export const drivers_6_1_definition = {
  domain: "drivers",
  sequence: 7,
  capability: "service",
  enabled: true,
...
export const drivers_6_2_definition = {
  domain: "drivers",
  sequence: 8,
  capability: "service",
  enabled: true,
...
export const drivers_6_3_definition = {
  domain: "drivers",
  sequence: 9,
  capability: "service",
  enabled: true,
...
export const drivers_6_4_definition = {
  domain: "drivers",
  sequence: 10,
  capability: "service",
  enabled: true,
...
export const drivers_6_5_definition = {
  domain: "drivers",
  sequence: 11,
  capability: "service",
  enabled: true,
...
export const drivers_6_6_definition = {
  domain: "drivers",
  sequence: 12,
  capability: "service",
  enabled: true,
...
export const drivers_6_7_definition = {
  domain: "drivers",
  sequence: 13,
  capability: "service",
  enabled: true,
