...
export const drivers_66_0_definition = {
  domain: "drivers",
  sequence: 66,
  capability: "service",
  enabled: true,
...
export const drivers_66_1_definition = {
  domain: "drivers",
  sequence: 67,
  capability: "service",
  enabled: true,
...
export const drivers_66_2_definition = {
  domain: "drivers",
  sequence: 68,
  capability: "service",
  enabled: true,
...
export const drivers_66_3_definition = {
  domain: "drivers",
  sequence: 69,
  capability: "service",
  enabled: true,
...
export const drivers_66_4_definition = {
  domain: "drivers",
  sequence: 70,
  capability: "service",
  enabled: true,
...
export const drivers_66_5_definition = {
  domain: "drivers",
  sequence: 71,
  capability: "service",
  enabled: true,
...
export const drivers_66_6_definition = {
  domain: "drivers",
  sequence: 72,
  capability: "service",
  enabled: true,
...
export const drivers_66_7_definition = {
  domain: "drivers",
  sequence: 73,
  capability: "service",
  enabled: true,
