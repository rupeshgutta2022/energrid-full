...
export const drivers_94_0_definition = {
  domain: "drivers",
  sequence: 94,
  capability: "service",
  enabled: true,
...
export const drivers_94_1_definition = {
  domain: "drivers",
  sequence: 95,
  capability: "service",
  enabled: true,
...
export const drivers_94_2_definition = {
  domain: "drivers",
  sequence: 96,
  capability: "service",
  enabled: true,
...
export const drivers_94_3_definition = {
  domain: "drivers",
  sequence: 97,
  capability: "service",
  enabled: true,
...
export const drivers_94_4_definition = {
  domain: "drivers",
  sequence: 98,
  capability: "service",
  enabled: true,
...
export const drivers_94_5_definition = {
  domain: "drivers",
  sequence: 99,
  capability: "service",
  enabled: true,
...
export const drivers_94_6_definition = {
  domain: "drivers",
  sequence: 100,
  capability: "service",
  enabled: true,
...
export const drivers_94_7_definition = {
  domain: "drivers",
  sequence: 101,
  capability: "service",
  enabled: true,
