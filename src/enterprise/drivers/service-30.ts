...
export const drivers_30_0_definition = {
  domain: "drivers",
  sequence: 30,
  capability: "service",
  enabled: true,
...
export const drivers_30_1_definition = {
  domain: "drivers",
  sequence: 31,
  capability: "service",
  enabled: true,
...
export const drivers_30_2_definition = {
  domain: "drivers",
  sequence: 32,
  capability: "service",
  enabled: true,
...
export const drivers_30_3_definition = {
  domain: "drivers",
  sequence: 33,
  capability: "service",
  enabled: true,
...
export const drivers_30_4_definition = {
  domain: "drivers",
  sequence: 34,
  capability: "service",
  enabled: true,
...
export const drivers_30_5_definition = {
  domain: "drivers",
  sequence: 35,
  capability: "service",
  enabled: true,
...
export const drivers_30_6_definition = {
  domain: "drivers",
  sequence: 36,
  capability: "service",
  enabled: true,
...
export const drivers_30_7_definition = {
  domain: "drivers",
  sequence: 37,
  capability: "service",
  enabled: true,
