...
export const drivers_2_0_definition = {
  domain: "drivers",
  sequence: 2,
  capability: "service",
  enabled: true,
...
export const drivers_2_1_definition = {
  domain: "drivers",
  sequence: 3,
  capability: "service",
  enabled: true,
...
export const drivers_2_2_definition = {
  domain: "drivers",
  sequence: 4,
  capability: "service",
  enabled: true,
...
export const drivers_2_3_definition = {
  domain: "drivers",
  sequence: 5,
  capability: "service",
  enabled: true,
...
export const drivers_2_4_definition = {
  domain: "drivers",
  sequence: 6,
  capability: "service",
  enabled: true,
...
export const drivers_2_5_definition = {
  domain: "drivers",
  sequence: 7,
  capability: "service",
  enabled: true,
...
export const drivers_2_6_definition = {
  domain: "drivers",
  sequence: 8,
  capability: "service",
  enabled: true,
...
export const drivers_2_7_definition = {
  domain: "drivers",
  sequence: 9,
  capability: "service",
  enabled: true,
