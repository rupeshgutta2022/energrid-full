...
export const drivers_118_0_definition = {
  domain: "drivers",
  sequence: 118,
  capability: "service",
  enabled: true,
...
export const drivers_118_1_definition = {
  domain: "drivers",
  sequence: 119,
  capability: "service",
  enabled: true,
...
export const drivers_118_2_definition = {
  domain: "drivers",
  sequence: 120,
  capability: "service",
  enabled: true,
...
export const drivers_118_3_definition = {
  domain: "drivers",
  sequence: 121,
  capability: "service",
  enabled: true,
...
export const drivers_118_4_definition = {
  domain: "drivers",
  sequence: 122,
  capability: "service",
  enabled: true,
...
export const drivers_118_5_definition = {
  domain: "drivers",
  sequence: 123,
  capability: "service",
  enabled: true,
...
export const drivers_118_6_definition = {
  domain: "drivers",
  sequence: 124,
  capability: "service",
  enabled: true,
...
export const drivers_118_7_definition = {
  domain: "drivers",
  sequence: 125,
  capability: "service",
  enabled: true,
