...
export const drivers_114_0_definition = {
  domain: "drivers",
  sequence: 114,
  capability: "service",
  enabled: true,
...
export const drivers_114_1_definition = {
  domain: "drivers",
  sequence: 115,
  capability: "service",
  enabled: true,
...
export const drivers_114_2_definition = {
  domain: "drivers",
  sequence: 116,
  capability: "service",
  enabled: true,
...
export const drivers_114_3_definition = {
  domain: "drivers",
  sequence: 117,
  capability: "service",
  enabled: true,
...
export const drivers_114_4_definition = {
  domain: "drivers",
  sequence: 118,
  capability: "service",
  enabled: true,
...
export const drivers_114_5_definition = {
  domain: "drivers",
  sequence: 119,
  capability: "service",
  enabled: true,
...
export const drivers_114_6_definition = {
  domain: "drivers",
  sequence: 120,
  capability: "service",
  enabled: true,
...
export const drivers_114_7_definition = {
  domain: "drivers",
  sequence: 121,
  capability: "service",
  enabled: true,
