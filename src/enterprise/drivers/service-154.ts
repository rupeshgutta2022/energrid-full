...
export const drivers_154_0_definition = {
  domain: "drivers",
  sequence: 154,
  capability: "service",
  enabled: true,
...
export const drivers_154_1_definition = {
  domain: "drivers",
  sequence: 155,
  capability: "service",
  enabled: true,
...
export const drivers_154_2_definition = {
  domain: "drivers",
  sequence: 156,
  capability: "service",
  enabled: true,
...
export const drivers_154_3_definition = {
  domain: "drivers",
  sequence: 157,
  capability: "service",
  enabled: true,
...
export const drivers_154_4_definition = {
  domain: "drivers",
  sequence: 158,
  capability: "service",
  enabled: true,
...
export const drivers_154_5_definition = {
  domain: "drivers",
  sequence: 159,
  capability: "service",
  enabled: true,
