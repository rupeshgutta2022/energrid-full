...
export const drivers_70_0_definition = {
  domain: "drivers",
  sequence: 70,
  capability: "service",
  enabled: true,
...
export const drivers_70_1_definition = {
  domain: "drivers",
  sequence: 71,
  capability: "service",
  enabled: true,
...
export const drivers_70_2_definition = {
  domain: "drivers",
  sequence: 72,
  capability: "service",
  enabled: true,
...
export const drivers_70_3_definition = {
  domain: "drivers",
  sequence: 73,
  capability: "service",
  enabled: true,
...
export const drivers_70_4_definition = {
  domain: "drivers",
  sequence: 74,
  capability: "service",
  enabled: true,
...
export const drivers_70_5_definition = {
  domain: "drivers",
  sequence: 75,
  capability: "service",
  enabled: true,
...
export const drivers_70_6_definition = {
  domain: "drivers",
  sequence: 76,
  capability: "service",
  enabled: true,
...
export const drivers_70_7_definition = {
  domain: "drivers",
  sequence: 77,
  capability: "service",
  enabled: true,
