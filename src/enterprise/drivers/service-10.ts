...
export const drivers_10_0_definition = {
  domain: "drivers",
  sequence: 10,
  capability: "service",
  enabled: true,
...
export const drivers_10_1_definition = {
  domain: "drivers",
  sequence: 11,
  capability: "service",
  enabled: true,
...
export const drivers_10_2_definition = {
  domain: "drivers",
  sequence: 12,
  capability: "service",
  enabled: true,
...
export const drivers_10_3_definition = {
  domain: "drivers",
  sequence: 13,
  capability: "service",
  enabled: true,
...
export const drivers_10_4_definition = {
  domain: "drivers",
  sequence: 14,
  capability: "service",
  enabled: true,
...
export const drivers_10_5_definition = {
  domain: "drivers",
  sequence: 15,
  capability: "service",
  enabled: true,
...
export const drivers_10_6_definition = {
  domain: "drivers",
  sequence: 16,
  capability: "service",
  enabled: true,
...
export const drivers_10_7_definition = {
  domain: "drivers",
  sequence: 17,
  capability: "service",
  enabled: true,
