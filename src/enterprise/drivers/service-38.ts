...
export const drivers_38_0_definition = {
  domain: "drivers",
  sequence: 38,
  capability: "service",
  enabled: true,
...
export const drivers_38_1_definition = {
  domain: "drivers",
  sequence: 39,
  capability: "service",
  enabled: true,
...
export const drivers_38_2_definition = {
  domain: "drivers",
  sequence: 40,
  capability: "service",
  enabled: true,
...
export const drivers_38_3_definition = {
  domain: "drivers",
  sequence: 41,
  capability: "service",
  enabled: true,
...
export const drivers_38_4_definition = {
  domain: "drivers",
  sequence: 42,
  capability: "service",
  enabled: true,
...
export const drivers_38_5_definition = {
  domain: "drivers",
  sequence: 43,
  capability: "service",
  enabled: true,
...
export const drivers_38_6_definition = {
  domain: "drivers",
  sequence: 44,
  capability: "service",
  enabled: true,
...
export const drivers_38_7_definition = {
  domain: "drivers",
  sequence: 45,
  capability: "service",
  enabled: true,
