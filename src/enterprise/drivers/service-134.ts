...
export const drivers_134_0_definition = {
  domain: "drivers",
  sequence: 134,
  capability: "service",
  enabled: true,
...
export const drivers_134_1_definition = {
  domain: "drivers",
  sequence: 135,
  capability: "service",
  enabled: true,
...
export const drivers_134_2_definition = {
  domain: "drivers",
  sequence: 136,
  capability: "service",
  enabled: true,
...
export const drivers_134_3_definition = {
  domain: "drivers",
  sequence: 137,
  capability: "service",
  enabled: true,
...
export const drivers_134_4_definition = {
  domain: "drivers",
  sequence: 138,
  capability: "service",
  enabled: true,
...
export const drivers_134_5_definition = {
  domain: "drivers",
  sequence: 139,
  capability: "service",
  enabled: true,
...
export const drivers_134_6_definition = {
  domain: "drivers",
  sequence: 140,
  capability: "service",
  enabled: true,
...
export const drivers_134_7_definition = {
  domain: "drivers",
  sequence: 141,
  capability: "service",
  enabled: true,
