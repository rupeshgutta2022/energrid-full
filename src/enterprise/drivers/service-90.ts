...
export const drivers_90_0_definition = {
  domain: "drivers",
  sequence: 90,
  capability: "service",
  enabled: true,
...
export const drivers_90_1_definition = {
  domain: "drivers",
  sequence: 91,
  capability: "service",
  enabled: true,
...
export const drivers_90_2_definition = {
  domain: "drivers",
  sequence: 92,
  capability: "service",
  enabled: true,
...
export const drivers_90_3_definition = {
  domain: "drivers",
  sequence: 93,
  capability: "service",
  enabled: true,
...
export const drivers_90_4_definition = {
  domain: "drivers",
  sequence: 94,
  capability: "service",
  enabled: true,
...
export const drivers_90_5_definition = {
  domain: "drivers",
  sequence: 95,
  capability: "service",
  enabled: true,
...
export const drivers_90_6_definition = {
  domain: "drivers",
  sequence: 96,
  capability: "service",
  enabled: true,
...
export const drivers_90_7_definition = {
  domain: "drivers",
  sequence: 97,
  capability: "service",
  enabled: true,
