...
export const drivers_54_0_definition = {
  domain: "drivers",
  sequence: 54,
  capability: "service",
  enabled: true,
...
export const drivers_54_1_definition = {
  domain: "drivers",
  sequence: 55,
  capability: "service",
  enabled: true,
...
export const drivers_54_2_definition = {
  domain: "drivers",
  sequence: 56,
  capability: "service",
  enabled: true,
...
export const drivers_54_3_definition = {
  domain: "drivers",
  sequence: 57,
  capability: "service",
  enabled: true,
...
export const drivers_54_4_definition = {
  domain: "drivers",
  sequence: 58,
  capability: "service",
  enabled: true,
...
export const drivers_54_5_definition = {
  domain: "drivers",
  sequence: 59,
  capability: "service",
  enabled: true,
...
export const drivers_54_6_definition = {
  domain: "drivers",
  sequence: 60,
  capability: "service",
  enabled: true,
...
export const drivers_54_7_definition = {
  domain: "drivers",
  sequence: 61,
  capability: "service",
  enabled: true,
