...
export const drivers_26_0_definition = {
  domain: "drivers",
  sequence: 26,
  capability: "service",
  enabled: true,
...
export const drivers_26_1_definition = {
  domain: "drivers",
  sequence: 27,
  capability: "service",
  enabled: true,
...
export const drivers_26_2_definition = {
  domain: "drivers",
  sequence: 28,
  capability: "service",
  enabled: true,
...
export const drivers_26_3_definition = {
  domain: "drivers",
  sequence: 29,
  capability: "service",
  enabled: true,
...
export const drivers_26_4_definition = {
  domain: "drivers",
  sequence: 30,
  capability: "service",
  enabled: true,
...
export const drivers_26_5_definition = {
  domain: "drivers",
  sequence: 31,
  capability: "service",
  enabled: true,
...
export const drivers_26_6_definition = {
  domain: "drivers",
  sequence: 32,
  capability: "service",
  enabled: true,
...
export const drivers_26_7_definition = {
  domain: "drivers",
  sequence: 33,
  capability: "service",
  enabled: true,
