...
export const drivers_86_0_definition = {
  domain: "drivers",
  sequence: 86,
  capability: "service",
  enabled: true,
...
export const drivers_86_1_definition = {
  domain: "drivers",
  sequence: 87,
  capability: "service",
  enabled: true,
...
export const drivers_86_2_definition = {
  domain: "drivers",
  sequence: 88,
  capability: "service",
  enabled: true,
...
export const drivers_86_3_definition = {
  domain: "drivers",
  sequence: 89,
  capability: "service",
  enabled: true,
...
export const drivers_86_4_definition = {
  domain: "drivers",
  sequence: 90,
  capability: "service",
  enabled: true,
...
export const drivers_86_5_definition = {
  domain: "drivers",
  sequence: 91,
  capability: "service",
  enabled: true,
...
export const drivers_86_6_definition = {
  domain: "drivers",
  sequence: 92,
  capability: "service",
  enabled: true,
...
export const drivers_86_7_definition = {
  domain: "drivers",
  sequence: 93,
  capability: "service",
  enabled: true,
