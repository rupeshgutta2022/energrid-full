...
export const drivers_110_0_definition = {
  domain: "drivers",
  sequence: 110,
  capability: "service",
  enabled: true,
...
export const drivers_110_1_definition = {
  domain: "drivers",
  sequence: 111,
  capability: "service",
  enabled: true,
...
export const drivers_110_2_definition = {
  domain: "drivers",
  sequence: 112,
  capability: "service",
  enabled: true,
...
export const drivers_110_3_definition = {
  domain: "drivers",
  sequence: 113,
  capability: "service",
  enabled: true,
...
export const drivers_110_4_definition = {
  domain: "drivers",
  sequence: 114,
  capability: "service",
  enabled: true,
...
export const drivers_110_5_definition = {
  domain: "drivers",
  sequence: 115,
  capability: "service",
  enabled: true,
...
export const drivers_110_6_definition = {
  domain: "drivers",
  sequence: 116,
  capability: "service",
  enabled: true,
...
export const drivers_110_7_definition = {
  domain: "drivers",
  sequence: 117,
  capability: "service",
  enabled: true,
