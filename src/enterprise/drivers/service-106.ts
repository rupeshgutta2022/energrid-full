...
export const drivers_106_0_definition = {
  domain: "drivers",
  sequence: 106,
  capability: "service",
  enabled: true,
...
export const drivers_106_1_definition = {
  domain: "drivers",
  sequence: 107,
  capability: "service",
  enabled: true,
...
export const drivers_106_2_definition = {
  domain: "drivers",
  sequence: 108,
  capability: "service",
  enabled: true,
...
export const drivers_106_3_definition = {
  domain: "drivers",
  sequence: 109,
  capability: "service",
  enabled: true,
...
export const drivers_106_4_definition = {
  domain: "drivers",
  sequence: 110,
  capability: "service",
  enabled: true,
...
export const drivers_106_5_definition = {
  domain: "drivers",
  sequence: 111,
  capability: "service",
  enabled: true,
...
export const drivers_106_6_definition = {
  domain: "drivers",
  sequence: 112,
  capability: "service",
  enabled: true,
...
export const drivers_106_7_definition = {
  domain: "drivers",
  sequence: 113,
  capability: "service",
  enabled: true,
