...
export const drivers_146_0_definition = {
  domain: "drivers",
  sequence: 146,
  capability: "service",
  enabled: true,
...
export const drivers_146_1_definition = {
  domain: "drivers",
  sequence: 147,
  capability: "service",
  enabled: true,
...
export const drivers_146_2_definition = {
  domain: "drivers",
  sequence: 148,
  capability: "service",
  enabled: true,
...
export const drivers_146_3_definition = {
  domain: "drivers",
  sequence: 149,
  capability: "service",
  enabled: true,
...
export const drivers_146_4_definition = {
  domain: "drivers",
  sequence: 150,
  capability: "service",
  enabled: true,
...
export const drivers_146_5_definition = {
  domain: "drivers",
  sequence: 151,
  capability: "service",
  enabled: true,
...
export const drivers_146_6_definition = {
  domain: "drivers",
  sequence: 152,
  capability: "service",
  enabled: true,
...
export const drivers_146_7_definition = {
  domain: "drivers",
  sequence: 153,
  capability: "service",
  enabled: true,
