...
export const drivers_22_0_definition = {
  domain: "drivers",
  sequence: 22,
  capability: "service",
  enabled: true,
...
export const drivers_22_1_definition = {
  domain: "drivers",
  sequence: 23,
  capability: "service",
  enabled: true,
...
export const drivers_22_2_definition = {
  domain: "drivers",
  sequence: 24,
  capability: "service",
  enabled: true,
...
export const drivers_22_3_definition = {
  domain: "drivers",
  sequence: 25,
  capability: "service",
  enabled: true,
...
export const drivers_22_4_definition = {
  domain: "drivers",
  sequence: 26,
  capability: "service",
  enabled: true,
...
export const drivers_22_5_definition = {
  domain: "drivers",
  sequence: 27,
  capability: "service",
  enabled: true,
...
export const drivers_22_6_definition = {
  domain: "drivers",
  sequence: 28,
  capability: "service",
  enabled: true,
...
export const drivers_22_7_definition = {
  domain: "drivers",
  sequence: 29,
  capability: "service",
  enabled: true,
