...
export const drivers_62_0_definition = {
  domain: "drivers",
  sequence: 62,
  capability: "service",
  enabled: true,
...
export const drivers_62_1_definition = {
  domain: "drivers",
  sequence: 63,
  capability: "service",
  enabled: true,
...
export const drivers_62_2_definition = {
  domain: "drivers",
  sequence: 64,
  capability: "service",
  enabled: true,
...
export const drivers_62_3_definition = {
  domain: "drivers",
  sequence: 65,
  capability: "service",
  enabled: true,
...
export const drivers_62_4_definition = {
  domain: "drivers",
  sequence: 66,
  capability: "service",
  enabled: true,
...
export const drivers_62_5_definition = {
  domain: "drivers",
  sequence: 67,
  capability: "service",
  enabled: true,
...
export const drivers_62_6_definition = {
  domain: "drivers",
  sequence: 68,
  capability: "service",
  enabled: true,
...
export const drivers_62_7_definition = {
  domain: "drivers",
  sequence: 69,
  capability: "service",
  enabled: true,
