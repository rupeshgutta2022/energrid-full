...
export const drivers_42_0_definition = {
  domain: "drivers",
  sequence: 42,
  capability: "service",
  enabled: true,
...
export const drivers_42_1_definition = {
  domain: "drivers",
  sequence: 43,
  capability: "service",
  enabled: true,
...
export const drivers_42_2_definition = {
  domain: "drivers",
  sequence: 44,
  capability: "service",
  enabled: true,
...
export const drivers_42_3_definition = {
  domain: "drivers",
  sequence: 45,
  capability: "service",
  enabled: true,
...
export const drivers_42_4_definition = {
  domain: "drivers",
  sequence: 46,
  capability: "service",
  enabled: true,
...
export const drivers_42_5_definition = {
  domain: "drivers",
  sequence: 47,
  capability: "service",
  enabled: true,
...
export const drivers_42_6_definition = {
  domain: "drivers",
  sequence: 48,
  capability: "service",
  enabled: true,
...
export const drivers_42_7_definition = {
  domain: "drivers",
  sequence: 49,
  capability: "service",
  enabled: true,
