...
export const drivers_142_0_definition = {
  domain: "drivers",
  sequence: 142,
  capability: "service",
  enabled: true,
...
export const drivers_142_1_definition = {
  domain: "drivers",
  sequence: 143,
  capability: "service",
  enabled: true,
...
export const drivers_142_2_definition = {
  domain: "drivers",
  sequence: 144,
  capability: "service",
  enabled: true,
...
export const drivers_142_3_definition = {
  domain: "drivers",
  sequence: 145,
  capability: "service",
  enabled: true,
...
export const drivers_142_4_definition = {
  domain: "drivers",
  sequence: 146,
  capability: "service",
  enabled: true,
...
export const drivers_142_5_definition = {
  domain: "drivers",
  sequence: 147,
  capability: "service",
  enabled: true,
...
export const drivers_142_6_definition = {
  domain: "drivers",
  sequence: 148,
  capability: "service",
  enabled: true,
...
export const drivers_142_7_definition = {
  domain: "drivers",
  sequence: 149,
  capability: "service",
  enabled: true,
