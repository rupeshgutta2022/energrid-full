...
export const drivers_46_0_definition = {
  domain: "drivers",
  sequence: 46,
  capability: "service",
  enabled: true,
...
export const drivers_46_1_definition = {
  domain: "drivers",
  sequence: 47,
  capability: "service",
  enabled: true,
...
export const drivers_46_2_definition = {
  domain: "drivers",
  sequence: 48,
  capability: "service",
  enabled: true,
...
export const drivers_46_3_definition = {
  domain: "drivers",
  sequence: 49,
  capability: "service",
  enabled: true,
...
export const drivers_46_4_definition = {
  domain: "drivers",
  sequence: 50,
  capability: "service",
  enabled: true,
...
export const drivers_46_5_definition = {
  domain: "drivers",
  sequence: 51,
  capability: "service",
  enabled: true,
...
export const drivers_46_6_definition = {
  domain: "drivers",
  sequence: 52,
  capability: "service",
  enabled: true,
...
export const drivers_46_7_definition = {
  domain: "drivers",
  sequence: 53,
  capability: "service",
  enabled: true,
