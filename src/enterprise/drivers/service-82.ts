...
export const drivers_82_0_definition = {
  domain: "drivers",
  sequence: 82,
  capability: "service",
  enabled: true,
...
export const drivers_82_1_definition = {
  domain: "drivers",
  sequence: 83,
  capability: "service",
  enabled: true,
...
export const drivers_82_2_definition = {
  domain: "drivers",
  sequence: 84,
  capability: "service",
  enabled: true,
...
export const drivers_82_3_definition = {
  domain: "drivers",
  sequence: 85,
  capability: "service",
  enabled: true,
...
export const drivers_82_4_definition = {
  domain: "drivers",
  sequence: 86,
  capability: "service",
  enabled: true,
...
export const drivers_82_5_definition = {
  domain: "drivers",
  sequence: 87,
  capability: "service",
  enabled: true,
...
export const drivers_82_6_definition = {
  domain: "drivers",
  sequence: 88,
  capability: "service",
  enabled: true,
...
export const drivers_82_7_definition = {
  domain: "drivers",
  sequence: 89,
  capability: "service",
  enabled: true,
