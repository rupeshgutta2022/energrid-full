...
export const crm_78_0_definition = {
  domain: "crm",
  sequence: 78,
  capability: "service",
  enabled: true,
...
export const crm_78_1_definition = {
  domain: "crm",
  sequence: 79,
  capability: "service",
  enabled: true,
...
export const crm_78_2_definition = {
  domain: "crm",
  sequence: 80,
  capability: "service",
  enabled: true,
...
export const crm_78_3_definition = {
  domain: "crm",
  sequence: 81,
  capability: "service",
  enabled: true,
...
export const crm_78_4_definition = {
  domain: "crm",
  sequence: 82,
  capability: "service",
  enabled: true,
...
export const crm_78_5_definition = {
  domain: "crm",
  sequence: 83,
  capability: "service",
  enabled: true,
...
export const crm_78_6_definition = {
  domain: "crm",
  sequence: 84,
  capability: "service",
  enabled: true,
...
export const crm_78_7_definition = {
  domain: "crm",
  sequence: 85,
  capability: "service",
  enabled: true,
