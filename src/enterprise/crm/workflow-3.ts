...
export const crm_3_0_definition = {
  domain: "crm",
  sequence: 3,
  capability: "workflow",
  enabled: true,
...
export const crm_3_1_definition = {
  domain: "crm",
  sequence: 4,
  capability: "workflow",
  enabled: true,
...
export const crm_3_2_definition = {
  domain: "crm",
  sequence: 5,
  capability: "workflow",
  enabled: true,
...
export const crm_3_3_definition = {
  domain: "crm",
  sequence: 6,
  capability: "workflow",
  enabled: true,
...
export const crm_3_4_definition = {
  domain: "crm",
  sequence: 7,
  capability: "workflow",
  enabled: true,
...
export const crm_3_5_definition = {
  domain: "crm",
  sequence: 8,
  capability: "workflow",
  enabled: true,
...
export const crm_3_6_definition = {
  domain: "crm",
  sequence: 9,
  capability: "workflow",
  enabled: true,
...
export const crm_3_7_definition = {
  domain: "crm",
  sequence: 10,
  capability: "workflow",
  enabled: true,
