...
export const crm_38_0_definition = {
  domain: "crm",
  sequence: 38,
  capability: "service",
  enabled: true,
...
export const crm_38_1_definition = {
  domain: "crm",
  sequence: 39,
  capability: "service",
  enabled: true,
...
export const crm_38_2_definition = {
  domain: "crm",
  sequence: 40,
  capability: "service",
  enabled: true,
...
export const crm_38_3_definition = {
  domain: "crm",
  sequence: 41,
  capability: "service",
  enabled: true,
...
export const crm_38_4_definition = {
  domain: "crm",
  sequence: 42,
  capability: "service",
  enabled: true,
...
export const crm_38_5_definition = {
  domain: "crm",
  sequence: 43,
  capability: "service",
  enabled: true,
...
export const crm_38_6_definition = {
  domain: "crm",
  sequence: 44,
  capability: "service",
  enabled: true,
...
export const crm_38_7_definition = {
  domain: "crm",
  sequence: 45,
  capability: "service",
  enabled: true,
