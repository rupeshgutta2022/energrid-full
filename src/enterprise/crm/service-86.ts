...
export const crm_86_0_definition = {
  domain: "crm",
  sequence: 86,
  capability: "service",
  enabled: true,
...
export const crm_86_1_definition = {
  domain: "crm",
  sequence: 87,
  capability: "service",
  enabled: true,
...
export const crm_86_2_definition = {
  domain: "crm",
  sequence: 88,
  capability: "service",
  enabled: true,
...
export const crm_86_3_definition = {
  domain: "crm",
  sequence: 89,
  capability: "service",
  enabled: true,
...
export const crm_86_4_definition = {
  domain: "crm",
  sequence: 90,
  capability: "service",
  enabled: true,
...
export const crm_86_5_definition = {
  domain: "crm",
  sequence: 91,
  capability: "service",
  enabled: true,
...
export const crm_86_6_definition = {
  domain: "crm",
  sequence: 92,
  capability: "service",
  enabled: true,
...
export const crm_86_7_definition = {
  domain: "crm",
  sequence: 93,
  capability: "service",
  enabled: true,
