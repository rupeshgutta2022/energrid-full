...
export const crm_54_0_definition = {
  domain: "crm",
  sequence: 54,
  capability: "service",
  enabled: true,
...
export const crm_54_1_definition = {
  domain: "crm",
  sequence: 55,
  capability: "service",
  enabled: true,
...
export const crm_54_2_definition = {
  domain: "crm",
  sequence: 56,
  capability: "service",
  enabled: true,
...
export const crm_54_3_definition = {
  domain: "crm",
  sequence: 57,
  capability: "service",
  enabled: true,
...
export const crm_54_4_definition = {
  domain: "crm",
  sequence: 58,
  capability: "service",
  enabled: true,
...
export const crm_54_5_definition = {
  domain: "crm",
  sequence: 59,
  capability: "service",
  enabled: true,
...
export const crm_54_6_definition = {
  domain: "crm",
  sequence: 60,
  capability: "service",
  enabled: true,
...
export const crm_54_7_definition = {
  domain: "crm",
  sequence: 61,
  capability: "service",
  enabled: true,
