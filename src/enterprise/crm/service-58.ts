...
export const crm_58_0_definition = {
  domain: "crm",
  sequence: 58,
  capability: "service",
  enabled: true,
...
export const crm_58_1_definition = {
  domain: "crm",
  sequence: 59,
  capability: "service",
  enabled: true,
...
export const crm_58_2_definition = {
  domain: "crm",
  sequence: 60,
  capability: "service",
  enabled: true,
...
export const crm_58_3_definition = {
  domain: "crm",
  sequence: 61,
  capability: "service",
  enabled: true,
...
export const crm_58_4_definition = {
  domain: "crm",
  sequence: 62,
  capability: "service",
  enabled: true,
...
export const crm_58_5_definition = {
  domain: "crm",
  sequence: 63,
  capability: "service",
  enabled: true,
...
export const crm_58_6_definition = {
  domain: "crm",
  sequence: 64,
  capability: "service",
  enabled: true,
...
export const crm_58_7_definition = {
  domain: "crm",
  sequence: 65,
  capability: "service",
  enabled: true,
