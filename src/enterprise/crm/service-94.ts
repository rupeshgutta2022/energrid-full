...
export const crm_94_0_definition = {
  domain: "crm",
  sequence: 94,
  capability: "service",
  enabled: true,
...
export const crm_94_1_definition = {
  domain: "crm",
  sequence: 95,
  capability: "service",
  enabled: true,
...
export const crm_94_2_definition = {
  domain: "crm",
  sequence: 96,
  capability: "service",
  enabled: true,
...
export const crm_94_3_definition = {
  domain: "crm",
  sequence: 97,
  capability: "service",
  enabled: true,
...
export const crm_94_4_definition = {
  domain: "crm",
  sequence: 98,
  capability: "service",
  enabled: true,
...
export const crm_94_5_definition = {
  domain: "crm",
  sequence: 99,
  capability: "service",
  enabled: true,
...
export const crm_94_6_definition = {
  domain: "crm",
  sequence: 100,
  capability: "service",
  enabled: true,
...
export const crm_94_7_definition = {
  domain: "crm",
  sequence: 101,
  capability: "service",
  enabled: true,
