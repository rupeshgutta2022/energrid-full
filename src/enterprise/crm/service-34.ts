...
export const crm_34_0_definition = {
  domain: "crm",
  sequence: 34,
  capability: "service",
  enabled: true,
...
export const crm_34_1_definition = {
  domain: "crm",
  sequence: 35,
  capability: "service",
  enabled: true,
...
export const crm_34_2_definition = {
  domain: "crm",
  sequence: 36,
  capability: "service",
  enabled: true,
...
export const crm_34_3_definition = {
  domain: "crm",
  sequence: 37,
  capability: "service",
  enabled: true,
...
export const crm_34_4_definition = {
  domain: "crm",
  sequence: 38,
  capability: "service",
  enabled: true,
...
export const crm_34_5_definition = {
  domain: "crm",
  sequence: 39,
  capability: "service",
  enabled: true,
...
export const crm_34_6_definition = {
  domain: "crm",
  sequence: 40,
  capability: "service",
  enabled: true,
...
export const crm_34_7_definition = {
  domain: "crm",
  sequence: 41,
  capability: "service",
  enabled: true,
