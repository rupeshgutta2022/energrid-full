...
export const crm_18_0_definition = {
  domain: "crm",
  sequence: 18,
  capability: "service",
  enabled: true,
...
export const crm_18_1_definition = {
  domain: "crm",
  sequence: 19,
  capability: "service",
  enabled: true,
...
export const crm_18_2_definition = {
  domain: "crm",
  sequence: 20,
  capability: "service",
  enabled: true,
...
export const crm_18_3_definition = {
  domain: "crm",
  sequence: 21,
  capability: "service",
  enabled: true,
...
export const crm_18_4_definition = {
  domain: "crm",
  sequence: 22,
  capability: "service",
  enabled: true,
...
export const crm_18_5_definition = {
  domain: "crm",
  sequence: 23,
  capability: "service",
  enabled: true,
...
export const crm_18_6_definition = {
  domain: "crm",
  sequence: 24,
  capability: "service",
  enabled: true,
...
export const crm_18_7_definition = {
  domain: "crm",
  sequence: 25,
  capability: "service",
  enabled: true,
