...
export const crm_14_0_definition = {
  domain: "crm",
  sequence: 14,
  capability: "service",
  enabled: true,
...
export const crm_14_1_definition = {
  domain: "crm",
  sequence: 15,
  capability: "service",
  enabled: true,
...
export const crm_14_2_definition = {
  domain: "crm",
  sequence: 16,
  capability: "service",
  enabled: true,
...
export const crm_14_3_definition = {
  domain: "crm",
  sequence: 17,
  capability: "service",
  enabled: true,
...
export const crm_14_4_definition = {
  domain: "crm",
  sequence: 18,
  capability: "service",
  enabled: true,
...
export const crm_14_5_definition = {
  domain: "crm",
  sequence: 19,
  capability: "service",
  enabled: true,
...
export const crm_14_6_definition = {
  domain: "crm",
  sequence: 20,
  capability: "service",
  enabled: true,
...
export const crm_14_7_definition = {
  domain: "crm",
  sequence: 21,
  capability: "service",
  enabled: true,
