...
export const crm_7_0_definition = {
  domain: "crm",
  sequence: 7,
  capability: "workflow",
  enabled: true,
...
export const crm_7_1_definition = {
  domain: "crm",
  sequence: 8,
  capability: "workflow",
  enabled: true,
...
export const crm_7_2_definition = {
  domain: "crm",
  sequence: 9,
  capability: "workflow",
  enabled: true,
...
export const crm_7_3_definition = {
  domain: "crm",
  sequence: 10,
  capability: "workflow",
  enabled: true,
...
export const crm_7_4_definition = {
  domain: "crm",
  sequence: 11,
  capability: "workflow",
  enabled: true,
...
export const crm_7_5_definition = {
  domain: "crm",
  sequence: 12,
  capability: "workflow",
  enabled: true,
...
export const crm_7_6_definition = {
  domain: "crm",
  sequence: 13,
  capability: "workflow",
  enabled: true,
...
export const crm_7_7_definition = {
  domain: "crm",
  sequence: 14,
  capability: "workflow",
  enabled: true,
