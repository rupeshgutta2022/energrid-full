...
export const crm_26_0_definition = {
  domain: "crm",
  sequence: 26,
  capability: "service",
  enabled: true,
...
export const crm_26_1_definition = {
  domain: "crm",
  sequence: 27,
  capability: "service",
  enabled: true,
...
export const crm_26_2_definition = {
  domain: "crm",
  sequence: 28,
  capability: "service",
  enabled: true,
...
export const crm_26_3_definition = {
  domain: "crm",
  sequence: 29,
  capability: "service",
  enabled: true,
...
export const crm_26_4_definition = {
  domain: "crm",
  sequence: 30,
  capability: "service",
  enabled: true,
...
export const crm_26_5_definition = {
  domain: "crm",
  sequence: 31,
  capability: "service",
  enabled: true,
...
export const crm_26_6_definition = {
  domain: "crm",
  sequence: 32,
  capability: "service",
  enabled: true,
...
export const crm_26_7_definition = {
  domain: "crm",
  sequence: 33,
  capability: "service",
  enabled: true,
