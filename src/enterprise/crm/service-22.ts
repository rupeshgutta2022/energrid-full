...
export const crm_22_0_definition = {
  domain: "crm",
  sequence: 22,
  capability: "service",
  enabled: true,
...
export const crm_22_1_definition = {
  domain: "crm",
  sequence: 23,
  capability: "service",
  enabled: true,
...
export const crm_22_2_definition = {
  domain: "crm",
  sequence: 24,
  capability: "service",
  enabled: true,
...
export const crm_22_3_definition = {
  domain: "crm",
  sequence: 25,
  capability: "service",
  enabled: true,
...
export const crm_22_4_definition = {
  domain: "crm",
  sequence: 26,
  capability: "service",
  enabled: true,
...
export const crm_22_5_definition = {
  domain: "crm",
  sequence: 27,
  capability: "service",
  enabled: true,
...
export const crm_22_6_definition = {
  domain: "crm",
  sequence: 28,
  capability: "service",
  enabled: true,
...
export const crm_22_7_definition = {
  domain: "crm",
  sequence: 29,
  capability: "service",
  enabled: true,
