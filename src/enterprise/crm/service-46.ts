...
export const crm_46_0_definition = {
  domain: "crm",
  sequence: 46,
  capability: "service",
  enabled: true,
...
export const crm_46_1_definition = {
  domain: "crm",
  sequence: 47,
  capability: "service",
  enabled: true,
...
export const crm_46_2_definition = {
  domain: "crm",
  sequence: 48,
  capability: "service",
  enabled: true,
...
export const crm_46_3_definition = {
  domain: "crm",
  sequence: 49,
  capability: "service",
  enabled: true,
...
export const crm_46_4_definition = {
  domain: "crm",
  sequence: 50,
  capability: "service",
  enabled: true,
...
export const crm_46_5_definition = {
  domain: "crm",
  sequence: 51,
  capability: "service",
  enabled: true,
...
export const crm_46_6_definition = {
  domain: "crm",
  sequence: 52,
  capability: "service",
  enabled: true,
...
export const crm_46_7_definition = {
  domain: "crm",
  sequence: 53,
  capability: "service",
  enabled: true,
