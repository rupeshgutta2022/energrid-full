...
export const crm_155_0_definition = {
  domain: "crm",
  sequence: 155,
  capability: "workflow",
  enabled: true,
...
export const crm_155_1_definition = {
  domain: "crm",
  sequence: 156,
  capability: "workflow",
  enabled: true,
...
export const crm_155_2_definition = {
  domain: "crm",
  sequence: 157,
  capability: "workflow",
  enabled: true,
...
export const crm_155_3_definition = {
  domain: "crm",
  sequence: 158,
  capability: "workflow",
  enabled: true,
...
export const crm_155_4_definition = {
  domain: "crm",
  sequence: 159,
  capability: "workflow",
  enabled: true,
...
export const crm_155_5_definition = {
  domain: "crm",
  sequence: 160,
  capability: "workflow",
  enabled: true,
