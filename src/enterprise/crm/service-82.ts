...
export const crm_82_0_definition = {
  domain: "crm",
  sequence: 82,
  capability: "service",
  enabled: true,
...
export const crm_82_1_definition = {
  domain: "crm",
  sequence: 83,
  capability: "service",
  enabled: true,
...
export const crm_82_2_definition = {
  domain: "crm",
  sequence: 84,
  capability: "service",
  enabled: true,
...
export const crm_82_3_definition = {
  domain: "crm",
  sequence: 85,
  capability: "service",
  enabled: true,
...
export const crm_82_4_definition = {
  domain: "crm",
  sequence: 86,
  capability: "service",
  enabled: true,
...
export const crm_82_5_definition = {
  domain: "crm",
  sequence: 87,
  capability: "service",
  enabled: true,
...
export const crm_82_6_definition = {
  domain: "crm",
  sequence: 88,
  capability: "service",
  enabled: true,
...
export const crm_82_7_definition = {
  domain: "crm",
  sequence: 89,
  capability: "service",
  enabled: true,
