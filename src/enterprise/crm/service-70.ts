...
export const crm_70_0_definition = {
  domain: "crm",
  sequence: 70,
  capability: "service",
  enabled: true,
...
export const crm_70_1_definition = {
  domain: "crm",
  sequence: 71,
  capability: "service",
  enabled: true,
...
export const crm_70_2_definition = {
  domain: "crm",
  sequence: 72,
  capability: "service",
  enabled: true,
...
export const crm_70_3_definition = {
  domain: "crm",
  sequence: 73,
  capability: "service",
  enabled: true,
...
export const crm_70_4_definition = {
  domain: "crm",
  sequence: 74,
  capability: "service",
  enabled: true,
...
export const crm_70_5_definition = {
  domain: "crm",
  sequence: 75,
  capability: "service",
  enabled: true,
...
export const crm_70_6_definition = {
  domain: "crm",
  sequence: 76,
  capability: "service",
  enabled: true,
...
export const crm_70_7_definition = {
  domain: "crm",
  sequence: 77,
  capability: "service",
  enabled: true,
