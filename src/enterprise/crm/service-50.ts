...
export const crm_50_0_definition = {
  domain: "crm",
  sequence: 50,
  capability: "service",
  enabled: true,
...
export const crm_50_1_definition = {
  domain: "crm",
  sequence: 51,
  capability: "service",
  enabled: true,
...
export const crm_50_2_definition = {
  domain: "crm",
  sequence: 52,
  capability: "service",
  enabled: true,
...
export const crm_50_3_definition = {
  domain: "crm",
  sequence: 53,
  capability: "service",
  enabled: true,
...
export const crm_50_4_definition = {
  domain: "crm",
  sequence: 54,
  capability: "service",
  enabled: true,
...
export const crm_50_5_definition = {
  domain: "crm",
  sequence: 55,
  capability: "service",
  enabled: true,
...
export const crm_50_6_definition = {
  domain: "crm",
  sequence: 56,
  capability: "service",
  enabled: true,
...
export const crm_50_7_definition = {
  domain: "crm",
  sequence: 57,
  capability: "service",
  enabled: true,
