...
export const crm_42_0_definition = {
  domain: "crm",
  sequence: 42,
  capability: "service",
  enabled: true,
...
export const crm_42_1_definition = {
  domain: "crm",
  sequence: 43,
  capability: "service",
  enabled: true,
...
export const crm_42_2_definition = {
  domain: "crm",
  sequence: 44,
  capability: "service",
  enabled: true,
...
export const crm_42_3_definition = {
  domain: "crm",
  sequence: 45,
  capability: "service",
  enabled: true,
...
export const crm_42_4_definition = {
  domain: "crm",
  sequence: 46,
  capability: "service",
  enabled: true,
...
export const crm_42_5_definition = {
  domain: "crm",
  sequence: 47,
  capability: "service",
  enabled: true,
...
export const crm_42_6_definition = {
  domain: "crm",
  sequence: 48,
  capability: "service",
  enabled: true,
...
export const crm_42_7_definition = {
  domain: "crm",
  sequence: 49,
  capability: "service",
  enabled: true,
