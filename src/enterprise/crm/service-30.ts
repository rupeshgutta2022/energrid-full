...
export const crm_30_0_definition = {
  domain: "crm",
  sequence: 30,
  capability: "service",
  enabled: true,
...
export const crm_30_1_definition = {
  domain: "crm",
  sequence: 31,
  capability: "service",
  enabled: true,
...
export const crm_30_2_definition = {
  domain: "crm",
  sequence: 32,
  capability: "service",
  enabled: true,
...
export const crm_30_3_definition = {
  domain: "crm",
  sequence: 33,
  capability: "service",
  enabled: true,
...
export const crm_30_4_definition = {
  domain: "crm",
  sequence: 34,
  capability: "service",
  enabled: true,
...
export const crm_30_5_definition = {
  domain: "crm",
  sequence: 35,
  capability: "service",
  enabled: true,
...
export const crm_30_6_definition = {
  domain: "crm",
  sequence: 36,
  capability: "service",
  enabled: true,
...
export const crm_30_7_definition = {
  domain: "crm",
  sequence: 37,
  capability: "service",
  enabled: true,
