...
export const crm_90_0_definition = {
  domain: "crm",
  sequence: 90,
  capability: "service",
  enabled: true,
...
export const crm_90_1_definition = {
  domain: "crm",
  sequence: 91,
  capability: "service",
  enabled: true,
...
export const crm_90_2_definition = {
  domain: "crm",
  sequence: 92,
  capability: "service",
  enabled: true,
...
export const crm_90_3_definition = {
  domain: "crm",
  sequence: 93,
  capability: "service",
  enabled: true,
...
export const crm_90_4_definition = {
  domain: "crm",
  sequence: 94,
  capability: "service",
  enabled: true,
...
export const crm_90_5_definition = {
  domain: "crm",
  sequence: 95,
  capability: "service",
  enabled: true,
...
export const crm_90_6_definition = {
  domain: "crm",
  sequence: 96,
  capability: "service",
  enabled: true,
...
export const crm_90_7_definition = {
  domain: "crm",
  sequence: 97,
  capability: "service",
  enabled: true,
