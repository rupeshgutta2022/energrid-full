...
export const crm_154_0_definition = {
  domain: "crm",
  sequence: 154,
  capability: "service",
  enabled: true,
...
export const crm_154_1_definition = {
  domain: "crm",
  sequence: 155,
  capability: "service",
  enabled: true,
...
export const crm_154_2_definition = {
  domain: "crm",
  sequence: 156,
  capability: "service",
  enabled: true,
...
export const crm_154_3_definition = {
  domain: "crm",
  sequence: 157,
  capability: "service",
  enabled: true,
...
export const crm_154_4_definition = {
  domain: "crm",
  sequence: 158,
  capability: "service",
  enabled: true,
...
export const crm_154_5_definition = {
  domain: "crm",
  sequence: 159,
  capability: "service",
  enabled: true,
