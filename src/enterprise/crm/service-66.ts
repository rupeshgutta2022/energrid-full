...
export const crm_66_0_definition = {
  domain: "crm",
  sequence: 66,
  capability: "service",
  enabled: true,
...
export const crm_66_1_definition = {
  domain: "crm",
  sequence: 67,
  capability: "service",
  enabled: true,
...
export const crm_66_2_definition = {
  domain: "crm",
  sequence: 68,
  capability: "service",
  enabled: true,
...
export const crm_66_3_definition = {
  domain: "crm",
  sequence: 69,
  capability: "service",
  enabled: true,
...
export const crm_66_4_definition = {
  domain: "crm",
  sequence: 70,
  capability: "service",
  enabled: true,
...
export const crm_66_5_definition = {
  domain: "crm",
  sequence: 71,
  capability: "service",
  enabled: true,
...
export const crm_66_6_definition = {
  domain: "crm",
  sequence: 72,
  capability: "service",
  enabled: true,
...
export const crm_66_7_definition = {
  domain: "crm",
  sequence: 73,
  capability: "service",
  enabled: true,
