...
export const crm_6_0_definition = {
  domain: "crm",
  sequence: 6,
  capability: "service",
  enabled: true,
...
export const crm_6_1_definition = {
  domain: "crm",
  sequence: 7,
  capability: "service",
  enabled: true,
...
export const crm_6_2_definition = {
  domain: "crm",
  sequence: 8,
  capability: "service",
  enabled: true,
...
export const crm_6_3_definition = {
  domain: "crm",
  sequence: 9,
  capability: "service",
  enabled: true,
...
export const crm_6_4_definition = {
  domain: "crm",
  sequence: 10,
  capability: "service",
  enabled: true,
...
export const crm_6_5_definition = {
  domain: "crm",
  sequence: 11,
  capability: "service",
  enabled: true,
...
export const crm_6_6_definition = {
  domain: "crm",
  sequence: 12,
  capability: "service",
  enabled: true,
...
export const crm_6_7_definition = {
  domain: "crm",
  sequence: 13,
  capability: "service",
  enabled: true,
