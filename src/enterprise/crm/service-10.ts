...
export const crm_10_0_definition = {
  domain: "crm",
  sequence: 10,
  capability: "service",
  enabled: true,
...
export const crm_10_1_definition = {
  domain: "crm",
  sequence: 11,
  capability: "service",
  enabled: true,
...
export const crm_10_2_definition = {
  domain: "crm",
  sequence: 12,
  capability: "service",
  enabled: true,
...
export const crm_10_3_definition = {
  domain: "crm",
  sequence: 13,
  capability: "service",
  enabled: true,
...
export const crm_10_4_definition = {
  domain: "crm",
  sequence: 14,
  capability: "service",
  enabled: true,
...
export const crm_10_5_definition = {
  domain: "crm",
  sequence: 15,
  capability: "service",
  enabled: true,
...
export const crm_10_6_definition = {
  domain: "crm",
  sequence: 16,
  capability: "service",
  enabled: true,
...
export const crm_10_7_definition = {
  domain: "crm",
  sequence: 17,
  capability: "service",
  enabled: true,
