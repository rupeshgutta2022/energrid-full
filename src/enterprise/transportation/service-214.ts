...
export const transportation_214_0_definition = {
...
export const transportation_214_1_definition = {
  domain: "transportation",
  sequence: 215,
  capability: "service",
  enabled: true,
...
export const transportation_214_2_definition = {
  domain: "transportation",
  sequence: 216,
  capability: "service",
  enabled: true,
...
export const transportation_214_3_definition = {
  domain: "transportation",
  sequence: 217,
  capability: "service",
  enabled: true,
...
export const transportation_214_4_definition = {
  domain: "transportation",
  sequence: 218,
  capability: "service",
  enabled: true,
...
export const transportation_214_5_definition = {
  domain: "transportation",
  sequence: 219,
  capability: "service",
  enabled: true,
...
export const transportation_214_6_definition = {
  domain: "transportation",
  sequence: 220,
  capability: "service",
  enabled: true,
...
export const transportation_214_7_definition = {
  domain: "transportation",
  sequence: 221,
  capability: "service",
  enabled: true,
