...
export const transportation_206_0_definition = {
...
export const transportation_206_1_definition = {
  domain: "transportation",
  sequence: 207,
  capability: "service",
  enabled: true,
...
export const transportation_206_2_definition = {
  domain: "transportation",
  sequence: 208,
  capability: "service",
  enabled: true,
...
export const transportation_206_3_definition = {
  domain: "transportation",
  sequence: 209,
  capability: "service",
  enabled: true,
...
export const transportation_206_4_definition = {
  domain: "transportation",
  sequence: 210,
  capability: "service",
  enabled: true,
...
export const transportation_206_5_definition = {
  domain: "transportation",
  sequence: 211,
  capability: "service",
  enabled: true,
...
export const transportation_206_6_definition = {
  domain: "transportation",
  sequence: 212,
  capability: "service",
  enabled: true,
...
export const transportation_206_7_definition = {
  domain: "transportation",
  sequence: 213,
  capability: "service",
  enabled: true,
