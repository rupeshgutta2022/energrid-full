...
export const transportation_202_0_definition = {
...
export const transportation_202_1_definition = {
  domain: "transportation",
  sequence: 203,
  capability: "service",
  enabled: true,
...
export const transportation_202_2_definition = {
  domain: "transportation",
  sequence: 204,
  capability: "service",
  enabled: true,
...
export const transportation_202_3_definition = {
  domain: "transportation",
  sequence: 205,
  capability: "service",
  enabled: true,
...
export const transportation_202_4_definition = {
  domain: "transportation",
  sequence: 206,
  capability: "service",
  enabled: true,
...
export const transportation_202_5_definition = {
  domain: "transportation",
  sequence: 207,
  capability: "service",
  enabled: true,
...
export const transportation_202_6_definition = {
  domain: "transportation",
  sequence: 208,
  capability: "service",
  enabled: true,
...
export const transportation_202_7_definition = {
  domain: "transportation",
  sequence: 209,
  capability: "service",
  enabled: true,
