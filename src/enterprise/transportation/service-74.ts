...
export const transportation_74_0_definition = {
...
export const transportation_74_1_definition = {
  domain: "transportation",
  sequence: 75,
  capability: "service",
  enabled: true,
...
export const transportation_74_2_definition = {
  domain: "transportation",
  sequence: 76,
  capability: "service",
  enabled: true,
...
export const transportation_74_3_definition = {
  domain: "transportation",
  sequence: 77,
  capability: "service",
  enabled: true,
...
export const transportation_74_4_definition = {
  domain: "transportation",
  sequence: 78,
  capability: "service",
  enabled: true,
...
export const transportation_74_5_definition = {
  domain: "transportation",
  sequence: 79,
  capability: "service",
  enabled: true,
...
export const transportation_74_6_definition = {
  domain: "transportation",
  sequence: 80,
  capability: "service",
  enabled: true,
...
export const transportation_74_7_definition = {
  domain: "transportation",
  sequence: 81,
  capability: "service",
  enabled: true,
