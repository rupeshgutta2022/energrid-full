...
export const transportation_106_0_definition = {
...
export const transportation_106_1_definition = {
  domain: "transportation",
  sequence: 107,
  capability: "service",
  enabled: true,
...
export const transportation_106_2_definition = {
  domain: "transportation",
  sequence: 108,
  capability: "service",
  enabled: true,
...
export const transportation_106_3_definition = {
  domain: "transportation",
  sequence: 109,
  capability: "service",
  enabled: true,
...
export const transportation_106_4_definition = {
  domain: "transportation",
  sequence: 110,
  capability: "service",
  enabled: true,
...
export const transportation_106_5_definition = {
  domain: "transportation",
  sequence: 111,
  capability: "service",
  enabled: true,
...
export const transportation_106_6_definition = {
  domain: "transportation",
  sequence: 112,
  capability: "service",
  enabled: true,
...
export const transportation_106_7_definition = {
  domain: "transportation",
  sequence: 113,
  capability: "service",
  enabled: true,
