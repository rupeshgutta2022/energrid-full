...
export const transportation_190_0_definition = {
...
export const transportation_190_1_definition = {
  domain: "transportation",
  sequence: 191,
  capability: "service",
  enabled: true,
...
export const transportation_190_2_definition = {
  domain: "transportation",
  sequence: 192,
  capability: "service",
  enabled: true,
...
export const transportation_190_3_definition = {
  domain: "transportation",
  sequence: 193,
  capability: "service",
  enabled: true,
...
export const transportation_190_4_definition = {
  domain: "transportation",
  sequence: 194,
  capability: "service",
  enabled: true,
...
export const transportation_190_5_definition = {
  domain: "transportation",
  sequence: 195,
  capability: "service",
  enabled: true,
...
export const transportation_190_6_definition = {
  domain: "transportation",
  sequence: 196,
  capability: "service",
  enabled: true,
...
export const transportation_190_7_definition = {
  domain: "transportation",
  sequence: 197,
  capability: "service",
  enabled: true,
