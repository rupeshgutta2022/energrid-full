...
export const transportation_54_0_definition = {
...
export const transportation_54_1_definition = {
  domain: "transportation",
  sequence: 55,
  capability: "service",
  enabled: true,
...
export const transportation_54_2_definition = {
  domain: "transportation",
  sequence: 56,
  capability: "service",
  enabled: true,
...
export const transportation_54_3_definition = {
  domain: "transportation",
  sequence: 57,
  capability: "service",
  enabled: true,
...
export const transportation_54_4_definition = {
  domain: "transportation",
  sequence: 58,
  capability: "service",
  enabled: true,
...
export const transportation_54_5_definition = {
  domain: "transportation",
  sequence: 59,
  capability: "service",
  enabled: true,
...
export const transportation_54_6_definition = {
  domain: "transportation",
  sequence: 60,
  capability: "service",
  enabled: true,
...
export const transportation_54_7_definition = {
  domain: "transportation",
  sequence: 61,
  capability: "service",
  enabled: true,
