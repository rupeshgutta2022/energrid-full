...
export const transportation_231_0_definition = {
...
export const transportation_231_1_definition = {
  domain: "transportation",
  sequence: 232,
  capability: "workflow",
  enabled: true,
...
export const transportation_231_2_definition = {
  domain: "transportation",
  sequence: 233,
  capability: "workflow",
  enabled: true,
...
export const transportation_231_3_definition = {
  domain: "transportation",
  sequence: 234,
  capability: "workflow",
  enabled: true,
...
export const transportation_231_4_definition = {
  domain: "transportation",
  sequence: 235,
  capability: "workflow",
  enabled: true,
