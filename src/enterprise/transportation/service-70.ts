...
export const transportation_70_0_definition = {
...
export const transportation_70_1_definition = {
  domain: "transportation",
  sequence: 71,
  capability: "service",
  enabled: true,
...
export const transportation_70_2_definition = {
  domain: "transportation",
  sequence: 72,
  capability: "service",
  enabled: true,
...
export const transportation_70_3_definition = {
  domain: "transportation",
  sequence: 73,
  capability: "service",
  enabled: true,
...
export const transportation_70_4_definition = {
  domain: "transportation",
  sequence: 74,
  capability: "service",
  enabled: true,
...
export const transportation_70_5_definition = {
  domain: "transportation",
  sequence: 75,
  capability: "service",
  enabled: true,
...
export const transportation_70_6_definition = {
  domain: "transportation",
  sequence: 76,
  capability: "service",
  enabled: true,
...
export const transportation_70_7_definition = {
  domain: "transportation",
  sequence: 77,
  capability: "service",
  enabled: true,
