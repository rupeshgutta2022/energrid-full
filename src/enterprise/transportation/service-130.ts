...
export const transportation_130_0_definition = {
...
export const transportation_130_1_definition = {
  domain: "transportation",
  sequence: 131,
  capability: "service",
  enabled: true,
...
export const transportation_130_2_definition = {
  domain: "transportation",
  sequence: 132,
  capability: "service",
  enabled: true,
...
export const transportation_130_3_definition = {
  domain: "transportation",
  sequence: 133,
  capability: "service",
  enabled: true,
...
export const transportation_130_4_definition = {
  domain: "transportation",
  sequence: 134,
  capability: "service",
  enabled: true,
...
export const transportation_130_5_definition = {
  domain: "transportation",
  sequence: 135,
  capability: "service",
  enabled: true,
...
export const transportation_130_6_definition = {
  domain: "transportation",
  sequence: 136,
  capability: "service",
  enabled: true,
...
export const transportation_130_7_definition = {
  domain: "transportation",
  sequence: 137,
  capability: "service",
  enabled: true,
