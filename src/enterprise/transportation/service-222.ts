...
export const transportation_222_0_definition = {
...
export const transportation_222_1_definition = {
  domain: "transportation",
  sequence: 223,
  capability: "service",
  enabled: true,
...
export const transportation_222_2_definition = {
  domain: "transportation",
  sequence: 224,
  capability: "service",
  enabled: true,
...
export const transportation_222_3_definition = {
  domain: "transportation",
  sequence: 225,
  capability: "service",
  enabled: true,
...
export const transportation_222_4_definition = {
  domain: "transportation",
  sequence: 226,
  capability: "service",
  enabled: true,
...
export const transportation_222_5_definition = {
  domain: "transportation",
  sequence: 227,
  capability: "service",
  enabled: true,
...
export const transportation_222_6_definition = {
  domain: "transportation",
  sequence: 228,
  capability: "service",
  enabled: true,
...
export const transportation_222_7_definition = {
  domain: "transportation",
  sequence: 229,
  capability: "service",
  enabled: true,
