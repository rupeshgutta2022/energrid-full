...
export const transportation_198_0_definition = {
...
export const transportation_198_1_definition = {
  domain: "transportation",
  sequence: 199,
  capability: "service",
  enabled: true,
...
export const transportation_198_2_definition = {
  domain: "transportation",
  sequence: 200,
  capability: "service",
  enabled: true,
...
export const transportation_198_3_definition = {
  domain: "transportation",
  sequence: 201,
  capability: "service",
  enabled: true,
...
export const transportation_198_4_definition = {
  domain: "transportation",
  sequence: 202,
  capability: "service",
  enabled: true,
...
export const transportation_198_5_definition = {
  domain: "transportation",
  sequence: 203,
  capability: "service",
  enabled: true,
...
export const transportation_198_6_definition = {
  domain: "transportation",
  sequence: 204,
  capability: "service",
  enabled: true,
...
export const transportation_198_7_definition = {
  domain: "transportation",
  sequence: 205,
  capability: "service",
  enabled: true,
