...
export const transportation_82_0_definition = {
...
export const transportation_82_1_definition = {
  domain: "transportation",
  sequence: 83,
  capability: "service",
  enabled: true,
...
export const transportation_82_2_definition = {
  domain: "transportation",
  sequence: 84,
  capability: "service",
  enabled: true,
...
export const transportation_82_3_definition = {
  domain: "transportation",
  sequence: 85,
  capability: "service",
  enabled: true,
...
export const transportation_82_4_definition = {
  domain: "transportation",
  sequence: 86,
  capability: "service",
  enabled: true,
...
export const transportation_82_5_definition = {
  domain: "transportation",
  sequence: 87,
  capability: "service",
  enabled: true,
...
export const transportation_82_6_definition = {
  domain: "transportation",
  sequence: 88,
  capability: "service",
  enabled: true,
...
export const transportation_82_7_definition = {
  domain: "transportation",
  sequence: 89,
  capability: "service",
  enabled: true,
