...
export const transportation_6_0_definition = {
...
export const transportation_6_1_definition = {
  domain: "transportation",
  sequence: 7,
  capability: "service",
  enabled: true,
...
export const transportation_6_2_definition = {
  domain: "transportation",
  sequence: 8,
  capability: "service",
  enabled: true,
...
export const transportation_6_3_definition = {
  domain: "transportation",
  sequence: 9,
  capability: "service",
  enabled: true,
...
export const transportation_6_4_definition = {
  domain: "transportation",
  sequence: 10,
  capability: "service",
  enabled: true,
...
export const transportation_6_5_definition = {
  domain: "transportation",
  sequence: 11,
  capability: "service",
  enabled: true,
...
export const transportation_6_6_definition = {
  domain: "transportation",
  sequence: 12,
  capability: "service",
  enabled: true,
...
export const transportation_6_7_definition = {
  domain: "transportation",
  sequence: 13,
  capability: "service",
  enabled: true,
