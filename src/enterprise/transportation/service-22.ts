...
export const transportation_22_0_definition = {
...
export const transportation_22_1_definition = {
  domain: "transportation",
  sequence: 23,
  capability: "service",
  enabled: true,
...
export const transportation_22_2_definition = {
  domain: "transportation",
  sequence: 24,
  capability: "service",
  enabled: true,
...
export const transportation_22_3_definition = {
  domain: "transportation",
  sequence: 25,
  capability: "service",
  enabled: true,
...
export const transportation_22_4_definition = {
  domain: "transportation",
  sequence: 26,
  capability: "service",
  enabled: true,
...
export const transportation_22_5_definition = {
  domain: "transportation",
  sequence: 27,
  capability: "service",
  enabled: true,
...
export const transportation_22_6_definition = {
  domain: "transportation",
  sequence: 28,
  capability: "service",
  enabled: true,
...
export const transportation_22_7_definition = {
  domain: "transportation",
  sequence: 29,
  capability: "service",
  enabled: true,
