...
export const transportation_194_0_definition = {
...
export const transportation_194_1_definition = {
  domain: "transportation",
  sequence: 195,
  capability: "service",
  enabled: true,
...
export const transportation_194_2_definition = {
  domain: "transportation",
  sequence: 196,
  capability: "service",
  enabled: true,
...
export const transportation_194_3_definition = {
  domain: "transportation",
  sequence: 197,
  capability: "service",
  enabled: true,
...
export const transportation_194_4_definition = {
  domain: "transportation",
  sequence: 198,
  capability: "service",
  enabled: true,
...
export const transportation_194_5_definition = {
  domain: "transportation",
  sequence: 199,
  capability: "service",
  enabled: true,
...
export const transportation_194_6_definition = {
  domain: "transportation",
  sequence: 200,
  capability: "service",
  enabled: true,
...
export const transportation_194_7_definition = {
  domain: "transportation",
  sequence: 201,
  capability: "service",
  enabled: true,
