...
export const transportation_166_0_definition = {
...
export const transportation_166_1_definition = {
  domain: "transportation",
  sequence: 167,
  capability: "service",
  enabled: true,
...
export const transportation_166_2_definition = {
  domain: "transportation",
  sequence: 168,
  capability: "service",
  enabled: true,
...
export const transportation_166_3_definition = {
  domain: "transportation",
  sequence: 169,
  capability: "service",
  enabled: true,
...
export const transportation_166_4_definition = {
  domain: "transportation",
  sequence: 170,
  capability: "service",
  enabled: true,
...
export const transportation_166_5_definition = {
  domain: "transportation",
  sequence: 171,
  capability: "service",
  enabled: true,
...
export const transportation_166_6_definition = {
  domain: "transportation",
  sequence: 172,
  capability: "service",
  enabled: true,
...
export const transportation_166_7_definition = {
  domain: "transportation",
  sequence: 173,
  capability: "service",
  enabled: true,
