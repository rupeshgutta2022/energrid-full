...
export const transportation_42_0_definition = {
...
export const transportation_42_1_definition = {
  domain: "transportation",
  sequence: 43,
  capability: "service",
  enabled: true,
...
export const transportation_42_2_definition = {
  domain: "transportation",
  sequence: 44,
  capability: "service",
  enabled: true,
...
export const transportation_42_3_definition = {
  domain: "transportation",
  sequence: 45,
  capability: "service",
  enabled: true,
...
export const transportation_42_4_definition = {
  domain: "transportation",
  sequence: 46,
  capability: "service",
  enabled: true,
...
export const transportation_42_5_definition = {
  domain: "transportation",
  sequence: 47,
  capability: "service",
  enabled: true,
...
export const transportation_42_6_definition = {
  domain: "transportation",
  sequence: 48,
  capability: "service",
  enabled: true,
...
export const transportation_42_7_definition = {
  domain: "transportation",
  sequence: 49,
  capability: "service",
  enabled: true,
