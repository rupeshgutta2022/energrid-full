...
export const transportation_102_0_definition = {
...
export const transportation_102_1_definition = {
  domain: "transportation",
  sequence: 103,
  capability: "service",
  enabled: true,
...
export const transportation_102_2_definition = {
  domain: "transportation",
  sequence: 104,
  capability: "service",
  enabled: true,
...
export const transportation_102_3_definition = {
  domain: "transportation",
  sequence: 105,
  capability: "service",
  enabled: true,
...
export const transportation_102_4_definition = {
  domain: "transportation",
  sequence: 106,
  capability: "service",
  enabled: true,
...
export const transportation_102_5_definition = {
  domain: "transportation",
  sequence: 107,
  capability: "service",
  enabled: true,
...
export const transportation_102_6_definition = {
  domain: "transportation",
  sequence: 108,
  capability: "service",
  enabled: true,
...
export const transportation_102_7_definition = {
  domain: "transportation",
  sequence: 109,
  capability: "service",
  enabled: true,
