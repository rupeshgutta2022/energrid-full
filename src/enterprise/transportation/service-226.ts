...
export const transportation_226_0_definition = {
...
export const transportation_226_1_definition = {
  domain: "transportation",
  sequence: 227,
  capability: "service",
  enabled: true,
...
export const transportation_226_2_definition = {
  domain: "transportation",
  sequence: 228,
  capability: "service",
  enabled: true,
...
export const transportation_226_3_definition = {
  domain: "transportation",
  sequence: 229,
  capability: "service",
  enabled: true,
...
export const transportation_226_4_definition = {
  domain: "transportation",
  sequence: 230,
  capability: "service",
  enabled: true,
...
export const transportation_226_5_definition = {
  domain: "transportation",
  sequence: 231,
  capability: "service",
  enabled: true,
