...
export const transportation_158_0_definition = {
...
export const transportation_158_1_definition = {
  domain: "transportation",
  sequence: 159,
  capability: "service",
  enabled: true,
...
export const transportation_158_2_definition = {
  domain: "transportation",
  sequence: 160,
  capability: "service",
  enabled: true,
...
export const transportation_158_3_definition = {
  domain: "transportation",
  sequence: 161,
  capability: "service",
  enabled: true,
...
export const transportation_158_4_definition = {
  domain: "transportation",
  sequence: 162,
  capability: "service",
  enabled: true,
...
export const transportation_158_5_definition = {
  domain: "transportation",
  sequence: 163,
  capability: "service",
  enabled: true,
...
export const transportation_158_6_definition = {
  domain: "transportation",
  sequence: 164,
  capability: "service",
  enabled: true,
...
export const transportation_158_7_definition = {
  domain: "transportation",
  sequence: 165,
  capability: "service",
  enabled: true,
