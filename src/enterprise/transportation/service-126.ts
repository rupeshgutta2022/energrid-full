...
export const transportation_126_0_definition = {
...
export const transportation_126_1_definition = {
  domain: "transportation",
  sequence: 127,
  capability: "service",
  enabled: true,
...
export const transportation_126_2_definition = {
  domain: "transportation",
  sequence: 128,
  capability: "service",
  enabled: true,
...
export const transportation_126_3_definition = {
  domain: "transportation",
  sequence: 129,
  capability: "service",
  enabled: true,
...
export const transportation_126_4_definition = {
  domain: "transportation",
  sequence: 130,
  capability: "service",
  enabled: true,
...
export const transportation_126_5_definition = {
  domain: "transportation",
  sequence: 131,
  capability: "service",
  enabled: true,
...
export const transportation_126_6_definition = {
  domain: "transportation",
  sequence: 132,
  capability: "service",
  enabled: true,
...
export const transportation_126_7_definition = {
  domain: "transportation",
  sequence: 133,
  capability: "service",
  enabled: true,
