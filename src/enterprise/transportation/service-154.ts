...
export const transportation_154_0_definition = {
...
export const transportation_154_1_definition = {
  domain: "transportation",
  sequence: 155,
  capability: "service",
  enabled: true,
...
export const transportation_154_2_definition = {
  domain: "transportation",
  sequence: 156,
  capability: "service",
  enabled: true,
...
export const transportation_154_3_definition = {
  domain: "transportation",
  sequence: 157,
  capability: "service",
  enabled: true,
...
export const transportation_154_4_definition = {
  domain: "transportation",
  sequence: 158,
  capability: "service",
  enabled: true,
...
export const transportation_154_5_definition = {
  domain: "transportation",
  sequence: 159,
  capability: "service",
  enabled: true,
...
export const transportation_154_6_definition = {
  domain: "transportation",
  sequence: 160,
  capability: "service",
  enabled: true,
...
export const transportation_154_7_definition = {
  domain: "transportation",
  sequence: 161,
  capability: "service",
  enabled: true,
