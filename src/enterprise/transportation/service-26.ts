...
export const transportation_26_0_definition = {
...
export const transportation_26_1_definition = {
  domain: "transportation",
  sequence: 27,
  capability: "service",
  enabled: true,
...
export const transportation_26_2_definition = {
  domain: "transportation",
  sequence: 28,
  capability: "service",
  enabled: true,
...
export const transportation_26_3_definition = {
  domain: "transportation",
  sequence: 29,
  capability: "service",
  enabled: true,
...
export const transportation_26_4_definition = {
  domain: "transportation",
  sequence: 30,
  capability: "service",
  enabled: true,
...
export const transportation_26_5_definition = {
  domain: "transportation",
  sequence: 31,
  capability: "service",
  enabled: true,
...
export const transportation_26_6_definition = {
  domain: "transportation",
  sequence: 32,
  capability: "service",
  enabled: true,
...
export const transportation_26_7_definition = {
  domain: "transportation",
  sequence: 33,
  capability: "service",
  enabled: true,
