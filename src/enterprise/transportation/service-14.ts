...
export const transportation_14_0_definition = {
...
export const transportation_14_1_definition = {
  domain: "transportation",
  sequence: 15,
  capability: "service",
  enabled: true,
...
export const transportation_14_2_definition = {
  domain: "transportation",
  sequence: 16,
  capability: "service",
  enabled: true,
...
export const transportation_14_3_definition = {
  domain: "transportation",
  sequence: 17,
  capability: "service",
  enabled: true,
...
export const transportation_14_4_definition = {
  domain: "transportation",
  sequence: 18,
  capability: "service",
  enabled: true,
...
export const transportation_14_5_definition = {
  domain: "transportation",
  sequence: 19,
  capability: "service",
  enabled: true,
...
export const transportation_14_6_definition = {
  domain: "transportation",
  sequence: 20,
  capability: "service",
  enabled: true,
...
export const transportation_14_7_definition = {
  domain: "transportation",
  sequence: 21,
  capability: "service",
  enabled: true,
