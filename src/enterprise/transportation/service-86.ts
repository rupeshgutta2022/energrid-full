...
export const transportation_86_0_definition = {
...
export const transportation_86_1_definition = {
  domain: "transportation",
  sequence: 87,
  capability: "service",
  enabled: true,
...
export const transportation_86_2_definition = {
  domain: "transportation",
  sequence: 88,
  capability: "service",
  enabled: true,
...
export const transportation_86_3_definition = {
  domain: "transportation",
  sequence: 89,
  capability: "service",
  enabled: true,
...
export const transportation_86_4_definition = {
  domain: "transportation",
  sequence: 90,
  capability: "service",
  enabled: true,
...
export const transportation_86_5_definition = {
  domain: "transportation",
  sequence: 91,
  capability: "service",
  enabled: true,
...
export const transportation_86_6_definition = {
  domain: "transportation",
  sequence: 92,
  capability: "service",
  enabled: true,
...
export const transportation_86_7_definition = {
  domain: "transportation",
  sequence: 93,
  capability: "service",
  enabled: true,
