...
export const transportation_94_0_definition = {
...
export const transportation_94_1_definition = {
  domain: "transportation",
  sequence: 95,
  capability: "service",
  enabled: true,
...
export const transportation_94_2_definition = {
  domain: "transportation",
  sequence: 96,
  capability: "service",
  enabled: true,
...
export const transportation_94_3_definition = {
  domain: "transportation",
  sequence: 97,
  capability: "service",
  enabled: true,
...
export const transportation_94_4_definition = {
  domain: "transportation",
  sequence: 98,
  capability: "service",
  enabled: true,
...
export const transportation_94_5_definition = {
  domain: "transportation",
  sequence: 99,
  capability: "service",
  enabled: true,
...
export const transportation_94_6_definition = {
  domain: "transportation",
  sequence: 100,
  capability: "service",
  enabled: true,
...
export const transportation_94_7_definition = {
  domain: "transportation",
  sequence: 101,
  capability: "service",
  enabled: true,
