...
export const transportation_186_0_definition = {
...
export const transportation_186_1_definition = {
  domain: "transportation",
  sequence: 187,
  capability: "service",
  enabled: true,
...
export const transportation_186_2_definition = {
  domain: "transportation",
  sequence: 188,
  capability: "service",
  enabled: true,
...
export const transportation_186_3_definition = {
  domain: "transportation",
  sequence: 189,
  capability: "service",
  enabled: true,
...
export const transportation_186_4_definition = {
  domain: "transportation",
  sequence: 190,
  capability: "service",
  enabled: true,
...
export const transportation_186_5_definition = {
  domain: "transportation",
  sequence: 191,
  capability: "service",
  enabled: true,
...
export const transportation_186_6_definition = {
  domain: "transportation",
  sequence: 192,
  capability: "service",
  enabled: true,
...
export const transportation_186_7_definition = {
  domain: "transportation",
  sequence: 193,
  capability: "service",
  enabled: true,
