...
export const transportation_34_0_definition = {
...
export const transportation_34_1_definition = {
  domain: "transportation",
  sequence: 35,
  capability: "service",
  enabled: true,
...
export const transportation_34_2_definition = {
  domain: "transportation",
  sequence: 36,
  capability: "service",
  enabled: true,
...
export const transportation_34_3_definition = {
  domain: "transportation",
  sequence: 37,
  capability: "service",
  enabled: true,
...
export const transportation_34_4_definition = {
  domain: "transportation",
  sequence: 38,
  capability: "service",
  enabled: true,
...
export const transportation_34_5_definition = {
  domain: "transportation",
  sequence: 39,
  capability: "service",
  enabled: true,
...
export const transportation_34_6_definition = {
  domain: "transportation",
  sequence: 40,
  capability: "service",
  enabled: true,
...
export const transportation_34_7_definition = {
  domain: "transportation",
  sequence: 41,
  capability: "service",
  enabled: true,
