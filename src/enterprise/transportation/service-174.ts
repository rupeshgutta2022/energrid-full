...
export const transportation_174_0_definition = {
...
export const transportation_174_1_definition = {
  domain: "transportation",
  sequence: 175,
  capability: "service",
  enabled: true,
...
export const transportation_174_2_definition = {
  domain: "transportation",
  sequence: 176,
  capability: "service",
  enabled: true,
...
export const transportation_174_3_definition = {
  domain: "transportation",
  sequence: 177,
  capability: "service",
  enabled: true,
...
export const transportation_174_4_definition = {
  domain: "transportation",
  sequence: 178,
  capability: "service",
  enabled: true,
...
export const transportation_174_5_definition = {
  domain: "transportation",
  sequence: 179,
  capability: "service",
  enabled: true,
...
export const transportation_174_6_definition = {
  domain: "transportation",
  sequence: 180,
  capability: "service",
  enabled: true,
...
export const transportation_174_7_definition = {
  domain: "transportation",
  sequence: 181,
  capability: "service",
  enabled: true,
