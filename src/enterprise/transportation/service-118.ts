...
export const transportation_118_0_definition = {
...
export const transportation_118_1_definition = {
  domain: "transportation",
  sequence: 119,
  capability: "service",
  enabled: true,
...
export const transportation_118_2_definition = {
  domain: "transportation",
  sequence: 120,
  capability: "service",
  enabled: true,
...
export const transportation_118_3_definition = {
  domain: "transportation",
  sequence: 121,
  capability: "service",
  enabled: true,
...
export const transportation_118_4_definition = {
  domain: "transportation",
  sequence: 122,
  capability: "service",
  enabled: true,
...
export const transportation_118_5_definition = {
  domain: "transportation",
  sequence: 123,
  capability: "service",
  enabled: true,
...
export const transportation_118_6_definition = {
  domain: "transportation",
  sequence: 124,
  capability: "service",
  enabled: true,
...
export const transportation_118_7_definition = {
  domain: "transportation",
  sequence: 125,
  capability: "service",
  enabled: true,
