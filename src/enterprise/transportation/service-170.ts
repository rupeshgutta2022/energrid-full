...
export const transportation_170_0_definition = {
...
export const transportation_170_1_definition = {
  domain: "transportation",
  sequence: 171,
  capability: "service",
  enabled: true,
...
export const transportation_170_2_definition = {
  domain: "transportation",
  sequence: 172,
  capability: "service",
  enabled: true,
...
export const transportation_170_3_definition = {
  domain: "transportation",
  sequence: 173,
  capability: "service",
  enabled: true,
...
export const transportation_170_4_definition = {
  domain: "transportation",
  sequence: 174,
  capability: "service",
  enabled: true,
...
export const transportation_170_5_definition = {
  domain: "transportation",
  sequence: 175,
  capability: "service",
  enabled: true,
...
export const transportation_170_6_definition = {
  domain: "transportation",
  sequence: 176,
  capability: "service",
  enabled: true,
...
export const transportation_170_7_definition = {
  domain: "transportation",
  sequence: 177,
  capability: "service",
  enabled: true,
