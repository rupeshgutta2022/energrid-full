...
export const transportation_218_0_definition = {
...
export const transportation_218_1_definition = {
  domain: "transportation",
  sequence: 219,
  capability: "service",
  enabled: true,
...
export const transportation_218_2_definition = {
  domain: "transportation",
  sequence: 220,
  capability: "service",
  enabled: true,
...
export const transportation_218_3_definition = {
  domain: "transportation",
  sequence: 221,
  capability: "service",
  enabled: true,
...
export const transportation_218_4_definition = {
  domain: "transportation",
  sequence: 222,
  capability: "service",
  enabled: true,
...
export const transportation_218_5_definition = {
  domain: "transportation",
  sequence: 223,
  capability: "service",
  enabled: true,
...
export const transportation_218_6_definition = {
  domain: "transportation",
  sequence: 224,
  capability: "service",
  enabled: true,
...
export const transportation_218_7_definition = {
  domain: "transportation",
  sequence: 225,
  capability: "service",
  enabled: true,
