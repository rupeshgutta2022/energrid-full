...
export const transportation_30_0_definition = {
...
export const transportation_30_1_definition = {
  domain: "transportation",
  sequence: 31,
  capability: "service",
  enabled: true,
...
export const transportation_30_2_definition = {
  domain: "transportation",
  sequence: 32,
  capability: "service",
  enabled: true,
...
export const transportation_30_3_definition = {
  domain: "transportation",
  sequence: 33,
  capability: "service",
  enabled: true,
...
export const transportation_30_4_definition = {
  domain: "transportation",
  sequence: 34,
  capability: "service",
  enabled: true,
...
export const transportation_30_5_definition = {
  domain: "transportation",
  sequence: 35,
  capability: "service",
  enabled: true,
...
export const transportation_30_6_definition = {
  domain: "transportation",
  sequence: 36,
  capability: "service",
  enabled: true,
...
export const transportation_30_7_definition = {
  domain: "transportation",
  sequence: 37,
  capability: "service",
  enabled: true,
