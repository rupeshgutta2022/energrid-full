...
export const transportation_182_0_definition = {
...
export const transportation_182_1_definition = {
  domain: "transportation",
  sequence: 183,
  capability: "service",
  enabled: true,
...
export const transportation_182_2_definition = {
  domain: "transportation",
  sequence: 184,
  capability: "service",
  enabled: true,
...
export const transportation_182_3_definition = {
  domain: "transportation",
  sequence: 185,
  capability: "service",
  enabled: true,
...
export const transportation_182_4_definition = {
  domain: "transportation",
  sequence: 186,
  capability: "service",
  enabled: true,
...
export const transportation_182_5_definition = {
  domain: "transportation",
  sequence: 187,
  capability: "service",
  enabled: true,
...
export const transportation_182_6_definition = {
  domain: "transportation",
  sequence: 188,
  capability: "service",
  enabled: true,
...
export const transportation_182_7_definition = {
  domain: "transportation",
  sequence: 189,
  capability: "service",
  enabled: true,
