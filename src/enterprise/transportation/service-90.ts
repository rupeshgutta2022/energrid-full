...
export const transportation_90_0_definition = {
...
export const transportation_90_1_definition = {
  domain: "transportation",
  sequence: 91,
  capability: "service",
  enabled: true,
...
export const transportation_90_2_definition = {
  domain: "transportation",
  sequence: 92,
  capability: "service",
  enabled: true,
...
export const transportation_90_3_definition = {
  domain: "transportation",
  sequence: 93,
  capability: "service",
  enabled: true,
...
export const transportation_90_4_definition = {
  domain: "transportation",
  sequence: 94,
  capability: "service",
  enabled: true,
...
export const transportation_90_5_definition = {
  domain: "transportation",
  sequence: 95,
  capability: "service",
  enabled: true,
...
export const transportation_90_6_definition = {
  domain: "transportation",
  sequence: 96,
  capability: "service",
  enabled: true,
...
export const transportation_90_7_definition = {
  domain: "transportation",
  sequence: 97,
  capability: "service",
  enabled: true,
