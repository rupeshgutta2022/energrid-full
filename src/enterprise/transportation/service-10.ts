...
export const transportation_10_0_definition = {
...
export const transportation_10_1_definition = {
  domain: "transportation",
  sequence: 11,
  capability: "service",
  enabled: true,
...
export const transportation_10_2_definition = {
  domain: "transportation",
  sequence: 12,
  capability: "service",
  enabled: true,
...
export const transportation_10_3_definition = {
  domain: "transportation",
  sequence: 13,
  capability: "service",
  enabled: true,
...
export const transportation_10_4_definition = {
  domain: "transportation",
  sequence: 14,
  capability: "service",
  enabled: true,
...
export const transportation_10_5_definition = {
  domain: "transportation",
  sequence: 15,
  capability: "service",
  enabled: true,
...
export const transportation_10_6_definition = {
  domain: "transportation",
  sequence: 16,
  capability: "service",
  enabled: true,
...
export const transportation_10_7_definition = {
  domain: "transportation",
  sequence: 17,
  capability: "service",
  enabled: true,
