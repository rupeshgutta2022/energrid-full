...
export const transportation_230_0_definition = {
...
export const transportation_230_1_definition = {
  domain: "transportation",
  sequence: 231,
  capability: "service",
  enabled: true,
...
export const transportation_230_2_definition = {
  domain: "transportation",
  sequence: 232,
  capability: "service",
  enabled: true,
...
export const transportation_230_3_definition = {
  domain: "transportation",
  sequence: 233,
  capability: "service",
  enabled: true,
