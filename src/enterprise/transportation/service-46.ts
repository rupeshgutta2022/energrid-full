...
export const transportation_46_0_definition = {
...
export const transportation_46_1_definition = {
  domain: "transportation",
  sequence: 47,
  capability: "service",
  enabled: true,
...
export const transportation_46_2_definition = {
  domain: "transportation",
  sequence: 48,
  capability: "service",
  enabled: true,
...
export const transportation_46_3_definition = {
  domain: "transportation",
  sequence: 49,
  capability: "service",
  enabled: true,
...
export const transportation_46_4_definition = {
  domain: "transportation",
  sequence: 50,
  capability: "service",
  enabled: true,
...
export const transportation_46_5_definition = {
  domain: "transportation",
  sequence: 51,
  capability: "service",
  enabled: true,
...
export const transportation_46_6_definition = {
  domain: "transportation",
  sequence: 52,
  capability: "service",
  enabled: true,
...
export const transportation_46_7_definition = {
  domain: "transportation",
  sequence: 53,
  capability: "service",
  enabled: true,
