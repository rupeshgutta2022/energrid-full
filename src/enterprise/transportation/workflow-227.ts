...
export const transportation_227_0_definition = {
...
export const transportation_227_1_definition = {
  domain: "transportation",
  sequence: 228,
  capability: "workflow",
  enabled: true,
...
export const transportation_227_2_definition = {
  domain: "transportation",
  sequence: 229,
  capability: "workflow",
  enabled: true,
...
export const transportation_227_3_definition = {
  domain: "transportation",
  sequence: 230,
  capability: "workflow",
  enabled: true,
...
export const transportation_227_4_definition = {
  domain: "transportation",
  sequence: 231,
  capability: "workflow",
  enabled: true,
...
export const transportation_227_5_definition = {
  domain: "transportation",
  sequence: 232,
  capability: "workflow",
  enabled: true,
...
export const transportation_227_6_definition = {
  domain: "transportation",
  sequence: 233,
  capability: "workflow",
  enabled: true,
