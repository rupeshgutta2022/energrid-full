...
export const transportation_210_0_definition = {
...
export const transportation_210_1_definition = {
  domain: "transportation",
  sequence: 211,
  capability: "service",
  enabled: true,
...
export const transportation_210_2_definition = {
  domain: "transportation",
  sequence: 212,
  capability: "service",
  enabled: true,
...
export const transportation_210_3_definition = {
  domain: "transportation",
  sequence: 213,
  capability: "service",
  enabled: true,
...
export const transportation_210_4_definition = {
  domain: "transportation",
  sequence: 214,
  capability: "service",
  enabled: true,
...
export const transportation_210_5_definition = {
  domain: "transportation",
  sequence: 215,
  capability: "service",
  enabled: true,
...
export const transportation_210_6_definition = {
  domain: "transportation",
  sequence: 216,
  capability: "service",
  enabled: true,
...
export const transportation_210_7_definition = {
  domain: "transportation",
  sequence: 217,
  capability: "service",
  enabled: true,
