...
export const transportation_150_0_definition = {
...
export const transportation_150_1_definition = {
  domain: "transportation",
  sequence: 151,
  capability: "service",
  enabled: true,
...
export const transportation_150_2_definition = {
  domain: "transportation",
  sequence: 152,
  capability: "service",
  enabled: true,
...
export const transportation_150_3_definition = {
  domain: "transportation",
  sequence: 153,
  capability: "service",
  enabled: true,
...
export const transportation_150_4_definition = {
  domain: "transportation",
  sequence: 154,
  capability: "service",
  enabled: true,
...
export const transportation_150_5_definition = {
  domain: "transportation",
  sequence: 155,
  capability: "service",
  enabled: true,
...
export const transportation_150_6_definition = {
  domain: "transportation",
  sequence: 156,
  capability: "service",
  enabled: true,
...
export const transportation_150_7_definition = {
  domain: "transportation",
  sequence: 157,
  capability: "service",
  enabled: true,
