...
export const transportation_134_0_definition = {
...
export const transportation_134_1_definition = {
  domain: "transportation",
  sequence: 135,
  capability: "service",
  enabled: true,
...
export const transportation_134_2_definition = {
  domain: "transportation",
  sequence: 136,
  capability: "service",
  enabled: true,
...
export const transportation_134_3_definition = {
  domain: "transportation",
  sequence: 137,
  capability: "service",
  enabled: true,
...
export const transportation_134_4_definition = {
  domain: "transportation",
  sequence: 138,
  capability: "service",
  enabled: true,
...
export const transportation_134_5_definition = {
  domain: "transportation",
  sequence: 139,
  capability: "service",
  enabled: true,
...
export const transportation_134_6_definition = {
  domain: "transportation",
  sequence: 140,
  capability: "service",
  enabled: true,
...
export const transportation_134_7_definition = {
  domain: "transportation",
  sequence: 141,
  capability: "service",
  enabled: true,
