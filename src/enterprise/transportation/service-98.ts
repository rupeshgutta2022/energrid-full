...
export const transportation_98_0_definition = {
...
export const transportation_98_1_definition = {
  domain: "transportation",
  sequence: 99,
  capability: "service",
  enabled: true,
...
export const transportation_98_2_definition = {
  domain: "transportation",
  sequence: 100,
  capability: "service",
  enabled: true,
...
export const transportation_98_3_definition = {
  domain: "transportation",
  sequence: 101,
  capability: "service",
  enabled: true,
...
export const transportation_98_4_definition = {
  domain: "transportation",
  sequence: 102,
  capability: "service",
  enabled: true,
...
export const transportation_98_5_definition = {
  domain: "transportation",
  sequence: 103,
  capability: "service",
  enabled: true,
...
export const transportation_98_6_definition = {
  domain: "transportation",
  sequence: 104,
  capability: "service",
  enabled: true,
...
export const transportation_98_7_definition = {
  domain: "transportation",
  sequence: 105,
  capability: "service",
  enabled: true,
