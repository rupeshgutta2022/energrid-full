...
export const transportation_78_0_definition = {
...
export const transportation_78_1_definition = {
  domain: "transportation",
  sequence: 79,
  capability: "service",
  enabled: true,
...
export const transportation_78_2_definition = {
  domain: "transportation",
  sequence: 80,
  capability: "service",
  enabled: true,
...
export const transportation_78_3_definition = {
  domain: "transportation",
  sequence: 81,
  capability: "service",
  enabled: true,
...
export const transportation_78_4_definition = {
  domain: "transportation",
  sequence: 82,
  capability: "service",
  enabled: true,
...
export const transportation_78_5_definition = {
  domain: "transportation",
  sequence: 83,
  capability: "service",
  enabled: true,
...
export const transportation_78_6_definition = {
  domain: "transportation",
  sequence: 84,
  capability: "service",
  enabled: true,
...
export const transportation_78_7_definition = {
  domain: "transportation",
  sequence: 85,
  capability: "service",
  enabled: true,
