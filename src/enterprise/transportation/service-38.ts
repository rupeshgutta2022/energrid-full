...
export const transportation_38_0_definition = {
...
export const transportation_38_1_definition = {
  domain: "transportation",
  sequence: 39,
  capability: "service",
  enabled: true,
...
export const transportation_38_2_definition = {
  domain: "transportation",
  sequence: 40,
  capability: "service",
  enabled: true,
...
export const transportation_38_3_definition = {
  domain: "transportation",
  sequence: 41,
  capability: "service",
  enabled: true,
...
export const transportation_38_4_definition = {
  domain: "transportation",
  sequence: 42,
  capability: "service",
  enabled: true,
...
export const transportation_38_5_definition = {
  domain: "transportation",
  sequence: 43,
  capability: "service",
  enabled: true,
...
export const transportation_38_6_definition = {
  domain: "transportation",
  sequence: 44,
  capability: "service",
  enabled: true,
...
export const transportation_38_7_definition = {
  domain: "transportation",
  sequence: 45,
  capability: "service",
  enabled: true,
