...
export const transportation_18_0_definition = {
...
export const transportation_18_1_definition = {
  domain: "transportation",
  sequence: 19,
  capability: "service",
  enabled: true,
...
export const transportation_18_2_definition = {
  domain: "transportation",
  sequence: 20,
  capability: "service",
  enabled: true,
...
export const transportation_18_3_definition = {
  domain: "transportation",
  sequence: 21,
  capability: "service",
  enabled: true,
...
export const transportation_18_4_definition = {
  domain: "transportation",
  sequence: 22,
  capability: "service",
  enabled: true,
...
export const transportation_18_5_definition = {
  domain: "transportation",
  sequence: 23,
  capability: "service",
  enabled: true,
...
export const transportation_18_6_definition = {
  domain: "transportation",
  sequence: 24,
  capability: "service",
  enabled: true,
...
export const transportation_18_7_definition = {
  domain: "transportation",
  sequence: 25,
  capability: "service",
  enabled: true,
