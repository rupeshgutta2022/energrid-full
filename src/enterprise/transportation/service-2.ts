...
export const transportation_2_0_definition = {
...
export const transportation_2_1_definition = {
  domain: "transportation",
  sequence: 3,
  capability: "service",
  enabled: true,
...
export const transportation_2_2_definition = {
  domain: "transportation",
  sequence: 4,
  capability: "service",
  enabled: true,
...
export const transportation_2_3_definition = {
  domain: "transportation",
  sequence: 5,
  capability: "service",
  enabled: true,
...
export const transportation_2_4_definition = {
  domain: "transportation",
  sequence: 6,
  capability: "service",
  enabled: true,
...
export const transportation_2_5_definition = {
  domain: "transportation",
  sequence: 7,
  capability: "service",
  enabled: true,
...
export const transportation_2_6_definition = {
  domain: "transportation",
  sequence: 8,
  capability: "service",
  enabled: true,
...
export const transportation_2_7_definition = {
  domain: "transportation",
  sequence: 9,
  capability: "service",
  enabled: true,
