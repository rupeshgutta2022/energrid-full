...
export const inventory_62_0_definition = {
  domain: "inventory",
  sequence: 62,
  capability: "service",
  enabled: true,
...
export const inventory_62_1_definition = {
  domain: "inventory",
  sequence: 63,
  capability: "service",
  enabled: true,
...
export const inventory_62_2_definition = {
  domain: "inventory",
  sequence: 64,
  capability: "service",
  enabled: true,
...
export const inventory_62_3_definition = {
  domain: "inventory",
  sequence: 65,
  capability: "service",
  enabled: true,
...
export const inventory_62_4_definition = {
  domain: "inventory",
  sequence: 66,
  capability: "service",
  enabled: true,
...
export const inventory_62_5_definition = {
  domain: "inventory",
  sequence: 67,
  capability: "service",
  enabled: true,
...
export const inventory_62_6_definition = {
  domain: "inventory",
  sequence: 68,
  capability: "service",
  enabled: true,
...
export const inventory_62_7_definition = {
  domain: "inventory",
  sequence: 69,
  capability: "service",
  enabled: true,
