...
export const inventory_134_0_definition = {
  domain: "inventory",
  sequence: 134,
  capability: "service",
  enabled: true,
...
export const inventory_134_1_definition = {
  domain: "inventory",
  sequence: 135,
  capability: "service",
  enabled: true,
...
export const inventory_134_2_definition = {
  domain: "inventory",
  sequence: 136,
  capability: "service",
  enabled: true,
...
export const inventory_134_3_definition = {
  domain: "inventory",
  sequence: 137,
  capability: "service",
  enabled: true,
...
export const inventory_134_4_definition = {
  domain: "inventory",
  sequence: 138,
  capability: "service",
  enabled: true,
...
export const inventory_134_5_definition = {
  domain: "inventory",
  sequence: 139,
  capability: "service",
  enabled: true,
...
export const inventory_134_6_definition = {
  domain: "inventory",
  sequence: 140,
  capability: "service",
  enabled: true,
...
export const inventory_134_7_definition = {
  domain: "inventory",
  sequence: 141,
  capability: "service",
  enabled: true,
