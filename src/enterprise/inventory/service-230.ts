...
export const inventory_230_0_definition = {
  domain: "inventory",
  sequence: 230,
  capability: "service",
  enabled: true,
...
export const inventory_230_1_definition = {
  domain: "inventory",
  sequence: 231,
  capability: "service",
  enabled: true,
...
export const inventory_230_2_definition = {
  domain: "inventory",
  sequence: 232,
  capability: "service",
  enabled: true,
...
export const inventory_230_3_definition = {
  domain: "inventory",
  sequence: 233,
  capability: "service",
  enabled: true,
