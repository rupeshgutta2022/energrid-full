...
export const inventory_154_0_definition = {
  domain: "inventory",
  sequence: 154,
  capability: "service",
  enabled: true,
...
export const inventory_154_1_definition = {
  domain: "inventory",
  sequence: 155,
  capability: "service",
  enabled: true,
...
export const inventory_154_2_definition = {
  domain: "inventory",
  sequence: 156,
  capability: "service",
  enabled: true,
...
export const inventory_154_3_definition = {
  domain: "inventory",
  sequence: 157,
  capability: "service",
  enabled: true,
...
export const inventory_154_4_definition = {
  domain: "inventory",
  sequence: 158,
  capability: "service",
  enabled: true,
...
export const inventory_154_5_definition = {
  domain: "inventory",
  sequence: 159,
  capability: "service",
  enabled: true,
...
export const inventory_154_6_definition = {
  domain: "inventory",
  sequence: 160,
  capability: "service",
  enabled: true,
...
export const inventory_154_7_definition = {
  domain: "inventory",
  sequence: 161,
  capability: "service",
  enabled: true,
