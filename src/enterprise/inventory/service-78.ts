...
export const inventory_78_0_definition = {
  domain: "inventory",
  sequence: 78,
  capability: "service",
  enabled: true,
...
export const inventory_78_1_definition = {
  domain: "inventory",
  sequence: 79,
  capability: "service",
  enabled: true,
...
export const inventory_78_2_definition = {
  domain: "inventory",
  sequence: 80,
  capability: "service",
  enabled: true,
...
export const inventory_78_3_definition = {
  domain: "inventory",
  sequence: 81,
  capability: "service",
  enabled: true,
...
export const inventory_78_4_definition = {
  domain: "inventory",
  sequence: 82,
  capability: "service",
  enabled: true,
...
export const inventory_78_5_definition = {
  domain: "inventory",
  sequence: 83,
  capability: "service",
  enabled: true,
...
export const inventory_78_6_definition = {
  domain: "inventory",
  sequence: 84,
  capability: "service",
  enabled: true,
...
export const inventory_78_7_definition = {
  domain: "inventory",
  sequence: 85,
  capability: "service",
  enabled: true,
