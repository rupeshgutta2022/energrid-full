...
export const inventory_110_0_definition = {
  domain: "inventory",
  sequence: 110,
  capability: "service",
  enabled: true,
...
export const inventory_110_1_definition = {
  domain: "inventory",
  sequence: 111,
  capability: "service",
  enabled: true,
...
export const inventory_110_2_definition = {
  domain: "inventory",
  sequence: 112,
  capability: "service",
  enabled: true,
...
export const inventory_110_3_definition = {
  domain: "inventory",
  sequence: 113,
  capability: "service",
  enabled: true,
...
export const inventory_110_4_definition = {
  domain: "inventory",
  sequence: 114,
  capability: "service",
  enabled: true,
...
export const inventory_110_5_definition = {
  domain: "inventory",
  sequence: 115,
  capability: "service",
  enabled: true,
...
export const inventory_110_6_definition = {
  domain: "inventory",
  sequence: 116,
  capability: "service",
  enabled: true,
...
export const inventory_110_7_definition = {
  domain: "inventory",
  sequence: 117,
  capability: "service",
  enabled: true,
