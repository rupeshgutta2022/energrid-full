...
export const inventory_206_0_definition = {
  domain: "inventory",
  sequence: 206,
  capability: "service",
  enabled: true,
...
export const inventory_206_1_definition = {
  domain: "inventory",
  sequence: 207,
  capability: "service",
  enabled: true,
...
export const inventory_206_2_definition = {
  domain: "inventory",
  sequence: 208,
  capability: "service",
  enabled: true,
...
export const inventory_206_3_definition = {
  domain: "inventory",
  sequence: 209,
  capability: "service",
  enabled: true,
...
export const inventory_206_4_definition = {
  domain: "inventory",
  sequence: 210,
  capability: "service",
  enabled: true,
...
export const inventory_206_5_definition = {
  domain: "inventory",
  sequence: 211,
  capability: "service",
  enabled: true,
...
export const inventory_206_6_definition = {
  domain: "inventory",
  sequence: 212,
  capability: "service",
  enabled: true,
...
export const inventory_206_7_definition = {
  domain: "inventory",
  sequence: 213,
  capability: "service",
  enabled: true,
