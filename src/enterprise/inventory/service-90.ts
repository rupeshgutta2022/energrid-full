...
export const inventory_90_0_definition = {
  domain: "inventory",
  sequence: 90,
  capability: "service",
  enabled: true,
...
export const inventory_90_1_definition = {
  domain: "inventory",
  sequence: 91,
  capability: "service",
  enabled: true,
...
export const inventory_90_2_definition = {
  domain: "inventory",
  sequence: 92,
  capability: "service",
  enabled: true,
...
export const inventory_90_3_definition = {
  domain: "inventory",
  sequence: 93,
  capability: "service",
  enabled: true,
...
export const inventory_90_4_definition = {
  domain: "inventory",
  sequence: 94,
  capability: "service",
  enabled: true,
...
export const inventory_90_5_definition = {
  domain: "inventory",
  sequence: 95,
  capability: "service",
  enabled: true,
...
export const inventory_90_6_definition = {
  domain: "inventory",
  sequence: 96,
  capability: "service",
  enabled: true,
...
export const inventory_90_7_definition = {
  domain: "inventory",
  sequence: 97,
  capability: "service",
  enabled: true,
