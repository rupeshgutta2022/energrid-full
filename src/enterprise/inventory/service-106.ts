...
export const inventory_106_0_definition = {
  domain: "inventory",
  sequence: 106,
  capability: "service",
  enabled: true,
...
export const inventory_106_1_definition = {
  domain: "inventory",
  sequence: 107,
  capability: "service",
  enabled: true,
...
export const inventory_106_2_definition = {
  domain: "inventory",
  sequence: 108,
  capability: "service",
  enabled: true,
...
export const inventory_106_3_definition = {
  domain: "inventory",
  sequence: 109,
  capability: "service",
  enabled: true,
...
export const inventory_106_4_definition = {
  domain: "inventory",
  sequence: 110,
  capability: "service",
  enabled: true,
...
export const inventory_106_5_definition = {
  domain: "inventory",
  sequence: 111,
  capability: "service",
  enabled: true,
...
export const inventory_106_6_definition = {
  domain: "inventory",
  sequence: 112,
  capability: "service",
  enabled: true,
...
export const inventory_106_7_definition = {
  domain: "inventory",
  sequence: 113,
  capability: "service",
  enabled: true,
