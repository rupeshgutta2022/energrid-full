...
export const inventory_18_0_definition = {
  domain: "inventory",
  sequence: 18,
  capability: "service",
  enabled: true,
...
export const inventory_18_1_definition = {
  domain: "inventory",
  sequence: 19,
  capability: "service",
  enabled: true,
...
export const inventory_18_2_definition = {
  domain: "inventory",
  sequence: 20,
  capability: "service",
  enabled: true,
...
export const inventory_18_3_definition = {
  domain: "inventory",
  sequence: 21,
  capability: "service",
  enabled: true,
...
export const inventory_18_4_definition = {
  domain: "inventory",
  sequence: 22,
  capability: "service",
  enabled: true,
...
export const inventory_18_5_definition = {
  domain: "inventory",
  sequence: 23,
  capability: "service",
  enabled: true,
...
export const inventory_18_6_definition = {
  domain: "inventory",
  sequence: 24,
  capability: "service",
  enabled: true,
...
export const inventory_18_7_definition = {
  domain: "inventory",
  sequence: 25,
  capability: "service",
  enabled: true,
