...
export const inventory_70_0_definition = {
  domain: "inventory",
  sequence: 70,
  capability: "service",
  enabled: true,
...
export const inventory_70_1_definition = {
  domain: "inventory",
  sequence: 71,
  capability: "service",
  enabled: true,
...
export const inventory_70_2_definition = {
  domain: "inventory",
  sequence: 72,
  capability: "service",
  enabled: true,
...
export const inventory_70_3_definition = {
  domain: "inventory",
  sequence: 73,
  capability: "service",
  enabled: true,
...
export const inventory_70_4_definition = {
  domain: "inventory",
  sequence: 74,
  capability: "service",
  enabled: true,
...
export const inventory_70_5_definition = {
  domain: "inventory",
  sequence: 75,
  capability: "service",
  enabled: true,
...
export const inventory_70_6_definition = {
  domain: "inventory",
  sequence: 76,
  capability: "service",
  enabled: true,
...
export const inventory_70_7_definition = {
  domain: "inventory",
  sequence: 77,
  capability: "service",
  enabled: true,
