...
export const inventory_210_0_definition = {
  domain: "inventory",
  sequence: 210,
  capability: "service",
  enabled: true,
...
export const inventory_210_1_definition = {
  domain: "inventory",
  sequence: 211,
  capability: "service",
  enabled: true,
...
export const inventory_210_2_definition = {
  domain: "inventory",
  sequence: 212,
  capability: "service",
  enabled: true,
...
export const inventory_210_3_definition = {
  domain: "inventory",
  sequence: 213,
  capability: "service",
  enabled: true,
...
export const inventory_210_4_definition = {
  domain: "inventory",
  sequence: 214,
  capability: "service",
  enabled: true,
...
export const inventory_210_5_definition = {
  domain: "inventory",
  sequence: 215,
  capability: "service",
  enabled: true,
...
export const inventory_210_6_definition = {
  domain: "inventory",
  sequence: 216,
  capability: "service",
  enabled: true,
...
export const inventory_210_7_definition = {
  domain: "inventory",
  sequence: 217,
  capability: "service",
  enabled: true,
