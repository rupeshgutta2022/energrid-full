...
export const inventory_130_0_definition = {
  domain: "inventory",
  sequence: 130,
  capability: "service",
  enabled: true,
...
export const inventory_130_1_definition = {
  domain: "inventory",
  sequence: 131,
  capability: "service",
  enabled: true,
...
export const inventory_130_2_definition = {
  domain: "inventory",
  sequence: 132,
  capability: "service",
  enabled: true,
...
export const inventory_130_3_definition = {
  domain: "inventory",
  sequence: 133,
  capability: "service",
  enabled: true,
...
export const inventory_130_4_definition = {
  domain: "inventory",
  sequence: 134,
  capability: "service",
  enabled: true,
...
export const inventory_130_5_definition = {
  domain: "inventory",
  sequence: 135,
  capability: "service",
  enabled: true,
...
export const inventory_130_6_definition = {
  domain: "inventory",
  sequence: 136,
  capability: "service",
  enabled: true,
...
export const inventory_130_7_definition = {
  domain: "inventory",
  sequence: 137,
  capability: "service",
  enabled: true,
