...
export const inventory_58_0_definition = {
  domain: "inventory",
  sequence: 58,
  capability: "service",
  enabled: true,
...
export const inventory_58_1_definition = {
  domain: "inventory",
  sequence: 59,
  capability: "service",
  enabled: true,
...
export const inventory_58_2_definition = {
  domain: "inventory",
  sequence: 60,
  capability: "service",
  enabled: true,
...
export const inventory_58_3_definition = {
  domain: "inventory",
  sequence: 61,
  capability: "service",
  enabled: true,
...
export const inventory_58_4_definition = {
  domain: "inventory",
  sequence: 62,
  capability: "service",
  enabled: true,
...
export const inventory_58_5_definition = {
  domain: "inventory",
  sequence: 63,
  capability: "service",
  enabled: true,
...
export const inventory_58_6_definition = {
  domain: "inventory",
  sequence: 64,
  capability: "service",
  enabled: true,
...
export const inventory_58_7_definition = {
  domain: "inventory",
  sequence: 65,
  capability: "service",
  enabled: true,
