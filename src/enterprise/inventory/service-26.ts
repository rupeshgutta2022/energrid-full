...
export const inventory_26_0_definition = {
  domain: "inventory",
  sequence: 26,
  capability: "service",
  enabled: true,
...
export const inventory_26_1_definition = {
  domain: "inventory",
  sequence: 27,
  capability: "service",
  enabled: true,
...
export const inventory_26_2_definition = {
  domain: "inventory",
  sequence: 28,
  capability: "service",
  enabled: true,
...
export const inventory_26_3_definition = {
  domain: "inventory",
  sequence: 29,
  capability: "service",
  enabled: true,
...
export const inventory_26_4_definition = {
  domain: "inventory",
  sequence: 30,
  capability: "service",
  enabled: true,
...
export const inventory_26_5_definition = {
  domain: "inventory",
  sequence: 31,
  capability: "service",
  enabled: true,
...
export const inventory_26_6_definition = {
  domain: "inventory",
  sequence: 32,
  capability: "service",
  enabled: true,
...
export const inventory_26_7_definition = {
  domain: "inventory",
  sequence: 33,
  capability: "service",
  enabled: true,
