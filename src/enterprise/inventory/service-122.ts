...
export const inventory_122_0_definition = {
  domain: "inventory",
  sequence: 122,
  capability: "service",
  enabled: true,
...
export const inventory_122_1_definition = {
  domain: "inventory",
  sequence: 123,
  capability: "service",
  enabled: true,
...
export const inventory_122_2_definition = {
  domain: "inventory",
  sequence: 124,
  capability: "service",
  enabled: true,
...
export const inventory_122_3_definition = {
  domain: "inventory",
  sequence: 125,
  capability: "service",
  enabled: true,
...
export const inventory_122_4_definition = {
  domain: "inventory",
  sequence: 126,
  capability: "service",
  enabled: true,
...
export const inventory_122_5_definition = {
  domain: "inventory",
  sequence: 127,
  capability: "service",
  enabled: true,
...
export const inventory_122_6_definition = {
  domain: "inventory",
  sequence: 128,
  capability: "service",
  enabled: true,
...
export const inventory_122_7_definition = {
  domain: "inventory",
  sequence: 129,
  capability: "service",
  enabled: true,
