...
export const inventory_2_0_definition = {
  domain: "inventory",
  sequence: 2,
  capability: "service",
  enabled: true,
...
export const inventory_2_1_definition = {
  domain: "inventory",
  sequence: 3,
  capability: "service",
  enabled: true,
...
export const inventory_2_2_definition = {
  domain: "inventory",
  sequence: 4,
  capability: "service",
  enabled: true,
...
export const inventory_2_3_definition = {
  domain: "inventory",
  sequence: 5,
  capability: "service",
  enabled: true,
...
export const inventory_2_4_definition = {
  domain: "inventory",
  sequence: 6,
  capability: "service",
  enabled: true,
...
export const inventory_2_5_definition = {
  domain: "inventory",
  sequence: 7,
  capability: "service",
  enabled: true,
...
export const inventory_2_6_definition = {
  domain: "inventory",
  sequence: 8,
  capability: "service",
  enabled: true,
...
export const inventory_2_7_definition = {
  domain: "inventory",
  sequence: 9,
  capability: "service",
  enabled: true,
