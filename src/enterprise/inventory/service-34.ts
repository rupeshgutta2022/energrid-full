...
export const inventory_34_0_definition = {
  domain: "inventory",
  sequence: 34,
  capability: "service",
  enabled: true,
...
export const inventory_34_1_definition = {
  domain: "inventory",
  sequence: 35,
  capability: "service",
  enabled: true,
...
export const inventory_34_2_definition = {
  domain: "inventory",
  sequence: 36,
  capability: "service",
  enabled: true,
...
export const inventory_34_3_definition = {
  domain: "inventory",
  sequence: 37,
  capability: "service",
  enabled: true,
...
export const inventory_34_4_definition = {
  domain: "inventory",
  sequence: 38,
  capability: "service",
  enabled: true,
...
export const inventory_34_5_definition = {
  domain: "inventory",
  sequence: 39,
  capability: "service",
  enabled: true,
...
export const inventory_34_6_definition = {
  domain: "inventory",
  sequence: 40,
  capability: "service",
  enabled: true,
...
export const inventory_34_7_definition = {
  domain: "inventory",
  sequence: 41,
  capability: "service",
  enabled: true,
