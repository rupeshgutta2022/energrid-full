...
export const inventory_38_0_definition = {
  domain: "inventory",
  sequence: 38,
  capability: "service",
  enabled: true,
...
export const inventory_38_1_definition = {
  domain: "inventory",
  sequence: 39,
  capability: "service",
  enabled: true,
...
export const inventory_38_2_definition = {
  domain: "inventory",
  sequence: 40,
  capability: "service",
  enabled: true,
...
export const inventory_38_3_definition = {
  domain: "inventory",
  sequence: 41,
  capability: "service",
  enabled: true,
...
export const inventory_38_4_definition = {
  domain: "inventory",
  sequence: 42,
  capability: "service",
  enabled: true,
...
export const inventory_38_5_definition = {
  domain: "inventory",
  sequence: 43,
  capability: "service",
  enabled: true,
...
export const inventory_38_6_definition = {
  domain: "inventory",
  sequence: 44,
  capability: "service",
  enabled: true,
...
export const inventory_38_7_definition = {
  domain: "inventory",
  sequence: 45,
  capability: "service",
  enabled: true,
