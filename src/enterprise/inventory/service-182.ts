...
export const inventory_182_0_definition = {
  domain: "inventory",
  sequence: 182,
  capability: "service",
  enabled: true,
...
export const inventory_182_1_definition = {
  domain: "inventory",
  sequence: 183,
  capability: "service",
  enabled: true,
...
export const inventory_182_2_definition = {
  domain: "inventory",
  sequence: 184,
  capability: "service",
  enabled: true,
...
export const inventory_182_3_definition = {
  domain: "inventory",
  sequence: 185,
  capability: "service",
  enabled: true,
...
export const inventory_182_4_definition = {
  domain: "inventory",
  sequence: 186,
  capability: "service",
  enabled: true,
...
export const inventory_182_5_definition = {
  domain: "inventory",
  sequence: 187,
  capability: "service",
  enabled: true,
...
export const inventory_182_6_definition = {
  domain: "inventory",
  sequence: 188,
  capability: "service",
  enabled: true,
...
export const inventory_182_7_definition = {
  domain: "inventory",
  sequence: 189,
  capability: "service",
  enabled: true,
