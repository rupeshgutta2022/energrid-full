...
export const inventory_86_0_definition = {
  domain: "inventory",
  sequence: 86,
  capability: "service",
  enabled: true,
...
export const inventory_86_1_definition = {
  domain: "inventory",
  sequence: 87,
  capability: "service",
  enabled: true,
...
export const inventory_86_2_definition = {
  domain: "inventory",
  sequence: 88,
  capability: "service",
  enabled: true,
...
export const inventory_86_3_definition = {
  domain: "inventory",
  sequence: 89,
  capability: "service",
  enabled: true,
...
export const inventory_86_4_definition = {
  domain: "inventory",
  sequence: 90,
  capability: "service",
  enabled: true,
...
export const inventory_86_5_definition = {
  domain: "inventory",
  sequence: 91,
  capability: "service",
  enabled: true,
...
export const inventory_86_6_definition = {
  domain: "inventory",
  sequence: 92,
  capability: "service",
  enabled: true,
...
export const inventory_86_7_definition = {
  domain: "inventory",
  sequence: 93,
  capability: "service",
  enabled: true,
