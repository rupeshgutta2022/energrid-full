...
export const inventory_98_0_definition = {
  domain: "inventory",
  sequence: 98,
  capability: "service",
  enabled: true,
...
export const inventory_98_1_definition = {
  domain: "inventory",
  sequence: 99,
  capability: "service",
  enabled: true,
...
export const inventory_98_2_definition = {
  domain: "inventory",
  sequence: 100,
  capability: "service",
  enabled: true,
...
export const inventory_98_3_definition = {
  domain: "inventory",
  sequence: 101,
  capability: "service",
  enabled: true,
...
export const inventory_98_4_definition = {
  domain: "inventory",
  sequence: 102,
  capability: "service",
  enabled: true,
...
export const inventory_98_5_definition = {
  domain: "inventory",
  sequence: 103,
  capability: "service",
  enabled: true,
...
export const inventory_98_6_definition = {
  domain: "inventory",
  sequence: 104,
  capability: "service",
  enabled: true,
...
export const inventory_98_7_definition = {
  domain: "inventory",
  sequence: 105,
  capability: "service",
  enabled: true,
