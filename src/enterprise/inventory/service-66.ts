...
export const inventory_66_0_definition = {
  domain: "inventory",
  sequence: 66,
  capability: "service",
  enabled: true,
...
export const inventory_66_1_definition = {
  domain: "inventory",
  sequence: 67,
  capability: "service",
  enabled: true,
...
export const inventory_66_2_definition = {
  domain: "inventory",
  sequence: 68,
  capability: "service",
  enabled: true,
...
export const inventory_66_3_definition = {
  domain: "inventory",
  sequence: 69,
  capability: "service",
  enabled: true,
...
export const inventory_66_4_definition = {
  domain: "inventory",
  sequence: 70,
  capability: "service",
  enabled: true,
...
export const inventory_66_5_definition = {
  domain: "inventory",
  sequence: 71,
  capability: "service",
  enabled: true,
...
export const inventory_66_6_definition = {
  domain: "inventory",
  sequence: 72,
  capability: "service",
  enabled: true,
...
export const inventory_66_7_definition = {
  domain: "inventory",
  sequence: 73,
  capability: "service",
  enabled: true,
