...
export const inventory_30_0_definition = {
  domain: "inventory",
  sequence: 30,
  capability: "service",
  enabled: true,
...
export const inventory_30_1_definition = {
  domain: "inventory",
  sequence: 31,
  capability: "service",
  enabled: true,
...
export const inventory_30_2_definition = {
  domain: "inventory",
  sequence: 32,
  capability: "service",
  enabled: true,
...
export const inventory_30_3_definition = {
  domain: "inventory",
  sequence: 33,
  capability: "service",
  enabled: true,
...
export const inventory_30_4_definition = {
  domain: "inventory",
  sequence: 34,
  capability: "service",
  enabled: true,
...
export const inventory_30_5_definition = {
  domain: "inventory",
  sequence: 35,
  capability: "service",
  enabled: true,
...
export const inventory_30_6_definition = {
  domain: "inventory",
  sequence: 36,
  capability: "service",
  enabled: true,
...
export const inventory_30_7_definition = {
  domain: "inventory",
  sequence: 37,
  capability: "service",
  enabled: true,
