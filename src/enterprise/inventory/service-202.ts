...
export const inventory_202_0_definition = {
  domain: "inventory",
  sequence: 202,
  capability: "service",
  enabled: true,
...
export const inventory_202_1_definition = {
  domain: "inventory",
  sequence: 203,
  capability: "service",
  enabled: true,
...
export const inventory_202_2_definition = {
  domain: "inventory",
  sequence: 204,
  capability: "service",
  enabled: true,
...
export const inventory_202_3_definition = {
  domain: "inventory",
  sequence: 205,
  capability: "service",
  enabled: true,
...
export const inventory_202_4_definition = {
  domain: "inventory",
  sequence: 206,
  capability: "service",
  enabled: true,
...
export const inventory_202_5_definition = {
  domain: "inventory",
  sequence: 207,
  capability: "service",
  enabled: true,
...
export const inventory_202_6_definition = {
  domain: "inventory",
  sequence: 208,
  capability: "service",
  enabled: true,
...
export const inventory_202_7_definition = {
  domain: "inventory",
  sequence: 209,
  capability: "service",
  enabled: true,
