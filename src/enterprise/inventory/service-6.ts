...
export const inventory_6_0_definition = {
  domain: "inventory",
  sequence: 6,
  capability: "service",
  enabled: true,
...
export const inventory_6_1_definition = {
  domain: "inventory",
  sequence: 7,
  capability: "service",
  enabled: true,
...
export const inventory_6_2_definition = {
  domain: "inventory",
  sequence: 8,
  capability: "service",
  enabled: true,
...
export const inventory_6_3_definition = {
  domain: "inventory",
  sequence: 9,
  capability: "service",
  enabled: true,
...
export const inventory_6_4_definition = {
  domain: "inventory",
  sequence: 10,
  capability: "service",
  enabled: true,
...
export const inventory_6_5_definition = {
  domain: "inventory",
  sequence: 11,
  capability: "service",
  enabled: true,
...
export const inventory_6_6_definition = {
  domain: "inventory",
  sequence: 12,
  capability: "service",
  enabled: true,
...
export const inventory_6_7_definition = {
  domain: "inventory",
  sequence: 13,
  capability: "service",
  enabled: true,
