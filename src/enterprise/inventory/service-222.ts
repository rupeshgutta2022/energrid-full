...
export const inventory_222_0_definition = {
  domain: "inventory",
  sequence: 222,
  capability: "service",
  enabled: true,
...
export const inventory_222_1_definition = {
  domain: "inventory",
  sequence: 223,
  capability: "service",
  enabled: true,
...
export const inventory_222_2_definition = {
  domain: "inventory",
  sequence: 224,
  capability: "service",
  enabled: true,
...
export const inventory_222_3_definition = {
  domain: "inventory",
  sequence: 225,
  capability: "service",
  enabled: true,
...
export const inventory_222_4_definition = {
  domain: "inventory",
  sequence: 226,
  capability: "service",
  enabled: true,
...
export const inventory_222_5_definition = {
  domain: "inventory",
  sequence: 227,
  capability: "service",
  enabled: true,
...
export const inventory_222_6_definition = {
  domain: "inventory",
  sequence: 228,
  capability: "service",
  enabled: true,
...
export const inventory_222_7_definition = {
  domain: "inventory",
  sequence: 229,
  capability: "service",
  enabled: true,
