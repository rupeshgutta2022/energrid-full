...
export const inventory_94_0_definition = {
  domain: "inventory",
  sequence: 94,
  capability: "service",
  enabled: true,
...
export const inventory_94_1_definition = {
  domain: "inventory",
  sequence: 95,
  capability: "service",
  enabled: true,
...
export const inventory_94_2_definition = {
  domain: "inventory",
  sequence: 96,
  capability: "service",
  enabled: true,
...
export const inventory_94_3_definition = {
  domain: "inventory",
  sequence: 97,
  capability: "service",
  enabled: true,
...
export const inventory_94_4_definition = {
  domain: "inventory",
  sequence: 98,
  capability: "service",
  enabled: true,
...
export const inventory_94_5_definition = {
  domain: "inventory",
  sequence: 99,
  capability: "service",
  enabled: true,
...
export const inventory_94_6_definition = {
  domain: "inventory",
  sequence: 100,
  capability: "service",
  enabled: true,
...
export const inventory_94_7_definition = {
  domain: "inventory",
  sequence: 101,
  capability: "service",
  enabled: true,
