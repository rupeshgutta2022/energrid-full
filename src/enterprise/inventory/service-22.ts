...
export const inventory_22_0_definition = {
  domain: "inventory",
  sequence: 22,
  capability: "service",
  enabled: true,
...
export const inventory_22_1_definition = {
  domain: "inventory",
  sequence: 23,
  capability: "service",
  enabled: true,
...
export const inventory_22_2_definition = {
  domain: "inventory",
  sequence: 24,
  capability: "service",
  enabled: true,
...
export const inventory_22_3_definition = {
  domain: "inventory",
  sequence: 25,
  capability: "service",
  enabled: true,
...
export const inventory_22_4_definition = {
  domain: "inventory",
  sequence: 26,
  capability: "service",
  enabled: true,
...
export const inventory_22_5_definition = {
  domain: "inventory",
  sequence: 27,
  capability: "service",
  enabled: true,
...
export const inventory_22_6_definition = {
  domain: "inventory",
  sequence: 28,
  capability: "service",
  enabled: true,
...
export const inventory_22_7_definition = {
  domain: "inventory",
  sequence: 29,
  capability: "service",
  enabled: true,
