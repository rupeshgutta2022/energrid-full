...
export const inventory_174_0_definition = {
  domain: "inventory",
  sequence: 174,
  capability: "service",
  enabled: true,
...
export const inventory_174_1_definition = {
  domain: "inventory",
  sequence: 175,
  capability: "service",
  enabled: true,
...
export const inventory_174_2_definition = {
  domain: "inventory",
  sequence: 176,
  capability: "service",
  enabled: true,
...
export const inventory_174_3_definition = {
  domain: "inventory",
  sequence: 177,
  capability: "service",
  enabled: true,
...
export const inventory_174_4_definition = {
  domain: "inventory",
  sequence: 178,
  capability: "service",
  enabled: true,
...
export const inventory_174_5_definition = {
  domain: "inventory",
  sequence: 179,
  capability: "service",
  enabled: true,
...
export const inventory_174_6_definition = {
  domain: "inventory",
  sequence: 180,
  capability: "service",
  enabled: true,
...
export const inventory_174_7_definition = {
  domain: "inventory",
  sequence: 181,
  capability: "service",
  enabled: true,
