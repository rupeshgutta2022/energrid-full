...
export const inventory_10_0_definition = {
  domain: "inventory",
  sequence: 10,
  capability: "service",
  enabled: true,
...
export const inventory_10_1_definition = {
  domain: "inventory",
  sequence: 11,
  capability: "service",
  enabled: true,
...
export const inventory_10_2_definition = {
  domain: "inventory",
  sequence: 12,
  capability: "service",
  enabled: true,
...
export const inventory_10_3_definition = {
  domain: "inventory",
  sequence: 13,
  capability: "service",
  enabled: true,
...
export const inventory_10_4_definition = {
  domain: "inventory",
  sequence: 14,
  capability: "service",
  enabled: true,
...
export const inventory_10_5_definition = {
  domain: "inventory",
  sequence: 15,
  capability: "service",
  enabled: true,
...
export const inventory_10_6_definition = {
  domain: "inventory",
  sequence: 16,
  capability: "service",
  enabled: true,
...
export const inventory_10_7_definition = {
  domain: "inventory",
  sequence: 17,
  capability: "service",
  enabled: true,
