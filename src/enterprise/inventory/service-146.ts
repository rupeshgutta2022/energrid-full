...
export const inventory_146_0_definition = {
  domain: "inventory",
  sequence: 146,
  capability: "service",
  enabled: true,
...
export const inventory_146_1_definition = {
  domain: "inventory",
  sequence: 147,
  capability: "service",
  enabled: true,
...
export const inventory_146_2_definition = {
  domain: "inventory",
  sequence: 148,
  capability: "service",
  enabled: true,
...
export const inventory_146_3_definition = {
  domain: "inventory",
  sequence: 149,
  capability: "service",
  enabled: true,
...
export const inventory_146_4_definition = {
  domain: "inventory",
  sequence: 150,
  capability: "service",
  enabled: true,
...
export const inventory_146_5_definition = {
  domain: "inventory",
  sequence: 151,
  capability: "service",
  enabled: true,
...
export const inventory_146_6_definition = {
  domain: "inventory",
  sequence: 152,
  capability: "service",
  enabled: true,
...
export const inventory_146_7_definition = {
  domain: "inventory",
  sequence: 153,
  capability: "service",
  enabled: true,
