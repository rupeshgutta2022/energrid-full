...
export const inventory_114_0_definition = {
  domain: "inventory",
  sequence: 114,
  capability: "service",
  enabled: true,
...
export const inventory_114_1_definition = {
  domain: "inventory",
  sequence: 115,
  capability: "service",
  enabled: true,
...
export const inventory_114_2_definition = {
  domain: "inventory",
  sequence: 116,
  capability: "service",
  enabled: true,
...
export const inventory_114_3_definition = {
  domain: "inventory",
  sequence: 117,
  capability: "service",
  enabled: true,
...
export const inventory_114_4_definition = {
  domain: "inventory",
  sequence: 118,
  capability: "service",
  enabled: true,
...
export const inventory_114_5_definition = {
  domain: "inventory",
  sequence: 119,
  capability: "service",
  enabled: true,
...
export const inventory_114_6_definition = {
  domain: "inventory",
  sequence: 120,
  capability: "service",
  enabled: true,
...
export const inventory_114_7_definition = {
  domain: "inventory",
  sequence: 121,
  capability: "service",
  enabled: true,
