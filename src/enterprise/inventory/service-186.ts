...
export const inventory_186_0_definition = {
  domain: "inventory",
  sequence: 186,
  capability: "service",
  enabled: true,
...
export const inventory_186_1_definition = {
  domain: "inventory",
  sequence: 187,
  capability: "service",
  enabled: true,
...
export const inventory_186_2_definition = {
  domain: "inventory",
  sequence: 188,
  capability: "service",
  enabled: true,
...
export const inventory_186_3_definition = {
  domain: "inventory",
  sequence: 189,
  capability: "service",
  enabled: true,
...
export const inventory_186_4_definition = {
  domain: "inventory",
  sequence: 190,
  capability: "service",
  enabled: true,
...
export const inventory_186_5_definition = {
  domain: "inventory",
  sequence: 191,
  capability: "service",
  enabled: true,
...
export const inventory_186_6_definition = {
  domain: "inventory",
  sequence: 192,
  capability: "service",
  enabled: true,
...
export const inventory_186_7_definition = {
  domain: "inventory",
  sequence: 193,
  capability: "service",
  enabled: true,
