...
export const inventory_74_0_definition = {
  domain: "inventory",
  sequence: 74,
  capability: "service",
  enabled: true,
...
export const inventory_74_1_definition = {
  domain: "inventory",
  sequence: 75,
  capability: "service",
  enabled: true,
...
export const inventory_74_2_definition = {
  domain: "inventory",
  sequence: 76,
  capability: "service",
  enabled: true,
...
export const inventory_74_3_definition = {
  domain: "inventory",
  sequence: 77,
  capability: "service",
  enabled: true,
...
export const inventory_74_4_definition = {
  domain: "inventory",
  sequence: 78,
  capability: "service",
  enabled: true,
...
export const inventory_74_5_definition = {
  domain: "inventory",
  sequence: 79,
  capability: "service",
  enabled: true,
...
export const inventory_74_6_definition = {
  domain: "inventory",
  sequence: 80,
  capability: "service",
  enabled: true,
...
export const inventory_74_7_definition = {
  domain: "inventory",
  sequence: 81,
  capability: "service",
  enabled: true,
