...
export const inventory_218_0_definition = {
  domain: "inventory",
  sequence: 218,
  capability: "service",
  enabled: true,
...
export const inventory_218_1_definition = {
  domain: "inventory",
  sequence: 219,
  capability: "service",
  enabled: true,
...
export const inventory_218_2_definition = {
  domain: "inventory",
  sequence: 220,
  capability: "service",
  enabled: true,
...
export const inventory_218_3_definition = {
  domain: "inventory",
  sequence: 221,
  capability: "service",
  enabled: true,
...
export const inventory_218_4_definition = {
  domain: "inventory",
  sequence: 222,
  capability: "service",
  enabled: true,
...
export const inventory_218_5_definition = {
  domain: "inventory",
  sequence: 223,
  capability: "service",
  enabled: true,
...
export const inventory_218_6_definition = {
  domain: "inventory",
  sequence: 224,
  capability: "service",
  enabled: true,
...
export const inventory_218_7_definition = {
  domain: "inventory",
  sequence: 225,
  capability: "service",
  enabled: true,
