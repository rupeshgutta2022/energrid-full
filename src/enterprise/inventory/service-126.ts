...
export const inventory_126_0_definition = {
  domain: "inventory",
  sequence: 126,
  capability: "service",
  enabled: true,
...
export const inventory_126_1_definition = {
  domain: "inventory",
  sequence: 127,
  capability: "service",
  enabled: true,
...
export const inventory_126_2_definition = {
  domain: "inventory",
  sequence: 128,
  capability: "service",
  enabled: true,
...
export const inventory_126_3_definition = {
  domain: "inventory",
  sequence: 129,
  capability: "service",
  enabled: true,
...
export const inventory_126_4_definition = {
  domain: "inventory",
  sequence: 130,
  capability: "service",
  enabled: true,
...
export const inventory_126_5_definition = {
  domain: "inventory",
  sequence: 131,
  capability: "service",
  enabled: true,
...
export const inventory_126_6_definition = {
  domain: "inventory",
  sequence: 132,
  capability: "service",
  enabled: true,
...
export const inventory_126_7_definition = {
  domain: "inventory",
  sequence: 133,
  capability: "service",
  enabled: true,
