...
export const inventory_102_0_definition = {
  domain: "inventory",
  sequence: 102,
  capability: "service",
  enabled: true,
...
export const inventory_102_1_definition = {
  domain: "inventory",
  sequence: 103,
  capability: "service",
  enabled: true,
...
export const inventory_102_2_definition = {
  domain: "inventory",
  sequence: 104,
  capability: "service",
  enabled: true,
...
export const inventory_102_3_definition = {
  domain: "inventory",
  sequence: 105,
  capability: "service",
  enabled: true,
...
export const inventory_102_4_definition = {
  domain: "inventory",
  sequence: 106,
  capability: "service",
  enabled: true,
...
export const inventory_102_5_definition = {
  domain: "inventory",
  sequence: 107,
  capability: "service",
  enabled: true,
...
export const inventory_102_6_definition = {
  domain: "inventory",
  sequence: 108,
  capability: "service",
  enabled: true,
...
export const inventory_102_7_definition = {
  domain: "inventory",
  sequence: 109,
  capability: "service",
  enabled: true,
