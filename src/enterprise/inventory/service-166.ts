...
export const inventory_166_0_definition = {
  domain: "inventory",
  sequence: 166,
  capability: "service",
  enabled: true,
...
export const inventory_166_1_definition = {
  domain: "inventory",
  sequence: 167,
  capability: "service",
  enabled: true,
...
export const inventory_166_2_definition = {
  domain: "inventory",
  sequence: 168,
  capability: "service",
  enabled: true,
...
export const inventory_166_3_definition = {
  domain: "inventory",
  sequence: 169,
  capability: "service",
  enabled: true,
...
export const inventory_166_4_definition = {
  domain: "inventory",
  sequence: 170,
  capability: "service",
  enabled: true,
...
export const inventory_166_5_definition = {
  domain: "inventory",
  sequence: 171,
  capability: "service",
  enabled: true,
...
export const inventory_166_6_definition = {
  domain: "inventory",
  sequence: 172,
  capability: "service",
  enabled: true,
...
export const inventory_166_7_definition = {
  domain: "inventory",
  sequence: 173,
  capability: "service",
  enabled: true,
