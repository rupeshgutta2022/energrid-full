...
export const inventory_178_0_definition = {
  domain: "inventory",
  sequence: 178,
  capability: "service",
  enabled: true,
...
export const inventory_178_1_definition = {
  domain: "inventory",
  sequence: 179,
  capability: "service",
  enabled: true,
...
export const inventory_178_2_definition = {
  domain: "inventory",
  sequence: 180,
  capability: "service",
  enabled: true,
...
export const inventory_178_3_definition = {
  domain: "inventory",
  sequence: 181,
  capability: "service",
  enabled: true,
...
export const inventory_178_4_definition = {
  domain: "inventory",
  sequence: 182,
  capability: "service",
  enabled: true,
...
export const inventory_178_5_definition = {
  domain: "inventory",
  sequence: 183,
  capability: "service",
  enabled: true,
...
export const inventory_178_6_definition = {
  domain: "inventory",
  sequence: 184,
  capability: "service",
  enabled: true,
...
export const inventory_178_7_definition = {
  domain: "inventory",
  sequence: 185,
  capability: "service",
  enabled: true,
