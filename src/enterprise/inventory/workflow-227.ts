...
export const inventory_227_0_definition = {
  domain: "inventory",
  sequence: 227,
  capability: "workflow",
  enabled: true,
...
export const inventory_227_1_definition = {
  domain: "inventory",
  sequence: 228,
  capability: "workflow",
  enabled: true,
...
export const inventory_227_2_definition = {
  domain: "inventory",
  sequence: 229,
  capability: "workflow",
  enabled: true,
...
export const inventory_227_3_definition = {
  domain: "inventory",
  sequence: 230,
  capability: "workflow",
  enabled: true,
...
export const inventory_227_4_definition = {
  domain: "inventory",
  sequence: 231,
  capability: "workflow",
  enabled: true,
...
export const inventory_227_5_definition = {
  domain: "inventory",
  sequence: 232,
  capability: "workflow",
  enabled: true,
...
export const inventory_227_6_definition = {
  domain: "inventory",
  sequence: 233,
  capability: "workflow",
  enabled: true,
