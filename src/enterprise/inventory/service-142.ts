...
export const inventory_142_0_definition = {
  domain: "inventory",
  sequence: 142,
  capability: "service",
  enabled: true,
...
export const inventory_142_1_definition = {
  domain: "inventory",
  sequence: 143,
  capability: "service",
  enabled: true,
...
export const inventory_142_2_definition = {
  domain: "inventory",
  sequence: 144,
  capability: "service",
  enabled: true,
...
export const inventory_142_3_definition = {
  domain: "inventory",
  sequence: 145,
  capability: "service",
  enabled: true,
...
export const inventory_142_4_definition = {
  domain: "inventory",
  sequence: 146,
  capability: "service",
  enabled: true,
...
export const inventory_142_5_definition = {
  domain: "inventory",
  sequence: 147,
  capability: "service",
  enabled: true,
...
export const inventory_142_6_definition = {
  domain: "inventory",
  sequence: 148,
  capability: "service",
  enabled: true,
...
export const inventory_142_7_definition = {
  domain: "inventory",
  sequence: 149,
  capability: "service",
  enabled: true,
