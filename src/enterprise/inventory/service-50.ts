...
export const inventory_50_0_definition = {
  domain: "inventory",
  sequence: 50,
  capability: "service",
  enabled: true,
...
export const inventory_50_1_definition = {
  domain: "inventory",
  sequence: 51,
  capability: "service",
  enabled: true,
...
export const inventory_50_2_definition = {
  domain: "inventory",
  sequence: 52,
  capability: "service",
  enabled: true,
...
export const inventory_50_3_definition = {
  domain: "inventory",
  sequence: 53,
  capability: "service",
  enabled: true,
...
export const inventory_50_4_definition = {
  domain: "inventory",
  sequence: 54,
  capability: "service",
  enabled: true,
...
export const inventory_50_5_definition = {
  domain: "inventory",
  sequence: 55,
  capability: "service",
  enabled: true,
...
export const inventory_50_6_definition = {
  domain: "inventory",
  sequence: 56,
  capability: "service",
  enabled: true,
...
export const inventory_50_7_definition = {
  domain: "inventory",
  sequence: 57,
  capability: "service",
  enabled: true,
