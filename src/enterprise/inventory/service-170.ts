...
export const inventory_170_0_definition = {
  domain: "inventory",
  sequence: 170,
  capability: "service",
  enabled: true,
...
export const inventory_170_1_definition = {
  domain: "inventory",
  sequence: 171,
  capability: "service",
  enabled: true,
...
export const inventory_170_2_definition = {
  domain: "inventory",
  sequence: 172,
  capability: "service",
  enabled: true,
...
export const inventory_170_3_definition = {
  domain: "inventory",
  sequence: 173,
  capability: "service",
  enabled: true,
...
export const inventory_170_4_definition = {
  domain: "inventory",
  sequence: 174,
  capability: "service",
  enabled: true,
...
export const inventory_170_5_definition = {
  domain: "inventory",
  sequence: 175,
  capability: "service",
  enabled: true,
...
export const inventory_170_6_definition = {
  domain: "inventory",
  sequence: 176,
  capability: "service",
  enabled: true,
...
export const inventory_170_7_definition = {
  domain: "inventory",
  sequence: 177,
  capability: "service",
  enabled: true,
