...
export const inventory_118_0_definition = {
  domain: "inventory",
  sequence: 118,
  capability: "service",
  enabled: true,
...
export const inventory_118_1_definition = {
  domain: "inventory",
  sequence: 119,
  capability: "service",
  enabled: true,
...
export const inventory_118_2_definition = {
  domain: "inventory",
  sequence: 120,
  capability: "service",
  enabled: true,
...
export const inventory_118_3_definition = {
  domain: "inventory",
  sequence: 121,
  capability: "service",
  enabled: true,
...
export const inventory_118_4_definition = {
  domain: "inventory",
  sequence: 122,
  capability: "service",
  enabled: true,
...
export const inventory_118_5_definition = {
  domain: "inventory",
  sequence: 123,
  capability: "service",
  enabled: true,
...
export const inventory_118_6_definition = {
  domain: "inventory",
  sequence: 124,
  capability: "service",
  enabled: true,
...
export const inventory_118_7_definition = {
  domain: "inventory",
  sequence: 125,
  capability: "service",
  enabled: true,
