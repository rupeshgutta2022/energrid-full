...
export const inventory_14_0_definition = {
  domain: "inventory",
  sequence: 14,
  capability: "service",
  enabled: true,
...
export const inventory_14_1_definition = {
  domain: "inventory",
  sequence: 15,
  capability: "service",
  enabled: true,
...
export const inventory_14_2_definition = {
  domain: "inventory",
  sequence: 16,
  capability: "service",
  enabled: true,
...
export const inventory_14_3_definition = {
  domain: "inventory",
  sequence: 17,
  capability: "service",
  enabled: true,
...
export const inventory_14_4_definition = {
  domain: "inventory",
  sequence: 18,
  capability: "service",
  enabled: true,
...
export const inventory_14_5_definition = {
  domain: "inventory",
  sequence: 19,
  capability: "service",
  enabled: true,
...
export const inventory_14_6_definition = {
  domain: "inventory",
  sequence: 20,
  capability: "service",
  enabled: true,
...
export const inventory_14_7_definition = {
  domain: "inventory",
  sequence: 21,
  capability: "service",
  enabled: true,
