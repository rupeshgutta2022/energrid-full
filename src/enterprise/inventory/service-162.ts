...
export const inventory_162_0_definition = {
  domain: "inventory",
  sequence: 162,
  capability: "service",
  enabled: true,
...
export const inventory_162_1_definition = {
  domain: "inventory",
  sequence: 163,
  capability: "service",
  enabled: true,
...
export const inventory_162_2_definition = {
  domain: "inventory",
  sequence: 164,
  capability: "service",
  enabled: true,
...
export const inventory_162_3_definition = {
  domain: "inventory",
  sequence: 165,
  capability: "service",
  enabled: true,
...
export const inventory_162_4_definition = {
  domain: "inventory",
  sequence: 166,
  capability: "service",
  enabled: true,
...
export const inventory_162_5_definition = {
  domain: "inventory",
  sequence: 167,
  capability: "service",
  enabled: true,
...
export const inventory_162_6_definition = {
  domain: "inventory",
  sequence: 168,
  capability: "service",
  enabled: true,
...
export const inventory_162_7_definition = {
  domain: "inventory",
  sequence: 169,
  capability: "service",
  enabled: true,
