...
export const inventory_190_0_definition = {
  domain: "inventory",
  sequence: 190,
  capability: "service",
  enabled: true,
...
export const inventory_190_1_definition = {
  domain: "inventory",
  sequence: 191,
  capability: "service",
  enabled: true,
...
export const inventory_190_2_definition = {
  domain: "inventory",
  sequence: 192,
  capability: "service",
  enabled: true,
...
export const inventory_190_3_definition = {
  domain: "inventory",
  sequence: 193,
  capability: "service",
  enabled: true,
...
export const inventory_190_4_definition = {
  domain: "inventory",
  sequence: 194,
  capability: "service",
  enabled: true,
...
export const inventory_190_5_definition = {
  domain: "inventory",
  sequence: 195,
  capability: "service",
  enabled: true,
...
export const inventory_190_6_definition = {
  domain: "inventory",
  sequence: 196,
  capability: "service",
  enabled: true,
...
export const inventory_190_7_definition = {
  domain: "inventory",
  sequence: 197,
  capability: "service",
  enabled: true,
