...
export const inventory_198_0_definition = {
  domain: "inventory",
  sequence: 198,
  capability: "service",
  enabled: true,
...
export const inventory_198_1_definition = {
  domain: "inventory",
  sequence: 199,
  capability: "service",
  enabled: true,
...
export const inventory_198_2_definition = {
  domain: "inventory",
  sequence: 200,
  capability: "service",
  enabled: true,
...
export const inventory_198_3_definition = {
  domain: "inventory",
  sequence: 201,
  capability: "service",
  enabled: true,
...
export const inventory_198_4_definition = {
  domain: "inventory",
  sequence: 202,
  capability: "service",
  enabled: true,
...
export const inventory_198_5_definition = {
  domain: "inventory",
  sequence: 203,
  capability: "service",
  enabled: true,
...
export const inventory_198_6_definition = {
  domain: "inventory",
  sequence: 204,
  capability: "service",
  enabled: true,
...
export const inventory_198_7_definition = {
  domain: "inventory",
  sequence: 205,
  capability: "service",
  enabled: true,
