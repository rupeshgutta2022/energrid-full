...
export const inventory_46_0_definition = {
  domain: "inventory",
  sequence: 46,
  capability: "service",
  enabled: true,
...
export const inventory_46_1_definition = {
  domain: "inventory",
  sequence: 47,
  capability: "service",
  enabled: true,
...
export const inventory_46_2_definition = {
  domain: "inventory",
  sequence: 48,
  capability: "service",
  enabled: true,
...
export const inventory_46_3_definition = {
  domain: "inventory",
  sequence: 49,
  capability: "service",
  enabled: true,
...
export const inventory_46_4_definition = {
  domain: "inventory",
  sequence: 50,
  capability: "service",
  enabled: true,
...
export const inventory_46_5_definition = {
  domain: "inventory",
  sequence: 51,
  capability: "service",
  enabled: true,
...
export const inventory_46_6_definition = {
  domain: "inventory",
  sequence: 52,
  capability: "service",
  enabled: true,
...
export const inventory_46_7_definition = {
  domain: "inventory",
  sequence: 53,
  capability: "service",
  enabled: true,
