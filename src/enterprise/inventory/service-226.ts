...
export const inventory_226_0_definition = {
  domain: "inventory",
  sequence: 226,
  capability: "service",
  enabled: true,
...
export const inventory_226_1_definition = {
  domain: "inventory",
  sequence: 227,
  capability: "service",
  enabled: true,
...
export const inventory_226_2_definition = {
  domain: "inventory",
  sequence: 228,
  capability: "service",
  enabled: true,
...
export const inventory_226_3_definition = {
  domain: "inventory",
  sequence: 229,
  capability: "service",
  enabled: true,
...
export const inventory_226_4_definition = {
  domain: "inventory",
  sequence: 230,
  capability: "service",
  enabled: true,
...
export const inventory_226_5_definition = {
  domain: "inventory",
  sequence: 231,
  capability: "service",
  enabled: true,
