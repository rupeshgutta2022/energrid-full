...
export const inventory_138_0_definition = {
  domain: "inventory",
  sequence: 138,
  capability: "service",
  enabled: true,
...
export const inventory_138_1_definition = {
  domain: "inventory",
  sequence: 139,
  capability: "service",
  enabled: true,
...
export const inventory_138_2_definition = {
  domain: "inventory",
  sequence: 140,
  capability: "service",
  enabled: true,
...
export const inventory_138_3_definition = {
  domain: "inventory",
  sequence: 141,
  capability: "service",
  enabled: true,
...
export const inventory_138_4_definition = {
  domain: "inventory",
  sequence: 142,
  capability: "service",
  enabled: true,
...
export const inventory_138_5_definition = {
  domain: "inventory",
  sequence: 143,
  capability: "service",
  enabled: true,
...
export const inventory_138_6_definition = {
  domain: "inventory",
  sequence: 144,
  capability: "service",
  enabled: true,
...
export const inventory_138_7_definition = {
  domain: "inventory",
  sequence: 145,
  capability: "service",
  enabled: true,
