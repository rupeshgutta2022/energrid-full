...
export const pricing_10_0_definition = {
  domain: "pricing",
  sequence: 10,
  capability: "service",
  enabled: true,
...
export const pricing_10_1_definition = {
  domain: "pricing",
  sequence: 11,
  capability: "service",
  enabled: true,
...
export const pricing_10_2_definition = {
  domain: "pricing",
  sequence: 12,
  capability: "service",
  enabled: true,
...
export const pricing_10_3_definition = {
  domain: "pricing",
  sequence: 13,
  capability: "service",
  enabled: true,
...
export const pricing_10_4_definition = {
  domain: "pricing",
  sequence: 14,
  capability: "service",
  enabled: true,
...
export const pricing_10_5_definition = {
  domain: "pricing",
  sequence: 15,
  capability: "service",
  enabled: true,
...
export const pricing_10_6_definition = {
  domain: "pricing",
  sequence: 16,
  capability: "service",
  enabled: true,
...
export const pricing_10_7_definition = {
  domain: "pricing",
  sequence: 17,
  capability: "service",
  enabled: true,
