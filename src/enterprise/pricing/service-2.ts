...
export const pricing_2_0_definition = {
  domain: "pricing",
  sequence: 2,
  capability: "service",
  enabled: true,
...
export const pricing_2_1_definition = {
  domain: "pricing",
  sequence: 3,
  capability: "service",
  enabled: true,
...
export const pricing_2_2_definition = {
  domain: "pricing",
  sequence: 4,
  capability: "service",
  enabled: true,
...
export const pricing_2_3_definition = {
  domain: "pricing",
  sequence: 5,
  capability: "service",
  enabled: true,
...
export const pricing_2_4_definition = {
  domain: "pricing",
  sequence: 6,
  capability: "service",
  enabled: true,
...
export const pricing_2_5_definition = {
  domain: "pricing",
  sequence: 7,
  capability: "service",
  enabled: true,
...
export const pricing_2_6_definition = {
  domain: "pricing",
  sequence: 8,
  capability: "service",
  enabled: true,
...
export const pricing_2_7_definition = {
  domain: "pricing",
  sequence: 9,
  capability: "service",
  enabled: true,
