...
export const pricing_186_0_definition = {
  domain: "pricing",
  sequence: 186,
  capability: "service",
  enabled: true,
...
export const pricing_186_1_definition = {
  domain: "pricing",
  sequence: 187,
  capability: "service",
  enabled: true,
...
export const pricing_186_2_definition = {
  domain: "pricing",
  sequence: 188,
  capability: "service",
  enabled: true,
...
export const pricing_186_3_definition = {
  domain: "pricing",
  sequence: 189,
  capability: "service",
  enabled: true,
...
export const pricing_186_4_definition = {
  domain: "pricing",
  sequence: 190,
  capability: "service",
  enabled: true,
...
export const pricing_186_5_definition = {
  domain: "pricing",
  sequence: 191,
  capability: "service",
  enabled: true,
...
export const pricing_186_6_definition = {
  domain: "pricing",
  sequence: 192,
  capability: "service",
  enabled: true,
...
export const pricing_186_7_definition = {
  domain: "pricing",
  sequence: 193,
  capability: "service",
  enabled: true,
