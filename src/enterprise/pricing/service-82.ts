...
export const pricing_82_0_definition = {
  domain: "pricing",
  sequence: 82,
  capability: "service",
  enabled: true,
...
export const pricing_82_1_definition = {
  domain: "pricing",
  sequence: 83,
  capability: "service",
  enabled: true,
...
export const pricing_82_2_definition = {
  domain: "pricing",
  sequence: 84,
  capability: "service",
  enabled: true,
...
export const pricing_82_3_definition = {
  domain: "pricing",
  sequence: 85,
  capability: "service",
  enabled: true,
...
export const pricing_82_4_definition = {
  domain: "pricing",
  sequence: 86,
  capability: "service",
  enabled: true,
...
export const pricing_82_5_definition = {
  domain: "pricing",
  sequence: 87,
  capability: "service",
  enabled: true,
...
export const pricing_82_6_definition = {
  domain: "pricing",
  sequence: 88,
  capability: "service",
  enabled: true,
...
export const pricing_82_7_definition = {
  domain: "pricing",
  sequence: 89,
  capability: "service",
  enabled: true,
