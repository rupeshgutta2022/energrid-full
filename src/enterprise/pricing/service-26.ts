...
export const pricing_26_0_definition = {
  domain: "pricing",
  sequence: 26,
  capability: "service",
  enabled: true,
...
export const pricing_26_1_definition = {
  domain: "pricing",
  sequence: 27,
  capability: "service",
  enabled: true,
...
export const pricing_26_2_definition = {
  domain: "pricing",
  sequence: 28,
  capability: "service",
  enabled: true,
...
export const pricing_26_3_definition = {
  domain: "pricing",
  sequence: 29,
  capability: "service",
  enabled: true,
...
export const pricing_26_4_definition = {
  domain: "pricing",
  sequence: 30,
  capability: "service",
  enabled: true,
...
export const pricing_26_5_definition = {
  domain: "pricing",
  sequence: 31,
  capability: "service",
  enabled: true,
...
export const pricing_26_6_definition = {
  domain: "pricing",
  sequence: 32,
  capability: "service",
  enabled: true,
...
export const pricing_26_7_definition = {
  domain: "pricing",
  sequence: 33,
  capability: "service",
  enabled: true,
