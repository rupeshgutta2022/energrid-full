...
export const pricing_98_0_definition = {
  domain: "pricing",
  sequence: 98,
  capability: "service",
  enabled: true,
...
export const pricing_98_1_definition = {
  domain: "pricing",
  sequence: 99,
  capability: "service",
  enabled: true,
...
export const pricing_98_2_definition = {
  domain: "pricing",
  sequence: 100,
  capability: "service",
  enabled: true,
...
export const pricing_98_3_definition = {
  domain: "pricing",
  sequence: 101,
  capability: "service",
  enabled: true,
...
export const pricing_98_4_definition = {
  domain: "pricing",
  sequence: 102,
  capability: "service",
  enabled: true,
...
export const pricing_98_5_definition = {
  domain: "pricing",
  sequence: 103,
  capability: "service",
  enabled: true,
...
export const pricing_98_6_definition = {
  domain: "pricing",
  sequence: 104,
  capability: "service",
  enabled: true,
...
export const pricing_98_7_definition = {
  domain: "pricing",
  sequence: 105,
  capability: "service",
  enabled: true,
