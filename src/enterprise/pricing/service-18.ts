...
export const pricing_18_0_definition = {
  domain: "pricing",
  sequence: 18,
  capability: "service",
  enabled: true,
...
export const pricing_18_1_definition = {
  domain: "pricing",
  sequence: 19,
  capability: "service",
  enabled: true,
...
export const pricing_18_2_definition = {
  domain: "pricing",
  sequence: 20,
  capability: "service",
  enabled: true,
...
export const pricing_18_3_definition = {
  domain: "pricing",
  sequence: 21,
  capability: "service",
  enabled: true,
...
export const pricing_18_4_definition = {
  domain: "pricing",
  sequence: 22,
  capability: "service",
  enabled: true,
...
export const pricing_18_5_definition = {
  domain: "pricing",
  sequence: 23,
  capability: "service",
  enabled: true,
...
export const pricing_18_6_definition = {
  domain: "pricing",
  sequence: 24,
  capability: "service",
  enabled: true,
...
export const pricing_18_7_definition = {
  domain: "pricing",
  sequence: 25,
  capability: "service",
  enabled: true,
