...
export const pricing_86_0_definition = {
  domain: "pricing",
  sequence: 86,
  capability: "service",
  enabled: true,
...
export const pricing_86_1_definition = {
  domain: "pricing",
  sequence: 87,
  capability: "service",
  enabled: true,
...
export const pricing_86_2_definition = {
  domain: "pricing",
  sequence: 88,
  capability: "service",
  enabled: true,
...
export const pricing_86_3_definition = {
  domain: "pricing",
  sequence: 89,
  capability: "service",
  enabled: true,
...
export const pricing_86_4_definition = {
  domain: "pricing",
  sequence: 90,
  capability: "service",
  enabled: true,
...
export const pricing_86_5_definition = {
  domain: "pricing",
  sequence: 91,
  capability: "service",
  enabled: true,
...
export const pricing_86_6_definition = {
  domain: "pricing",
  sequence: 92,
  capability: "service",
  enabled: true,
...
export const pricing_86_7_definition = {
  domain: "pricing",
  sequence: 93,
  capability: "service",
  enabled: true,
