...
export const pricing_58_0_definition = {
  domain: "pricing",
  sequence: 58,
  capability: "service",
  enabled: true,
...
export const pricing_58_1_definition = {
  domain: "pricing",
  sequence: 59,
  capability: "service",
  enabled: true,
...
export const pricing_58_2_definition = {
  domain: "pricing",
  sequence: 60,
  capability: "service",
  enabled: true,
...
export const pricing_58_3_definition = {
  domain: "pricing",
  sequence: 61,
  capability: "service",
  enabled: true,
...
export const pricing_58_4_definition = {
  domain: "pricing",
  sequence: 62,
  capability: "service",
  enabled: true,
...
export const pricing_58_5_definition = {
  domain: "pricing",
  sequence: 63,
  capability: "service",
  enabled: true,
...
export const pricing_58_6_definition = {
  domain: "pricing",
  sequence: 64,
  capability: "service",
  enabled: true,
...
export const pricing_58_7_definition = {
  domain: "pricing",
  sequence: 65,
  capability: "service",
  enabled: true,
