...
export const pricing_122_0_definition = {
  domain: "pricing",
  sequence: 122,
  capability: "service",
  enabled: true,
...
export const pricing_122_1_definition = {
  domain: "pricing",
  sequence: 123,
  capability: "service",
  enabled: true,
...
export const pricing_122_2_definition = {
  domain: "pricing",
  sequence: 124,
  capability: "service",
  enabled: true,
...
export const pricing_122_3_definition = {
  domain: "pricing",
  sequence: 125,
  capability: "service",
  enabled: true,
...
export const pricing_122_4_definition = {
  domain: "pricing",
  sequence: 126,
  capability: "service",
  enabled: true,
...
export const pricing_122_5_definition = {
  domain: "pricing",
  sequence: 127,
  capability: "service",
  enabled: true,
...
export const pricing_122_6_definition = {
  domain: "pricing",
  sequence: 128,
  capability: "service",
  enabled: true,
...
export const pricing_122_7_definition = {
  domain: "pricing",
  sequence: 129,
  capability: "service",
  enabled: true,
