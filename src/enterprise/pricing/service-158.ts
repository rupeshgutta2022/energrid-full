...
export const pricing_158_0_definition = {
  domain: "pricing",
  sequence: 158,
  capability: "service",
  enabled: true,
...
export const pricing_158_1_definition = {
  domain: "pricing",
  sequence: 159,
  capability: "service",
  enabled: true,
...
export const pricing_158_2_definition = {
  domain: "pricing",
  sequence: 160,
  capability: "service",
  enabled: true,
...
export const pricing_158_3_definition = {
  domain: "pricing",
  sequence: 161,
  capability: "service",
  enabled: true,
...
export const pricing_158_4_definition = {
  domain: "pricing",
  sequence: 162,
  capability: "service",
  enabled: true,
...
export const pricing_158_5_definition = {
  domain: "pricing",
  sequence: 163,
  capability: "service",
  enabled: true,
...
export const pricing_158_6_definition = {
  domain: "pricing",
  sequence: 164,
  capability: "service",
  enabled: true,
...
export const pricing_158_7_definition = {
  domain: "pricing",
  sequence: 165,
  capability: "service",
  enabled: true,
