...
export const pricing_138_0_definition = {
  domain: "pricing",
  sequence: 138,
  capability: "service",
  enabled: true,
...
export const pricing_138_1_definition = {
  domain: "pricing",
  sequence: 139,
  capability: "service",
  enabled: true,
...
export const pricing_138_2_definition = {
  domain: "pricing",
  sequence: 140,
  capability: "service",
  enabled: true,
...
export const pricing_138_3_definition = {
  domain: "pricing",
  sequence: 141,
  capability: "service",
  enabled: true,
...
export const pricing_138_4_definition = {
  domain: "pricing",
  sequence: 142,
  capability: "service",
  enabled: true,
...
export const pricing_138_5_definition = {
  domain: "pricing",
  sequence: 143,
  capability: "service",
  enabled: true,
...
export const pricing_138_6_definition = {
  domain: "pricing",
  sequence: 144,
  capability: "service",
  enabled: true,
...
export const pricing_138_7_definition = {
  domain: "pricing",
  sequence: 145,
  capability: "service",
  enabled: true,
