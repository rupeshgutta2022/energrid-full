...
export const pricing_146_0_definition = {
  domain: "pricing",
  sequence: 146,
  capability: "service",
  enabled: true,
...
export const pricing_146_1_definition = {
  domain: "pricing",
  sequence: 147,
  capability: "service",
  enabled: true,
...
export const pricing_146_2_definition = {
  domain: "pricing",
  sequence: 148,
  capability: "service",
  enabled: true,
...
export const pricing_146_3_definition = {
  domain: "pricing",
  sequence: 149,
  capability: "service",
  enabled: true,
...
export const pricing_146_4_definition = {
  domain: "pricing",
  sequence: 150,
  capability: "service",
  enabled: true,
...
export const pricing_146_5_definition = {
  domain: "pricing",
  sequence: 151,
  capability: "service",
  enabled: true,
...
export const pricing_146_6_definition = {
  domain: "pricing",
  sequence: 152,
  capability: "service",
  enabled: true,
...
export const pricing_146_7_definition = {
  domain: "pricing",
  sequence: 153,
  capability: "service",
  enabled: true,
