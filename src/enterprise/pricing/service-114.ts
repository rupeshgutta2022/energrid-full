...
export const pricing_114_0_definition = {
  domain: "pricing",
  sequence: 114,
  capability: "service",
  enabled: true,
...
export const pricing_114_1_definition = {
  domain: "pricing",
  sequence: 115,
  capability: "service",
  enabled: true,
...
export const pricing_114_2_definition = {
  domain: "pricing",
  sequence: 116,
  capability: "service",
  enabled: true,
...
export const pricing_114_3_definition = {
  domain: "pricing",
  sequence: 117,
  capability: "service",
  enabled: true,
...
export const pricing_114_4_definition = {
  domain: "pricing",
  sequence: 118,
  capability: "service",
  enabled: true,
...
export const pricing_114_5_definition = {
  domain: "pricing",
  sequence: 119,
  capability: "service",
  enabled: true,
...
export const pricing_114_6_definition = {
  domain: "pricing",
  sequence: 120,
  capability: "service",
  enabled: true,
...
export const pricing_114_7_definition = {
  domain: "pricing",
  sequence: 121,
  capability: "service",
  enabled: true,
