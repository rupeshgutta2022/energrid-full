...
export const pricing_6_0_definition = {
  domain: "pricing",
  sequence: 6,
  capability: "service",
  enabled: true,
...
export const pricing_6_1_definition = {
  domain: "pricing",
  sequence: 7,
  capability: "service",
  enabled: true,
...
export const pricing_6_2_definition = {
  domain: "pricing",
  sequence: 8,
  capability: "service",
  enabled: true,
...
export const pricing_6_3_definition = {
  domain: "pricing",
  sequence: 9,
  capability: "service",
  enabled: true,
...
export const pricing_6_4_definition = {
  domain: "pricing",
  sequence: 10,
  capability: "service",
  enabled: true,
...
export const pricing_6_5_definition = {
  domain: "pricing",
  sequence: 11,
  capability: "service",
  enabled: true,
...
export const pricing_6_6_definition = {
  domain: "pricing",
  sequence: 12,
  capability: "service",
  enabled: true,
...
export const pricing_6_7_definition = {
  domain: "pricing",
  sequence: 13,
  capability: "service",
  enabled: true,
