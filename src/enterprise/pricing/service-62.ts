...
export const pricing_62_0_definition = {
  domain: "pricing",
  sequence: 62,
  capability: "service",
  enabled: true,
...
export const pricing_62_1_definition = {
  domain: "pricing",
  sequence: 63,
  capability: "service",
  enabled: true,
...
export const pricing_62_2_definition = {
  domain: "pricing",
  sequence: 64,
  capability: "service",
  enabled: true,
...
export const pricing_62_3_definition = {
  domain: "pricing",
  sequence: 65,
  capability: "service",
  enabled: true,
...
export const pricing_62_4_definition = {
  domain: "pricing",
  sequence: 66,
  capability: "service",
  enabled: true,
...
export const pricing_62_5_definition = {
  domain: "pricing",
  sequence: 67,
  capability: "service",
  enabled: true,
...
export const pricing_62_6_definition = {
  domain: "pricing",
  sequence: 68,
  capability: "service",
  enabled: true,
...
export const pricing_62_7_definition = {
  domain: "pricing",
  sequence: 69,
  capability: "service",
  enabled: true,
