...
export const pricing_50_0_definition = {
  domain: "pricing",
  sequence: 50,
  capability: "service",
  enabled: true,
...
export const pricing_50_1_definition = {
  domain: "pricing",
  sequence: 51,
  capability: "service",
  enabled: true,
...
export const pricing_50_2_definition = {
  domain: "pricing",
  sequence: 52,
  capability: "service",
  enabled: true,
...
export const pricing_50_3_definition = {
  domain: "pricing",
  sequence: 53,
  capability: "service",
  enabled: true,
...
export const pricing_50_4_definition = {
  domain: "pricing",
  sequence: 54,
  capability: "service",
  enabled: true,
...
export const pricing_50_5_definition = {
  domain: "pricing",
  sequence: 55,
  capability: "service",
  enabled: true,
...
export const pricing_50_6_definition = {
  domain: "pricing",
  sequence: 56,
  capability: "service",
  enabled: true,
...
export const pricing_50_7_definition = {
  domain: "pricing",
  sequence: 57,
  capability: "service",
  enabled: true,
