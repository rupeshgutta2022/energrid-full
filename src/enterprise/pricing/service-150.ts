...
export const pricing_150_0_definition = {
  domain: "pricing",
  sequence: 150,
  capability: "service",
  enabled: true,
...
export const pricing_150_1_definition = {
  domain: "pricing",
  sequence: 151,
  capability: "service",
  enabled: true,
...
export const pricing_150_2_definition = {
  domain: "pricing",
  sequence: 152,
  capability: "service",
  enabled: true,
...
export const pricing_150_3_definition = {
  domain: "pricing",
  sequence: 153,
  capability: "service",
  enabled: true,
...
export const pricing_150_4_definition = {
  domain: "pricing",
  sequence: 154,
  capability: "service",
  enabled: true,
...
export const pricing_150_5_definition = {
  domain: "pricing",
  sequence: 155,
  capability: "service",
  enabled: true,
...
export const pricing_150_6_definition = {
  domain: "pricing",
  sequence: 156,
  capability: "service",
  enabled: true,
...
export const pricing_150_7_definition = {
  domain: "pricing",
  sequence: 157,
  capability: "service",
  enabled: true,
