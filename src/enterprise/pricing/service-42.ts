...
export const pricing_42_0_definition = {
  domain: "pricing",
  sequence: 42,
  capability: "service",
  enabled: true,
...
export const pricing_42_1_definition = {
  domain: "pricing",
  sequence: 43,
  capability: "service",
  enabled: true,
...
export const pricing_42_2_definition = {
  domain: "pricing",
  sequence: 44,
  capability: "service",
  enabled: true,
...
export const pricing_42_3_definition = {
  domain: "pricing",
  sequence: 45,
  capability: "service",
  enabled: true,
...
export const pricing_42_4_definition = {
  domain: "pricing",
  sequence: 46,
  capability: "service",
  enabled: true,
...
export const pricing_42_5_definition = {
  domain: "pricing",
  sequence: 47,
  capability: "service",
  enabled: true,
...
export const pricing_42_6_definition = {
  domain: "pricing",
  sequence: 48,
  capability: "service",
  enabled: true,
...
export const pricing_42_7_definition = {
  domain: "pricing",
  sequence: 49,
  capability: "service",
  enabled: true,
