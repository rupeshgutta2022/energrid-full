...
export const pricing_170_0_definition = {
  domain: "pricing",
  sequence: 170,
  capability: "service",
  enabled: true,
...
export const pricing_170_1_definition = {
  domain: "pricing",
  sequence: 171,
  capability: "service",
  enabled: true,
...
export const pricing_170_2_definition = {
  domain: "pricing",
  sequence: 172,
  capability: "service",
  enabled: true,
...
export const pricing_170_3_definition = {
  domain: "pricing",
  sequence: 173,
  capability: "service",
  enabled: true,
...
export const pricing_170_4_definition = {
  domain: "pricing",
  sequence: 174,
  capability: "service",
  enabled: true,
...
export const pricing_170_5_definition = {
  domain: "pricing",
  sequence: 175,
  capability: "service",
  enabled: true,
...
export const pricing_170_6_definition = {
  domain: "pricing",
  sequence: 176,
  capability: "service",
  enabled: true,
...
export const pricing_170_7_definition = {
  domain: "pricing",
  sequence: 177,
  capability: "service",
  enabled: true,
