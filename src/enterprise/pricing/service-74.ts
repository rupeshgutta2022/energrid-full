...
export const pricing_74_0_definition = {
  domain: "pricing",
  sequence: 74,
  capability: "service",
  enabled: true,
...
export const pricing_74_1_definition = {
  domain: "pricing",
  sequence: 75,
  capability: "service",
  enabled: true,
...
export const pricing_74_2_definition = {
  domain: "pricing",
  sequence: 76,
  capability: "service",
  enabled: true,
...
export const pricing_74_3_definition = {
  domain: "pricing",
  sequence: 77,
  capability: "service",
  enabled: true,
...
export const pricing_74_4_definition = {
  domain: "pricing",
  sequence: 78,
  capability: "service",
  enabled: true,
...
export const pricing_74_5_definition = {
  domain: "pricing",
  sequence: 79,
  capability: "service",
  enabled: true,
...
export const pricing_74_6_definition = {
  domain: "pricing",
  sequence: 80,
  capability: "service",
  enabled: true,
...
export const pricing_74_7_definition = {
  domain: "pricing",
  sequence: 81,
  capability: "service",
  enabled: true,
