...
export const pricing_182_0_definition = {
  domain: "pricing",
  sequence: 182,
  capability: "service",
  enabled: true,
...
export const pricing_182_1_definition = {
  domain: "pricing",
  sequence: 183,
  capability: "service",
  enabled: true,
...
export const pricing_182_2_definition = {
  domain: "pricing",
  sequence: 184,
  capability: "service",
  enabled: true,
...
export const pricing_182_3_definition = {
  domain: "pricing",
  sequence: 185,
  capability: "service",
  enabled: true,
...
export const pricing_182_4_definition = {
  domain: "pricing",
  sequence: 186,
  capability: "service",
  enabled: true,
...
export const pricing_182_5_definition = {
  domain: "pricing",
  sequence: 187,
  capability: "service",
  enabled: true,
...
export const pricing_182_6_definition = {
  domain: "pricing",
  sequence: 188,
  capability: "service",
  enabled: true,
...
export const pricing_182_7_definition = {
  domain: "pricing",
  sequence: 189,
  capability: "service",
  enabled: true,
