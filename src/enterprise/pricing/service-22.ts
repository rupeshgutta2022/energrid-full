...
export const pricing_22_0_definition = {
  domain: "pricing",
  sequence: 22,
  capability: "service",
  enabled: true,
...
export const pricing_22_1_definition = {
  domain: "pricing",
  sequence: 23,
  capability: "service",
  enabled: true,
...
export const pricing_22_2_definition = {
  domain: "pricing",
  sequence: 24,
  capability: "service",
  enabled: true,
...
export const pricing_22_3_definition = {
  domain: "pricing",
  sequence: 25,
  capability: "service",
  enabled: true,
...
export const pricing_22_4_definition = {
  domain: "pricing",
  sequence: 26,
  capability: "service",
  enabled: true,
...
export const pricing_22_5_definition = {
  domain: "pricing",
  sequence: 27,
  capability: "service",
  enabled: true,
...
export const pricing_22_6_definition = {
  domain: "pricing",
  sequence: 28,
  capability: "service",
  enabled: true,
...
export const pricing_22_7_definition = {
  domain: "pricing",
  sequence: 29,
  capability: "service",
  enabled: true,
