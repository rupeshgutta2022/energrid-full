...
export const pricing_106_0_definition = {
  domain: "pricing",
  sequence: 106,
  capability: "service",
  enabled: true,
...
export const pricing_106_1_definition = {
  domain: "pricing",
  sequence: 107,
  capability: "service",
  enabled: true,
...
export const pricing_106_2_definition = {
  domain: "pricing",
  sequence: 108,
  capability: "service",
  enabled: true,
...
export const pricing_106_3_definition = {
  domain: "pricing",
  sequence: 109,
  capability: "service",
  enabled: true,
...
export const pricing_106_4_definition = {
  domain: "pricing",
  sequence: 110,
  capability: "service",
  enabled: true,
...
export const pricing_106_5_definition = {
  domain: "pricing",
  sequence: 111,
  capability: "service",
  enabled: true,
...
export const pricing_106_6_definition = {
  domain: "pricing",
  sequence: 112,
  capability: "service",
  enabled: true,
...
export const pricing_106_7_definition = {
  domain: "pricing",
  sequence: 113,
  capability: "service",
  enabled: true,
