...
export const pricing_178_0_definition = {
  domain: "pricing",
  sequence: 178,
  capability: "service",
  enabled: true,
...
export const pricing_178_1_definition = {
  domain: "pricing",
  sequence: 179,
  capability: "service",
  enabled: true,
...
export const pricing_178_2_definition = {
  domain: "pricing",
  sequence: 180,
  capability: "service",
  enabled: true,
...
export const pricing_178_3_definition = {
  domain: "pricing",
  sequence: 181,
  capability: "service",
  enabled: true,
...
export const pricing_178_4_definition = {
  domain: "pricing",
  sequence: 182,
  capability: "service",
  enabled: true,
...
export const pricing_178_5_definition = {
  domain: "pricing",
  sequence: 183,
  capability: "service",
  enabled: true,
...
export const pricing_178_6_definition = {
  domain: "pricing",
  sequence: 184,
  capability: "service",
  enabled: true,
...
export const pricing_178_7_definition = {
  domain: "pricing",
  sequence: 185,
  capability: "service",
  enabled: true,
