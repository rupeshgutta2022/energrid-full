...
export const pricing_190_0_definition = {
  domain: "pricing",
  sequence: 190,
  capability: "service",
  enabled: true,
...
export const pricing_190_1_definition = {
  domain: "pricing",
  sequence: 191,
  capability: "service",
  enabled: true,
...
export const pricing_190_2_definition = {
  domain: "pricing",
  sequence: 192,
  capability: "service",
  enabled: true,
...
export const pricing_190_3_definition = {
  domain: "pricing",
  sequence: 193,
  capability: "service",
  enabled: true,
...
export const pricing_190_4_definition = {
  domain: "pricing",
  sequence: 194,
  capability: "service",
  enabled: true,
...
export const pricing_190_5_definition = {
  domain: "pricing",
  sequence: 195,
  capability: "service",
  enabled: true,
