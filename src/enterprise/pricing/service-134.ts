...
export const pricing_134_0_definition = {
  domain: "pricing",
  sequence: 134,
  capability: "service",
  enabled: true,
...
export const pricing_134_1_definition = {
  domain: "pricing",
  sequence: 135,
  capability: "service",
  enabled: true,
...
export const pricing_134_2_definition = {
  domain: "pricing",
  sequence: 136,
  capability: "service",
  enabled: true,
...
export const pricing_134_3_definition = {
  domain: "pricing",
  sequence: 137,
  capability: "service",
  enabled: true,
...
export const pricing_134_4_definition = {
  domain: "pricing",
  sequence: 138,
  capability: "service",
  enabled: true,
...
export const pricing_134_5_definition = {
  domain: "pricing",
  sequence: 139,
  capability: "service",
  enabled: true,
...
export const pricing_134_6_definition = {
  domain: "pricing",
  sequence: 140,
  capability: "service",
  enabled: true,
...
export const pricing_134_7_definition = {
  domain: "pricing",
  sequence: 141,
  capability: "service",
  enabled: true,
