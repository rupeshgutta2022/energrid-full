...
export const pricing_30_0_definition = {
  domain: "pricing",
  sequence: 30,
  capability: "service",
  enabled: true,
...
export const pricing_30_1_definition = {
  domain: "pricing",
  sequence: 31,
  capability: "service",
  enabled: true,
...
export const pricing_30_2_definition = {
  domain: "pricing",
  sequence: 32,
  capability: "service",
  enabled: true,
...
export const pricing_30_3_definition = {
  domain: "pricing",
  sequence: 33,
  capability: "service",
  enabled: true,
...
export const pricing_30_4_definition = {
  domain: "pricing",
  sequence: 34,
  capability: "service",
  enabled: true,
...
export const pricing_30_5_definition = {
  domain: "pricing",
  sequence: 35,
  capability: "service",
  enabled: true,
...
export const pricing_30_6_definition = {
  domain: "pricing",
  sequence: 36,
  capability: "service",
  enabled: true,
...
export const pricing_30_7_definition = {
  domain: "pricing",
  sequence: 37,
  capability: "service",
  enabled: true,
