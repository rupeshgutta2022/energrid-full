...
export const pricing_78_0_definition = {
  domain: "pricing",
  sequence: 78,
  capability: "service",
  enabled: true,
...
export const pricing_78_1_definition = {
  domain: "pricing",
  sequence: 79,
  capability: "service",
  enabled: true,
...
export const pricing_78_2_definition = {
  domain: "pricing",
  sequence: 80,
  capability: "service",
  enabled: true,
...
export const pricing_78_3_definition = {
  domain: "pricing",
  sequence: 81,
  capability: "service",
  enabled: true,
...
export const pricing_78_4_definition = {
  domain: "pricing",
  sequence: 82,
  capability: "service",
  enabled: true,
...
export const pricing_78_5_definition = {
  domain: "pricing",
  sequence: 83,
  capability: "service",
  enabled: true,
...
export const pricing_78_6_definition = {
  domain: "pricing",
  sequence: 84,
  capability: "service",
  enabled: true,
...
export const pricing_78_7_definition = {
  domain: "pricing",
  sequence: 85,
  capability: "service",
  enabled: true,
