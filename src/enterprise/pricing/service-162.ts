...
export const pricing_162_0_definition = {
  domain: "pricing",
  sequence: 162,
  capability: "service",
  enabled: true,
...
export const pricing_162_1_definition = {
  domain: "pricing",
  sequence: 163,
  capability: "service",
  enabled: true,
...
export const pricing_162_2_definition = {
  domain: "pricing",
  sequence: 164,
  capability: "service",
  enabled: true,
...
export const pricing_162_3_definition = {
  domain: "pricing",
  sequence: 165,
  capability: "service",
  enabled: true,
...
export const pricing_162_4_definition = {
  domain: "pricing",
  sequence: 166,
  capability: "service",
  enabled: true,
...
export const pricing_162_5_definition = {
  domain: "pricing",
  sequence: 167,
  capability: "service",
  enabled: true,
...
export const pricing_162_6_definition = {
  domain: "pricing",
  sequence: 168,
  capability: "service",
  enabled: true,
...
export const pricing_162_7_definition = {
  domain: "pricing",
  sequence: 169,
  capability: "service",
  enabled: true,
