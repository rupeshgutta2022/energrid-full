...
export const pricing_118_0_definition = {
  domain: "pricing",
  sequence: 118,
  capability: "service",
  enabled: true,
...
export const pricing_118_1_definition = {
  domain: "pricing",
  sequence: 119,
  capability: "service",
  enabled: true,
...
export const pricing_118_2_definition = {
  domain: "pricing",
  sequence: 120,
  capability: "service",
  enabled: true,
...
export const pricing_118_3_definition = {
  domain: "pricing",
  sequence: 121,
  capability: "service",
  enabled: true,
...
export const pricing_118_4_definition = {
  domain: "pricing",
  sequence: 122,
  capability: "service",
  enabled: true,
...
export const pricing_118_5_definition = {
  domain: "pricing",
  sequence: 123,
  capability: "service",
  enabled: true,
...
export const pricing_118_6_definition = {
  domain: "pricing",
  sequence: 124,
  capability: "service",
  enabled: true,
...
export const pricing_118_7_definition = {
  domain: "pricing",
  sequence: 125,
  capability: "service",
  enabled: true,
