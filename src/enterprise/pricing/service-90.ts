...
export const pricing_90_0_definition = {
  domain: "pricing",
  sequence: 90,
  capability: "service",
  enabled: true,
...
export const pricing_90_1_definition = {
  domain: "pricing",
  sequence: 91,
  capability: "service",
  enabled: true,
...
export const pricing_90_2_definition = {
  domain: "pricing",
  sequence: 92,
  capability: "service",
  enabled: true,
...
export const pricing_90_3_definition = {
  domain: "pricing",
  sequence: 93,
  capability: "service",
  enabled: true,
...
export const pricing_90_4_definition = {
  domain: "pricing",
  sequence: 94,
  capability: "service",
  enabled: true,
...
export const pricing_90_5_definition = {
  domain: "pricing",
  sequence: 95,
  capability: "service",
  enabled: true,
...
export const pricing_90_6_definition = {
  domain: "pricing",
  sequence: 96,
  capability: "service",
  enabled: true,
...
export const pricing_90_7_definition = {
  domain: "pricing",
  sequence: 97,
  capability: "service",
  enabled: true,
