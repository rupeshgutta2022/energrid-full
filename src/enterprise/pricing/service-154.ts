...
export const pricing_154_0_definition = {
  domain: "pricing",
  sequence: 154,
  capability: "service",
  enabled: true,
...
export const pricing_154_1_definition = {
  domain: "pricing",
  sequence: 155,
  capability: "service",
  enabled: true,
...
export const pricing_154_2_definition = {
  domain: "pricing",
  sequence: 156,
  capability: "service",
  enabled: true,
...
export const pricing_154_3_definition = {
  domain: "pricing",
  sequence: 157,
  capability: "service",
  enabled: true,
...
export const pricing_154_4_definition = {
  domain: "pricing",
  sequence: 158,
  capability: "service",
  enabled: true,
...
export const pricing_154_5_definition = {
  domain: "pricing",
  sequence: 159,
  capability: "service",
  enabled: true,
...
export const pricing_154_6_definition = {
  domain: "pricing",
  sequence: 160,
  capability: "service",
  enabled: true,
...
export const pricing_154_7_definition = {
  domain: "pricing",
  sequence: 161,
  capability: "service",
  enabled: true,
