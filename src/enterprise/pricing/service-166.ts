...
export const pricing_166_0_definition = {
  domain: "pricing",
  sequence: 166,
  capability: "service",
  enabled: true,
...
export const pricing_166_1_definition = {
  domain: "pricing",
  sequence: 167,
  capability: "service",
  enabled: true,
...
export const pricing_166_2_definition = {
  domain: "pricing",
  sequence: 168,
  capability: "service",
  enabled: true,
...
export const pricing_166_3_definition = {
  domain: "pricing",
  sequence: 169,
  capability: "service",
  enabled: true,
...
export const pricing_166_4_definition = {
  domain: "pricing",
  sequence: 170,
  capability: "service",
  enabled: true,
...
export const pricing_166_5_definition = {
  domain: "pricing",
  sequence: 171,
  capability: "service",
  enabled: true,
...
export const pricing_166_6_definition = {
  domain: "pricing",
  sequence: 172,
  capability: "service",
  enabled: true,
...
export const pricing_166_7_definition = {
  domain: "pricing",
  sequence: 173,
  capability: "service",
  enabled: true,
