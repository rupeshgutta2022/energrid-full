...
export const pricing_54_0_definition = {
  domain: "pricing",
  sequence: 54,
  capability: "service",
  enabled: true,
...
export const pricing_54_1_definition = {
  domain: "pricing",
  sequence: 55,
  capability: "service",
  enabled: true,
...
export const pricing_54_2_definition = {
  domain: "pricing",
  sequence: 56,
  capability: "service",
  enabled: true,
...
export const pricing_54_3_definition = {
  domain: "pricing",
  sequence: 57,
  capability: "service",
  enabled: true,
...
export const pricing_54_4_definition = {
  domain: "pricing",
  sequence: 58,
  capability: "service",
  enabled: true,
...
export const pricing_54_5_definition = {
  domain: "pricing",
  sequence: 59,
  capability: "service",
  enabled: true,
...
export const pricing_54_6_definition = {
  domain: "pricing",
  sequence: 60,
  capability: "service",
  enabled: true,
...
export const pricing_54_7_definition = {
  domain: "pricing",
  sequence: 61,
  capability: "service",
  enabled: true,
