...
export const pricing_130_0_definition = {
  domain: "pricing",
  sequence: 130,
  capability: "service",
  enabled: true,
...
export const pricing_130_1_definition = {
  domain: "pricing",
  sequence: 131,
  capability: "service",
  enabled: true,
...
export const pricing_130_2_definition = {
  domain: "pricing",
  sequence: 132,
  capability: "service",
  enabled: true,
...
export const pricing_130_3_definition = {
  domain: "pricing",
  sequence: 133,
  capability: "service",
  enabled: true,
...
export const pricing_130_4_definition = {
  domain: "pricing",
  sequence: 134,
  capability: "service",
  enabled: true,
...
export const pricing_130_5_definition = {
  domain: "pricing",
  sequence: 135,
  capability: "service",
  enabled: true,
...
export const pricing_130_6_definition = {
  domain: "pricing",
  sequence: 136,
  capability: "service",
  enabled: true,
...
export const pricing_130_7_definition = {
  domain: "pricing",
  sequence: 137,
  capability: "service",
  enabled: true,
