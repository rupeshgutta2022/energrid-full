...
export const pricing_195_0_definition = {
  domain: "pricing",
  sequence: 195,
  capability: "workflow",
  enabled: true,
...
export const pricing_195_1_definition = {
  domain: "pricing",
  sequence: 196,
  capability: "workflow",
  enabled: true,
...
export const pricing_195_2_definition = {
  domain: "pricing",
  sequence: 197,
  capability: "workflow",
  enabled: true,
...
export const pricing_195_3_definition = {
  domain: "pricing",
  sequence: 198,
  capability: "workflow",
  enabled: true,
...
export const pricing_195_4_definition = {
  domain: "pricing",
  sequence: 199,
  capability: "workflow",
  enabled: true,
