...
export const pricing_174_0_definition = {
  domain: "pricing",
  sequence: 174,
  capability: "service",
  enabled: true,
...
export const pricing_174_1_definition = {
  domain: "pricing",
  sequence: 175,
  capability: "service",
  enabled: true,
...
export const pricing_174_2_definition = {
  domain: "pricing",
  sequence: 176,
  capability: "service",
  enabled: true,
...
export const pricing_174_3_definition = {
  domain: "pricing",
  sequence: 177,
  capability: "service",
  enabled: true,
...
export const pricing_174_4_definition = {
  domain: "pricing",
  sequence: 178,
  capability: "service",
  enabled: true,
...
export const pricing_174_5_definition = {
  domain: "pricing",
  sequence: 179,
  capability: "service",
  enabled: true,
...
export const pricing_174_6_definition = {
  domain: "pricing",
  sequence: 180,
  capability: "service",
  enabled: true,
...
export const pricing_174_7_definition = {
  domain: "pricing",
  sequence: 181,
  capability: "service",
  enabled: true,
