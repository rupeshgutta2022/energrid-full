...
export const pricing_70_0_definition = {
  domain: "pricing",
  sequence: 70,
  capability: "service",
  enabled: true,
...
export const pricing_70_1_definition = {
  domain: "pricing",
  sequence: 71,
  capability: "service",
  enabled: true,
...
export const pricing_70_2_definition = {
  domain: "pricing",
  sequence: 72,
  capability: "service",
  enabled: true,
...
export const pricing_70_3_definition = {
  domain: "pricing",
  sequence: 73,
  capability: "service",
  enabled: true,
...
export const pricing_70_4_definition = {
  domain: "pricing",
  sequence: 74,
  capability: "service",
  enabled: true,
...
export const pricing_70_5_definition = {
  domain: "pricing",
  sequence: 75,
  capability: "service",
  enabled: true,
...
export const pricing_70_6_definition = {
  domain: "pricing",
  sequence: 76,
  capability: "service",
  enabled: true,
...
export const pricing_70_7_definition = {
  domain: "pricing",
  sequence: 77,
  capability: "service",
  enabled: true,
