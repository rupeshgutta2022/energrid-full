...
export const pricing_14_0_definition = {
  domain: "pricing",
  sequence: 14,
  capability: "service",
  enabled: true,
...
export const pricing_14_1_definition = {
  domain: "pricing",
  sequence: 15,
  capability: "service",
  enabled: true,
...
export const pricing_14_2_definition = {
  domain: "pricing",
  sequence: 16,
  capability: "service",
  enabled: true,
...
export const pricing_14_3_definition = {
  domain: "pricing",
  sequence: 17,
  capability: "service",
  enabled: true,
...
export const pricing_14_4_definition = {
  domain: "pricing",
  sequence: 18,
  capability: "service",
  enabled: true,
...
export const pricing_14_5_definition = {
  domain: "pricing",
  sequence: 19,
  capability: "service",
  enabled: true,
...
export const pricing_14_6_definition = {
  domain: "pricing",
  sequence: 20,
  capability: "service",
  enabled: true,
...
export const pricing_14_7_definition = {
  domain: "pricing",
  sequence: 21,
  capability: "service",
  enabled: true,
