...
export const warehouse_238_0_definition = {
  domain: "warehouse",
  sequence: 238,
  capability: "service",
  enabled: true,
...
export const warehouse_238_1_definition = {
  domain: "warehouse",
  sequence: 239,
  capability: "service",
  enabled: true,
...
export const warehouse_238_2_definition = {
  domain: "warehouse",
  sequence: 240,
  capability: "service",
  enabled: true,
...
export const warehouse_238_3_definition = {
  domain: "warehouse",
  sequence: 241,
  capability: "service",
  enabled: true,
...
export const warehouse_238_4_definition = {
  domain: "warehouse",
  sequence: 242,
  capability: "service",
  enabled: true,
...
export const warehouse_238_5_definition = {
  domain: "warehouse",
  sequence: 243,
  capability: "service",
  enabled: true,
...
export const warehouse_238_6_definition = {
  domain: "warehouse",
  sequence: 244,
  capability: "service",
  enabled: true,
...
export const warehouse_238_7_definition = {
  domain: "warehouse",
  sequence: 245,
  capability: "service",
  enabled: true,
