...
export const warehouse_138_0_definition = {
  domain: "warehouse",
  sequence: 138,
  capability: "service",
  enabled: true,
...
export const warehouse_138_1_definition = {
  domain: "warehouse",
  sequence: 139,
  capability: "service",
  enabled: true,
...
export const warehouse_138_2_definition = {
  domain: "warehouse",
  sequence: 140,
  capability: "service",
  enabled: true,
...
export const warehouse_138_3_definition = {
  domain: "warehouse",
  sequence: 141,
  capability: "service",
  enabled: true,
...
export const warehouse_138_4_definition = {
  domain: "warehouse",
  sequence: 142,
  capability: "service",
  enabled: true,
...
export const warehouse_138_5_definition = {
  domain: "warehouse",
  sequence: 143,
  capability: "service",
  enabled: true,
...
export const warehouse_138_6_definition = {
  domain: "warehouse",
  sequence: 144,
  capability: "service",
  enabled: true,
...
export const warehouse_138_7_definition = {
  domain: "warehouse",
  sequence: 145,
  capability: "service",
  enabled: true,
