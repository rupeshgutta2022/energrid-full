...
export const warehouse_134_0_definition = {
  domain: "warehouse",
  sequence: 134,
  capability: "service",
  enabled: true,
...
export const warehouse_134_1_definition = {
  domain: "warehouse",
  sequence: 135,
  capability: "service",
  enabled: true,
...
export const warehouse_134_2_definition = {
  domain: "warehouse",
  sequence: 136,
  capability: "service",
  enabled: true,
...
export const warehouse_134_3_definition = {
  domain: "warehouse",
  sequence: 137,
  capability: "service",
  enabled: true,
...
export const warehouse_134_4_definition = {
  domain: "warehouse",
  sequence: 138,
  capability: "service",
  enabled: true,
...
export const warehouse_134_5_definition = {
  domain: "warehouse",
  sequence: 139,
  capability: "service",
  enabled: true,
...
export const warehouse_134_6_definition = {
  domain: "warehouse",
  sequence: 140,
  capability: "service",
  enabled: true,
...
export const warehouse_134_7_definition = {
  domain: "warehouse",
  sequence: 141,
  capability: "service",
  enabled: true,
