...
export const warehouse_38_0_definition = {
  domain: "warehouse",
  sequence: 38,
  capability: "service",
  enabled: true,
...
export const warehouse_38_1_definition = {
  domain: "warehouse",
  sequence: 39,
  capability: "service",
  enabled: true,
...
export const warehouse_38_2_definition = {
  domain: "warehouse",
  sequence: 40,
  capability: "service",
  enabled: true,
...
export const warehouse_38_3_definition = {
  domain: "warehouse",
  sequence: 41,
  capability: "service",
  enabled: true,
...
export const warehouse_38_4_definition = {
  domain: "warehouse",
  sequence: 42,
  capability: "service",
  enabled: true,
...
export const warehouse_38_5_definition = {
  domain: "warehouse",
  sequence: 43,
  capability: "service",
  enabled: true,
...
export const warehouse_38_6_definition = {
  domain: "warehouse",
  sequence: 44,
  capability: "service",
  enabled: true,
...
export const warehouse_38_7_definition = {
  domain: "warehouse",
  sequence: 45,
  capability: "service",
  enabled: true,
