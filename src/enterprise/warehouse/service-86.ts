...
export const warehouse_86_0_definition = {
  domain: "warehouse",
  sequence: 86,
  capability: "service",
  enabled: true,
...
export const warehouse_86_1_definition = {
  domain: "warehouse",
  sequence: 87,
  capability: "service",
  enabled: true,
...
export const warehouse_86_2_definition = {
  domain: "warehouse",
  sequence: 88,
  capability: "service",
  enabled: true,
...
export const warehouse_86_3_definition = {
  domain: "warehouse",
  sequence: 89,
  capability: "service",
  enabled: true,
...
export const warehouse_86_4_definition = {
  domain: "warehouse",
  sequence: 90,
  capability: "service",
  enabled: true,
...
export const warehouse_86_5_definition = {
  domain: "warehouse",
  sequence: 91,
  capability: "service",
  enabled: true,
...
export const warehouse_86_6_definition = {
  domain: "warehouse",
  sequence: 92,
  capability: "service",
  enabled: true,
...
export const warehouse_86_7_definition = {
  domain: "warehouse",
  sequence: 93,
  capability: "service",
  enabled: true,
