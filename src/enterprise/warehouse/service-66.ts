...
export const warehouse_66_0_definition = {
  domain: "warehouse",
  sequence: 66,
  capability: "service",
  enabled: true,
...
export const warehouse_66_1_definition = {
  domain: "warehouse",
  sequence: 67,
  capability: "service",
  enabled: true,
...
export const warehouse_66_2_definition = {
  domain: "warehouse",
  sequence: 68,
  capability: "service",
  enabled: true,
...
export const warehouse_66_3_definition = {
  domain: "warehouse",
  sequence: 69,
  capability: "service",
  enabled: true,
...
export const warehouse_66_4_definition = {
  domain: "warehouse",
  sequence: 70,
  capability: "service",
  enabled: true,
...
export const warehouse_66_5_definition = {
  domain: "warehouse",
  sequence: 71,
  capability: "service",
  enabled: true,
...
export const warehouse_66_6_definition = {
  domain: "warehouse",
  sequence: 72,
  capability: "service",
  enabled: true,
...
export const warehouse_66_7_definition = {
  domain: "warehouse",
  sequence: 73,
  capability: "service",
  enabled: true,
