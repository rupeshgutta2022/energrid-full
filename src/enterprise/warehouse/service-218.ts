...
export const warehouse_218_0_definition = {
  domain: "warehouse",
  sequence: 218,
  capability: "service",
  enabled: true,
...
export const warehouse_218_1_definition = {
  domain: "warehouse",
  sequence: 219,
  capability: "service",
  enabled: true,
...
export const warehouse_218_2_definition = {
  domain: "warehouse",
  sequence: 220,
  capability: "service",
  enabled: true,
...
export const warehouse_218_3_definition = {
  domain: "warehouse",
  sequence: 221,
  capability: "service",
  enabled: true,
...
export const warehouse_218_4_definition = {
  domain: "warehouse",
  sequence: 222,
  capability: "service",
  enabled: true,
...
export const warehouse_218_5_definition = {
  domain: "warehouse",
  sequence: 223,
  capability: "service",
  enabled: true,
...
export const warehouse_218_6_definition = {
  domain: "warehouse",
  sequence: 224,
  capability: "service",
  enabled: true,
...
export const warehouse_218_7_definition = {
  domain: "warehouse",
  sequence: 225,
  capability: "service",
  enabled: true,
