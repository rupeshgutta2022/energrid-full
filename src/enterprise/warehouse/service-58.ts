...
export const warehouse_58_0_definition = {
  domain: "warehouse",
  sequence: 58,
  capability: "service",
  enabled: true,
...
export const warehouse_58_1_definition = {
  domain: "warehouse",
  sequence: 59,
  capability: "service",
  enabled: true,
...
export const warehouse_58_2_definition = {
  domain: "warehouse",
  sequence: 60,
  capability: "service",
  enabled: true,
...
export const warehouse_58_3_definition = {
  domain: "warehouse",
  sequence: 61,
  capability: "service",
  enabled: true,
...
export const warehouse_58_4_definition = {
  domain: "warehouse",
  sequence: 62,
  capability: "service",
  enabled: true,
...
export const warehouse_58_5_definition = {
  domain: "warehouse",
  sequence: 63,
  capability: "service",
  enabled: true,
...
export const warehouse_58_6_definition = {
  domain: "warehouse",
  sequence: 64,
  capability: "service",
  enabled: true,
...
export const warehouse_58_7_definition = {
  domain: "warehouse",
  sequence: 65,
  capability: "service",
  enabled: true,
