...
export const warehouse_74_0_definition = {
  domain: "warehouse",
  sequence: 74,
  capability: "service",
  enabled: true,
...
export const warehouse_74_1_definition = {
  domain: "warehouse",
  sequence: 75,
  capability: "service",
  enabled: true,
...
export const warehouse_74_2_definition = {
  domain: "warehouse",
  sequence: 76,
  capability: "service",
  enabled: true,
...
export const warehouse_74_3_definition = {
  domain: "warehouse",
  sequence: 77,
  capability: "service",
  enabled: true,
...
export const warehouse_74_4_definition = {
  domain: "warehouse",
  sequence: 78,
  capability: "service",
  enabled: true,
...
export const warehouse_74_5_definition = {
  domain: "warehouse",
  sequence: 79,
  capability: "service",
  enabled: true,
...
export const warehouse_74_6_definition = {
  domain: "warehouse",
  sequence: 80,
  capability: "service",
  enabled: true,
...
export const warehouse_74_7_definition = {
  domain: "warehouse",
  sequence: 81,
  capability: "service",
  enabled: true,
