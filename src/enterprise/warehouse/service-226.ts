...
export const warehouse_226_0_definition = {
  domain: "warehouse",
  sequence: 226,
  capability: "service",
  enabled: true,
...
export const warehouse_226_1_definition = {
  domain: "warehouse",
  sequence: 227,
  capability: "service",
  enabled: true,
...
export const warehouse_226_2_definition = {
  domain: "warehouse",
  sequence: 228,
  capability: "service",
  enabled: true,
...
export const warehouse_226_3_definition = {
  domain: "warehouse",
  sequence: 229,
  capability: "service",
  enabled: true,
...
export const warehouse_226_4_definition = {
  domain: "warehouse",
  sequence: 230,
  capability: "service",
  enabled: true,
...
export const warehouse_226_5_definition = {
  domain: "warehouse",
  sequence: 231,
  capability: "service",
  enabled: true,
...
export const warehouse_226_6_definition = {
  domain: "warehouse",
  sequence: 232,
  capability: "service",
  enabled: true,
...
export const warehouse_226_7_definition = {
  domain: "warehouse",
  sequence: 233,
  capability: "service",
  enabled: true,
