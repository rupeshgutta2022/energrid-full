...
export const warehouse_214_0_definition = {
  domain: "warehouse",
  sequence: 214,
  capability: "service",
  enabled: true,
...
export const warehouse_214_1_definition = {
  domain: "warehouse",
  sequence: 215,
  capability: "service",
  enabled: true,
...
export const warehouse_214_2_definition = {
  domain: "warehouse",
  sequence: 216,
  capability: "service",
  enabled: true,
...
export const warehouse_214_3_definition = {
  domain: "warehouse",
  sequence: 217,
  capability: "service",
  enabled: true,
...
export const warehouse_214_4_definition = {
  domain: "warehouse",
  sequence: 218,
  capability: "service",
  enabled: true,
...
export const warehouse_214_5_definition = {
  domain: "warehouse",
  sequence: 219,
  capability: "service",
  enabled: true,
...
export const warehouse_214_6_definition = {
  domain: "warehouse",
  sequence: 220,
  capability: "service",
  enabled: true,
...
export const warehouse_214_7_definition = {
  domain: "warehouse",
  sequence: 221,
  capability: "service",
  enabled: true,
