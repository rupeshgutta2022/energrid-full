...
export const warehouse_246_0_definition = {
  domain: "warehouse",
  sequence: 246,
  capability: "service",
  enabled: true,
...
export const warehouse_246_1_definition = {
  domain: "warehouse",
  sequence: 247,
  capability: "service",
  enabled: true,
...
export const warehouse_246_2_definition = {
  domain: "warehouse",
  sequence: 248,
  capability: "service",
  enabled: true,
...
export const warehouse_246_3_definition = {
  domain: "warehouse",
  sequence: 249,
  capability: "service",
  enabled: true,
...
export const warehouse_246_4_definition = {
  domain: "warehouse",
  sequence: 250,
  capability: "service",
  enabled: true,
