...
export const warehouse_142_0_definition = {
  domain: "warehouse",
  sequence: 142,
  capability: "service",
  enabled: true,
...
export const warehouse_142_1_definition = {
  domain: "warehouse",
  sequence: 143,
  capability: "service",
  enabled: true,
...
export const warehouse_142_2_definition = {
  domain: "warehouse",
  sequence: 144,
  capability: "service",
  enabled: true,
...
export const warehouse_142_3_definition = {
  domain: "warehouse",
  sequence: 145,
  capability: "service",
  enabled: true,
...
export const warehouse_142_4_definition = {
  domain: "warehouse",
  sequence: 146,
  capability: "service",
  enabled: true,
...
export const warehouse_142_5_definition = {
  domain: "warehouse",
  sequence: 147,
  capability: "service",
  enabled: true,
...
export const warehouse_142_6_definition = {
  domain: "warehouse",
  sequence: 148,
  capability: "service",
  enabled: true,
...
export const warehouse_142_7_definition = {
  domain: "warehouse",
  sequence: 149,
  capability: "service",
  enabled: true,
