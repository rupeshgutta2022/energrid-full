...
export const warehouse_34_0_definition = {
  domain: "warehouse",
  sequence: 34,
  capability: "service",
  enabled: true,
...
export const warehouse_34_1_definition = {
  domain: "warehouse",
  sequence: 35,
  capability: "service",
  enabled: true,
...
export const warehouse_34_2_definition = {
  domain: "warehouse",
  sequence: 36,
  capability: "service",
  enabled: true,
...
export const warehouse_34_3_definition = {
  domain: "warehouse",
  sequence: 37,
  capability: "service",
  enabled: true,
...
export const warehouse_34_4_definition = {
  domain: "warehouse",
  sequence: 38,
  capability: "service",
  enabled: true,
...
export const warehouse_34_5_definition = {
  domain: "warehouse",
  sequence: 39,
  capability: "service",
  enabled: true,
...
export const warehouse_34_6_definition = {
  domain: "warehouse",
  sequence: 40,
  capability: "service",
  enabled: true,
...
export const warehouse_34_7_definition = {
  domain: "warehouse",
  sequence: 41,
  capability: "service",
  enabled: true,
