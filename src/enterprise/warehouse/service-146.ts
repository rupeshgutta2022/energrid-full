...
export const warehouse_146_0_definition = {
  domain: "warehouse",
  sequence: 146,
  capability: "service",
  enabled: true,
...
export const warehouse_146_1_definition = {
  domain: "warehouse",
  sequence: 147,
  capability: "service",
  enabled: true,
...
export const warehouse_146_2_definition = {
  domain: "warehouse",
  sequence: 148,
  capability: "service",
  enabled: true,
...
export const warehouse_146_3_definition = {
  domain: "warehouse",
  sequence: 149,
  capability: "service",
  enabled: true,
...
export const warehouse_146_4_definition = {
  domain: "warehouse",
  sequence: 150,
  capability: "service",
  enabled: true,
...
export const warehouse_146_5_definition = {
  domain: "warehouse",
  sequence: 151,
  capability: "service",
  enabled: true,
...
export const warehouse_146_6_definition = {
  domain: "warehouse",
  sequence: 152,
  capability: "service",
  enabled: true,
...
export const warehouse_146_7_definition = {
  domain: "warehouse",
  sequence: 153,
  capability: "service",
  enabled: true,
