...
export const warehouse_18_0_definition = {
  domain: "warehouse",
  sequence: 18,
  capability: "service",
  enabled: true,
...
export const warehouse_18_1_definition = {
  domain: "warehouse",
  sequence: 19,
  capability: "service",
  enabled: true,
...
export const warehouse_18_2_definition = {
  domain: "warehouse",
  sequence: 20,
  capability: "service",
  enabled: true,
...
export const warehouse_18_3_definition = {
  domain: "warehouse",
  sequence: 21,
  capability: "service",
  enabled: true,
...
export const warehouse_18_4_definition = {
  domain: "warehouse",
  sequence: 22,
  capability: "service",
  enabled: true,
...
export const warehouse_18_5_definition = {
  domain: "warehouse",
  sequence: 23,
  capability: "service",
  enabled: true,
...
export const warehouse_18_6_definition = {
  domain: "warehouse",
  sequence: 24,
  capability: "service",
  enabled: true,
...
export const warehouse_18_7_definition = {
  domain: "warehouse",
  sequence: 25,
  capability: "service",
  enabled: true,
