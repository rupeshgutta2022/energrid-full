...
export const warehouse_170_0_definition = {
  domain: "warehouse",
  sequence: 170,
  capability: "service",
  enabled: true,
...
export const warehouse_170_1_definition = {
  domain: "warehouse",
  sequence: 171,
  capability: "service",
  enabled: true,
...
export const warehouse_170_2_definition = {
  domain: "warehouse",
  sequence: 172,
  capability: "service",
  enabled: true,
...
export const warehouse_170_3_definition = {
  domain: "warehouse",
  sequence: 173,
  capability: "service",
  enabled: true,
...
export const warehouse_170_4_definition = {
  domain: "warehouse",
  sequence: 174,
  capability: "service",
  enabled: true,
...
export const warehouse_170_5_definition = {
  domain: "warehouse",
  sequence: 175,
  capability: "service",
  enabled: true,
...
export const warehouse_170_6_definition = {
  domain: "warehouse",
  sequence: 176,
  capability: "service",
  enabled: true,
...
export const warehouse_170_7_definition = {
  domain: "warehouse",
  sequence: 177,
  capability: "service",
  enabled: true,
