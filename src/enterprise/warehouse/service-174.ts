...
export const warehouse_174_0_definition = {
  domain: "warehouse",
  sequence: 174,
  capability: "service",
  enabled: true,
...
export const warehouse_174_1_definition = {
  domain: "warehouse",
  sequence: 175,
  capability: "service",
  enabled: true,
...
export const warehouse_174_2_definition = {
  domain: "warehouse",
  sequence: 176,
  capability: "service",
  enabled: true,
...
export const warehouse_174_3_definition = {
  domain: "warehouse",
  sequence: 177,
  capability: "service",
  enabled: true,
...
export const warehouse_174_4_definition = {
  domain: "warehouse",
  sequence: 178,
  capability: "service",
  enabled: true,
...
export const warehouse_174_5_definition = {
  domain: "warehouse",
  sequence: 179,
  capability: "service",
  enabled: true,
...
export const warehouse_174_6_definition = {
  domain: "warehouse",
  sequence: 180,
  capability: "service",
  enabled: true,
...
export const warehouse_174_7_definition = {
  domain: "warehouse",
  sequence: 181,
  capability: "service",
  enabled: true,
