...
export const warehouse_90_0_definition = {
  domain: "warehouse",
  sequence: 90,
  capability: "service",
  enabled: true,
...
export const warehouse_90_1_definition = {
  domain: "warehouse",
  sequence: 91,
  capability: "service",
  enabled: true,
...
export const warehouse_90_2_definition = {
  domain: "warehouse",
  sequence: 92,
  capability: "service",
  enabled: true,
...
export const warehouse_90_3_definition = {
  domain: "warehouse",
  sequence: 93,
  capability: "service",
  enabled: true,
...
export const warehouse_90_4_definition = {
  domain: "warehouse",
  sequence: 94,
  capability: "service",
  enabled: true,
...
export const warehouse_90_5_definition = {
  domain: "warehouse",
  sequence: 95,
  capability: "service",
  enabled: true,
...
export const warehouse_90_6_definition = {
  domain: "warehouse",
  sequence: 96,
  capability: "service",
  enabled: true,
...
export const warehouse_90_7_definition = {
  domain: "warehouse",
  sequence: 97,
  capability: "service",
  enabled: true,
