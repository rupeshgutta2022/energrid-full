...
export const warehouse_194_0_definition = {
  domain: "warehouse",
  sequence: 194,
  capability: "service",
  enabled: true,
...
export const warehouse_194_1_definition = {
  domain: "warehouse",
  sequence: 195,
  capability: "service",
  enabled: true,
...
export const warehouse_194_2_definition = {
  domain: "warehouse",
  sequence: 196,
  capability: "service",
  enabled: true,
...
export const warehouse_194_3_definition = {
  domain: "warehouse",
  sequence: 197,
  capability: "service",
  enabled: true,
...
export const warehouse_194_4_definition = {
  domain: "warehouse",
  sequence: 198,
  capability: "service",
  enabled: true,
...
export const warehouse_194_5_definition = {
  domain: "warehouse",
  sequence: 199,
  capability: "service",
  enabled: true,
...
export const warehouse_194_6_definition = {
  domain: "warehouse",
  sequence: 200,
  capability: "service",
  enabled: true,
...
export const warehouse_194_7_definition = {
  domain: "warehouse",
  sequence: 201,
  capability: "service",
  enabled: true,
