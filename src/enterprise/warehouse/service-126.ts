...
export const warehouse_126_0_definition = {
  domain: "warehouse",
  sequence: 126,
  capability: "service",
  enabled: true,
...
export const warehouse_126_1_definition = {
  domain: "warehouse",
  sequence: 127,
  capability: "service",
  enabled: true,
...
export const warehouse_126_2_definition = {
  domain: "warehouse",
  sequence: 128,
  capability: "service",
  enabled: true,
...
export const warehouse_126_3_definition = {
  domain: "warehouse",
  sequence: 129,
  capability: "service",
  enabled: true,
...
export const warehouse_126_4_definition = {
  domain: "warehouse",
  sequence: 130,
  capability: "service",
  enabled: true,
...
export const warehouse_126_5_definition = {
  domain: "warehouse",
  sequence: 131,
  capability: "service",
  enabled: true,
...
export const warehouse_126_6_definition = {
  domain: "warehouse",
  sequence: 132,
  capability: "service",
  enabled: true,
...
export const warehouse_126_7_definition = {
  domain: "warehouse",
  sequence: 133,
  capability: "service",
  enabled: true,
