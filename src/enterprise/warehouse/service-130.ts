...
export const warehouse_130_0_definition = {
  domain: "warehouse",
  sequence: 130,
  capability: "service",
  enabled: true,
...
export const warehouse_130_1_definition = {
  domain: "warehouse",
  sequence: 131,
  capability: "service",
  enabled: true,
...
export const warehouse_130_2_definition = {
  domain: "warehouse",
  sequence: 132,
  capability: "service",
  enabled: true,
...
export const warehouse_130_3_definition = {
  domain: "warehouse",
  sequence: 133,
  capability: "service",
  enabled: true,
...
export const warehouse_130_4_definition = {
  domain: "warehouse",
  sequence: 134,
  capability: "service",
  enabled: true,
...
export const warehouse_130_5_definition = {
  domain: "warehouse",
  sequence: 135,
  capability: "service",
  enabled: true,
...
export const warehouse_130_6_definition = {
  domain: "warehouse",
  sequence: 136,
  capability: "service",
  enabled: true,
...
export const warehouse_130_7_definition = {
  domain: "warehouse",
  sequence: 137,
  capability: "service",
  enabled: true,
