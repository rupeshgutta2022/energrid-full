...
export const warehouse_234_0_definition = {
  domain: "warehouse",
  sequence: 234,
  capability: "service",
  enabled: true,
...
export const warehouse_234_1_definition = {
  domain: "warehouse",
  sequence: 235,
  capability: "service",
  enabled: true,
...
export const warehouse_234_2_definition = {
  domain: "warehouse",
  sequence: 236,
  capability: "service",
  enabled: true,
...
export const warehouse_234_3_definition = {
  domain: "warehouse",
  sequence: 237,
  capability: "service",
  enabled: true,
...
export const warehouse_234_4_definition = {
  domain: "warehouse",
  sequence: 238,
  capability: "service",
  enabled: true,
...
export const warehouse_234_5_definition = {
  domain: "warehouse",
  sequence: 239,
  capability: "service",
  enabled: true,
...
export const warehouse_234_6_definition = {
  domain: "warehouse",
  sequence: 240,
  capability: "service",
  enabled: true,
...
export const warehouse_234_7_definition = {
  domain: "warehouse",
  sequence: 241,
  capability: "service",
  enabled: true,
