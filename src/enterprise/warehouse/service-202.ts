...
export const warehouse_202_0_definition = {
  domain: "warehouse",
  sequence: 202,
  capability: "service",
  enabled: true,
...
export const warehouse_202_1_definition = {
  domain: "warehouse",
  sequence: 203,
  capability: "service",
  enabled: true,
...
export const warehouse_202_2_definition = {
  domain: "warehouse",
  sequence: 204,
  capability: "service",
  enabled: true,
...
export const warehouse_202_3_definition = {
  domain: "warehouse",
  sequence: 205,
  capability: "service",
  enabled: true,
...
export const warehouse_202_4_definition = {
  domain: "warehouse",
  sequence: 206,
  capability: "service",
  enabled: true,
...
export const warehouse_202_5_definition = {
  domain: "warehouse",
  sequence: 207,
  capability: "service",
  enabled: true,
...
export const warehouse_202_6_definition = {
  domain: "warehouse",
  sequence: 208,
  capability: "service",
  enabled: true,
...
export const warehouse_202_7_definition = {
  domain: "warehouse",
  sequence: 209,
  capability: "service",
  enabled: true,
