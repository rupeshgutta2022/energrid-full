...
export const warehouse_186_0_definition = {
  domain: "warehouse",
  sequence: 186,
  capability: "service",
  enabled: true,
...
export const warehouse_186_1_definition = {
  domain: "warehouse",
  sequence: 187,
  capability: "service",
  enabled: true,
...
export const warehouse_186_2_definition = {
  domain: "warehouse",
  sequence: 188,
  capability: "service",
  enabled: true,
...
export const warehouse_186_3_definition = {
  domain: "warehouse",
  sequence: 189,
  capability: "service",
  enabled: true,
...
export const warehouse_186_4_definition = {
  domain: "warehouse",
  sequence: 190,
  capability: "service",
  enabled: true,
...
export const warehouse_186_5_definition = {
  domain: "warehouse",
  sequence: 191,
  capability: "service",
  enabled: true,
...
export const warehouse_186_6_definition = {
  domain: "warehouse",
  sequence: 192,
  capability: "service",
  enabled: true,
...
export const warehouse_186_7_definition = {
  domain: "warehouse",
  sequence: 193,
  capability: "service",
  enabled: true,
