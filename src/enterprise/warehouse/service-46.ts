...
export const warehouse_46_0_definition = {
  domain: "warehouse",
  sequence: 46,
  capability: "service",
  enabled: true,
...
export const warehouse_46_1_definition = {
  domain: "warehouse",
  sequence: 47,
  capability: "service",
  enabled: true,
...
export const warehouse_46_2_definition = {
  domain: "warehouse",
  sequence: 48,
  capability: "service",
  enabled: true,
...
export const warehouse_46_3_definition = {
  domain: "warehouse",
  sequence: 49,
  capability: "service",
  enabled: true,
...
export const warehouse_46_4_definition = {
  domain: "warehouse",
  sequence: 50,
  capability: "service",
  enabled: true,
...
export const warehouse_46_5_definition = {
  domain: "warehouse",
  sequence: 51,
  capability: "service",
  enabled: true,
...
export const warehouse_46_6_definition = {
  domain: "warehouse",
  sequence: 52,
  capability: "service",
  enabled: true,
...
export const warehouse_46_7_definition = {
  domain: "warehouse",
  sequence: 53,
  capability: "service",
  enabled: true,
