...
export const warehouse_6_0_definition = {
  domain: "warehouse",
  sequence: 6,
  capability: "service",
  enabled: true,
...
export const warehouse_6_1_definition = {
  domain: "warehouse",
  sequence: 7,
  capability: "service",
  enabled: true,
...
export const warehouse_6_2_definition = {
  domain: "warehouse",
  sequence: 8,
  capability: "service",
  enabled: true,
...
export const warehouse_6_3_definition = {
  domain: "warehouse",
  sequence: 9,
  capability: "service",
  enabled: true,
...
export const warehouse_6_4_definition = {
  domain: "warehouse",
  sequence: 10,
  capability: "service",
  enabled: true,
...
export const warehouse_6_5_definition = {
  domain: "warehouse",
  sequence: 11,
  capability: "service",
  enabled: true,
...
export const warehouse_6_6_definition = {
  domain: "warehouse",
  sequence: 12,
  capability: "service",
  enabled: true,
...
export const warehouse_6_7_definition = {
  domain: "warehouse",
  sequence: 13,
  capability: "service",
  enabled: true,
