...
export const warehouse_106_0_definition = {
  domain: "warehouse",
  sequence: 106,
  capability: "service",
  enabled: true,
...
export const warehouse_106_1_definition = {
  domain: "warehouse",
  sequence: 107,
  capability: "service",
  enabled: true,
...
export const warehouse_106_2_definition = {
  domain: "warehouse",
  sequence: 108,
  capability: "service",
  enabled: true,
...
export const warehouse_106_3_definition = {
  domain: "warehouse",
  sequence: 109,
  capability: "service",
  enabled: true,
...
export const warehouse_106_4_definition = {
  domain: "warehouse",
  sequence: 110,
  capability: "service",
  enabled: true,
...
export const warehouse_106_5_definition = {
  domain: "warehouse",
  sequence: 111,
  capability: "service",
  enabled: true,
...
export const warehouse_106_6_definition = {
  domain: "warehouse",
  sequence: 112,
  capability: "service",
  enabled: true,
...
export const warehouse_106_7_definition = {
  domain: "warehouse",
  sequence: 113,
  capability: "service",
  enabled: true,
