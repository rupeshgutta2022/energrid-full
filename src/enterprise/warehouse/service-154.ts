...
export const warehouse_154_0_definition = {
  domain: "warehouse",
  sequence: 154,
  capability: "service",
  enabled: true,
...
export const warehouse_154_1_definition = {
  domain: "warehouse",
  sequence: 155,
  capability: "service",
  enabled: true,
...
export const warehouse_154_2_definition = {
  domain: "warehouse",
  sequence: 156,
  capability: "service",
  enabled: true,
...
export const warehouse_154_3_definition = {
  domain: "warehouse",
  sequence: 157,
  capability: "service",
  enabled: true,
...
export const warehouse_154_4_definition = {
  domain: "warehouse",
  sequence: 158,
  capability: "service",
  enabled: true,
...
export const warehouse_154_5_definition = {
  domain: "warehouse",
  sequence: 159,
  capability: "service",
  enabled: true,
...
export const warehouse_154_6_definition = {
  domain: "warehouse",
  sequence: 160,
  capability: "service",
  enabled: true,
...
export const warehouse_154_7_definition = {
  domain: "warehouse",
  sequence: 161,
  capability: "service",
  enabled: true,
