...
export const warehouse_14_0_definition = {
  domain: "warehouse",
  sequence: 14,
  capability: "service",
  enabled: true,
...
export const warehouse_14_1_definition = {
  domain: "warehouse",
  sequence: 15,
  capability: "service",
  enabled: true,
...
export const warehouse_14_2_definition = {
  domain: "warehouse",
  sequence: 16,
  capability: "service",
  enabled: true,
...
export const warehouse_14_3_definition = {
  domain: "warehouse",
  sequence: 17,
  capability: "service",
  enabled: true,
...
export const warehouse_14_4_definition = {
  domain: "warehouse",
  sequence: 18,
  capability: "service",
  enabled: true,
...
export const warehouse_14_5_definition = {
  domain: "warehouse",
  sequence: 19,
  capability: "service",
  enabled: true,
...
export const warehouse_14_6_definition = {
  domain: "warehouse",
  sequence: 20,
  capability: "service",
  enabled: true,
...
export const warehouse_14_7_definition = {
  domain: "warehouse",
  sequence: 21,
  capability: "service",
  enabled: true,
