...
export const warehouse_166_0_definition = {
  domain: "warehouse",
  sequence: 166,
  capability: "service",
  enabled: true,
...
export const warehouse_166_1_definition = {
  domain: "warehouse",
  sequence: 167,
  capability: "service",
  enabled: true,
...
export const warehouse_166_2_definition = {
  domain: "warehouse",
  sequence: 168,
  capability: "service",
  enabled: true,
...
export const warehouse_166_3_definition = {
  domain: "warehouse",
  sequence: 169,
  capability: "service",
  enabled: true,
...
export const warehouse_166_4_definition = {
  domain: "warehouse",
  sequence: 170,
  capability: "service",
  enabled: true,
...
export const warehouse_166_5_definition = {
  domain: "warehouse",
  sequence: 171,
  capability: "service",
  enabled: true,
...
export const warehouse_166_6_definition = {
  domain: "warehouse",
  sequence: 172,
  capability: "service",
  enabled: true,
...
export const warehouse_166_7_definition = {
  domain: "warehouse",
  sequence: 173,
  capability: "service",
  enabled: true,
