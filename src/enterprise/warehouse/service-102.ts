...
export const warehouse_102_0_definition = {
  domain: "warehouse",
  sequence: 102,
  capability: "service",
  enabled: true,
...
export const warehouse_102_1_definition = {
  domain: "warehouse",
  sequence: 103,
  capability: "service",
  enabled: true,
...
export const warehouse_102_2_definition = {
  domain: "warehouse",
  sequence: 104,
  capability: "service",
  enabled: true,
...
export const warehouse_102_3_definition = {
  domain: "warehouse",
  sequence: 105,
  capability: "service",
  enabled: true,
...
export const warehouse_102_4_definition = {
  domain: "warehouse",
  sequence: 106,
  capability: "service",
  enabled: true,
...
export const warehouse_102_5_definition = {
  domain: "warehouse",
  sequence: 107,
  capability: "service",
  enabled: true,
...
export const warehouse_102_6_definition = {
  domain: "warehouse",
  sequence: 108,
  capability: "service",
  enabled: true,
...
export const warehouse_102_7_definition = {
  domain: "warehouse",
  sequence: 109,
  capability: "service",
  enabled: true,
