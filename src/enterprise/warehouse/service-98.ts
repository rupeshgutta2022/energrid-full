...
export const warehouse_98_0_definition = {
  domain: "warehouse",
  sequence: 98,
  capability: "service",
  enabled: true,
...
export const warehouse_98_1_definition = {
  domain: "warehouse",
  sequence: 99,
  capability: "service",
  enabled: true,
...
export const warehouse_98_2_definition = {
  domain: "warehouse",
  sequence: 100,
  capability: "service",
  enabled: true,
...
export const warehouse_98_3_definition = {
  domain: "warehouse",
  sequence: 101,
  capability: "service",
  enabled: true,
...
export const warehouse_98_4_definition = {
  domain: "warehouse",
  sequence: 102,
  capability: "service",
  enabled: true,
...
export const warehouse_98_5_definition = {
  domain: "warehouse",
  sequence: 103,
  capability: "service",
  enabled: true,
...
export const warehouse_98_6_definition = {
  domain: "warehouse",
  sequence: 104,
  capability: "service",
  enabled: true,
...
export const warehouse_98_7_definition = {
  domain: "warehouse",
  sequence: 105,
  capability: "service",
  enabled: true,
