...
export const warehouse_2_0_definition = {
  domain: "warehouse",
  sequence: 2,
  capability: "service",
  enabled: true,
...
export const warehouse_2_1_definition = {
  domain: "warehouse",
  sequence: 3,
  capability: "service",
  enabled: true,
...
export const warehouse_2_2_definition = {
  domain: "warehouse",
  sequence: 4,
  capability: "service",
  enabled: true,
...
export const warehouse_2_3_definition = {
  domain: "warehouse",
  sequence: 5,
  capability: "service",
  enabled: true,
...
export const warehouse_2_4_definition = {
  domain: "warehouse",
  sequence: 6,
  capability: "service",
  enabled: true,
...
export const warehouse_2_5_definition = {
  domain: "warehouse",
  sequence: 7,
  capability: "service",
  enabled: true,
...
export const warehouse_2_6_definition = {
  domain: "warehouse",
  sequence: 8,
  capability: "service",
  enabled: true,
...
export const warehouse_2_7_definition = {
  domain: "warehouse",
  sequence: 9,
  capability: "service",
  enabled: true,
