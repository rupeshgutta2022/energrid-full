...
export const warehouse_110_0_definition = {
  domain: "warehouse",
  sequence: 110,
  capability: "service",
  enabled: true,
...
export const warehouse_110_1_definition = {
  domain: "warehouse",
  sequence: 111,
  capability: "service",
  enabled: true,
...
export const warehouse_110_2_definition = {
  domain: "warehouse",
  sequence: 112,
  capability: "service",
  enabled: true,
...
export const warehouse_110_3_definition = {
  domain: "warehouse",
  sequence: 113,
  capability: "service",
  enabled: true,
...
export const warehouse_110_4_definition = {
  domain: "warehouse",
  sequence: 114,
  capability: "service",
  enabled: true,
...
export const warehouse_110_5_definition = {
  domain: "warehouse",
  sequence: 115,
  capability: "service",
  enabled: true,
...
export const warehouse_110_6_definition = {
  domain: "warehouse",
  sequence: 116,
  capability: "service",
  enabled: true,
...
export const warehouse_110_7_definition = {
  domain: "warehouse",
  sequence: 117,
  capability: "service",
  enabled: true,
