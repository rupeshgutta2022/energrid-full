...
export const warehouse_162_0_definition = {
  domain: "warehouse",
  sequence: 162,
  capability: "service",
  enabled: true,
...
export const warehouse_162_1_definition = {
  domain: "warehouse",
  sequence: 163,
  capability: "service",
  enabled: true,
...
export const warehouse_162_2_definition = {
  domain: "warehouse",
  sequence: 164,
  capability: "service",
  enabled: true,
...
export const warehouse_162_3_definition = {
  domain: "warehouse",
  sequence: 165,
  capability: "service",
  enabled: true,
...
export const warehouse_162_4_definition = {
  domain: "warehouse",
  sequence: 166,
  capability: "service",
  enabled: true,
...
export const warehouse_162_5_definition = {
  domain: "warehouse",
  sequence: 167,
  capability: "service",
  enabled: true,
...
export const warehouse_162_6_definition = {
  domain: "warehouse",
  sequence: 168,
  capability: "service",
  enabled: true,
...
export const warehouse_162_7_definition = {
  domain: "warehouse",
  sequence: 169,
  capability: "service",
  enabled: true,
