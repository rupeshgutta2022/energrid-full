...
export const warehouse_62_0_definition = {
  domain: "warehouse",
  sequence: 62,
  capability: "service",
  enabled: true,
...
export const warehouse_62_1_definition = {
  domain: "warehouse",
  sequence: 63,
  capability: "service",
  enabled: true,
...
export const warehouse_62_2_definition = {
  domain: "warehouse",
  sequence: 64,
  capability: "service",
  enabled: true,
...
export const warehouse_62_3_definition = {
  domain: "warehouse",
  sequence: 65,
  capability: "service",
  enabled: true,
...
export const warehouse_62_4_definition = {
  domain: "warehouse",
  sequence: 66,
  capability: "service",
  enabled: true,
...
export const warehouse_62_5_definition = {
  domain: "warehouse",
  sequence: 67,
  capability: "service",
  enabled: true,
...
export const warehouse_62_6_definition = {
  domain: "warehouse",
  sequence: 68,
  capability: "service",
  enabled: true,
...
export const warehouse_62_7_definition = {
  domain: "warehouse",
  sequence: 69,
  capability: "service",
  enabled: true,
