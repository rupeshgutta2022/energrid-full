...
export const warehouse_182_0_definition = {
  domain: "warehouse",
  sequence: 182,
  capability: "service",
  enabled: true,
...
export const warehouse_182_1_definition = {
  domain: "warehouse",
  sequence: 183,
  capability: "service",
  enabled: true,
...
export const warehouse_182_2_definition = {
  domain: "warehouse",
  sequence: 184,
  capability: "service",
  enabled: true,
...
export const warehouse_182_3_definition = {
  domain: "warehouse",
  sequence: 185,
  capability: "service",
  enabled: true,
...
export const warehouse_182_4_definition = {
  domain: "warehouse",
  sequence: 186,
  capability: "service",
  enabled: true,
...
export const warehouse_182_5_definition = {
  domain: "warehouse",
  sequence: 187,
  capability: "service",
  enabled: true,
...
export const warehouse_182_6_definition = {
  domain: "warehouse",
  sequence: 188,
  capability: "service",
  enabled: true,
...
export const warehouse_182_7_definition = {
  domain: "warehouse",
  sequence: 189,
  capability: "service",
  enabled: true,
