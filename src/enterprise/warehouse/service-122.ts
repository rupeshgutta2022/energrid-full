...
export const warehouse_122_0_definition = {
  domain: "warehouse",
  sequence: 122,
  capability: "service",
  enabled: true,
...
export const warehouse_122_1_definition = {
  domain: "warehouse",
  sequence: 123,
  capability: "service",
  enabled: true,
...
export const warehouse_122_2_definition = {
  domain: "warehouse",
  sequence: 124,
  capability: "service",
  enabled: true,
...
export const warehouse_122_3_definition = {
  domain: "warehouse",
  sequence: 125,
  capability: "service",
  enabled: true,
...
export const warehouse_122_4_definition = {
  domain: "warehouse",
  sequence: 126,
  capability: "service",
  enabled: true,
...
export const warehouse_122_5_definition = {
  domain: "warehouse",
  sequence: 127,
  capability: "service",
  enabled: true,
...
export const warehouse_122_6_definition = {
  domain: "warehouse",
  sequence: 128,
  capability: "service",
  enabled: true,
...
export const warehouse_122_7_definition = {
  domain: "warehouse",
  sequence: 129,
  capability: "service",
  enabled: true,
