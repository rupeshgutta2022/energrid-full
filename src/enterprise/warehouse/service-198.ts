...
export const warehouse_198_0_definition = {
  domain: "warehouse",
  sequence: 198,
  capability: "service",
  enabled: true,
...
export const warehouse_198_1_definition = {
  domain: "warehouse",
  sequence: 199,
  capability: "service",
  enabled: true,
...
export const warehouse_198_2_definition = {
  domain: "warehouse",
  sequence: 200,
  capability: "service",
  enabled: true,
...
export const warehouse_198_3_definition = {
  domain: "warehouse",
  sequence: 201,
  capability: "service",
  enabled: true,
...
export const warehouse_198_4_definition = {
  domain: "warehouse",
  sequence: 202,
  capability: "service",
  enabled: true,
...
export const warehouse_198_5_definition = {
  domain: "warehouse",
  sequence: 203,
  capability: "service",
  enabled: true,
...
export const warehouse_198_6_definition = {
  domain: "warehouse",
  sequence: 204,
  capability: "service",
  enabled: true,
...
export const warehouse_198_7_definition = {
  domain: "warehouse",
  sequence: 205,
  capability: "service",
  enabled: true,
