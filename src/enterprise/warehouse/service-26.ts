...
export const warehouse_26_0_definition = {
  domain: "warehouse",
  sequence: 26,
  capability: "service",
  enabled: true,
...
export const warehouse_26_1_definition = {
  domain: "warehouse",
  sequence: 27,
  capability: "service",
  enabled: true,
...
export const warehouse_26_2_definition = {
  domain: "warehouse",
  sequence: 28,
  capability: "service",
  enabled: true,
...
export const warehouse_26_3_definition = {
  domain: "warehouse",
  sequence: 29,
  capability: "service",
  enabled: true,
...
export const warehouse_26_4_definition = {
  domain: "warehouse",
  sequence: 30,
  capability: "service",
  enabled: true,
...
export const warehouse_26_5_definition = {
  domain: "warehouse",
  sequence: 31,
  capability: "service",
  enabled: true,
...
export const warehouse_26_6_definition = {
  domain: "warehouse",
  sequence: 32,
  capability: "service",
  enabled: true,
...
export const warehouse_26_7_definition = {
  domain: "warehouse",
  sequence: 33,
  capability: "service",
  enabled: true,
