...
export const warehouse_150_0_definition = {
  domain: "warehouse",
  sequence: 150,
  capability: "service",
  enabled: true,
...
export const warehouse_150_1_definition = {
  domain: "warehouse",
  sequence: 151,
  capability: "service",
  enabled: true,
...
export const warehouse_150_2_definition = {
  domain: "warehouse",
  sequence: 152,
  capability: "service",
  enabled: true,
...
export const warehouse_150_3_definition = {
  domain: "warehouse",
  sequence: 153,
  capability: "service",
  enabled: true,
...
export const warehouse_150_4_definition = {
  domain: "warehouse",
  sequence: 154,
  capability: "service",
  enabled: true,
...
export const warehouse_150_5_definition = {
  domain: "warehouse",
  sequence: 155,
  capability: "service",
  enabled: true,
...
export const warehouse_150_6_definition = {
  domain: "warehouse",
  sequence: 156,
  capability: "service",
  enabled: true,
...
export const warehouse_150_7_definition = {
  domain: "warehouse",
  sequence: 157,
  capability: "service",
  enabled: true,
