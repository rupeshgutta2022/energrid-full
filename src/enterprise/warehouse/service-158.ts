...
export const warehouse_158_0_definition = {
  domain: "warehouse",
  sequence: 158,
  capability: "service",
  enabled: true,
...
export const warehouse_158_1_definition = {
  domain: "warehouse",
  sequence: 159,
  capability: "service",
  enabled: true,
...
export const warehouse_158_2_definition = {
  domain: "warehouse",
  sequence: 160,
  capability: "service",
  enabled: true,
...
export const warehouse_158_3_definition = {
  domain: "warehouse",
  sequence: 161,
  capability: "service",
  enabled: true,
...
export const warehouse_158_4_definition = {
  domain: "warehouse",
  sequence: 162,
  capability: "service",
  enabled: true,
...
export const warehouse_158_5_definition = {
  domain: "warehouse",
  sequence: 163,
  capability: "service",
  enabled: true,
...
export const warehouse_158_6_definition = {
  domain: "warehouse",
  sequence: 164,
  capability: "service",
  enabled: true,
...
export const warehouse_158_7_definition = {
  domain: "warehouse",
  sequence: 165,
  capability: "service",
  enabled: true,
