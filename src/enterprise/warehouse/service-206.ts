...
export const warehouse_206_0_definition = {
  domain: "warehouse",
  sequence: 206,
  capability: "service",
  enabled: true,
...
export const warehouse_206_1_definition = {
  domain: "warehouse",
  sequence: 207,
  capability: "service",
  enabled: true,
...
export const warehouse_206_2_definition = {
  domain: "warehouse",
  sequence: 208,
  capability: "service",
  enabled: true,
...
export const warehouse_206_3_definition = {
  domain: "warehouse",
  sequence: 209,
  capability: "service",
  enabled: true,
...
export const warehouse_206_4_definition = {
  domain: "warehouse",
  sequence: 210,
  capability: "service",
  enabled: true,
...
export const warehouse_206_5_definition = {
  domain: "warehouse",
  sequence: 211,
  capability: "service",
  enabled: true,
...
export const warehouse_206_6_definition = {
  domain: "warehouse",
  sequence: 212,
  capability: "service",
  enabled: true,
...
export const warehouse_206_7_definition = {
  domain: "warehouse",
  sequence: 213,
  capability: "service",
  enabled: true,
