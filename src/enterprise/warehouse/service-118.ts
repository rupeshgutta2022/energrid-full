...
export const warehouse_118_0_definition = {
  domain: "warehouse",
  sequence: 118,
  capability: "service",
  enabled: true,
...
export const warehouse_118_1_definition = {
  domain: "warehouse",
  sequence: 119,
  capability: "service",
  enabled: true,
...
export const warehouse_118_2_definition = {
  domain: "warehouse",
  sequence: 120,
  capability: "service",
  enabled: true,
...
export const warehouse_118_3_definition = {
  domain: "warehouse",
  sequence: 121,
  capability: "service",
  enabled: true,
...
export const warehouse_118_4_definition = {
  domain: "warehouse",
  sequence: 122,
  capability: "service",
  enabled: true,
...
export const warehouse_118_5_definition = {
  domain: "warehouse",
  sequence: 123,
  capability: "service",
  enabled: true,
...
export const warehouse_118_6_definition = {
  domain: "warehouse",
  sequence: 124,
  capability: "service",
  enabled: true,
...
export const warehouse_118_7_definition = {
  domain: "warehouse",
  sequence: 125,
  capability: "service",
  enabled: true,
