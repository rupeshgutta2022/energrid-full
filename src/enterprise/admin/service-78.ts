...
export const admin_78_0_definition = {
  domain: "admin",
  sequence: 78,
  capability: "service",
  enabled: true,
...
export const admin_78_1_definition = {
  domain: "admin",
  sequence: 79,
  capability: "service",
  enabled: true,
...
export const admin_78_2_definition = {
  domain: "admin",
  sequence: 80,
  capability: "service",
  enabled: true,
...
export const admin_78_3_definition = {
  domain: "admin",
  sequence: 81,
  capability: "service",
  enabled: true,
...
export const admin_78_4_definition = {
  domain: "admin",
  sequence: 82,
  capability: "service",
  enabled: true,
...
export const admin_78_5_definition = {
  domain: "admin",
  sequence: 83,
  capability: "service",
  enabled: true,
...
export const admin_78_6_definition = {
  domain: "admin",
  sequence: 84,
  capability: "service",
  enabled: true,
...
export const admin_78_7_definition = {
  domain: "admin",
  sequence: 85,
  capability: "service",
  enabled: true,
