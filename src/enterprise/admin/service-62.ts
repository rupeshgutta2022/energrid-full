...
export const admin_62_0_definition = {
  domain: "admin",
  sequence: 62,
  capability: "service",
  enabled: true,
...
export const admin_62_1_definition = {
  domain: "admin",
  sequence: 63,
  capability: "service",
  enabled: true,
...
export const admin_62_2_definition = {
  domain: "admin",
  sequence: 64,
  capability: "service",
  enabled: true,
...
export const admin_62_3_definition = {
  domain: "admin",
  sequence: 65,
  capability: "service",
  enabled: true,
...
export const admin_62_4_definition = {
  domain: "admin",
  sequence: 66,
  capability: "service",
  enabled: true,
...
export const admin_62_5_definition = {
  domain: "admin",
  sequence: 67,
  capability: "service",
  enabled: true,
...
export const admin_62_6_definition = {
  domain: "admin",
  sequence: 68,
  capability: "service",
  enabled: true,
...
export const admin_62_7_definition = {
  domain: "admin",
  sequence: 69,
  capability: "service",
  enabled: true,
