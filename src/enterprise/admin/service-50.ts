...
export const admin_50_0_definition = {
  domain: "admin",
  sequence: 50,
  capability: "service",
  enabled: true,
...
export const admin_50_1_definition = {
  domain: "admin",
  sequence: 51,
  capability: "service",
  enabled: true,
...
export const admin_50_2_definition = {
  domain: "admin",
  sequence: 52,
  capability: "service",
  enabled: true,
...
export const admin_50_3_definition = {
  domain: "admin",
  sequence: 53,
  capability: "service",
  enabled: true,
...
export const admin_50_4_definition = {
  domain: "admin",
  sequence: 54,
  capability: "service",
  enabled: true,
...
export const admin_50_5_definition = {
  domain: "admin",
  sequence: 55,
  capability: "service",
  enabled: true,
...
export const admin_50_6_definition = {
  domain: "admin",
  sequence: 56,
  capability: "service",
  enabled: true,
...
export const admin_50_7_definition = {
  domain: "admin",
  sequence: 57,
  capability: "service",
  enabled: true,
