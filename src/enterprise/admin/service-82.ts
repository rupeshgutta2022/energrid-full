...
export const admin_82_0_definition = {
  domain: "admin",
  sequence: 82,
  capability: "service",
  enabled: true,
...
export const admin_82_1_definition = {
  domain: "admin",
  sequence: 83,
  capability: "service",
  enabled: true,
...
export const admin_82_2_definition = {
  domain: "admin",
  sequence: 84,
  capability: "service",
  enabled: true,
...
export const admin_82_3_definition = {
  domain: "admin",
  sequence: 85,
  capability: "service",
  enabled: true,
...
export const admin_82_4_definition = {
  domain: "admin",
  sequence: 86,
  capability: "service",
  enabled: true,
...
export const admin_82_5_definition = {
  domain: "admin",
  sequence: 87,
  capability: "service",
  enabled: true,
...
export const admin_82_6_definition = {
  domain: "admin",
  sequence: 88,
  capability: "service",
  enabled: true,
...
export const admin_82_7_definition = {
  domain: "admin",
  sequence: 89,
  capability: "service",
  enabled: true,
