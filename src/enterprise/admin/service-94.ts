...
export const admin_94_0_definition = {
  domain: "admin",
  sequence: 94,
  capability: "service",
  enabled: true,
...
export const admin_94_1_definition = {
  domain: "admin",
  sequence: 95,
  capability: "service",
  enabled: true,
...
export const admin_94_2_definition = {
  domain: "admin",
  sequence: 96,
  capability: "service",
  enabled: true,
...
export const admin_94_3_definition = {
  domain: "admin",
  sequence: 97,
  capability: "service",
  enabled: true,
...
export const admin_94_4_definition = {
  domain: "admin",
  sequence: 98,
  capability: "service",
  enabled: true,
...
export const admin_94_5_definition = {
  domain: "admin",
  sequence: 99,
  capability: "service",
  enabled: true,
...
export const admin_94_6_definition = {
  domain: "admin",
  sequence: 100,
  capability: "service",
  enabled: true,
...
export const admin_94_7_definition = {
  domain: "admin",
  sequence: 101,
  capability: "service",
  enabled: true,
