...
export const admin_98_0_definition = {
  domain: "admin",
  sequence: 98,
  capability: "service",
  enabled: true,
...
export const admin_98_1_definition = {
  domain: "admin",
  sequence: 99,
  capability: "service",
  enabled: true,
...
export const admin_98_2_definition = {
  domain: "admin",
  sequence: 100,
  capability: "service",
  enabled: true,
...
export const admin_98_3_definition = {
  domain: "admin",
  sequence: 101,
  capability: "service",
  enabled: true,
...
export const admin_98_4_definition = {
  domain: "admin",
  sequence: 102,
  capability: "service",
  enabled: true,
...
export const admin_98_5_definition = {
  domain: "admin",
  sequence: 103,
  capability: "service",
  enabled: true,
...
export const admin_98_6_definition = {
  domain: "admin",
  sequence: 104,
  capability: "service",
  enabled: true,
...
export const admin_98_7_definition = {
  domain: "admin",
  sequence: 105,
  capability: "service",
  enabled: true,
