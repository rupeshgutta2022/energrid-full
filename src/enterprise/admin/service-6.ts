...
export const admin_6_0_definition = {
  domain: "admin",
  sequence: 6,
  capability: "service",
  enabled: true,
...
export const admin_6_1_definition = {
  domain: "admin",
  sequence: 7,
  capability: "service",
  enabled: true,
...
export const admin_6_2_definition = {
  domain: "admin",
  sequence: 8,
  capability: "service",
  enabled: true,
...
export const admin_6_3_definition = {
  domain: "admin",
  sequence: 9,
  capability: "service",
  enabled: true,
...
export const admin_6_4_definition = {
  domain: "admin",
  sequence: 10,
  capability: "service",
  enabled: true,
...
export const admin_6_5_definition = {
  domain: "admin",
  sequence: 11,
  capability: "service",
  enabled: true,
...
export const admin_6_6_definition = {
  domain: "admin",
  sequence: 12,
  capability: "service",
  enabled: true,
...
export const admin_6_7_definition = {
  domain: "admin",
  sequence: 13,
  capability: "service",
  enabled: true,
