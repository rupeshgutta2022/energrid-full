...
export const admin_90_0_definition = {
  domain: "admin",
  sequence: 90,
  capability: "service",
  enabled: true,
...
export const admin_90_1_definition = {
  domain: "admin",
  sequence: 91,
  capability: "service",
  enabled: true,
...
export const admin_90_2_definition = {
  domain: "admin",
  sequence: 92,
  capability: "service",
  enabled: true,
...
export const admin_90_3_definition = {
  domain: "admin",
  sequence: 93,
  capability: "service",
  enabled: true,
...
export const admin_90_4_definition = {
  domain: "admin",
  sequence: 94,
  capability: "service",
  enabled: true,
...
export const admin_90_5_definition = {
  domain: "admin",
  sequence: 95,
  capability: "service",
  enabled: true,
...
export const admin_90_6_definition = {
  domain: "admin",
  sequence: 96,
  capability: "service",
  enabled: true,
...
export const admin_90_7_definition = {
  domain: "admin",
  sequence: 97,
  capability: "service",
  enabled: true,
