...
export const admin_14_0_definition = {
  domain: "admin",
  sequence: 14,
  capability: "service",
  enabled: true,
...
export const admin_14_1_definition = {
  domain: "admin",
  sequence: 15,
  capability: "service",
  enabled: true,
...
export const admin_14_2_definition = {
  domain: "admin",
  sequence: 16,
  capability: "service",
  enabled: true,
...
export const admin_14_3_definition = {
  domain: "admin",
  sequence: 17,
  capability: "service",
  enabled: true,
...
export const admin_14_4_definition = {
  domain: "admin",
  sequence: 18,
  capability: "service",
  enabled: true,
...
export const admin_14_5_definition = {
  domain: "admin",
  sequence: 19,
  capability: "service",
  enabled: true,
...
export const admin_14_6_definition = {
  domain: "admin",
  sequence: 20,
  capability: "service",
  enabled: true,
...
export const admin_14_7_definition = {
  domain: "admin",
  sequence: 21,
  capability: "service",
  enabled: true,
