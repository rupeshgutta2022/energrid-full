...
export const admin_86_0_definition = {
  domain: "admin",
  sequence: 86,
  capability: "service",
  enabled: true,
...
export const admin_86_1_definition = {
  domain: "admin",
  sequence: 87,
  capability: "service",
  enabled: true,
...
export const admin_86_2_definition = {
  domain: "admin",
  sequence: 88,
  capability: "service",
  enabled: true,
...
export const admin_86_3_definition = {
  domain: "admin",
  sequence: 89,
  capability: "service",
  enabled: true,
...
export const admin_86_4_definition = {
  domain: "admin",
  sequence: 90,
  capability: "service",
  enabled: true,
...
export const admin_86_5_definition = {
  domain: "admin",
  sequence: 91,
  capability: "service",
  enabled: true,
...
export const admin_86_6_definition = {
  domain: "admin",
  sequence: 92,
  capability: "service",
  enabled: true,
...
export const admin_86_7_definition = {
  domain: "admin",
  sequence: 93,
  capability: "service",
  enabled: true,
