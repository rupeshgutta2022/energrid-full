...
export const admin_18_0_definition = {
  domain: "admin",
  sequence: 18,
  capability: "service",
  enabled: true,
...
export const admin_18_1_definition = {
  domain: "admin",
  sequence: 19,
  capability: "service",
  enabled: true,
...
export const admin_18_2_definition = {
  domain: "admin",
  sequence: 20,
  capability: "service",
  enabled: true,
...
export const admin_18_3_definition = {
  domain: "admin",
  sequence: 21,
  capability: "service",
  enabled: true,
...
export const admin_18_4_definition = {
  domain: "admin",
  sequence: 22,
  capability: "service",
  enabled: true,
...
export const admin_18_5_definition = {
  domain: "admin",
  sequence: 23,
  capability: "service",
  enabled: true,
...
export const admin_18_6_definition = {
  domain: "admin",
  sequence: 24,
  capability: "service",
  enabled: true,
...
export const admin_18_7_definition = {
  domain: "admin",
  sequence: 25,
  capability: "service",
  enabled: true,
