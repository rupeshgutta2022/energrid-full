...
export const admin_38_0_definition = {
  domain: "admin",
  sequence: 38,
  capability: "service",
  enabled: true,
...
export const admin_38_1_definition = {
  domain: "admin",
  sequence: 39,
  capability: "service",
  enabled: true,
...
export const admin_38_2_definition = {
  domain: "admin",
  sequence: 40,
  capability: "service",
  enabled: true,
...
export const admin_38_3_definition = {
  domain: "admin",
  sequence: 41,
  capability: "service",
  enabled: true,
...
export const admin_38_4_definition = {
  domain: "admin",
  sequence: 42,
  capability: "service",
  enabled: true,
...
export const admin_38_5_definition = {
  domain: "admin",
  sequence: 43,
  capability: "service",
  enabled: true,
...
export const admin_38_6_definition = {
  domain: "admin",
  sequence: 44,
  capability: "service",
  enabled: true,
...
export const admin_38_7_definition = {
  domain: "admin",
  sequence: 45,
  capability: "service",
  enabled: true,
