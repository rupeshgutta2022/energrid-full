...
export const admin_54_0_definition = {
  domain: "admin",
  sequence: 54,
  capability: "service",
  enabled: true,
...
export const admin_54_1_definition = {
  domain: "admin",
  sequence: 55,
  capability: "service",
  enabled: true,
...
export const admin_54_2_definition = {
  domain: "admin",
  sequence: 56,
  capability: "service",
  enabled: true,
...
export const admin_54_3_definition = {
  domain: "admin",
  sequence: 57,
  capability: "service",
  enabled: true,
...
export const admin_54_4_definition = {
  domain: "admin",
  sequence: 58,
  capability: "service",
  enabled: true,
...
export const admin_54_5_definition = {
  domain: "admin",
  sequence: 59,
  capability: "service",
  enabled: true,
...
export const admin_54_6_definition = {
  domain: "admin",
  sequence: 60,
  capability: "service",
  enabled: true,
...
export const admin_54_7_definition = {
  domain: "admin",
  sequence: 61,
  capability: "service",
  enabled: true,
