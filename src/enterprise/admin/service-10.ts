...
export const admin_10_0_definition = {
  domain: "admin",
  sequence: 10,
  capability: "service",
  enabled: true,
...
export const admin_10_1_definition = {
  domain: "admin",
  sequence: 11,
  capability: "service",
  enabled: true,
...
export const admin_10_2_definition = {
  domain: "admin",
  sequence: 12,
  capability: "service",
  enabled: true,
...
export const admin_10_3_definition = {
  domain: "admin",
  sequence: 13,
  capability: "service",
  enabled: true,
...
export const admin_10_4_definition = {
  domain: "admin",
  sequence: 14,
  capability: "service",
  enabled: true,
...
export const admin_10_5_definition = {
  domain: "admin",
  sequence: 15,
  capability: "service",
  enabled: true,
...
export const admin_10_6_definition = {
  domain: "admin",
  sequence: 16,
  capability: "service",
  enabled: true,
...
export const admin_10_7_definition = {
  domain: "admin",
  sequence: 17,
  capability: "service",
  enabled: true,
