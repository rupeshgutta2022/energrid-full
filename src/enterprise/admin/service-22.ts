...
export const admin_22_0_definition = {
  domain: "admin",
  sequence: 22,
  capability: "service",
  enabled: true,
...
export const admin_22_1_definition = {
  domain: "admin",
  sequence: 23,
  capability: "service",
  enabled: true,
...
export const admin_22_2_definition = {
  domain: "admin",
  sequence: 24,
  capability: "service",
  enabled: true,
...
export const admin_22_3_definition = {
  domain: "admin",
  sequence: 25,
  capability: "service",
  enabled: true,
...
export const admin_22_4_definition = {
  domain: "admin",
  sequence: 26,
  capability: "service",
  enabled: true,
...
export const admin_22_5_definition = {
  domain: "admin",
  sequence: 27,
  capability: "service",
  enabled: true,
...
export const admin_22_6_definition = {
  domain: "admin",
  sequence: 28,
  capability: "service",
  enabled: true,
...
export const admin_22_7_definition = {
  domain: "admin",
  sequence: 29,
  capability: "service",
  enabled: true,
