...
export const admin_66_0_definition = {
  domain: "admin",
  sequence: 66,
  capability: "service",
  enabled: true,
...
export const admin_66_1_definition = {
  domain: "admin",
  sequence: 67,
  capability: "service",
  enabled: true,
...
export const admin_66_2_definition = {
  domain: "admin",
  sequence: 68,
  capability: "service",
  enabled: true,
...
export const admin_66_3_definition = {
  domain: "admin",
  sequence: 69,
  capability: "service",
  enabled: true,
...
export const admin_66_4_definition = {
  domain: "admin",
  sequence: 70,
  capability: "service",
  enabled: true,
...
export const admin_66_5_definition = {
  domain: "admin",
  sequence: 71,
  capability: "service",
  enabled: true,
...
export const admin_66_6_definition = {
  domain: "admin",
  sequence: 72,
  capability: "service",
  enabled: true,
...
export const admin_66_7_definition = {
  domain: "admin",
  sequence: 73,
  capability: "service",
  enabled: true,
