...
export const admin_2_0_definition = {
  domain: "admin",
  sequence: 2,
  capability: "service",
  enabled: true,
...
export const admin_2_1_definition = {
  domain: "admin",
  sequence: 3,
  capability: "service",
  enabled: true,
...
export const admin_2_2_definition = {
  domain: "admin",
  sequence: 4,
  capability: "service",
  enabled: true,
...
export const admin_2_3_definition = {
  domain: "admin",
  sequence: 5,
  capability: "service",
  enabled: true,
...
export const admin_2_4_definition = {
  domain: "admin",
  sequence: 6,
  capability: "service",
  enabled: true,
...
export const admin_2_5_definition = {
  domain: "admin",
  sequence: 7,
  capability: "service",
  enabled: true,
...
export const admin_2_6_definition = {
  domain: "admin",
  sequence: 8,
  capability: "service",
  enabled: true,
...
export const admin_2_7_definition = {
  domain: "admin",
  sequence: 9,
  capability: "service",
  enabled: true,
