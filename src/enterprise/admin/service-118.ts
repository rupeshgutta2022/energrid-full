...
export const admin_118_0_definition = {
  domain: "admin",
  sequence: 118,
  capability: "service",
  enabled: true,
...
export const admin_118_1_definition = {
  domain: "admin",
  sequence: 119,
  capability: "service",
  enabled: true,
...
export const admin_118_2_definition = {
  domain: "admin",
  sequence: 120,
  capability: "service",
  enabled: true,
...
export const admin_118_3_definition = {
  domain: "admin",
  sequence: 121,
  capability: "service",
  enabled: true,
...
export const admin_118_4_definition = {
  domain: "admin",
  sequence: 122,
  capability: "service",
  enabled: true,
