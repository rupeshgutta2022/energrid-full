...
export const admin_30_0_definition = {
  domain: "admin",
  sequence: 30,
  capability: "service",
  enabled: true,
...
export const admin_30_1_definition = {
  domain: "admin",
  sequence: 31,
  capability: "service",
  enabled: true,
...
export const admin_30_2_definition = {
  domain: "admin",
  sequence: 32,
  capability: "service",
  enabled: true,
...
export const admin_30_3_definition = {
  domain: "admin",
  sequence: 33,
  capability: "service",
  enabled: true,
...
export const admin_30_4_definition = {
  domain: "admin",
  sequence: 34,
  capability: "service",
  enabled: true,
...
export const admin_30_5_definition = {
  domain: "admin",
  sequence: 35,
  capability: "service",
  enabled: true,
...
export const admin_30_6_definition = {
  domain: "admin",
  sequence: 36,
  capability: "service",
  enabled: true,
...
export const admin_30_7_definition = {
  domain: "admin",
  sequence: 37,
  capability: "service",
  enabled: true,
