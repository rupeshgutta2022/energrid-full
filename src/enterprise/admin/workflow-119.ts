...
export const admin_119_0_definition = {
  domain: "admin",
  sequence: 119,
  capability: "workflow",
  enabled: true,
...
export const admin_119_1_definition = {
  domain: "admin",
  sequence: 120,
  capability: "workflow",
  enabled: true,
...
export const admin_119_2_definition = {
  domain: "admin",
  sequence: 121,
  capability: "workflow",
  enabled: true,
...
export const admin_119_3_definition = {
  domain: "admin",
  sequence: 122,
  capability: "workflow",
  enabled: true,
...
export const admin_119_4_definition = {
  domain: "admin",
  sequence: 123,
  capability: "workflow",
  enabled: true,
...
export const admin_119_5_definition = {
  domain: "admin",
  sequence: 124,
  capability: "workflow",
  enabled: true,
