...
export const admin_42_0_definition = {
  domain: "admin",
  sequence: 42,
  capability: "service",
  enabled: true,
...
export const admin_42_1_definition = {
  domain: "admin",
  sequence: 43,
  capability: "service",
  enabled: true,
...
export const admin_42_2_definition = {
  domain: "admin",
  sequence: 44,
  capability: "service",
  enabled: true,
...
export const admin_42_3_definition = {
  domain: "admin",
  sequence: 45,
  capability: "service",
  enabled: true,
...
export const admin_42_4_definition = {
  domain: "admin",
  sequence: 46,
  capability: "service",
  enabled: true,
...
export const admin_42_5_definition = {
  domain: "admin",
  sequence: 47,
  capability: "service",
  enabled: true,
...
export const admin_42_6_definition = {
  domain: "admin",
  sequence: 48,
  capability: "service",
  enabled: true,
...
export const admin_42_7_definition = {
  domain: "admin",
  sequence: 49,
  capability: "service",
  enabled: true,
