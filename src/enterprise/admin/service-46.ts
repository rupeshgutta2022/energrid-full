...
export const admin_46_0_definition = {
  domain: "admin",
  sequence: 46,
  capability: "service",
  enabled: true,
...
export const admin_46_1_definition = {
  domain: "admin",
  sequence: 47,
  capability: "service",
  enabled: true,
...
export const admin_46_2_definition = {
  domain: "admin",
  sequence: 48,
  capability: "service",
  enabled: true,
...
export const admin_46_3_definition = {
  domain: "admin",
  sequence: 49,
  capability: "service",
  enabled: true,
...
export const admin_46_4_definition = {
  domain: "admin",
  sequence: 50,
  capability: "service",
  enabled: true,
...
export const admin_46_5_definition = {
  domain: "admin",
  sequence: 51,
  capability: "service",
  enabled: true,
...
export const admin_46_6_definition = {
  domain: "admin",
  sequence: 52,
  capability: "service",
  enabled: true,
...
export const admin_46_7_definition = {
  domain: "admin",
  sequence: 53,
  capability: "service",
  enabled: true,
