...
export const admin_74_0_definition = {
  domain: "admin",
  sequence: 74,
  capability: "service",
  enabled: true,
...
export const admin_74_1_definition = {
  domain: "admin",
  sequence: 75,
  capability: "service",
  enabled: true,
...
export const admin_74_2_definition = {
  domain: "admin",
  sequence: 76,
  capability: "service",
  enabled: true,
...
export const admin_74_3_definition = {
  domain: "admin",
  sequence: 77,
  capability: "service",
  enabled: true,
...
export const admin_74_4_definition = {
  domain: "admin",
  sequence: 78,
  capability: "service",
  enabled: true,
...
export const admin_74_5_definition = {
  domain: "admin",
  sequence: 79,
  capability: "service",
  enabled: true,
...
export const admin_74_6_definition = {
  domain: "admin",
  sequence: 80,
  capability: "service",
  enabled: true,
...
export const admin_74_7_definition = {
  domain: "admin",
  sequence: 81,
  capability: "service",
  enabled: true,
