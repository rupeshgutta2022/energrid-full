...
export const admin_70_0_definition = {
  domain: "admin",
  sequence: 70,
  capability: "service",
  enabled: true,
...
export const admin_70_1_definition = {
  domain: "admin",
  sequence: 71,
  capability: "service",
  enabled: true,
...
export const admin_70_2_definition = {
  domain: "admin",
  sequence: 72,
  capability: "service",
  enabled: true,
...
export const admin_70_3_definition = {
  domain: "admin",
  sequence: 73,
  capability: "service",
  enabled: true,
...
export const admin_70_4_definition = {
  domain: "admin",
  sequence: 74,
  capability: "service",
  enabled: true,
...
export const admin_70_5_definition = {
  domain: "admin",
  sequence: 75,
  capability: "service",
  enabled: true,
...
export const admin_70_6_definition = {
  domain: "admin",
  sequence: 76,
  capability: "service",
  enabled: true,
...
export const admin_70_7_definition = {
  domain: "admin",
  sequence: 77,
  capability: "service",
  enabled: true,
