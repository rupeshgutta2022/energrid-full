...
export const analytics_86_0_definition = {
  domain: "analytics",
  sequence: 86,
  capability: "service",
  enabled: true,
...
export const analytics_86_1_definition = {
  domain: "analytics",
  sequence: 87,
  capability: "service",
  enabled: true,
...
export const analytics_86_2_definition = {
  domain: "analytics",
  sequence: 88,
  capability: "service",
  enabled: true,
...
export const analytics_86_3_definition = {
  domain: "analytics",
  sequence: 89,
  capability: "service",
  enabled: true,
...
export const analytics_86_4_definition = {
  domain: "analytics",
  sequence: 90,
  capability: "service",
  enabled: true,
...
export const analytics_86_5_definition = {
  domain: "analytics",
  sequence: 91,
  capability: "service",
  enabled: true,
...
export const analytics_86_6_definition = {
  domain: "analytics",
  sequence: 92,
  capability: "service",
  enabled: true,
...
export const analytics_86_7_definition = {
  domain: "analytics",
  sequence: 93,
  capability: "service",
  enabled: true,
