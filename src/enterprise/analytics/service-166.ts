...
export const analytics_166_0_definition = {
  domain: "analytics",
  sequence: 166,
  capability: "service",
  enabled: true,
...
export const analytics_166_1_definition = {
  domain: "analytics",
  sequence: 167,
  capability: "service",
  enabled: true,
...
export const analytics_166_2_definition = {
  domain: "analytics",
  sequence: 168,
  capability: "service",
  enabled: true,
...
export const analytics_166_3_definition = {
  domain: "analytics",
  sequence: 169,
  capability: "service",
  enabled: true,
...
export const analytics_166_4_definition = {
  domain: "analytics",
  sequence: 170,
  capability: "service",
  enabled: true,
...
export const analytics_166_5_definition = {
  domain: "analytics",
  sequence: 171,
  capability: "service",
  enabled: true,
...
export const analytics_166_6_definition = {
  domain: "analytics",
  sequence: 172,
  capability: "service",
  enabled: true,
...
export const analytics_166_7_definition = {
  domain: "analytics",
  sequence: 173,
  capability: "service",
  enabled: true,
