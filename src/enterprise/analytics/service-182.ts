...
export const analytics_182_0_definition = {
  domain: "analytics",
  sequence: 182,
  capability: "service",
  enabled: true,
...
export const analytics_182_1_definition = {
  domain: "analytics",
  sequence: 183,
  capability: "service",
  enabled: true,
...
export const analytics_182_2_definition = {
  domain: "analytics",
  sequence: 184,
  capability: "service",
  enabled: true,
...
export const analytics_182_3_definition = {
  domain: "analytics",
  sequence: 185,
  capability: "service",
  enabled: true,
...
export const analytics_182_4_definition = {
  domain: "analytics",
  sequence: 186,
  capability: "service",
  enabled: true,
...
export const analytics_182_5_definition = {
  domain: "analytics",
  sequence: 187,
  capability: "service",
  enabled: true,
...
export const analytics_182_6_definition = {
  domain: "analytics",
  sequence: 188,
  capability: "service",
  enabled: true,
...
export const analytics_182_7_definition = {
  domain: "analytics",
  sequence: 189,
  capability: "service",
  enabled: true,
