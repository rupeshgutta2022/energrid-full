...
export const analytics_6_0_definition = {
  domain: "analytics",
  sequence: 6,
  capability: "service",
  enabled: true,
...
export const analytics_6_1_definition = {
  domain: "analytics",
  sequence: 7,
  capability: "service",
  enabled: true,
...
export const analytics_6_2_definition = {
  domain: "analytics",
  sequence: 8,
  capability: "service",
  enabled: true,
...
export const analytics_6_3_definition = {
  domain: "analytics",
  sequence: 9,
  capability: "service",
  enabled: true,
...
export const analytics_6_4_definition = {
  domain: "analytics",
  sequence: 10,
  capability: "service",
  enabled: true,
...
export const analytics_6_5_definition = {
  domain: "analytics",
  sequence: 11,
  capability: "service",
  enabled: true,
...
export const analytics_6_6_definition = {
  domain: "analytics",
  sequence: 12,
  capability: "service",
  enabled: true,
...
export const analytics_6_7_definition = {
  domain: "analytics",
  sequence: 13,
  capability: "service",
  enabled: true,
