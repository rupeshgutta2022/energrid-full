...
export const analytics_50_0_definition = {
  domain: "analytics",
  sequence: 50,
  capability: "service",
  enabled: true,
...
export const analytics_50_1_definition = {
  domain: "analytics",
  sequence: 51,
  capability: "service",
  enabled: true,
...
export const analytics_50_2_definition = {
  domain: "analytics",
  sequence: 52,
  capability: "service",
  enabled: true,
...
export const analytics_50_3_definition = {
  domain: "analytics",
  sequence: 53,
  capability: "service",
  enabled: true,
...
export const analytics_50_4_definition = {
  domain: "analytics",
  sequence: 54,
  capability: "service",
  enabled: true,
...
export const analytics_50_5_definition = {
  domain: "analytics",
  sequence: 55,
  capability: "service",
  enabled: true,
...
export const analytics_50_6_definition = {
  domain: "analytics",
  sequence: 56,
  capability: "service",
  enabled: true,
...
export const analytics_50_7_definition = {
  domain: "analytics",
  sequence: 57,
  capability: "service",
  enabled: true,
