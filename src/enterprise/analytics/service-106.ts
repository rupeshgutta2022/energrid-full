...
export const analytics_106_0_definition = {
  domain: "analytics",
  sequence: 106,
  capability: "service",
  enabled: true,
...
export const analytics_106_1_definition = {
  domain: "analytics",
  sequence: 107,
  capability: "service",
  enabled: true,
...
export const analytics_106_2_definition = {
  domain: "analytics",
  sequence: 108,
  capability: "service",
  enabled: true,
...
export const analytics_106_3_definition = {
  domain: "analytics",
  sequence: 109,
  capability: "service",
  enabled: true,
...
export const analytics_106_4_definition = {
  domain: "analytics",
  sequence: 110,
  capability: "service",
  enabled: true,
...
export const analytics_106_5_definition = {
  domain: "analytics",
  sequence: 111,
  capability: "service",
  enabled: true,
...
export const analytics_106_6_definition = {
  domain: "analytics",
  sequence: 112,
  capability: "service",
  enabled: true,
...
export const analytics_106_7_definition = {
  domain: "analytics",
  sequence: 113,
  capability: "service",
  enabled: true,
