...
export const analytics_146_0_definition = {
  domain: "analytics",
  sequence: 146,
  capability: "service",
  enabled: true,
...
export const analytics_146_1_definition = {
  domain: "analytics",
  sequence: 147,
  capability: "service",
  enabled: true,
...
export const analytics_146_2_definition = {
  domain: "analytics",
  sequence: 148,
  capability: "service",
  enabled: true,
...
export const analytics_146_3_definition = {
  domain: "analytics",
  sequence: 149,
  capability: "service",
  enabled: true,
...
export const analytics_146_4_definition = {
  domain: "analytics",
  sequence: 150,
  capability: "service",
  enabled: true,
...
export const analytics_146_5_definition = {
  domain: "analytics",
  sequence: 151,
  capability: "service",
  enabled: true,
...
export const analytics_146_6_definition = {
  domain: "analytics",
  sequence: 152,
  capability: "service",
  enabled: true,
...
export const analytics_146_7_definition = {
  domain: "analytics",
  sequence: 153,
  capability: "service",
  enabled: true,
