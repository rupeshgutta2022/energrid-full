...
export const analytics_66_0_definition = {
  domain: "analytics",
  sequence: 66,
  capability: "service",
  enabled: true,
...
export const analytics_66_1_definition = {
  domain: "analytics",
  sequence: 67,
  capability: "service",
  enabled: true,
...
export const analytics_66_2_definition = {
  domain: "analytics",
  sequence: 68,
  capability: "service",
  enabled: true,
...
export const analytics_66_3_definition = {
  domain: "analytics",
  sequence: 69,
  capability: "service",
  enabled: true,
...
export const analytics_66_4_definition = {
  domain: "analytics",
  sequence: 70,
  capability: "service",
  enabled: true,
...
export const analytics_66_5_definition = {
  domain: "analytics",
  sequence: 71,
  capability: "service",
  enabled: true,
...
export const analytics_66_6_definition = {
  domain: "analytics",
  sequence: 72,
  capability: "service",
  enabled: true,
...
export const analytics_66_7_definition = {
  domain: "analytics",
  sequence: 73,
  capability: "service",
  enabled: true,
