...
export const analytics_18_0_definition = {
  domain: "analytics",
  sequence: 18,
  capability: "service",
  enabled: true,
...
export const analytics_18_1_definition = {
  domain: "analytics",
  sequence: 19,
  capability: "service",
  enabled: true,
...
export const analytics_18_2_definition = {
  domain: "analytics",
  sequence: 20,
  capability: "service",
  enabled: true,
...
export const analytics_18_3_definition = {
  domain: "analytics",
  sequence: 21,
  capability: "service",
  enabled: true,
...
export const analytics_18_4_definition = {
  domain: "analytics",
  sequence: 22,
  capability: "service",
  enabled: true,
...
export const analytics_18_5_definition = {
  domain: "analytics",
  sequence: 23,
  capability: "service",
  enabled: true,
...
export const analytics_18_6_definition = {
  domain: "analytics",
  sequence: 24,
  capability: "service",
  enabled: true,
...
export const analytics_18_7_definition = {
  domain: "analytics",
  sequence: 25,
  capability: "service",
  enabled: true,
