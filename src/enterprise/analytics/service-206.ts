...
export const analytics_206_0_definition = {
  domain: "analytics",
  sequence: 206,
  capability: "service",
  enabled: true,
...
export const analytics_206_1_definition = {
  domain: "analytics",
  sequence: 207,
  capability: "service",
  enabled: true,
...
export const analytics_206_2_definition = {
  domain: "analytics",
  sequence: 208,
  capability: "service",
  enabled: true,
...
export const analytics_206_3_definition = {
  domain: "analytics",
  sequence: 209,
  capability: "service",
  enabled: true,
...
export const analytics_206_4_definition = {
  domain: "analytics",
  sequence: 210,
  capability: "service",
  enabled: true,
...
export const analytics_206_5_definition = {
  domain: "analytics",
  sequence: 211,
  capability: "service",
  enabled: true,
...
export const analytics_206_6_definition = {
  domain: "analytics",
  sequence: 212,
  capability: "service",
  enabled: true,
