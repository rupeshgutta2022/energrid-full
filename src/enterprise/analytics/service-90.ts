...
export const analytics_90_0_definition = {
  domain: "analytics",
  sequence: 90,
  capability: "service",
  enabled: true,
...
export const analytics_90_1_definition = {
  domain: "analytics",
  sequence: 91,
  capability: "service",
  enabled: true,
...
export const analytics_90_2_definition = {
  domain: "analytics",
  sequence: 92,
  capability: "service",
  enabled: true,
...
export const analytics_90_3_definition = {
  domain: "analytics",
  sequence: 93,
  capability: "service",
  enabled: true,
...
export const analytics_90_4_definition = {
  domain: "analytics",
  sequence: 94,
  capability: "service",
  enabled: true,
...
export const analytics_90_5_definition = {
  domain: "analytics",
  sequence: 95,
  capability: "service",
  enabled: true,
...
export const analytics_90_6_definition = {
  domain: "analytics",
  sequence: 96,
  capability: "service",
  enabled: true,
...
export const analytics_90_7_definition = {
  domain: "analytics",
  sequence: 97,
  capability: "service",
  enabled: true,
