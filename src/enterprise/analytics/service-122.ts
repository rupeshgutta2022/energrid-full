...
export const analytics_122_0_definition = {
  domain: "analytics",
  sequence: 122,
  capability: "service",
  enabled: true,
...
export const analytics_122_1_definition = {
  domain: "analytics",
  sequence: 123,
  capability: "service",
  enabled: true,
...
export const analytics_122_2_definition = {
  domain: "analytics",
  sequence: 124,
  capability: "service",
  enabled: true,
...
export const analytics_122_3_definition = {
  domain: "analytics",
  sequence: 125,
  capability: "service",
  enabled: true,
...
export const analytics_122_4_definition = {
  domain: "analytics",
  sequence: 126,
  capability: "service",
  enabled: true,
...
export const analytics_122_5_definition = {
  domain: "analytics",
  sequence: 127,
  capability: "service",
  enabled: true,
...
export const analytics_122_6_definition = {
  domain: "analytics",
  sequence: 128,
  capability: "service",
  enabled: true,
...
export const analytics_122_7_definition = {
  domain: "analytics",
  sequence: 129,
  capability: "service",
  enabled: true,
