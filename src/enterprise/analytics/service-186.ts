...
export const analytics_186_0_definition = {
  domain: "analytics",
  sequence: 186,
  capability: "service",
  enabled: true,
...
export const analytics_186_1_definition = {
  domain: "analytics",
  sequence: 187,
  capability: "service",
  enabled: true,
...
export const analytics_186_2_definition = {
  domain: "analytics",
  sequence: 188,
  capability: "service",
  enabled: true,
...
export const analytics_186_3_definition = {
  domain: "analytics",
  sequence: 189,
  capability: "service",
  enabled: true,
...
export const analytics_186_4_definition = {
  domain: "analytics",
  sequence: 190,
  capability: "service",
  enabled: true,
...
export const analytics_186_5_definition = {
  domain: "analytics",
  sequence: 191,
  capability: "service",
  enabled: true,
...
export const analytics_186_6_definition = {
  domain: "analytics",
  sequence: 192,
  capability: "service",
  enabled: true,
...
export const analytics_186_7_definition = {
  domain: "analytics",
  sequence: 193,
  capability: "service",
  enabled: true,
