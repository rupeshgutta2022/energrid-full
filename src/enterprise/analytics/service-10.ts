...
export const analytics_10_0_definition = {
  domain: "analytics",
  sequence: 10,
  capability: "service",
  enabled: true,
...
export const analytics_10_1_definition = {
  domain: "analytics",
  sequence: 11,
  capability: "service",
  enabled: true,
...
export const analytics_10_2_definition = {
  domain: "analytics",
  sequence: 12,
  capability: "service",
  enabled: true,
...
export const analytics_10_3_definition = {
  domain: "analytics",
  sequence: 13,
  capability: "service",
  enabled: true,
...
export const analytics_10_4_definition = {
  domain: "analytics",
  sequence: 14,
  capability: "service",
  enabled: true,
...
export const analytics_10_5_definition = {
  domain: "analytics",
  sequence: 15,
  capability: "service",
  enabled: true,
...
export const analytics_10_6_definition = {
  domain: "analytics",
  sequence: 16,
  capability: "service",
  enabled: true,
...
export const analytics_10_7_definition = {
  domain: "analytics",
  sequence: 17,
  capability: "service",
  enabled: true,
