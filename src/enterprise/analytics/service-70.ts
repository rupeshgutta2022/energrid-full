...
export const analytics_70_0_definition = {
  domain: "analytics",
  sequence: 70,
  capability: "service",
  enabled: true,
...
export const analytics_70_1_definition = {
  domain: "analytics",
  sequence: 71,
  capability: "service",
  enabled: true,
...
export const analytics_70_2_definition = {
  domain: "analytics",
  sequence: 72,
  capability: "service",
  enabled: true,
...
export const analytics_70_3_definition = {
  domain: "analytics",
  sequence: 73,
  capability: "service",
  enabled: true,
...
export const analytics_70_4_definition = {
  domain: "analytics",
  sequence: 74,
  capability: "service",
  enabled: true,
...
export const analytics_70_5_definition = {
  domain: "analytics",
  sequence: 75,
  capability: "service",
  enabled: true,
...
export const analytics_70_6_definition = {
  domain: "analytics",
  sequence: 76,
  capability: "service",
  enabled: true,
...
export const analytics_70_7_definition = {
  domain: "analytics",
  sequence: 77,
  capability: "service",
  enabled: true,
