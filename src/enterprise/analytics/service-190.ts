...
export const analytics_190_0_definition = {
  domain: "analytics",
  sequence: 190,
  capability: "service",
  enabled: true,
...
export const analytics_190_1_definition = {
  domain: "analytics",
  sequence: 191,
  capability: "service",
  enabled: true,
...
export const analytics_190_2_definition = {
  domain: "analytics",
  sequence: 192,
  capability: "service",
  enabled: true,
...
export const analytics_190_3_definition = {
  domain: "analytics",
  sequence: 193,
  capability: "service",
  enabled: true,
...
export const analytics_190_4_definition = {
  domain: "analytics",
  sequence: 194,
  capability: "service",
  enabled: true,
...
export const analytics_190_5_definition = {
  domain: "analytics",
  sequence: 195,
  capability: "service",
  enabled: true,
...
export const analytics_190_6_definition = {
  domain: "analytics",
  sequence: 196,
  capability: "service",
  enabled: true,
...
export const analytics_190_7_definition = {
  domain: "analytics",
  sequence: 197,
  capability: "service",
  enabled: true,
