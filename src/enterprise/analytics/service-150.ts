...
export const analytics_150_0_definition = {
  domain: "analytics",
  sequence: 150,
  capability: "service",
  enabled: true,
...
export const analytics_150_1_definition = {
  domain: "analytics",
  sequence: 151,
  capability: "service",
  enabled: true,
...
export const analytics_150_2_definition = {
  domain: "analytics",
  sequence: 152,
  capability: "service",
  enabled: true,
...
export const analytics_150_3_definition = {
  domain: "analytics",
  sequence: 153,
  capability: "service",
  enabled: true,
...
export const analytics_150_4_definition = {
  domain: "analytics",
  sequence: 154,
  capability: "service",
  enabled: true,
...
export const analytics_150_5_definition = {
  domain: "analytics",
  sequence: 155,
  capability: "service",
  enabled: true,
...
export const analytics_150_6_definition = {
  domain: "analytics",
  sequence: 156,
  capability: "service",
  enabled: true,
...
export const analytics_150_7_definition = {
  domain: "analytics",
  sequence: 157,
  capability: "service",
  enabled: true,
