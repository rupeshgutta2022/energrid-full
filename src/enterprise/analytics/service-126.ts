...
export const analytics_126_0_definition = {
  domain: "analytics",
  sequence: 126,
  capability: "service",
  enabled: true,
...
export const analytics_126_1_definition = {
  domain: "analytics",
  sequence: 127,
  capability: "service",
  enabled: true,
...
export const analytics_126_2_definition = {
  domain: "analytics",
  sequence: 128,
  capability: "service",
  enabled: true,
...
export const analytics_126_3_definition = {
  domain: "analytics",
  sequence: 129,
  capability: "service",
  enabled: true,
...
export const analytics_126_4_definition = {
  domain: "analytics",
  sequence: 130,
  capability: "service",
  enabled: true,
...
export const analytics_126_5_definition = {
  domain: "analytics",
  sequence: 131,
  capability: "service",
  enabled: true,
...
export const analytics_126_6_definition = {
  domain: "analytics",
  sequence: 132,
  capability: "service",
  enabled: true,
...
export const analytics_126_7_definition = {
  domain: "analytics",
  sequence: 133,
  capability: "service",
  enabled: true,
