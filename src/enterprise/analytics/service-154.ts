...
export const analytics_154_0_definition = {
  domain: "analytics",
  sequence: 154,
  capability: "service",
  enabled: true,
...
export const analytics_154_1_definition = {
  domain: "analytics",
  sequence: 155,
  capability: "service",
  enabled: true,
...
export const analytics_154_2_definition = {
  domain: "analytics",
  sequence: 156,
  capability: "service",
  enabled: true,
...
export const analytics_154_3_definition = {
  domain: "analytics",
  sequence: 157,
  capability: "service",
  enabled: true,
...
export const analytics_154_4_definition = {
  domain: "analytics",
  sequence: 158,
  capability: "service",
  enabled: true,
...
export const analytics_154_5_definition = {
  domain: "analytics",
  sequence: 159,
  capability: "service",
  enabled: true,
...
export const analytics_154_6_definition = {
  domain: "analytics",
  sequence: 160,
  capability: "service",
  enabled: true,
...
export const analytics_154_7_definition = {
  domain: "analytics",
  sequence: 161,
  capability: "service",
  enabled: true,
