...
export const analytics_158_0_definition = {
  domain: "analytics",
  sequence: 158,
  capability: "service",
  enabled: true,
...
export const analytics_158_1_definition = {
  domain: "analytics",
  sequence: 159,
  capability: "service",
  enabled: true,
...
export const analytics_158_2_definition = {
  domain: "analytics",
  sequence: 160,
  capability: "service",
  enabled: true,
...
export const analytics_158_3_definition = {
  domain: "analytics",
  sequence: 161,
  capability: "service",
  enabled: true,
...
export const analytics_158_4_definition = {
  domain: "analytics",
  sequence: 162,
  capability: "service",
  enabled: true,
...
export const analytics_158_5_definition = {
  domain: "analytics",
  sequence: 163,
  capability: "service",
  enabled: true,
...
export const analytics_158_6_definition = {
  domain: "analytics",
  sequence: 164,
  capability: "service",
  enabled: true,
...
export const analytics_158_7_definition = {
  domain: "analytics",
  sequence: 165,
  capability: "service",
  enabled: true,
