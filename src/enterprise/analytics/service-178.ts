...
export const analytics_178_0_definition = {
  domain: "analytics",
  sequence: 178,
  capability: "service",
  enabled: true,
...
export const analytics_178_1_definition = {
  domain: "analytics",
  sequence: 179,
  capability: "service",
  enabled: true,
...
export const analytics_178_2_definition = {
  domain: "analytics",
  sequence: 180,
  capability: "service",
  enabled: true,
...
export const analytics_178_3_definition = {
  domain: "analytics",
  sequence: 181,
  capability: "service",
  enabled: true,
...
export const analytics_178_4_definition = {
  domain: "analytics",
  sequence: 182,
  capability: "service",
  enabled: true,
...
export const analytics_178_5_definition = {
  domain: "analytics",
  sequence: 183,
  capability: "service",
  enabled: true,
...
export const analytics_178_6_definition = {
  domain: "analytics",
  sequence: 184,
  capability: "service",
  enabled: true,
...
export const analytics_178_7_definition = {
  domain: "analytics",
  sequence: 185,
  capability: "service",
  enabled: true,
