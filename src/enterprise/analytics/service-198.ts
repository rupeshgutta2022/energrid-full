...
export const analytics_198_0_definition = {
  domain: "analytics",
  sequence: 198,
  capability: "service",
  enabled: true,
...
export const analytics_198_1_definition = {
  domain: "analytics",
  sequence: 199,
  capability: "service",
  enabled: true,
...
export const analytics_198_2_definition = {
  domain: "analytics",
  sequence: 200,
  capability: "service",
  enabled: true,
...
export const analytics_198_3_definition = {
  domain: "analytics",
  sequence: 201,
  capability: "service",
  enabled: true,
...
export const analytics_198_4_definition = {
  domain: "analytics",
  sequence: 202,
  capability: "service",
  enabled: true,
...
export const analytics_198_5_definition = {
  domain: "analytics",
  sequence: 203,
  capability: "service",
  enabled: true,
...
export const analytics_198_6_definition = {
  domain: "analytics",
  sequence: 204,
  capability: "service",
  enabled: true,
...
export const analytics_198_7_definition = {
  domain: "analytics",
  sequence: 205,
  capability: "service",
  enabled: true,
