...
export const analytics_138_0_definition = {
  domain: "analytics",
  sequence: 138,
  capability: "service",
  enabled: true,
...
export const analytics_138_1_definition = {
  domain: "analytics",
  sequence: 139,
  capability: "service",
  enabled: true,
...
export const analytics_138_2_definition = {
  domain: "analytics",
  sequence: 140,
  capability: "service",
  enabled: true,
...
export const analytics_138_3_definition = {
  domain: "analytics",
  sequence: 141,
  capability: "service",
  enabled: true,
...
export const analytics_138_4_definition = {
  domain: "analytics",
  sequence: 142,
  capability: "service",
  enabled: true,
...
export const analytics_138_5_definition = {
  domain: "analytics",
  sequence: 143,
  capability: "service",
  enabled: true,
...
export const analytics_138_6_definition = {
  domain: "analytics",
  sequence: 144,
  capability: "service",
  enabled: true,
...
export const analytics_138_7_definition = {
  domain: "analytics",
  sequence: 145,
  capability: "service",
  enabled: true,
