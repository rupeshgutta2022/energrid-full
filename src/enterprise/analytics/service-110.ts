...
export const analytics_110_0_definition = {
  domain: "analytics",
  sequence: 110,
  capability: "service",
  enabled: true,
...
export const analytics_110_1_definition = {
  domain: "analytics",
  sequence: 111,
  capability: "service",
  enabled: true,
...
export const analytics_110_2_definition = {
  domain: "analytics",
  sequence: 112,
  capability: "service",
  enabled: true,
...
export const analytics_110_3_definition = {
  domain: "analytics",
  sequence: 113,
  capability: "service",
  enabled: true,
...
export const analytics_110_4_definition = {
  domain: "analytics",
  sequence: 114,
  capability: "service",
  enabled: true,
...
export const analytics_110_5_definition = {
  domain: "analytics",
  sequence: 115,
  capability: "service",
  enabled: true,
...
export const analytics_110_6_definition = {
  domain: "analytics",
  sequence: 116,
  capability: "service",
  enabled: true,
...
export const analytics_110_7_definition = {
  domain: "analytics",
  sequence: 117,
  capability: "service",
  enabled: true,
