...
export const analytics_2_0_definition = {
  domain: "analytics",
  sequence: 2,
  capability: "service",
  enabled: true,
...
export const analytics_2_1_definition = {
  domain: "analytics",
  sequence: 3,
  capability: "service",
  enabled: true,
...
export const analytics_2_2_definition = {
  domain: "analytics",
  sequence: 4,
  capability: "service",
  enabled: true,
...
export const analytics_2_3_definition = {
  domain: "analytics",
  sequence: 5,
  capability: "service",
  enabled: true,
...
export const analytics_2_4_definition = {
  domain: "analytics",
  sequence: 6,
  capability: "service",
  enabled: true,
...
export const analytics_2_5_definition = {
  domain: "analytics",
  sequence: 7,
  capability: "service",
  enabled: true,
...
export const analytics_2_6_definition = {
  domain: "analytics",
  sequence: 8,
  capability: "service",
  enabled: true,
...
export const analytics_2_7_definition = {
  domain: "analytics",
  sequence: 9,
  capability: "service",
  enabled: true,
