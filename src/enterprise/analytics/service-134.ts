...
export const analytics_134_0_definition = {
  domain: "analytics",
  sequence: 134,
  capability: "service",
  enabled: true,
...
export const analytics_134_1_definition = {
  domain: "analytics",
  sequence: 135,
  capability: "service",
  enabled: true,
...
export const analytics_134_2_definition = {
  domain: "analytics",
  sequence: 136,
  capability: "service",
  enabled: true,
...
export const analytics_134_3_definition = {
  domain: "analytics",
  sequence: 137,
  capability: "service",
  enabled: true,
...
export const analytics_134_4_definition = {
  domain: "analytics",
  sequence: 138,
  capability: "service",
  enabled: true,
...
export const analytics_134_5_definition = {
  domain: "analytics",
  sequence: 139,
  capability: "service",
  enabled: true,
...
export const analytics_134_6_definition = {
  domain: "analytics",
  sequence: 140,
  capability: "service",
  enabled: true,
...
export const analytics_134_7_definition = {
  domain: "analytics",
  sequence: 141,
  capability: "service",
  enabled: true,
