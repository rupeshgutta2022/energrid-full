...
export const analytics_98_0_definition = {
  domain: "analytics",
  sequence: 98,
  capability: "service",
  enabled: true,
...
export const analytics_98_1_definition = {
  domain: "analytics",
  sequence: 99,
  capability: "service",
  enabled: true,
...
export const analytics_98_2_definition = {
  domain: "analytics",
  sequence: 100,
  capability: "service",
  enabled: true,
...
export const analytics_98_3_definition = {
  domain: "analytics",
  sequence: 101,
  capability: "service",
  enabled: true,
...
export const analytics_98_4_definition = {
  domain: "analytics",
  sequence: 102,
  capability: "service",
  enabled: true,
...
export const analytics_98_5_definition = {
  domain: "analytics",
  sequence: 103,
  capability: "service",
  enabled: true,
...
export const analytics_98_6_definition = {
  domain: "analytics",
  sequence: 104,
  capability: "service",
  enabled: true,
...
export const analytics_98_7_definition = {
  domain: "analytics",
  sequence: 105,
  capability: "service",
  enabled: true,
