...
export const analytics_142_0_definition = {
  domain: "analytics",
  sequence: 142,
  capability: "service",
  enabled: true,
...
export const analytics_142_1_definition = {
  domain: "analytics",
  sequence: 143,
  capability: "service",
  enabled: true,
...
export const analytics_142_2_definition = {
  domain: "analytics",
  sequence: 144,
  capability: "service",
  enabled: true,
...
export const analytics_142_3_definition = {
  domain: "analytics",
  sequence: 145,
  capability: "service",
  enabled: true,
...
export const analytics_142_4_definition = {
  domain: "analytics",
  sequence: 146,
  capability: "service",
  enabled: true,
...
export const analytics_142_5_definition = {
  domain: "analytics",
  sequence: 147,
  capability: "service",
  enabled: true,
...
export const analytics_142_6_definition = {
  domain: "analytics",
  sequence: 148,
  capability: "service",
  enabled: true,
...
export const analytics_142_7_definition = {
  domain: "analytics",
  sequence: 149,
  capability: "service",
  enabled: true,
