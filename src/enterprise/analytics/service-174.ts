...
export const analytics_174_0_definition = {
  domain: "analytics",
  sequence: 174,
  capability: "service",
  enabled: true,
...
export const analytics_174_1_definition = {
  domain: "analytics",
  sequence: 175,
  capability: "service",
  enabled: true,
...
export const analytics_174_2_definition = {
  domain: "analytics",
  sequence: 176,
  capability: "service",
  enabled: true,
...
export const analytics_174_3_definition = {
  domain: "analytics",
  sequence: 177,
  capability: "service",
  enabled: true,
...
export const analytics_174_4_definition = {
  domain: "analytics",
  sequence: 178,
  capability: "service",
  enabled: true,
...
export const analytics_174_5_definition = {
  domain: "analytics",
  sequence: 179,
  capability: "service",
  enabled: true,
...
export const analytics_174_6_definition = {
  domain: "analytics",
  sequence: 180,
  capability: "service",
  enabled: true,
...
export const analytics_174_7_definition = {
  domain: "analytics",
  sequence: 181,
  capability: "service",
  enabled: true,
