...
export const analytics_102_0_definition = {
  domain: "analytics",
  sequence: 102,
  capability: "service",
  enabled: true,
...
export const analytics_102_1_definition = {
  domain: "analytics",
  sequence: 103,
  capability: "service",
  enabled: true,
...
export const analytics_102_2_definition = {
  domain: "analytics",
  sequence: 104,
  capability: "service",
  enabled: true,
...
export const analytics_102_3_definition = {
  domain: "analytics",
  sequence: 105,
  capability: "service",
  enabled: true,
...
export const analytics_102_4_definition = {
  domain: "analytics",
  sequence: 106,
  capability: "service",
  enabled: true,
...
export const analytics_102_5_definition = {
  domain: "analytics",
  sequence: 107,
  capability: "service",
  enabled: true,
...
export const analytics_102_6_definition = {
  domain: "analytics",
  sequence: 108,
  capability: "service",
  enabled: true,
...
export const analytics_102_7_definition = {
  domain: "analytics",
  sequence: 109,
  capability: "service",
  enabled: true,
