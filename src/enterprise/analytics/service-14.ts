...
export const analytics_14_0_definition = {
  domain: "analytics",
  sequence: 14,
  capability: "service",
  enabled: true,
...
export const analytics_14_1_definition = {
  domain: "analytics",
  sequence: 15,
  capability: "service",
  enabled: true,
...
export const analytics_14_2_definition = {
  domain: "analytics",
  sequence: 16,
  capability: "service",
  enabled: true,
...
export const analytics_14_3_definition = {
  domain: "analytics",
  sequence: 17,
  capability: "service",
  enabled: true,
...
export const analytics_14_4_definition = {
  domain: "analytics",
  sequence: 18,
  capability: "service",
  enabled: true,
...
export const analytics_14_5_definition = {
  domain: "analytics",
  sequence: 19,
  capability: "service",
  enabled: true,
...
export const analytics_14_6_definition = {
  domain: "analytics",
  sequence: 20,
  capability: "service",
  enabled: true,
...
export const analytics_14_7_definition = {
  domain: "analytics",
  sequence: 21,
  capability: "service",
  enabled: true,
