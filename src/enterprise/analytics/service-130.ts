...
export const analytics_130_0_definition = {
  domain: "analytics",
  sequence: 130,
  capability: "service",
  enabled: true,
...
export const analytics_130_1_definition = {
  domain: "analytics",
  sequence: 131,
  capability: "service",
  enabled: true,
...
export const analytics_130_2_definition = {
  domain: "analytics",
  sequence: 132,
  capability: "service",
  enabled: true,
...
export const analytics_130_3_definition = {
  domain: "analytics",
  sequence: 133,
  capability: "service",
  enabled: true,
...
export const analytics_130_4_definition = {
  domain: "analytics",
  sequence: 134,
  capability: "service",
  enabled: true,
...
export const analytics_130_5_definition = {
  domain: "analytics",
  sequence: 135,
  capability: "service",
  enabled: true,
...
export const analytics_130_6_definition = {
  domain: "analytics",
  sequence: 136,
  capability: "service",
  enabled: true,
...
export const analytics_130_7_definition = {
  domain: "analytics",
  sequence: 137,
  capability: "service",
  enabled: true,
