...
export const analytics_114_0_definition = {
  domain: "analytics",
  sequence: 114,
  capability: "service",
  enabled: true,
...
export const analytics_114_1_definition = {
  domain: "analytics",
  sequence: 115,
  capability: "service",
  enabled: true,
...
export const analytics_114_2_definition = {
  domain: "analytics",
  sequence: 116,
  capability: "service",
  enabled: true,
...
export const analytics_114_3_definition = {
  domain: "analytics",
  sequence: 117,
  capability: "service",
  enabled: true,
...
export const analytics_114_4_definition = {
  domain: "analytics",
  sequence: 118,
  capability: "service",
  enabled: true,
...
export const analytics_114_5_definition = {
  domain: "analytics",
  sequence: 119,
  capability: "service",
  enabled: true,
...
export const analytics_114_6_definition = {
  domain: "analytics",
  sequence: 120,
  capability: "service",
  enabled: true,
...
export const analytics_114_7_definition = {
  domain: "analytics",
  sequence: 121,
  capability: "service",
  enabled: true,
