...
export const analytics_194_0_definition = {
  domain: "analytics",
  sequence: 194,
  capability: "service",
  enabled: true,
...
export const analytics_194_1_definition = {
  domain: "analytics",
  sequence: 195,
  capability: "service",
  enabled: true,
...
export const analytics_194_2_definition = {
  domain: "analytics",
  sequence: 196,
  capability: "service",
  enabled: true,
...
export const analytics_194_3_definition = {
  domain: "analytics",
  sequence: 197,
  capability: "service",
  enabled: true,
...
export const analytics_194_4_definition = {
  domain: "analytics",
  sequence: 198,
  capability: "service",
  enabled: true,
...
export const analytics_194_5_definition = {
  domain: "analytics",
  sequence: 199,
  capability: "service",
  enabled: true,
...
export const analytics_194_6_definition = {
  domain: "analytics",
  sequence: 200,
  capability: "service",
  enabled: true,
...
export const analytics_194_7_definition = {
  domain: "analytics",
  sequence: 201,
  capability: "service",
  enabled: true,
