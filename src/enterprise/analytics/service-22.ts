...
export const analytics_22_0_definition = {
  domain: "analytics",
  sequence: 22,
  capability: "service",
  enabled: true,
...
export const analytics_22_1_definition = {
  domain: "analytics",
  sequence: 23,
  capability: "service",
  enabled: true,
...
export const analytics_22_2_definition = {
  domain: "analytics",
  sequence: 24,
  capability: "service",
  enabled: true,
...
export const analytics_22_3_definition = {
  domain: "analytics",
  sequence: 25,
  capability: "service",
  enabled: true,
...
export const analytics_22_4_definition = {
  domain: "analytics",
  sequence: 26,
  capability: "service",
  enabled: true,
...
export const analytics_22_5_definition = {
  domain: "analytics",
  sequence: 27,
  capability: "service",
  enabled: true,
...
export const analytics_22_6_definition = {
  domain: "analytics",
  sequence: 28,
  capability: "service",
  enabled: true,
...
export const analytics_22_7_definition = {
  domain: "analytics",
  sequence: 29,
  capability: "service",
  enabled: true,
