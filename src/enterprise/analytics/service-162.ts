...
export const analytics_162_0_definition = {
  domain: "analytics",
  sequence: 162,
  capability: "service",
  enabled: true,
...
export const analytics_162_1_definition = {
  domain: "analytics",
  sequence: 163,
  capability: "service",
  enabled: true,
...
export const analytics_162_2_definition = {
  domain: "analytics",
  sequence: 164,
  capability: "service",
  enabled: true,
...
export const analytics_162_3_definition = {
  domain: "analytics",
  sequence: 165,
  capability: "service",
  enabled: true,
...
export const analytics_162_4_definition = {
  domain: "analytics",
  sequence: 166,
  capability: "service",
  enabled: true,
...
export const analytics_162_5_definition = {
  domain: "analytics",
  sequence: 167,
  capability: "service",
  enabled: true,
...
export const analytics_162_6_definition = {
  domain: "analytics",
  sequence: 168,
  capability: "service",
  enabled: true,
...
export const analytics_162_7_definition = {
  domain: "analytics",
  sequence: 169,
  capability: "service",
  enabled: true,
