...
export const analytics_62_0_definition = {
  domain: "analytics",
  sequence: 62,
  capability: "service",
  enabled: true,
...
export const analytics_62_1_definition = {
  domain: "analytics",
  sequence: 63,
  capability: "service",
  enabled: true,
...
export const analytics_62_2_definition = {
  domain: "analytics",
  sequence: 64,
  capability: "service",
  enabled: true,
...
export const analytics_62_3_definition = {
  domain: "analytics",
  sequence: 65,
  capability: "service",
  enabled: true,
...
export const analytics_62_4_definition = {
  domain: "analytics",
  sequence: 66,
  capability: "service",
  enabled: true,
...
export const analytics_62_5_definition = {
  domain: "analytics",
  sequence: 67,
  capability: "service",
  enabled: true,
...
export const analytics_62_6_definition = {
  domain: "analytics",
  sequence: 68,
  capability: "service",
  enabled: true,
...
export const analytics_62_7_definition = {
  domain: "analytics",
  sequence: 69,
  capability: "service",
  enabled: true,
