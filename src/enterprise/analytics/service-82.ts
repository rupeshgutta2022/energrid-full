...
export const analytics_82_0_definition = {
  domain: "analytics",
  sequence: 82,
  capability: "service",
  enabled: true,
...
export const analytics_82_1_definition = {
  domain: "analytics",
  sequence: 83,
  capability: "service",
  enabled: true,
...
export const analytics_82_2_definition = {
  domain: "analytics",
  sequence: 84,
  capability: "service",
  enabled: true,
...
export const analytics_82_3_definition = {
  domain: "analytics",
  sequence: 85,
  capability: "service",
  enabled: true,
...
export const analytics_82_4_definition = {
  domain: "analytics",
  sequence: 86,
  capability: "service",
  enabled: true,
...
export const analytics_82_5_definition = {
  domain: "analytics",
  sequence: 87,
  capability: "service",
  enabled: true,
...
export const analytics_82_6_definition = {
  domain: "analytics",
  sequence: 88,
  capability: "service",
  enabled: true,
...
export const analytics_82_7_definition = {
  domain: "analytics",
  sequence: 89,
  capability: "service",
  enabled: true,
