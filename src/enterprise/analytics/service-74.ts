...
export const analytics_74_0_definition = {
  domain: "analytics",
  sequence: 74,
  capability: "service",
  enabled: true,
...
export const analytics_74_1_definition = {
  domain: "analytics",
  sequence: 75,
  capability: "service",
  enabled: true,
...
export const analytics_74_2_definition = {
  domain: "analytics",
  sequence: 76,
  capability: "service",
  enabled: true,
...
export const analytics_74_3_definition = {
  domain: "analytics",
  sequence: 77,
  capability: "service",
  enabled: true,
...
export const analytics_74_4_definition = {
  domain: "analytics",
  sequence: 78,
  capability: "service",
  enabled: true,
...
export const analytics_74_5_definition = {
  domain: "analytics",
  sequence: 79,
  capability: "service",
  enabled: true,
...
export const analytics_74_6_definition = {
  domain: "analytics",
  sequence: 80,
  capability: "service",
  enabled: true,
...
export const analytics_74_7_definition = {
  domain: "analytics",
  sequence: 81,
  capability: "service",
  enabled: true,
