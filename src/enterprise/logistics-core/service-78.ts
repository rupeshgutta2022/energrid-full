...
export const logistics_core_78_0_definition = {
...
export const logistics_core_78_1_definition = {
  domain: "logistics-core",
  sequence: 79,
  capability: "service",
  enabled: true,
...
export const logistics_core_78_2_definition = {
  domain: "logistics-core",
  sequence: 80,
  capability: "service",
  enabled: true,
...
export const logistics_core_78_3_definition = {
  domain: "logistics-core",
  sequence: 81,
  capability: "service",
  enabled: true,
...
export const logistics_core_78_4_definition = {
  domain: "logistics-core",
  sequence: 82,
  capability: "service",
  enabled: true,
...
export const logistics_core_78_5_definition = {
  domain: "logistics-core",
  sequence: 83,
  capability: "service",
  enabled: true,
...
export const logistics_core_78_6_definition = {
  domain: "logistics-core",
  sequence: 84,
  capability: "service",
  enabled: true,
...
export const logistics_core_78_7_definition = {
  domain: "logistics-core",
  sequence: 85,
  capability: "service",
  enabled: true,
