...
export const logistics_core_266_0_definition = {
...
export const logistics_core_266_1_definition = {
  domain: "logistics-core",
  sequence: 267,
  capability: "service",
  enabled: true,
...
export const logistics_core_266_2_definition = {
  domain: "logistics-core",
  sequence: 268,
  capability: "service",
  enabled: true,
...
export const logistics_core_266_3_definition = {
  domain: "logistics-core",
  sequence: 269,
  capability: "service",
  enabled: true,
