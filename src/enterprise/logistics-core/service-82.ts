...
export const logistics_core_82_0_definition = {
...
export const logistics_core_82_1_definition = {
  domain: "logistics-core",
  sequence: 83,
  capability: "service",
  enabled: true,
...
export const logistics_core_82_2_definition = {
  domain: "logistics-core",
  sequence: 84,
  capability: "service",
  enabled: true,
...
export const logistics_core_82_3_definition = {
  domain: "logistics-core",
  sequence: 85,
  capability: "service",
  enabled: true,
...
export const logistics_core_82_4_definition = {
  domain: "logistics-core",
  sequence: 86,
  capability: "service",
  enabled: true,
...
export const logistics_core_82_5_definition = {
  domain: "logistics-core",
  sequence: 87,
  capability: "service",
  enabled: true,
...
export const logistics_core_82_6_definition = {
  domain: "logistics-core",
  sequence: 88,
  capability: "service",
  enabled: true,
...
export const logistics_core_82_7_definition = {
  domain: "logistics-core",
  sequence: 89,
  capability: "service",
  enabled: true,
