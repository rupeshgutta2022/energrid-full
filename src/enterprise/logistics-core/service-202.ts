...
export const logistics_core_202_0_definition = {
...
export const logistics_core_202_1_definition = {
  domain: "logistics-core",
  sequence: 203,
  capability: "service",
  enabled: true,
...
export const logistics_core_202_2_definition = {
  domain: "logistics-core",
  sequence: 204,
  capability: "service",
  enabled: true,
...
export const logistics_core_202_3_definition = {
  domain: "logistics-core",
  sequence: 205,
  capability: "service",
  enabled: true,
...
export const logistics_core_202_4_definition = {
  domain: "logistics-core",
  sequence: 206,
  capability: "service",
  enabled: true,
...
export const logistics_core_202_5_definition = {
  domain: "logistics-core",
  sequence: 207,
  capability: "service",
  enabled: true,
...
export const logistics_core_202_6_definition = {
  domain: "logistics-core",
  sequence: 208,
  capability: "service",
  enabled: true,
...
export const logistics_core_202_7_definition = {
  domain: "logistics-core",
  sequence: 209,
  capability: "service",
  enabled: true,
