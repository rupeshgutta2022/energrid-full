...
export const logistics_core_178_0_definition = {
...
export const logistics_core_178_1_definition = {
  domain: "logistics-core",
  sequence: 179,
  capability: "service",
  enabled: true,
...
export const logistics_core_178_2_definition = {
  domain: "logistics-core",
  sequence: 180,
  capability: "service",
  enabled: true,
...
export const logistics_core_178_3_definition = {
  domain: "logistics-core",
  sequence: 181,
  capability: "service",
  enabled: true,
...
export const logistics_core_178_4_definition = {
  domain: "logistics-core",
  sequence: 182,
  capability: "service",
  enabled: true,
...
export const logistics_core_178_5_definition = {
  domain: "logistics-core",
  sequence: 183,
  capability: "service",
  enabled: true,
...
export const logistics_core_178_6_definition = {
  domain: "logistics-core",
  sequence: 184,
  capability: "service",
  enabled: true,
...
export const logistics_core_178_7_definition = {
  domain: "logistics-core",
  sequence: 185,
  capability: "service",
  enabled: true,
