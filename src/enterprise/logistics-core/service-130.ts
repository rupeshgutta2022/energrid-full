...
export const logistics_core_130_0_definition = {
...
export const logistics_core_130_1_definition = {
  domain: "logistics-core",
  sequence: 131,
  capability: "service",
  enabled: true,
...
export const logistics_core_130_2_definition = {
  domain: "logistics-core",
  sequence: 132,
  capability: "service",
  enabled: true,
...
export const logistics_core_130_3_definition = {
  domain: "logistics-core",
  sequence: 133,
  capability: "service",
  enabled: true,
...
export const logistics_core_130_4_definition = {
  domain: "logistics-core",
  sequence: 134,
  capability: "service",
  enabled: true,
...
export const logistics_core_130_5_definition = {
  domain: "logistics-core",
  sequence: 135,
  capability: "service",
  enabled: true,
...
export const logistics_core_130_6_definition = {
  domain: "logistics-core",
  sequence: 136,
  capability: "service",
  enabled: true,
...
export const logistics_core_130_7_definition = {
  domain: "logistics-core",
  sequence: 137,
  capability: "service",
  enabled: true,
