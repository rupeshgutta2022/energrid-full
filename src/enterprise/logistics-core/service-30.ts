...
export const logistics_core_30_0_definition = {
...
export const logistics_core_30_1_definition = {
  domain: "logistics-core",
  sequence: 31,
  capability: "service",
  enabled: true,
...
export const logistics_core_30_2_definition = {
  domain: "logistics-core",
  sequence: 32,
  capability: "service",
  enabled: true,
...
export const logistics_core_30_3_definition = {
  domain: "logistics-core",
  sequence: 33,
  capability: "service",
  enabled: true,
...
export const logistics_core_30_4_definition = {
  domain: "logistics-core",
  sequence: 34,
  capability: "service",
  enabled: true,
...
export const logistics_core_30_5_definition = {
  domain: "logistics-core",
  sequence: 35,
  capability: "service",
  enabled: true,
...
export const logistics_core_30_6_definition = {
  domain: "logistics-core",
  sequence: 36,
  capability: "service",
  enabled: true,
...
export const logistics_core_30_7_definition = {
  domain: "logistics-core",
  sequence: 37,
  capability: "service",
  enabled: true,
