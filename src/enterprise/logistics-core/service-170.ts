...
export const logistics_core_170_0_definition = {
...
export const logistics_core_170_1_definition = {
  domain: "logistics-core",
  sequence: 171,
  capability: "service",
  enabled: true,
...
export const logistics_core_170_2_definition = {
  domain: "logistics-core",
  sequence: 172,
  capability: "service",
  enabled: true,
...
export const logistics_core_170_3_definition = {
  domain: "logistics-core",
  sequence: 173,
  capability: "service",
  enabled: true,
...
export const logistics_core_170_4_definition = {
  domain: "logistics-core",
  sequence: 174,
  capability: "service",
  enabled: true,
...
export const logistics_core_170_5_definition = {
  domain: "logistics-core",
  sequence: 175,
  capability: "service",
  enabled: true,
...
export const logistics_core_170_6_definition = {
  domain: "logistics-core",
  sequence: 176,
  capability: "service",
  enabled: true,
...
export const logistics_core_170_7_definition = {
  domain: "logistics-core",
  sequence: 177,
  capability: "service",
  enabled: true,
