...
export const logistics_core_194_0_definition = {
...
export const logistics_core_194_1_definition = {
  domain: "logistics-core",
  sequence: 195,
  capability: "service",
  enabled: true,
...
export const logistics_core_194_2_definition = {
  domain: "logistics-core",
  sequence: 196,
  capability: "service",
  enabled: true,
...
export const logistics_core_194_3_definition = {
  domain: "logistics-core",
  sequence: 197,
  capability: "service",
  enabled: true,
...
export const logistics_core_194_4_definition = {
  domain: "logistics-core",
  sequence: 198,
  capability: "service",
  enabled: true,
...
export const logistics_core_194_5_definition = {
  domain: "logistics-core",
  sequence: 199,
  capability: "service",
  enabled: true,
...
export const logistics_core_194_6_definition = {
  domain: "logistics-core",
  sequence: 200,
  capability: "service",
  enabled: true,
...
export const logistics_core_194_7_definition = {
  domain: "logistics-core",
  sequence: 201,
  capability: "service",
  enabled: true,
