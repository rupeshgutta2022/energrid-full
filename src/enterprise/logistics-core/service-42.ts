...
export const logistics_core_42_0_definition = {
...
export const logistics_core_42_1_definition = {
  domain: "logistics-core",
  sequence: 43,
  capability: "service",
  enabled: true,
...
export const logistics_core_42_2_definition = {
  domain: "logistics-core",
  sequence: 44,
  capability: "service",
  enabled: true,
...
export const logistics_core_42_3_definition = {
  domain: "logistics-core",
  sequence: 45,
  capability: "service",
  enabled: true,
...
export const logistics_core_42_4_definition = {
  domain: "logistics-core",
  sequence: 46,
  capability: "service",
  enabled: true,
...
export const logistics_core_42_5_definition = {
  domain: "logistics-core",
  sequence: 47,
  capability: "service",
  enabled: true,
...
export const logistics_core_42_6_definition = {
  domain: "logistics-core",
  sequence: 48,
  capability: "service",
  enabled: true,
...
export const logistics_core_42_7_definition = {
  domain: "logistics-core",
  sequence: 49,
  capability: "service",
  enabled: true,
