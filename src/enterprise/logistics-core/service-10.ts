...
export const logistics_core_10_0_definition = {
...
export const logistics_core_10_1_definition = {
  domain: "logistics-core",
  sequence: 11,
  capability: "service",
  enabled: true,
...
export const logistics_core_10_2_definition = {
  domain: "logistics-core",
  sequence: 12,
  capability: "service",
  enabled: true,
...
export const logistics_core_10_3_definition = {
  domain: "logistics-core",
  sequence: 13,
  capability: "service",
  enabled: true,
...
export const logistics_core_10_4_definition = {
  domain: "logistics-core",
  sequence: 14,
  capability: "service",
  enabled: true,
...
export const logistics_core_10_5_definition = {
  domain: "logistics-core",
  sequence: 15,
  capability: "service",
  enabled: true,
...
export const logistics_core_10_6_definition = {
  domain: "logistics-core",
  sequence: 16,
  capability: "service",
  enabled: true,
...
export const logistics_core_10_7_definition = {
  domain: "logistics-core",
  sequence: 17,
  capability: "service",
  enabled: true,
