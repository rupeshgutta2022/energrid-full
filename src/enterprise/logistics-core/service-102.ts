...
export const logistics_core_102_0_definition = {
...
export const logistics_core_102_1_definition = {
  domain: "logistics-core",
  sequence: 103,
  capability: "service",
  enabled: true,
...
export const logistics_core_102_2_definition = {
  domain: "logistics-core",
  sequence: 104,
  capability: "service",
  enabled: true,
...
export const logistics_core_102_3_definition = {
  domain: "logistics-core",
  sequence: 105,
  capability: "service",
  enabled: true,
...
export const logistics_core_102_4_definition = {
  domain: "logistics-core",
  sequence: 106,
  capability: "service",
  enabled: true,
...
export const logistics_core_102_5_definition = {
  domain: "logistics-core",
  sequence: 107,
  capability: "service",
  enabled: true,
...
export const logistics_core_102_6_definition = {
  domain: "logistics-core",
  sequence: 108,
  capability: "service",
  enabled: true,
...
export const logistics_core_102_7_definition = {
  domain: "logistics-core",
  sequence: 109,
  capability: "service",
  enabled: true,
