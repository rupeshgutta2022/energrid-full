...
export const logistics_core_267_0_definition = {
...
export const logistics_core_267_1_definition = {
  domain: "logistics-core",
  sequence: 268,
  capability: "workflow",
  enabled: true,
...
export const logistics_core_267_2_definition = {
  domain: "logistics-core",
  sequence: 269,
  capability: "workflow",
  enabled: true,
...
export const logistics_core_267_3_definition = {
  domain: "logistics-core",
  sequence: 270,
  capability: "workflow",
  enabled: true,
...
export const logistics_core_267_4_definition = {
  domain: "logistics-core",
  sequence: 271,
  capability: "workflow",
  enabled: true,
