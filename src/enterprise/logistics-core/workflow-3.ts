...
export const logistics_core_3_0_definition = {
...
export const logistics_core_3_1_definition = {
  domain: "logistics-core",
  sequence: 4,
  capability: "workflow",
  enabled: true,
...
export const logistics_core_3_2_definition = {
  domain: "logistics-core",
  sequence: 5,
  capability: "workflow",
  enabled: true,
...
export const logistics_core_3_3_definition = {
  domain: "logistics-core",
  sequence: 6,
  capability: "workflow",
  enabled: true,
...
export const logistics_core_3_4_definition = {
  domain: "logistics-core",
  sequence: 7,
  capability: "workflow",
  enabled: true,
...
export const logistics_core_3_5_definition = {
  domain: "logistics-core",
  sequence: 8,
  capability: "workflow",
  enabled: true,
...
export const logistics_core_3_6_definition = {
  domain: "logistics-core",
  sequence: 9,
  capability: "workflow",
  enabled: true,
...
export const logistics_core_3_7_definition = {
  domain: "logistics-core",
  sequence: 10,
  capability: "workflow",
  enabled: true,
