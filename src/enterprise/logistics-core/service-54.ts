...
export const logistics_core_54_0_definition = {
...
export const logistics_core_54_1_definition = {
  domain: "logistics-core",
  sequence: 55,
  capability: "service",
  enabled: true,
...
export const logistics_core_54_2_definition = {
  domain: "logistics-core",
  sequence: 56,
  capability: "service",
  enabled: true,
...
export const logistics_core_54_3_definition = {
  domain: "logistics-core",
  sequence: 57,
  capability: "service",
  enabled: true,
...
export const logistics_core_54_4_definition = {
  domain: "logistics-core",
  sequence: 58,
  capability: "service",
  enabled: true,
...
export const logistics_core_54_5_definition = {
  domain: "logistics-core",
  sequence: 59,
  capability: "service",
  enabled: true,
...
export const logistics_core_54_6_definition = {
  domain: "logistics-core",
  sequence: 60,
  capability: "service",
  enabled: true,
...
export const logistics_core_54_7_definition = {
  domain: "logistics-core",
  sequence: 61,
  capability: "service",
  enabled: true,
