...
export const logistics_core_250_0_definition = {
...
export const logistics_core_250_1_definition = {
  domain: "logistics-core",
  sequence: 251,
  capability: "service",
  enabled: true,
...
export const logistics_core_250_2_definition = {
  domain: "logistics-core",
  sequence: 252,
  capability: "service",
  enabled: true,
...
export const logistics_core_250_3_definition = {
  domain: "logistics-core",
  sequence: 253,
  capability: "service",
  enabled: true,
...
export const logistics_core_250_4_definition = {
  domain: "logistics-core",
  sequence: 254,
  capability: "service",
  enabled: true,
...
export const logistics_core_250_5_definition = {
  domain: "logistics-core",
  sequence: 255,
  capability: "service",
  enabled: true,
...
export const logistics_core_250_6_definition = {
  domain: "logistics-core",
  sequence: 256,
  capability: "service",
  enabled: true,
...
export const logistics_core_250_7_definition = {
  domain: "logistics-core",
  sequence: 257,
  capability: "service",
  enabled: true,
