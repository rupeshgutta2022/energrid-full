...
export const logistics_core_263_0_definition = {
...
export const logistics_core_263_1_definition = {
  domain: "logistics-core",
  sequence: 264,
  capability: "workflow",
  enabled: true,
...
export const logistics_core_263_2_definition = {
  domain: "logistics-core",
  sequence: 265,
  capability: "workflow",
  enabled: true,
...
export const logistics_core_263_3_definition = {
  domain: "logistics-core",
  sequence: 266,
  capability: "workflow",
  enabled: true,
...
export const logistics_core_263_4_definition = {
  domain: "logistics-core",
  sequence: 267,
  capability: "workflow",
  enabled: true,
...
export const logistics_core_263_5_definition = {
  domain: "logistics-core",
  sequence: 268,
  capability: "workflow",
  enabled: true,
...
export const logistics_core_263_6_definition = {
  domain: "logistics-core",
  sequence: 269,
  capability: "workflow",
  enabled: true,
