...
export const logistics_core_106_0_definition = {
...
export const logistics_core_106_1_definition = {
  domain: "logistics-core",
  sequence: 107,
  capability: "service",
  enabled: true,
...
export const logistics_core_106_2_definition = {
  domain: "logistics-core",
  sequence: 108,
  capability: "service",
  enabled: true,
...
export const logistics_core_106_3_definition = {
  domain: "logistics-core",
  sequence: 109,
  capability: "service",
  enabled: true,
...
export const logistics_core_106_4_definition = {
  domain: "logistics-core",
  sequence: 110,
  capability: "service",
  enabled: true,
...
export const logistics_core_106_5_definition = {
  domain: "logistics-core",
  sequence: 111,
  capability: "service",
  enabled: true,
...
export const logistics_core_106_6_definition = {
  domain: "logistics-core",
  sequence: 112,
  capability: "service",
  enabled: true,
...
export const logistics_core_106_7_definition = {
  domain: "logistics-core",
  sequence: 113,
  capability: "service",
  enabled: true,
