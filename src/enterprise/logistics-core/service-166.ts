...
export const logistics_core_166_0_definition = {
...
export const logistics_core_166_1_definition = {
  domain: "logistics-core",
  sequence: 167,
  capability: "service",
  enabled: true,
...
export const logistics_core_166_2_definition = {
  domain: "logistics-core",
  sequence: 168,
  capability: "service",
  enabled: true,
...
export const logistics_core_166_3_definition = {
  domain: "logistics-core",
  sequence: 169,
  capability: "service",
  enabled: true,
...
export const logistics_core_166_4_definition = {
  domain: "logistics-core",
  sequence: 170,
  capability: "service",
  enabled: true,
...
export const logistics_core_166_5_definition = {
  domain: "logistics-core",
  sequence: 171,
  capability: "service",
  enabled: true,
...
export const logistics_core_166_6_definition = {
  domain: "logistics-core",
  sequence: 172,
  capability: "service",
  enabled: true,
...
export const logistics_core_166_7_definition = {
  domain: "logistics-core",
  sequence: 173,
  capability: "service",
  enabled: true,
