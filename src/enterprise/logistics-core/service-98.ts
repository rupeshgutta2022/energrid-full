...
export const logistics_core_98_0_definition = {
...
export const logistics_core_98_1_definition = {
  domain: "logistics-core",
  sequence: 99,
  capability: "service",
  enabled: true,
...
export const logistics_core_98_2_definition = {
  domain: "logistics-core",
  sequence: 100,
  capability: "service",
  enabled: true,
...
export const logistics_core_98_3_definition = {
  domain: "logistics-core",
  sequence: 101,
  capability: "service",
  enabled: true,
...
export const logistics_core_98_4_definition = {
  domain: "logistics-core",
  sequence: 102,
  capability: "service",
  enabled: true,
...
export const logistics_core_98_5_definition = {
  domain: "logistics-core",
  sequence: 103,
  capability: "service",
  enabled: true,
...
export const logistics_core_98_6_definition = {
  domain: "logistics-core",
  sequence: 104,
  capability: "service",
  enabled: true,
...
export const logistics_core_98_7_definition = {
  domain: "logistics-core",
  sequence: 105,
  capability: "service",
  enabled: true,
