...
export const logistics_core_18_0_definition = {
...
export const logistics_core_18_1_definition = {
  domain: "logistics-core",
  sequence: 19,
  capability: "service",
  enabled: true,
...
export const logistics_core_18_2_definition = {
  domain: "logistics-core",
  sequence: 20,
  capability: "service",
  enabled: true,
...
export const logistics_core_18_3_definition = {
  domain: "logistics-core",
  sequence: 21,
  capability: "service",
  enabled: true,
...
export const logistics_core_18_4_definition = {
  domain: "logistics-core",
  sequence: 22,
  capability: "service",
  enabled: true,
...
export const logistics_core_18_5_definition = {
  domain: "logistics-core",
  sequence: 23,
  capability: "service",
  enabled: true,
...
export const logistics_core_18_6_definition = {
  domain: "logistics-core",
  sequence: 24,
  capability: "service",
  enabled: true,
...
export const logistics_core_18_7_definition = {
  domain: "logistics-core",
  sequence: 25,
  capability: "service",
  enabled: true,
