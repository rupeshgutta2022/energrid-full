...
export const logistics_core_7_0_definition = {
...
export const logistics_core_7_1_definition = {
  domain: "logistics-core",
  sequence: 8,
  capability: "workflow",
  enabled: true,
...
export const logistics_core_7_2_definition = {
  domain: "logistics-core",
  sequence: 9,
  capability: "workflow",
  enabled: true,
...
export const logistics_core_7_3_definition = {
  domain: "logistics-core",
  sequence: 10,
  capability: "workflow",
  enabled: true,
...
export const logistics_core_7_4_definition = {
  domain: "logistics-core",
  sequence: 11,
  capability: "workflow",
  enabled: true,
...
export const logistics_core_7_5_definition = {
  domain: "logistics-core",
  sequence: 12,
  capability: "workflow",
  enabled: true,
...
export const logistics_core_7_6_definition = {
  domain: "logistics-core",
  sequence: 13,
  capability: "workflow",
  enabled: true,
...
export const logistics_core_7_7_definition = {
  domain: "logistics-core",
  sequence: 14,
  capability: "workflow",
  enabled: true,
