...
export const logistics_core_62_0_definition = {
...
export const logistics_core_62_1_definition = {
  domain: "logistics-core",
  sequence: 63,
  capability: "service",
  enabled: true,
...
export const logistics_core_62_2_definition = {
  domain: "logistics-core",
  sequence: 64,
  capability: "service",
  enabled: true,
...
export const logistics_core_62_3_definition = {
  domain: "logistics-core",
  sequence: 65,
  capability: "service",
  enabled: true,
...
export const logistics_core_62_4_definition = {
  domain: "logistics-core",
  sequence: 66,
  capability: "service",
  enabled: true,
...
export const logistics_core_62_5_definition = {
  domain: "logistics-core",
  sequence: 67,
  capability: "service",
  enabled: true,
...
export const logistics_core_62_6_definition = {
  domain: "logistics-core",
  sequence: 68,
  capability: "service",
  enabled: true,
...
export const logistics_core_62_7_definition = {
  domain: "logistics-core",
  sequence: 69,
  capability: "service",
  enabled: true,
