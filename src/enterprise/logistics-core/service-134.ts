...
export const logistics_core_134_0_definition = {
...
export const logistics_core_134_1_definition = {
  domain: "logistics-core",
  sequence: 135,
  capability: "service",
  enabled: true,
...
export const logistics_core_134_2_definition = {
  domain: "logistics-core",
  sequence: 136,
  capability: "service",
  enabled: true,
...
export const logistics_core_134_3_definition = {
  domain: "logistics-core",
  sequence: 137,
  capability: "service",
  enabled: true,
...
export const logistics_core_134_4_definition = {
  domain: "logistics-core",
  sequence: 138,
  capability: "service",
  enabled: true,
...
export const logistics_core_134_5_definition = {
  domain: "logistics-core",
  sequence: 139,
  capability: "service",
  enabled: true,
...
export const logistics_core_134_6_definition = {
  domain: "logistics-core",
  sequence: 140,
  capability: "service",
  enabled: true,
...
export const logistics_core_134_7_definition = {
  domain: "logistics-core",
  sequence: 141,
  capability: "service",
  enabled: true,
