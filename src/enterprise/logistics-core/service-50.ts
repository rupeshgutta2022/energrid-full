...
export const logistics_core_50_0_definition = {
...
export const logistics_core_50_1_definition = {
  domain: "logistics-core",
  sequence: 51,
  capability: "service",
  enabled: true,
...
export const logistics_core_50_2_definition = {
  domain: "logistics-core",
  sequence: 52,
  capability: "service",
  enabled: true,
...
export const logistics_core_50_3_definition = {
  domain: "logistics-core",
  sequence: 53,
  capability: "service",
  enabled: true,
...
export const logistics_core_50_4_definition = {
  domain: "logistics-core",
  sequence: 54,
  capability: "service",
  enabled: true,
...
export const logistics_core_50_5_definition = {
  domain: "logistics-core",
  sequence: 55,
  capability: "service",
  enabled: true,
...
export const logistics_core_50_6_definition = {
  domain: "logistics-core",
  sequence: 56,
  capability: "service",
  enabled: true,
...
export const logistics_core_50_7_definition = {
  domain: "logistics-core",
  sequence: 57,
  capability: "service",
  enabled: true,
