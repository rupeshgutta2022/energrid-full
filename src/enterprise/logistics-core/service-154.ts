...
export const logistics_core_154_0_definition = {
...
export const logistics_core_154_1_definition = {
  domain: "logistics-core",
  sequence: 155,
  capability: "service",
  enabled: true,
...
export const logistics_core_154_2_definition = {
  domain: "logistics-core",
  sequence: 156,
  capability: "service",
  enabled: true,
...
export const logistics_core_154_3_definition = {
  domain: "logistics-core",
  sequence: 157,
  capability: "service",
  enabled: true,
...
export const logistics_core_154_4_definition = {
  domain: "logistics-core",
  sequence: 158,
  capability: "service",
  enabled: true,
...
export const logistics_core_154_5_definition = {
  domain: "logistics-core",
  sequence: 159,
  capability: "service",
  enabled: true,
...
export const logistics_core_154_6_definition = {
  domain: "logistics-core",
  sequence: 160,
  capability: "service",
  enabled: true,
...
export const logistics_core_154_7_definition = {
  domain: "logistics-core",
  sequence: 161,
  capability: "service",
  enabled: true,
