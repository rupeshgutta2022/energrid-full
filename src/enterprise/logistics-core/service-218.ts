...
export const logistics_core_218_0_definition = {
...
export const logistics_core_218_1_definition = {
  domain: "logistics-core",
  sequence: 219,
  capability: "service",
  enabled: true,
...
export const logistics_core_218_2_definition = {
  domain: "logistics-core",
  sequence: 220,
  capability: "service",
  enabled: true,
...
export const logistics_core_218_3_definition = {
  domain: "logistics-core",
  sequence: 221,
  capability: "service",
  enabled: true,
...
export const logistics_core_218_4_definition = {
  domain: "logistics-core",
  sequence: 222,
  capability: "service",
  enabled: true,
...
export const logistics_core_218_5_definition = {
  domain: "logistics-core",
  sequence: 223,
  capability: "service",
  enabled: true,
...
export const logistics_core_218_6_definition = {
  domain: "logistics-core",
  sequence: 224,
  capability: "service",
  enabled: true,
...
export const logistics_core_218_7_definition = {
  domain: "logistics-core",
  sequence: 225,
  capability: "service",
  enabled: true,
