...
export const logistics_core_38_0_definition = {
...
export const logistics_core_38_1_definition = {
  domain: "logistics-core",
  sequence: 39,
  capability: "service",
  enabled: true,
...
export const logistics_core_38_2_definition = {
  domain: "logistics-core",
  sequence: 40,
  capability: "service",
  enabled: true,
...
export const logistics_core_38_3_definition = {
  domain: "logistics-core",
  sequence: 41,
  capability: "service",
  enabled: true,
...
export const logistics_core_38_4_definition = {
  domain: "logistics-core",
  sequence: 42,
  capability: "service",
  enabled: true,
...
export const logistics_core_38_5_definition = {
  domain: "logistics-core",
  sequence: 43,
  capability: "service",
  enabled: true,
...
export const logistics_core_38_6_definition = {
  domain: "logistics-core",
  sequence: 44,
  capability: "service",
  enabled: true,
...
export const logistics_core_38_7_definition = {
  domain: "logistics-core",
  sequence: 45,
  capability: "service",
  enabled: true,
