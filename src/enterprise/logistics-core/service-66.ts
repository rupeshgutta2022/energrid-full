...
export const logistics_core_66_0_definition = {
...
export const logistics_core_66_1_definition = {
  domain: "logistics-core",
  sequence: 67,
  capability: "service",
  enabled: true,
...
export const logistics_core_66_2_definition = {
  domain: "logistics-core",
  sequence: 68,
  capability: "service",
  enabled: true,
...
export const logistics_core_66_3_definition = {
  domain: "logistics-core",
  sequence: 69,
  capability: "service",
  enabled: true,
...
export const logistics_core_66_4_definition = {
  domain: "logistics-core",
  sequence: 70,
  capability: "service",
  enabled: true,
...
export const logistics_core_66_5_definition = {
  domain: "logistics-core",
  sequence: 71,
  capability: "service",
  enabled: true,
...
export const logistics_core_66_6_definition = {
  domain: "logistics-core",
  sequence: 72,
  capability: "service",
  enabled: true,
...
export const logistics_core_66_7_definition = {
  domain: "logistics-core",
  sequence: 73,
  capability: "service",
  enabled: true,
