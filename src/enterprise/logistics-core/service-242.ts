...
export const logistics_core_242_0_definition = {
...
export const logistics_core_242_1_definition = {
  domain: "logistics-core",
  sequence: 243,
  capability: "service",
  enabled: true,
...
export const logistics_core_242_2_definition = {
  domain: "logistics-core",
  sequence: 244,
  capability: "service",
  enabled: true,
...
export const logistics_core_242_3_definition = {
  domain: "logistics-core",
  sequence: 245,
  capability: "service",
  enabled: true,
...
export const logistics_core_242_4_definition = {
  domain: "logistics-core",
  sequence: 246,
  capability: "service",
  enabled: true,
...
export const logistics_core_242_5_definition = {
  domain: "logistics-core",
  sequence: 247,
  capability: "service",
  enabled: true,
...
export const logistics_core_242_6_definition = {
  domain: "logistics-core",
  sequence: 248,
  capability: "service",
  enabled: true,
...
export const logistics_core_242_7_definition = {
  domain: "logistics-core",
  sequence: 249,
  capability: "service",
  enabled: true,
