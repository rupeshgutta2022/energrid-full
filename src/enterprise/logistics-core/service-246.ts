...
export const logistics_core_246_0_definition = {
...
export const logistics_core_246_1_definition = {
  domain: "logistics-core",
  sequence: 247,
  capability: "service",
  enabled: true,
...
export const logistics_core_246_2_definition = {
  domain: "logistics-core",
  sequence: 248,
  capability: "service",
  enabled: true,
...
export const logistics_core_246_3_definition = {
  domain: "logistics-core",
  sequence: 249,
  capability: "service",
  enabled: true,
...
export const logistics_core_246_4_definition = {
  domain: "logistics-core",
  sequence: 250,
  capability: "service",
  enabled: true,
...
export const logistics_core_246_5_definition = {
  domain: "logistics-core",
  sequence: 251,
  capability: "service",
  enabled: true,
...
export const logistics_core_246_6_definition = {
  domain: "logistics-core",
  sequence: 252,
  capability: "service",
  enabled: true,
...
export const logistics_core_246_7_definition = {
  domain: "logistics-core",
  sequence: 253,
  capability: "service",
  enabled: true,
