...
export const logistics_core_226_0_definition = {
...
export const logistics_core_226_1_definition = {
  domain: "logistics-core",
  sequence: 227,
  capability: "service",
  enabled: true,
...
export const logistics_core_226_2_definition = {
  domain: "logistics-core",
  sequence: 228,
  capability: "service",
  enabled: true,
...
export const logistics_core_226_3_definition = {
  domain: "logistics-core",
  sequence: 229,
  capability: "service",
  enabled: true,
...
export const logistics_core_226_4_definition = {
  domain: "logistics-core",
  sequence: 230,
  capability: "service",
  enabled: true,
...
export const logistics_core_226_5_definition = {
  domain: "logistics-core",
  sequence: 231,
  capability: "service",
  enabled: true,
...
export const logistics_core_226_6_definition = {
  domain: "logistics-core",
  sequence: 232,
  capability: "service",
  enabled: true,
...
export const logistics_core_226_7_definition = {
  domain: "logistics-core",
  sequence: 233,
  capability: "service",
  enabled: true,
