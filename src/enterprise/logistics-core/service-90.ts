...
export const logistics_core_90_0_definition = {
...
export const logistics_core_90_1_definition = {
  domain: "logistics-core",
  sequence: 91,
  capability: "service",
  enabled: true,
...
export const logistics_core_90_2_definition = {
  domain: "logistics-core",
  sequence: 92,
  capability: "service",
  enabled: true,
...
export const logistics_core_90_3_definition = {
  domain: "logistics-core",
  sequence: 93,
  capability: "service",
  enabled: true,
...
export const logistics_core_90_4_definition = {
  domain: "logistics-core",
  sequence: 94,
  capability: "service",
  enabled: true,
...
export const logistics_core_90_5_definition = {
  domain: "logistics-core",
  sequence: 95,
  capability: "service",
  enabled: true,
...
export const logistics_core_90_6_definition = {
  domain: "logistics-core",
  sequence: 96,
  capability: "service",
  enabled: true,
...
export const logistics_core_90_7_definition = {
  domain: "logistics-core",
  sequence: 97,
  capability: "service",
  enabled: true,
