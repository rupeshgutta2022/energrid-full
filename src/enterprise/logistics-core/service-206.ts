...
export const logistics_core_206_0_definition = {
...
export const logistics_core_206_1_definition = {
  domain: "logistics-core",
  sequence: 207,
  capability: "service",
  enabled: true,
...
export const logistics_core_206_2_definition = {
  domain: "logistics-core",
  sequence: 208,
  capability: "service",
  enabled: true,
...
export const logistics_core_206_3_definition = {
  domain: "logistics-core",
  sequence: 209,
  capability: "service",
  enabled: true,
...
export const logistics_core_206_4_definition = {
  domain: "logistics-core",
  sequence: 210,
  capability: "service",
  enabled: true,
...
export const logistics_core_206_5_definition = {
  domain: "logistics-core",
  sequence: 211,
  capability: "service",
  enabled: true,
...
export const logistics_core_206_6_definition = {
  domain: "logistics-core",
  sequence: 212,
  capability: "service",
  enabled: true,
...
export const logistics_core_206_7_definition = {
  domain: "logistics-core",
  sequence: 213,
  capability: "service",
  enabled: true,
