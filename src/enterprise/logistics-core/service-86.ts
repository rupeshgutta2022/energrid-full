...
export const logistics_core_86_0_definition = {
...
export const logistics_core_86_1_definition = {
  domain: "logistics-core",
  sequence: 87,
  capability: "service",
  enabled: true,
...
export const logistics_core_86_2_definition = {
  domain: "logistics-core",
  sequence: 88,
  capability: "service",
  enabled: true,
...
export const logistics_core_86_3_definition = {
  domain: "logistics-core",
  sequence: 89,
  capability: "service",
  enabled: true,
...
export const logistics_core_86_4_definition = {
  domain: "logistics-core",
  sequence: 90,
  capability: "service",
  enabled: true,
...
export const logistics_core_86_5_definition = {
  domain: "logistics-core",
  sequence: 91,
  capability: "service",
  enabled: true,
...
export const logistics_core_86_6_definition = {
  domain: "logistics-core",
  sequence: 92,
  capability: "service",
  enabled: true,
...
export const logistics_core_86_7_definition = {
  domain: "logistics-core",
  sequence: 93,
  capability: "service",
  enabled: true,
