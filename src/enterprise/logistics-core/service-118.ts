...
export const logistics_core_118_0_definition = {
...
export const logistics_core_118_1_definition = {
  domain: "logistics-core",
  sequence: 119,
  capability: "service",
  enabled: true,
...
export const logistics_core_118_2_definition = {
  domain: "logistics-core",
  sequence: 120,
  capability: "service",
  enabled: true,
...
export const logistics_core_118_3_definition = {
  domain: "logistics-core",
  sequence: 121,
  capability: "service",
  enabled: true,
...
export const logistics_core_118_4_definition = {
  domain: "logistics-core",
  sequence: 122,
  capability: "service",
  enabled: true,
...
export const logistics_core_118_5_definition = {
  domain: "logistics-core",
  sequence: 123,
  capability: "service",
  enabled: true,
...
export const logistics_core_118_6_definition = {
  domain: "logistics-core",
  sequence: 124,
  capability: "service",
  enabled: true,
...
export const logistics_core_118_7_definition = {
  domain: "logistics-core",
  sequence: 125,
  capability: "service",
  enabled: true,
