...
export const logistics_core_94_0_definition = {
...
export const logistics_core_94_1_definition = {
  domain: "logistics-core",
  sequence: 95,
  capability: "service",
  enabled: true,
...
export const logistics_core_94_2_definition = {
  domain: "logistics-core",
  sequence: 96,
  capability: "service",
  enabled: true,
...
export const logistics_core_94_3_definition = {
  domain: "logistics-core",
  sequence: 97,
  capability: "service",
  enabled: true,
...
export const logistics_core_94_4_definition = {
  domain: "logistics-core",
  sequence: 98,
  capability: "service",
  enabled: true,
...
export const logistics_core_94_5_definition = {
  domain: "logistics-core",
  sequence: 99,
  capability: "service",
  enabled: true,
...
export const logistics_core_94_6_definition = {
  domain: "logistics-core",
  sequence: 100,
  capability: "service",
  enabled: true,
...
export const logistics_core_94_7_definition = {
  domain: "logistics-core",
  sequence: 101,
  capability: "service",
  enabled: true,
