...
export const logistics_core_14_0_definition = {
...
export const logistics_core_14_1_definition = {
  domain: "logistics-core",
  sequence: 15,
  capability: "service",
  enabled: true,
...
export const logistics_core_14_2_definition = {
  domain: "logistics-core",
  sequence: 16,
  capability: "service",
  enabled: true,
...
export const logistics_core_14_3_definition = {
  domain: "logistics-core",
  sequence: 17,
  capability: "service",
  enabled: true,
...
export const logistics_core_14_4_definition = {
  domain: "logistics-core",
  sequence: 18,
  capability: "service",
  enabled: true,
...
export const logistics_core_14_5_definition = {
  domain: "logistics-core",
  sequence: 19,
  capability: "service",
  enabled: true,
...
export const logistics_core_14_6_definition = {
  domain: "logistics-core",
  sequence: 20,
  capability: "service",
  enabled: true,
...
export const logistics_core_14_7_definition = {
  domain: "logistics-core",
  sequence: 21,
  capability: "service",
  enabled: true,
