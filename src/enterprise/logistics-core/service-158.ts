...
export const logistics_core_158_0_definition = {
...
export const logistics_core_158_1_definition = {
  domain: "logistics-core",
  sequence: 159,
  capability: "service",
  enabled: true,
...
export const logistics_core_158_2_definition = {
  domain: "logistics-core",
  sequence: 160,
  capability: "service",
  enabled: true,
...
export const logistics_core_158_3_definition = {
  domain: "logistics-core",
  sequence: 161,
  capability: "service",
  enabled: true,
...
export const logistics_core_158_4_definition = {
  domain: "logistics-core",
  sequence: 162,
  capability: "service",
  enabled: true,
...
export const logistics_core_158_5_definition = {
  domain: "logistics-core",
  sequence: 163,
  capability: "service",
  enabled: true,
...
export const logistics_core_158_6_definition = {
  domain: "logistics-core",
  sequence: 164,
  capability: "service",
  enabled: true,
...
export const logistics_core_158_7_definition = {
  domain: "logistics-core",
  sequence: 165,
  capability: "service",
  enabled: true,
