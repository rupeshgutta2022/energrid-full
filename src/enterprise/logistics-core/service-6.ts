...
export const logistics_core_6_0_definition = {
...
export const logistics_core_6_1_definition = {
  domain: "logistics-core",
  sequence: 7,
  capability: "service",
  enabled: true,
...
export const logistics_core_6_2_definition = {
  domain: "logistics-core",
  sequence: 8,
  capability: "service",
  enabled: true,
...
export const logistics_core_6_3_definition = {
  domain: "logistics-core",
  sequence: 9,
  capability: "service",
  enabled: true,
...
export const logistics_core_6_4_definition = {
  domain: "logistics-core",
  sequence: 10,
  capability: "service",
  enabled: true,
...
export const logistics_core_6_5_definition = {
  domain: "logistics-core",
  sequence: 11,
  capability: "service",
  enabled: true,
...
export const logistics_core_6_6_definition = {
  domain: "logistics-core",
  sequence: 12,
  capability: "service",
  enabled: true,
...
export const logistics_core_6_7_definition = {
  domain: "logistics-core",
  sequence: 13,
  capability: "service",
  enabled: true,
