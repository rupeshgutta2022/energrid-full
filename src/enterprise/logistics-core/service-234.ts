...
export const logistics_core_234_0_definition = {
...
export const logistics_core_234_1_definition = {
  domain: "logistics-core",
  sequence: 235,
  capability: "service",
  enabled: true,
...
export const logistics_core_234_2_definition = {
  domain: "logistics-core",
  sequence: 236,
  capability: "service",
  enabled: true,
...
export const logistics_core_234_3_definition = {
  domain: "logistics-core",
  sequence: 237,
  capability: "service",
  enabled: true,
...
export const logistics_core_234_4_definition = {
  domain: "logistics-core",
  sequence: 238,
  capability: "service",
  enabled: true,
...
export const logistics_core_234_5_definition = {
  domain: "logistics-core",
  sequence: 239,
  capability: "service",
  enabled: true,
...
export const logistics_core_234_6_definition = {
  domain: "logistics-core",
  sequence: 240,
  capability: "service",
  enabled: true,
...
export const logistics_core_234_7_definition = {
  domain: "logistics-core",
  sequence: 241,
  capability: "service",
  enabled: true,
