...
export const logistics_core_174_0_definition = {
...
export const logistics_core_174_1_definition = {
  domain: "logistics-core",
  sequence: 175,
  capability: "service",
  enabled: true,
...
export const logistics_core_174_2_definition = {
  domain: "logistics-core",
  sequence: 176,
  capability: "service",
  enabled: true,
...
export const logistics_core_174_3_definition = {
  domain: "logistics-core",
  sequence: 177,
  capability: "service",
  enabled: true,
...
export const logistics_core_174_4_definition = {
  domain: "logistics-core",
  sequence: 178,
  capability: "service",
  enabled: true,
...
export const logistics_core_174_5_definition = {
  domain: "logistics-core",
  sequence: 179,
  capability: "service",
  enabled: true,
...
export const logistics_core_174_6_definition = {
  domain: "logistics-core",
  sequence: 180,
  capability: "service",
  enabled: true,
...
export const logistics_core_174_7_definition = {
  domain: "logistics-core",
  sequence: 181,
  capability: "service",
  enabled: true,
