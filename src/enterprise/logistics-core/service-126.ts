...
export const logistics_core_126_0_definition = {
...
export const logistics_core_126_1_definition = {
  domain: "logistics-core",
  sequence: 127,
  capability: "service",
  enabled: true,
...
export const logistics_core_126_2_definition = {
  domain: "logistics-core",
  sequence: 128,
  capability: "service",
  enabled: true,
...
export const logistics_core_126_3_definition = {
  domain: "logistics-core",
  sequence: 129,
  capability: "service",
  enabled: true,
...
export const logistics_core_126_4_definition = {
  domain: "logistics-core",
  sequence: 130,
  capability: "service",
  enabled: true,
...
export const logistics_core_126_5_definition = {
  domain: "logistics-core",
  sequence: 131,
  capability: "service",
  enabled: true,
...
export const logistics_core_126_6_definition = {
  domain: "logistics-core",
  sequence: 132,
  capability: "service",
  enabled: true,
...
export const logistics_core_126_7_definition = {
  domain: "logistics-core",
  sequence: 133,
  capability: "service",
  enabled: true,
