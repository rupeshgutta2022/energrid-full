...
export const logistics_core_182_0_definition = {
...
export const logistics_core_182_1_definition = {
  domain: "logistics-core",
  sequence: 183,
  capability: "service",
  enabled: true,
...
export const logistics_core_182_2_definition = {
  domain: "logistics-core",
  sequence: 184,
  capability: "service",
  enabled: true,
...
export const logistics_core_182_3_definition = {
  domain: "logistics-core",
  sequence: 185,
  capability: "service",
  enabled: true,
...
export const logistics_core_182_4_definition = {
  domain: "logistics-core",
  sequence: 186,
  capability: "service",
  enabled: true,
...
export const logistics_core_182_5_definition = {
  domain: "logistics-core",
  sequence: 187,
  capability: "service",
  enabled: true,
...
export const logistics_core_182_6_definition = {
  domain: "logistics-core",
  sequence: 188,
  capability: "service",
  enabled: true,
...
export const logistics_core_182_7_definition = {
  domain: "logistics-core",
  sequence: 189,
  capability: "service",
  enabled: true,
