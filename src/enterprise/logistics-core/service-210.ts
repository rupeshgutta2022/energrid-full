...
export const logistics_core_210_0_definition = {
...
export const logistics_core_210_1_definition = {
  domain: "logistics-core",
  sequence: 211,
  capability: "service",
  enabled: true,
...
export const logistics_core_210_2_definition = {
  domain: "logistics-core",
  sequence: 212,
  capability: "service",
  enabled: true,
...
export const logistics_core_210_3_definition = {
  domain: "logistics-core",
  sequence: 213,
  capability: "service",
  enabled: true,
...
export const logistics_core_210_4_definition = {
  domain: "logistics-core",
  sequence: 214,
  capability: "service",
  enabled: true,
...
export const logistics_core_210_5_definition = {
  domain: "logistics-core",
  sequence: 215,
  capability: "service",
  enabled: true,
...
export const logistics_core_210_6_definition = {
  domain: "logistics-core",
  sequence: 216,
  capability: "service",
  enabled: true,
...
export const logistics_core_210_7_definition = {
  domain: "logistics-core",
  sequence: 217,
  capability: "service",
  enabled: true,
