...
export const logistics_core_142_0_definition = {
...
export const logistics_core_142_1_definition = {
  domain: "logistics-core",
  sequence: 143,
  capability: "service",
  enabled: true,
...
export const logistics_core_142_2_definition = {
  domain: "logistics-core",
  sequence: 144,
  capability: "service",
  enabled: true,
...
export const logistics_core_142_3_definition = {
  domain: "logistics-core",
  sequence: 145,
  capability: "service",
  enabled: true,
...
export const logistics_core_142_4_definition = {
  domain: "logistics-core",
  sequence: 146,
  capability: "service",
  enabled: true,
...
export const logistics_core_142_5_definition = {
  domain: "logistics-core",
  sequence: 147,
  capability: "service",
  enabled: true,
...
export const logistics_core_142_6_definition = {
  domain: "logistics-core",
  sequence: 148,
  capability: "service",
  enabled: true,
...
export const logistics_core_142_7_definition = {
  domain: "logistics-core",
  sequence: 149,
  capability: "service",
  enabled: true,
