...
export const logistics_core_262_0_definition = {
...
export const logistics_core_262_1_definition = {
  domain: "logistics-core",
  sequence: 263,
  capability: "service",
  enabled: true,
...
export const logistics_core_262_2_definition = {
  domain: "logistics-core",
  sequence: 264,
  capability: "service",
  enabled: true,
...
export const logistics_core_262_3_definition = {
  domain: "logistics-core",
  sequence: 265,
  capability: "service",
  enabled: true,
...
export const logistics_core_262_4_definition = {
  domain: "logistics-core",
  sequence: 266,
  capability: "service",
  enabled: true,
...
export const logistics_core_262_5_definition = {
  domain: "logistics-core",
  sequence: 267,
  capability: "service",
  enabled: true,
