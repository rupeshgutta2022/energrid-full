...
export const logistics_core_222_0_definition = {
...
export const logistics_core_222_1_definition = {
  domain: "logistics-core",
  sequence: 223,
  capability: "service",
  enabled: true,
...
export const logistics_core_222_2_definition = {
  domain: "logistics-core",
  sequence: 224,
  capability: "service",
  enabled: true,
...
export const logistics_core_222_3_definition = {
  domain: "logistics-core",
  sequence: 225,
  capability: "service",
  enabled: true,
...
export const logistics_core_222_4_definition = {
  domain: "logistics-core",
  sequence: 226,
  capability: "service",
  enabled: true,
...
export const logistics_core_222_5_definition = {
  domain: "logistics-core",
  sequence: 227,
  capability: "service",
  enabled: true,
...
export const logistics_core_222_6_definition = {
  domain: "logistics-core",
  sequence: 228,
  capability: "service",
  enabled: true,
...
export const logistics_core_222_7_definition = {
  domain: "logistics-core",
  sequence: 229,
  capability: "service",
  enabled: true,
