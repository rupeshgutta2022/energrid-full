...
export const logistics_core_190_0_definition = {
...
export const logistics_core_190_1_definition = {
  domain: "logistics-core",
  sequence: 191,
  capability: "service",
  enabled: true,
...
export const logistics_core_190_2_definition = {
  domain: "logistics-core",
  sequence: 192,
  capability: "service",
  enabled: true,
...
export const logistics_core_190_3_definition = {
  domain: "logistics-core",
  sequence: 193,
  capability: "service",
  enabled: true,
...
export const logistics_core_190_4_definition = {
  domain: "logistics-core",
  sequence: 194,
  capability: "service",
  enabled: true,
...
export const logistics_core_190_5_definition = {
  domain: "logistics-core",
  sequence: 195,
  capability: "service",
  enabled: true,
...
export const logistics_core_190_6_definition = {
  domain: "logistics-core",
  sequence: 196,
  capability: "service",
  enabled: true,
...
export const logistics_core_190_7_definition = {
  domain: "logistics-core",
  sequence: 197,
  capability: "service",
  enabled: true,
