...
export const logistics_core_74_0_definition = {
...
export const logistics_core_74_1_definition = {
  domain: "logistics-core",
  sequence: 75,
  capability: "service",
  enabled: true,
...
export const logistics_core_74_2_definition = {
  domain: "logistics-core",
  sequence: 76,
  capability: "service",
  enabled: true,
...
export const logistics_core_74_3_definition = {
  domain: "logistics-core",
  sequence: 77,
  capability: "service",
  enabled: true,
...
export const logistics_core_74_4_definition = {
  domain: "logistics-core",
  sequence: 78,
  capability: "service",
  enabled: true,
...
export const logistics_core_74_5_definition = {
  domain: "logistics-core",
  sequence: 79,
  capability: "service",
  enabled: true,
...
export const logistics_core_74_6_definition = {
  domain: "logistics-core",
  sequence: 80,
  capability: "service",
  enabled: true,
...
export const logistics_core_74_7_definition = {
  domain: "logistics-core",
  sequence: 81,
  capability: "service",
  enabled: true,
