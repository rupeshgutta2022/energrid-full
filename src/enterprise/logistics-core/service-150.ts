...
export const logistics_core_150_0_definition = {
...
export const logistics_core_150_1_definition = {
  domain: "logistics-core",
  sequence: 151,
  capability: "service",
  enabled: true,
...
export const logistics_core_150_2_definition = {
  domain: "logistics-core",
  sequence: 152,
  capability: "service",
  enabled: true,
...
export const logistics_core_150_3_definition = {
  domain: "logistics-core",
  sequence: 153,
  capability: "service",
  enabled: true,
...
export const logistics_core_150_4_definition = {
  domain: "logistics-core",
  sequence: 154,
  capability: "service",
  enabled: true,
...
export const logistics_core_150_5_definition = {
  domain: "logistics-core",
  sequence: 155,
  capability: "service",
  enabled: true,
...
export const logistics_core_150_6_definition = {
  domain: "logistics-core",
  sequence: 156,
  capability: "service",
  enabled: true,
...
export const logistics_core_150_7_definition = {
  domain: "logistics-core",
  sequence: 157,
  capability: "service",
  enabled: true,
