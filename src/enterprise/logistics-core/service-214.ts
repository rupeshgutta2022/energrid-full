...
export const logistics_core_214_0_definition = {
...
export const logistics_core_214_1_definition = {
  domain: "logistics-core",
  sequence: 215,
  capability: "service",
  enabled: true,
...
export const logistics_core_214_2_definition = {
  domain: "logistics-core",
  sequence: 216,
  capability: "service",
  enabled: true,
...
export const logistics_core_214_3_definition = {
  domain: "logistics-core",
  sequence: 217,
  capability: "service",
  enabled: true,
...
export const logistics_core_214_4_definition = {
  domain: "logistics-core",
  sequence: 218,
  capability: "service",
  enabled: true,
...
export const logistics_core_214_5_definition = {
  domain: "logistics-core",
  sequence: 219,
  capability: "service",
  enabled: true,
...
export const logistics_core_214_6_definition = {
  domain: "logistics-core",
  sequence: 220,
  capability: "service",
  enabled: true,
...
export const logistics_core_214_7_definition = {
  domain: "logistics-core",
  sequence: 221,
  capability: "service",
  enabled: true,
