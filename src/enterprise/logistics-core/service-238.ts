...
export const logistics_core_238_0_definition = {
...
export const logistics_core_238_1_definition = {
  domain: "logistics-core",
  sequence: 239,
  capability: "service",
  enabled: true,
...
export const logistics_core_238_2_definition = {
  domain: "logistics-core",
  sequence: 240,
  capability: "service",
  enabled: true,
...
export const logistics_core_238_3_definition = {
  domain: "logistics-core",
  sequence: 241,
  capability: "service",
  enabled: true,
...
export const logistics_core_238_4_definition = {
  domain: "logistics-core",
  sequence: 242,
  capability: "service",
  enabled: true,
...
export const logistics_core_238_5_definition = {
  domain: "logistics-core",
  sequence: 243,
  capability: "service",
  enabled: true,
...
export const logistics_core_238_6_definition = {
  domain: "logistics-core",
  sequence: 244,
  capability: "service",
  enabled: true,
...
export const logistics_core_238_7_definition = {
  domain: "logistics-core",
  sequence: 245,
  capability: "service",
  enabled: true,
