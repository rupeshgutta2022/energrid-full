...
export const logistics_core_186_0_definition = {
...
export const logistics_core_186_1_definition = {
  domain: "logistics-core",
  sequence: 187,
  capability: "service",
  enabled: true,
...
export const logistics_core_186_2_definition = {
  domain: "logistics-core",
  sequence: 188,
  capability: "service",
  enabled: true,
...
export const logistics_core_186_3_definition = {
  domain: "logistics-core",
  sequence: 189,
  capability: "service",
  enabled: true,
...
export const logistics_core_186_4_definition = {
  domain: "logistics-core",
  sequence: 190,
  capability: "service",
  enabled: true,
...
export const logistics_core_186_5_definition = {
  domain: "logistics-core",
  sequence: 191,
  capability: "service",
  enabled: true,
...
export const logistics_core_186_6_definition = {
  domain: "logistics-core",
  sequence: 192,
  capability: "service",
  enabled: true,
...
export const logistics_core_186_7_definition = {
  domain: "logistics-core",
  sequence: 193,
  capability: "service",
  enabled: true,
