...
export const logistics_core_254_0_definition = {
...
export const logistics_core_254_1_definition = {
  domain: "logistics-core",
  sequence: 255,
  capability: "service",
  enabled: true,
...
export const logistics_core_254_2_definition = {
  domain: "logistics-core",
  sequence: 256,
  capability: "service",
  enabled: true,
...
export const logistics_core_254_3_definition = {
  domain: "logistics-core",
  sequence: 257,
  capability: "service",
  enabled: true,
...
export const logistics_core_254_4_definition = {
  domain: "logistics-core",
  sequence: 258,
  capability: "service",
  enabled: true,
...
export const logistics_core_254_5_definition = {
  domain: "logistics-core",
  sequence: 259,
  capability: "service",
  enabled: true,
...
export const logistics_core_254_6_definition = {
  domain: "logistics-core",
  sequence: 260,
  capability: "service",
  enabled: true,
...
export const logistics_core_254_7_definition = {
  domain: "logistics-core",
  sequence: 261,
  capability: "service",
  enabled: true,
