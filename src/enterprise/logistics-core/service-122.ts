...
export const logistics_core_122_0_definition = {
...
export const logistics_core_122_1_definition = {
  domain: "logistics-core",
  sequence: 123,
  capability: "service",
  enabled: true,
...
export const logistics_core_122_2_definition = {
  domain: "logistics-core",
  sequence: 124,
  capability: "service",
  enabled: true,
...
export const logistics_core_122_3_definition = {
  domain: "logistics-core",
  sequence: 125,
  capability: "service",
  enabled: true,
...
export const logistics_core_122_4_definition = {
  domain: "logistics-core",
  sequence: 126,
  capability: "service",
  enabled: true,
...
export const logistics_core_122_5_definition = {
  domain: "logistics-core",
  sequence: 127,
  capability: "service",
  enabled: true,
...
export const logistics_core_122_6_definition = {
  domain: "logistics-core",
  sequence: 128,
  capability: "service",
  enabled: true,
...
export const logistics_core_122_7_definition = {
  domain: "logistics-core",
  sequence: 129,
  capability: "service",
  enabled: true,
