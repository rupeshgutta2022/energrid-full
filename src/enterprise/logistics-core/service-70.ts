...
export const logistics_core_70_0_definition = {
...
export const logistics_core_70_1_definition = {
  domain: "logistics-core",
  sequence: 71,
  capability: "service",
  enabled: true,
...
export const logistics_core_70_2_definition = {
  domain: "logistics-core",
  sequence: 72,
  capability: "service",
  enabled: true,
...
export const logistics_core_70_3_definition = {
  domain: "logistics-core",
  sequence: 73,
  capability: "service",
  enabled: true,
...
export const logistics_core_70_4_definition = {
  domain: "logistics-core",
  sequence: 74,
  capability: "service",
  enabled: true,
...
export const logistics_core_70_5_definition = {
  domain: "logistics-core",
  sequence: 75,
  capability: "service",
  enabled: true,
...
export const logistics_core_70_6_definition = {
  domain: "logistics-core",
  sequence: 76,
  capability: "service",
  enabled: true,
...
export const logistics_core_70_7_definition = {
  domain: "logistics-core",
  sequence: 77,
  capability: "service",
  enabled: true,
