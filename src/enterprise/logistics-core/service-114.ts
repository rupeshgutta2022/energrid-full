...
export const logistics_core_114_0_definition = {
...
export const logistics_core_114_1_definition = {
  domain: "logistics-core",
  sequence: 115,
  capability: "service",
  enabled: true,
...
export const logistics_core_114_2_definition = {
  domain: "logistics-core",
  sequence: 116,
  capability: "service",
  enabled: true,
...
export const logistics_core_114_3_definition = {
  domain: "logistics-core",
  sequence: 117,
  capability: "service",
  enabled: true,
...
export const logistics_core_114_4_definition = {
  domain: "logistics-core",
  sequence: 118,
  capability: "service",
  enabled: true,
...
export const logistics_core_114_5_definition = {
  domain: "logistics-core",
  sequence: 119,
  capability: "service",
  enabled: true,
...
export const logistics_core_114_6_definition = {
  domain: "logistics-core",
  sequence: 120,
  capability: "service",
  enabled: true,
...
export const logistics_core_114_7_definition = {
  domain: "logistics-core",
  sequence: 121,
  capability: "service",
  enabled: true,
