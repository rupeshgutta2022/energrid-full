...
export const logistics_core_22_0_definition = {
...
export const logistics_core_22_1_definition = {
  domain: "logistics-core",
  sequence: 23,
  capability: "service",
  enabled: true,
...
export const logistics_core_22_2_definition = {
  domain: "logistics-core",
  sequence: 24,
  capability: "service",
  enabled: true,
...
export const logistics_core_22_3_definition = {
  domain: "logistics-core",
  sequence: 25,
  capability: "service",
  enabled: true,
...
export const logistics_core_22_4_definition = {
  domain: "logistics-core",
  sequence: 26,
  capability: "service",
  enabled: true,
...
export const logistics_core_22_5_definition = {
  domain: "logistics-core",
  sequence: 27,
  capability: "service",
  enabled: true,
...
export const logistics_core_22_6_definition = {
  domain: "logistics-core",
  sequence: 28,
  capability: "service",
  enabled: true,
...
export const logistics_core_22_7_definition = {
  domain: "logistics-core",
  sequence: 29,
  capability: "service",
  enabled: true,
