...
export const logistics_core_46_0_definition = {
...
export const logistics_core_46_1_definition = {
  domain: "logistics-core",
  sequence: 47,
  capability: "service",
  enabled: true,
...
export const logistics_core_46_2_definition = {
  domain: "logistics-core",
  sequence: 48,
  capability: "service",
  enabled: true,
...
export const logistics_core_46_3_definition = {
  domain: "logistics-core",
  sequence: 49,
  capability: "service",
  enabled: true,
...
export const logistics_core_46_4_definition = {
  domain: "logistics-core",
  sequence: 50,
  capability: "service",
  enabled: true,
...
export const logistics_core_46_5_definition = {
  domain: "logistics-core",
  sequence: 51,
  capability: "service",
  enabled: true,
...
export const logistics_core_46_6_definition = {
  domain: "logistics-core",
  sequence: 52,
  capability: "service",
  enabled: true,
...
export const logistics_core_46_7_definition = {
  domain: "logistics-core",
  sequence: 53,
  capability: "service",
  enabled: true,
