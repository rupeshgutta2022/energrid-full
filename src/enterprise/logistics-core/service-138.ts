...
export const logistics_core_138_0_definition = {
...
export const logistics_core_138_1_definition = {
  domain: "logistics-core",
  sequence: 139,
  capability: "service",
  enabled: true,
...
export const logistics_core_138_2_definition = {
  domain: "logistics-core",
  sequence: 140,
  capability: "service",
  enabled: true,
...
export const logistics_core_138_3_definition = {
  domain: "logistics-core",
  sequence: 141,
  capability: "service",
  enabled: true,
...
export const logistics_core_138_4_definition = {
  domain: "logistics-core",
  sequence: 142,
  capability: "service",
  enabled: true,
...
export const logistics_core_138_5_definition = {
  domain: "logistics-core",
  sequence: 143,
  capability: "service",
  enabled: true,
...
export const logistics_core_138_6_definition = {
  domain: "logistics-core",
  sequence: 144,
  capability: "service",
  enabled: true,
...
export const logistics_core_138_7_definition = {
  domain: "logistics-core",
  sequence: 145,
  capability: "service",
  enabled: true,
