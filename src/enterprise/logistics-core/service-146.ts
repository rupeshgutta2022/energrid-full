...
export const logistics_core_146_0_definition = {
...
export const logistics_core_146_1_definition = {
  domain: "logistics-core",
  sequence: 147,
  capability: "service",
  enabled: true,
...
export const logistics_core_146_2_definition = {
  domain: "logistics-core",
  sequence: 148,
  capability: "service",
  enabled: true,
...
export const logistics_core_146_3_definition = {
  domain: "logistics-core",
  sequence: 149,
  capability: "service",
  enabled: true,
...
export const logistics_core_146_4_definition = {
  domain: "logistics-core",
  sequence: 150,
  capability: "service",
  enabled: true,
...
export const logistics_core_146_5_definition = {
  domain: "logistics-core",
  sequence: 151,
  capability: "service",
  enabled: true,
...
export const logistics_core_146_6_definition = {
  domain: "logistics-core",
  sequence: 152,
  capability: "service",
  enabled: true,
...
export const logistics_core_146_7_definition = {
  domain: "logistics-core",
  sequence: 153,
  capability: "service",
  enabled: true,
