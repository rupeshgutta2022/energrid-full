...
export const logistics_core_198_0_definition = {
...
export const logistics_core_198_1_definition = {
  domain: "logistics-core",
  sequence: 199,
  capability: "service",
  enabled: true,
...
export const logistics_core_198_2_definition = {
  domain: "logistics-core",
  sequence: 200,
  capability: "service",
  enabled: true,
...
export const logistics_core_198_3_definition = {
  domain: "logistics-core",
  sequence: 201,
  capability: "service",
  enabled: true,
...
export const logistics_core_198_4_definition = {
  domain: "logistics-core",
  sequence: 202,
  capability: "service",
  enabled: true,
...
export const logistics_core_198_5_definition = {
  domain: "logistics-core",
  sequence: 203,
  capability: "service",
  enabled: true,
...
export const logistics_core_198_6_definition = {
  domain: "logistics-core",
  sequence: 204,
  capability: "service",
  enabled: true,
...
export const logistics_core_198_7_definition = {
  domain: "logistics-core",
  sequence: 205,
  capability: "service",
  enabled: true,
