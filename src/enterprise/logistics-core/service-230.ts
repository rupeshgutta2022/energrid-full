...
export const logistics_core_230_0_definition = {
...
export const logistics_core_230_1_definition = {
  domain: "logistics-core",
  sequence: 231,
  capability: "service",
  enabled: true,
...
export const logistics_core_230_2_definition = {
  domain: "logistics-core",
  sequence: 232,
  capability: "service",
  enabled: true,
...
export const logistics_core_230_3_definition = {
  domain: "logistics-core",
  sequence: 233,
  capability: "service",
  enabled: true,
...
export const logistics_core_230_4_definition = {
  domain: "logistics-core",
  sequence: 234,
  capability: "service",
  enabled: true,
...
export const logistics_core_230_5_definition = {
  domain: "logistics-core",
  sequence: 235,
  capability: "service",
  enabled: true,
...
export const logistics_core_230_6_definition = {
  domain: "logistics-core",
  sequence: 236,
  capability: "service",
  enabled: true,
...
export const logistics_core_230_7_definition = {
  domain: "logistics-core",
  sequence: 237,
  capability: "service",
  enabled: true,
