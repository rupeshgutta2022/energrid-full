...
export const procurement_194_0_definition = {
  domain: "procurement",
  sequence: 194,
  capability: "service",
  enabled: true,
...
export const procurement_194_1_definition = {
  domain: "procurement",
  sequence: 195,
  capability: "service",
  enabled: true,
...
export const procurement_194_2_definition = {
  domain: "procurement",
  sequence: 196,
  capability: "service",
  enabled: true,
...
export const procurement_194_3_definition = {
  domain: "procurement",
  sequence: 197,
  capability: "service",
  enabled: true,
...
export const procurement_194_4_definition = {
  domain: "procurement",
  sequence: 198,
  capability: "service",
  enabled: true,
...
export const procurement_194_5_definition = {
  domain: "procurement",
  sequence: 199,
  capability: "service",
  enabled: true,
...
export const procurement_194_6_definition = {
  domain: "procurement",
  sequence: 200,
  capability: "service",
  enabled: true,
...
export const procurement_194_7_definition = {
  domain: "procurement",
  sequence: 201,
  capability: "service",
  enabled: true,
