...
export const procurement_114_0_definition = {
  domain: "procurement",
  sequence: 114,
  capability: "service",
  enabled: true,
...
export const procurement_114_1_definition = {
  domain: "procurement",
  sequence: 115,
  capability: "service",
  enabled: true,
...
export const procurement_114_2_definition = {
  domain: "procurement",
  sequence: 116,
  capability: "service",
  enabled: true,
...
export const procurement_114_3_definition = {
  domain: "procurement",
  sequence: 117,
  capability: "service",
  enabled: true,
...
export const procurement_114_4_definition = {
  domain: "procurement",
  sequence: 118,
  capability: "service",
  enabled: true,
...
export const procurement_114_5_definition = {
  domain: "procurement",
  sequence: 119,
  capability: "service",
  enabled: true,
...
export const procurement_114_6_definition = {
  domain: "procurement",
  sequence: 120,
  capability: "service",
  enabled: true,
...
export const procurement_114_7_definition = {
  domain: "procurement",
  sequence: 121,
  capability: "service",
  enabled: true,
