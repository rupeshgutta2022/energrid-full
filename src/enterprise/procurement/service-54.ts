...
export const procurement_54_0_definition = {
  domain: "procurement",
  sequence: 54,
  capability: "service",
  enabled: true,
...
export const procurement_54_1_definition = {
  domain: "procurement",
  sequence: 55,
  capability: "service",
  enabled: true,
...
export const procurement_54_2_definition = {
  domain: "procurement",
  sequence: 56,
  capability: "service",
  enabled: true,
...
export const procurement_54_3_definition = {
  domain: "procurement",
  sequence: 57,
  capability: "service",
  enabled: true,
...
export const procurement_54_4_definition = {
  domain: "procurement",
  sequence: 58,
  capability: "service",
  enabled: true,
...
export const procurement_54_5_definition = {
  domain: "procurement",
  sequence: 59,
  capability: "service",
  enabled: true,
...
export const procurement_54_6_definition = {
  domain: "procurement",
  sequence: 60,
  capability: "service",
  enabled: true,
...
export const procurement_54_7_definition = {
  domain: "procurement",
  sequence: 61,
  capability: "service",
  enabled: true,
