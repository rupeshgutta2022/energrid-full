...
export const procurement_215_0_definition = {
  domain: "procurement",
  sequence: 215,
  capability: "workflow",
  enabled: true,
...
export const procurement_215_1_definition = {
  domain: "procurement",
  sequence: 216,
  capability: "workflow",
  enabled: true,
...
export const procurement_215_2_definition = {
  domain: "procurement",
  sequence: 217,
  capability: "workflow",
  enabled: true,
...
export const procurement_215_3_definition = {
  domain: "procurement",
  sequence: 218,
  capability: "workflow",
  enabled: true,
