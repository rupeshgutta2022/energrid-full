...
export const procurement_22_0_definition = {
  domain: "procurement",
  sequence: 22,
  capability: "service",
  enabled: true,
...
export const procurement_22_1_definition = {
  domain: "procurement",
  sequence: 23,
  capability: "service",
  enabled: true,
...
export const procurement_22_2_definition = {
  domain: "procurement",
  sequence: 24,
  capability: "service",
  enabled: true,
...
export const procurement_22_3_definition = {
  domain: "procurement",
  sequence: 25,
  capability: "service",
  enabled: true,
...
export const procurement_22_4_definition = {
  domain: "procurement",
  sequence: 26,
  capability: "service",
  enabled: true,
...
export const procurement_22_5_definition = {
  domain: "procurement",
  sequence: 27,
  capability: "service",
  enabled: true,
...
export const procurement_22_6_definition = {
  domain: "procurement",
  sequence: 28,
  capability: "service",
  enabled: true,
...
export const procurement_22_7_definition = {
  domain: "procurement",
  sequence: 29,
  capability: "service",
  enabled: true,
