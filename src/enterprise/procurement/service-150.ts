...
export const procurement_150_0_definition = {
  domain: "procurement",
  sequence: 150,
  capability: "service",
  enabled: true,
...
export const procurement_150_1_definition = {
  domain: "procurement",
  sequence: 151,
  capability: "service",
  enabled: true,
...
export const procurement_150_2_definition = {
  domain: "procurement",
  sequence: 152,
  capability: "service",
  enabled: true,
...
export const procurement_150_3_definition = {
  domain: "procurement",
  sequence: 153,
  capability: "service",
  enabled: true,
...
export const procurement_150_4_definition = {
  domain: "procurement",
  sequence: 154,
  capability: "service",
  enabled: true,
...
export const procurement_150_5_definition = {
  domain: "procurement",
  sequence: 155,
  capability: "service",
  enabled: true,
...
export const procurement_150_6_definition = {
  domain: "procurement",
  sequence: 156,
  capability: "service",
  enabled: true,
...
export const procurement_150_7_definition = {
  domain: "procurement",
  sequence: 157,
  capability: "service",
  enabled: true,
