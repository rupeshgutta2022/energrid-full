...
export const procurement_106_0_definition = {
  domain: "procurement",
  sequence: 106,
  capability: "service",
  enabled: true,
...
export const procurement_106_1_definition = {
  domain: "procurement",
  sequence: 107,
  capability: "service",
  enabled: true,
...
export const procurement_106_2_definition = {
  domain: "procurement",
  sequence: 108,
  capability: "service",
  enabled: true,
...
export const procurement_106_3_definition = {
  domain: "procurement",
  sequence: 109,
  capability: "service",
  enabled: true,
...
export const procurement_106_4_definition = {
  domain: "procurement",
  sequence: 110,
  capability: "service",
  enabled: true,
...
export const procurement_106_5_definition = {
  domain: "procurement",
  sequence: 111,
  capability: "service",
  enabled: true,
...
export const procurement_106_6_definition = {
  domain: "procurement",
  sequence: 112,
  capability: "service",
  enabled: true,
...
export const procurement_106_7_definition = {
  domain: "procurement",
  sequence: 113,
  capability: "service",
  enabled: true,
