...
export const procurement_182_0_definition = {
  domain: "procurement",
  sequence: 182,
  capability: "service",
  enabled: true,
...
export const procurement_182_1_definition = {
  domain: "procurement",
  sequence: 183,
  capability: "service",
  enabled: true,
...
export const procurement_182_2_definition = {
  domain: "procurement",
  sequence: 184,
  capability: "service",
  enabled: true,
...
export const procurement_182_3_definition = {
  domain: "procurement",
  sequence: 185,
  capability: "service",
  enabled: true,
...
export const procurement_182_4_definition = {
  domain: "procurement",
  sequence: 186,
  capability: "service",
  enabled: true,
...
export const procurement_182_5_definition = {
  domain: "procurement",
  sequence: 187,
  capability: "service",
  enabled: true,
...
export const procurement_182_6_definition = {
  domain: "procurement",
  sequence: 188,
  capability: "service",
  enabled: true,
...
export const procurement_182_7_definition = {
  domain: "procurement",
  sequence: 189,
  capability: "service",
  enabled: true,
