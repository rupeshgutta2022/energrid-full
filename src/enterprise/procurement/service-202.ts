...
export const procurement_202_0_definition = {
  domain: "procurement",
  sequence: 202,
  capability: "service",
  enabled: true,
...
export const procurement_202_1_definition = {
  domain: "procurement",
  sequence: 203,
  capability: "service",
  enabled: true,
...
export const procurement_202_2_definition = {
  domain: "procurement",
  sequence: 204,
  capability: "service",
  enabled: true,
...
export const procurement_202_3_definition = {
  domain: "procurement",
  sequence: 205,
  capability: "service",
  enabled: true,
...
export const procurement_202_4_definition = {
  domain: "procurement",
  sequence: 206,
  capability: "service",
  enabled: true,
...
export const procurement_202_5_definition = {
  domain: "procurement",
  sequence: 207,
  capability: "service",
  enabled: true,
...
export const procurement_202_6_definition = {
  domain: "procurement",
  sequence: 208,
  capability: "service",
  enabled: true,
...
export const procurement_202_7_definition = {
  domain: "procurement",
  sequence: 209,
  capability: "service",
  enabled: true,
