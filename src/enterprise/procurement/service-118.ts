...
export const procurement_118_0_definition = {
  domain: "procurement",
  sequence: 118,
  capability: "service",
  enabled: true,
...
export const procurement_118_1_definition = {
  domain: "procurement",
  sequence: 119,
  capability: "service",
  enabled: true,
...
export const procurement_118_2_definition = {
  domain: "procurement",
  sequence: 120,
  capability: "service",
  enabled: true,
...
export const procurement_118_3_definition = {
  domain: "procurement",
  sequence: 121,
  capability: "service",
  enabled: true,
...
export const procurement_118_4_definition = {
  domain: "procurement",
  sequence: 122,
  capability: "service",
  enabled: true,
...
export const procurement_118_5_definition = {
  domain: "procurement",
  sequence: 123,
  capability: "service",
  enabled: true,
...
export const procurement_118_6_definition = {
  domain: "procurement",
  sequence: 124,
  capability: "service",
  enabled: true,
...
export const procurement_118_7_definition = {
  domain: "procurement",
  sequence: 125,
  capability: "service",
  enabled: true,
