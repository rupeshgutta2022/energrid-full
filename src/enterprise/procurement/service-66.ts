...
export const procurement_66_0_definition = {
  domain: "procurement",
  sequence: 66,
  capability: "service",
  enabled: true,
...
export const procurement_66_1_definition = {
  domain: "procurement",
  sequence: 67,
  capability: "service",
  enabled: true,
...
export const procurement_66_2_definition = {
  domain: "procurement",
  sequence: 68,
  capability: "service",
  enabled: true,
...
export const procurement_66_3_definition = {
  domain: "procurement",
  sequence: 69,
  capability: "service",
  enabled: true,
...
export const procurement_66_4_definition = {
  domain: "procurement",
  sequence: 70,
  capability: "service",
  enabled: true,
...
export const procurement_66_5_definition = {
  domain: "procurement",
  sequence: 71,
  capability: "service",
  enabled: true,
...
export const procurement_66_6_definition = {
  domain: "procurement",
  sequence: 72,
  capability: "service",
  enabled: true,
...
export const procurement_66_7_definition = {
  domain: "procurement",
  sequence: 73,
  capability: "service",
  enabled: true,
