...
export const procurement_74_0_definition = {
  domain: "procurement",
  sequence: 74,
  capability: "service",
  enabled: true,
...
export const procurement_74_1_definition = {
  domain: "procurement",
  sequence: 75,
  capability: "service",
  enabled: true,
...
export const procurement_74_2_definition = {
  domain: "procurement",
  sequence: 76,
  capability: "service",
  enabled: true,
...
export const procurement_74_3_definition = {
  domain: "procurement",
  sequence: 77,
  capability: "service",
  enabled: true,
...
export const procurement_74_4_definition = {
  domain: "procurement",
  sequence: 78,
  capability: "service",
  enabled: true,
...
export const procurement_74_5_definition = {
  domain: "procurement",
  sequence: 79,
  capability: "service",
  enabled: true,
...
export const procurement_74_6_definition = {
  domain: "procurement",
  sequence: 80,
  capability: "service",
  enabled: true,
...
export const procurement_74_7_definition = {
  domain: "procurement",
  sequence: 81,
  capability: "service",
  enabled: true,
