...
export const procurement_174_0_definition = {
  domain: "procurement",
  sequence: 174,
  capability: "service",
  enabled: true,
...
export const procurement_174_1_definition = {
  domain: "procurement",
  sequence: 175,
  capability: "service",
  enabled: true,
...
export const procurement_174_2_definition = {
  domain: "procurement",
  sequence: 176,
  capability: "service",
  enabled: true,
...
export const procurement_174_3_definition = {
  domain: "procurement",
  sequence: 177,
  capability: "service",
  enabled: true,
...
export const procurement_174_4_definition = {
  domain: "procurement",
  sequence: 178,
  capability: "service",
  enabled: true,
...
export const procurement_174_5_definition = {
  domain: "procurement",
  sequence: 179,
  capability: "service",
  enabled: true,
...
export const procurement_174_6_definition = {
  domain: "procurement",
  sequence: 180,
  capability: "service",
  enabled: true,
...
export const procurement_174_7_definition = {
  domain: "procurement",
  sequence: 181,
  capability: "service",
  enabled: true,
