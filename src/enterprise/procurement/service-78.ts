...
export const procurement_78_0_definition = {
  domain: "procurement",
  sequence: 78,
  capability: "service",
  enabled: true,
...
export const procurement_78_1_definition = {
  domain: "procurement",
  sequence: 79,
  capability: "service",
  enabled: true,
...
export const procurement_78_2_definition = {
  domain: "procurement",
  sequence: 80,
  capability: "service",
  enabled: true,
...
export const procurement_78_3_definition = {
  domain: "procurement",
  sequence: 81,
  capability: "service",
  enabled: true,
...
export const procurement_78_4_definition = {
  domain: "procurement",
  sequence: 82,
  capability: "service",
  enabled: true,
...
export const procurement_78_5_definition = {
  domain: "procurement",
  sequence: 83,
  capability: "service",
  enabled: true,
...
export const procurement_78_6_definition = {
  domain: "procurement",
  sequence: 84,
  capability: "service",
  enabled: true,
...
export const procurement_78_7_definition = {
  domain: "procurement",
  sequence: 85,
  capability: "service",
  enabled: true,
