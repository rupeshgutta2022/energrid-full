...
export const procurement_38_0_definition = {
  domain: "procurement",
  sequence: 38,
  capability: "service",
  enabled: true,
...
export const procurement_38_1_definition = {
  domain: "procurement",
  sequence: 39,
  capability: "service",
  enabled: true,
...
export const procurement_38_2_definition = {
  domain: "procurement",
  sequence: 40,
  capability: "service",
  enabled: true,
...
export const procurement_38_3_definition = {
  domain: "procurement",
  sequence: 41,
  capability: "service",
  enabled: true,
...
export const procurement_38_4_definition = {
  domain: "procurement",
  sequence: 42,
  capability: "service",
  enabled: true,
...
export const procurement_38_5_definition = {
  domain: "procurement",
  sequence: 43,
  capability: "service",
  enabled: true,
...
export const procurement_38_6_definition = {
  domain: "procurement",
  sequence: 44,
  capability: "service",
  enabled: true,
...
export const procurement_38_7_definition = {
  domain: "procurement",
  sequence: 45,
  capability: "service",
  enabled: true,
