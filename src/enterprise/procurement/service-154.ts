...
export const procurement_154_0_definition = {
  domain: "procurement",
  sequence: 154,
  capability: "service",
  enabled: true,
...
export const procurement_154_1_definition = {
  domain: "procurement",
  sequence: 155,
  capability: "service",
  enabled: true,
...
export const procurement_154_2_definition = {
  domain: "procurement",
  sequence: 156,
  capability: "service",
  enabled: true,
...
export const procurement_154_3_definition = {
  domain: "procurement",
  sequence: 157,
  capability: "service",
  enabled: true,
...
export const procurement_154_4_definition = {
  domain: "procurement",
  sequence: 158,
  capability: "service",
  enabled: true,
...
export const procurement_154_5_definition = {
  domain: "procurement",
  sequence: 159,
  capability: "service",
  enabled: true,
...
export const procurement_154_6_definition = {
  domain: "procurement",
  sequence: 160,
  capability: "service",
  enabled: true,
...
export const procurement_154_7_definition = {
  domain: "procurement",
  sequence: 161,
  capability: "service",
  enabled: true,
