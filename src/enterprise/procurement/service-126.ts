...
export const procurement_126_0_definition = {
  domain: "procurement",
  sequence: 126,
  capability: "service",
  enabled: true,
...
export const procurement_126_1_definition = {
  domain: "procurement",
  sequence: 127,
  capability: "service",
  enabled: true,
...
export const procurement_126_2_definition = {
  domain: "procurement",
  sequence: 128,
  capability: "service",
  enabled: true,
...
export const procurement_126_3_definition = {
  domain: "procurement",
  sequence: 129,
  capability: "service",
  enabled: true,
...
export const procurement_126_4_definition = {
  domain: "procurement",
  sequence: 130,
  capability: "service",
  enabled: true,
...
export const procurement_126_5_definition = {
  domain: "procurement",
  sequence: 131,
  capability: "service",
  enabled: true,
...
export const procurement_126_6_definition = {
  domain: "procurement",
  sequence: 132,
  capability: "service",
  enabled: true,
...
export const procurement_126_7_definition = {
  domain: "procurement",
  sequence: 133,
  capability: "service",
  enabled: true,
