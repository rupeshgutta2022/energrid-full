...
export const procurement_98_0_definition = {
  domain: "procurement",
  sequence: 98,
  capability: "service",
  enabled: true,
...
export const procurement_98_1_definition = {
  domain: "procurement",
  sequence: 99,
  capability: "service",
  enabled: true,
...
export const procurement_98_2_definition = {
  domain: "procurement",
  sequence: 100,
  capability: "service",
  enabled: true,
...
export const procurement_98_3_definition = {
  domain: "procurement",
  sequence: 101,
  capability: "service",
  enabled: true,
...
export const procurement_98_4_definition = {
  domain: "procurement",
  sequence: 102,
  capability: "service",
  enabled: true,
...
export const procurement_98_5_definition = {
  domain: "procurement",
  sequence: 103,
  capability: "service",
  enabled: true,
...
export const procurement_98_6_definition = {
  domain: "procurement",
  sequence: 104,
  capability: "service",
  enabled: true,
...
export const procurement_98_7_definition = {
  domain: "procurement",
  sequence: 105,
  capability: "service",
  enabled: true,
