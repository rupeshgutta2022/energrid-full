...
export const procurement_26_0_definition = {
  domain: "procurement",
  sequence: 26,
  capability: "service",
  enabled: true,
...
export const procurement_26_1_definition = {
  domain: "procurement",
  sequence: 27,
  capability: "service",
  enabled: true,
...
export const procurement_26_2_definition = {
  domain: "procurement",
  sequence: 28,
  capability: "service",
  enabled: true,
...
export const procurement_26_3_definition = {
  domain: "procurement",
  sequence: 29,
  capability: "service",
  enabled: true,
...
export const procurement_26_4_definition = {
  domain: "procurement",
  sequence: 30,
  capability: "service",
  enabled: true,
...
export const procurement_26_5_definition = {
  domain: "procurement",
  sequence: 31,
  capability: "service",
  enabled: true,
...
export const procurement_26_6_definition = {
  domain: "procurement",
  sequence: 32,
  capability: "service",
  enabled: true,
...
export const procurement_26_7_definition = {
  domain: "procurement",
  sequence: 33,
  capability: "service",
  enabled: true,
