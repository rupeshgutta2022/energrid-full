...
export const procurement_210_0_definition = {
  domain: "procurement",
  sequence: 210,
  capability: "service",
  enabled: true,
...
export const procurement_210_1_definition = {
  domain: "procurement",
  sequence: 211,
  capability: "service",
  enabled: true,
...
export const procurement_210_2_definition = {
  domain: "procurement",
  sequence: 212,
  capability: "service",
  enabled: true,
...
export const procurement_210_3_definition = {
  domain: "procurement",
  sequence: 213,
  capability: "service",
  enabled: true,
...
export const procurement_210_4_definition = {
  domain: "procurement",
  sequence: 214,
  capability: "service",
  enabled: true,
