...
export const procurement_50_0_definition = {
  domain: "procurement",
  sequence: 50,
  capability: "service",
  enabled: true,
...
export const procurement_50_1_definition = {
  domain: "procurement",
  sequence: 51,
  capability: "service",
  enabled: true,
...
export const procurement_50_2_definition = {
  domain: "procurement",
  sequence: 52,
  capability: "service",
  enabled: true,
...
export const procurement_50_3_definition = {
  domain: "procurement",
  sequence: 53,
  capability: "service",
  enabled: true,
...
export const procurement_50_4_definition = {
  domain: "procurement",
  sequence: 54,
  capability: "service",
  enabled: true,
...
export const procurement_50_5_definition = {
  domain: "procurement",
  sequence: 55,
  capability: "service",
  enabled: true,
...
export const procurement_50_6_definition = {
  domain: "procurement",
  sequence: 56,
  capability: "service",
  enabled: true,
...
export const procurement_50_7_definition = {
  domain: "procurement",
  sequence: 57,
  capability: "service",
  enabled: true,
