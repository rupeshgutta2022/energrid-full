...
export const procurement_18_0_definition = {
  domain: "procurement",
  sequence: 18,
  capability: "service",
  enabled: true,
...
export const procurement_18_1_definition = {
  domain: "procurement",
  sequence: 19,
  capability: "service",
  enabled: true,
...
export const procurement_18_2_definition = {
  domain: "procurement",
  sequence: 20,
  capability: "service",
  enabled: true,
...
export const procurement_18_3_definition = {
  domain: "procurement",
  sequence: 21,
  capability: "service",
  enabled: true,
...
export const procurement_18_4_definition = {
  domain: "procurement",
  sequence: 22,
  capability: "service",
  enabled: true,
...
export const procurement_18_5_definition = {
  domain: "procurement",
  sequence: 23,
  capability: "service",
  enabled: true,
...
export const procurement_18_6_definition = {
  domain: "procurement",
  sequence: 24,
  capability: "service",
  enabled: true,
...
export const procurement_18_7_definition = {
  domain: "procurement",
  sequence: 25,
  capability: "service",
  enabled: true,
