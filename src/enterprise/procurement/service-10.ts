...
export const procurement_10_0_definition = {
  domain: "procurement",
  sequence: 10,
  capability: "service",
  enabled: true,
...
export const procurement_10_1_definition = {
  domain: "procurement",
  sequence: 11,
  capability: "service",
  enabled: true,
...
export const procurement_10_2_definition = {
  domain: "procurement",
  sequence: 12,
  capability: "service",
  enabled: true,
...
export const procurement_10_3_definition = {
  domain: "procurement",
  sequence: 13,
  capability: "service",
  enabled: true,
...
export const procurement_10_4_definition = {
  domain: "procurement",
  sequence: 14,
  capability: "service",
  enabled: true,
...
export const procurement_10_5_definition = {
  domain: "procurement",
  sequence: 15,
  capability: "service",
  enabled: true,
...
export const procurement_10_6_definition = {
  domain: "procurement",
  sequence: 16,
  capability: "service",
  enabled: true,
...
export const procurement_10_7_definition = {
  domain: "procurement",
  sequence: 17,
  capability: "service",
  enabled: true,
