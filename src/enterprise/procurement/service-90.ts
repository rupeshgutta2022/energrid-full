...
export const procurement_90_0_definition = {
  domain: "procurement",
  sequence: 90,
  capability: "service",
  enabled: true,
...
export const procurement_90_1_definition = {
  domain: "procurement",
  sequence: 91,
  capability: "service",
  enabled: true,
...
export const procurement_90_2_definition = {
  domain: "procurement",
  sequence: 92,
  capability: "service",
  enabled: true,
...
export const procurement_90_3_definition = {
  domain: "procurement",
  sequence: 93,
  capability: "service",
  enabled: true,
...
export const procurement_90_4_definition = {
  domain: "procurement",
  sequence: 94,
  capability: "service",
  enabled: true,
...
export const procurement_90_5_definition = {
  domain: "procurement",
  sequence: 95,
  capability: "service",
  enabled: true,
...
export const procurement_90_6_definition = {
  domain: "procurement",
  sequence: 96,
  capability: "service",
  enabled: true,
...
export const procurement_90_7_definition = {
  domain: "procurement",
  sequence: 97,
  capability: "service",
  enabled: true,
