...
export const procurement_146_0_definition = {
  domain: "procurement",
  sequence: 146,
  capability: "service",
  enabled: true,
...
export const procurement_146_1_definition = {
  domain: "procurement",
  sequence: 147,
  capability: "service",
  enabled: true,
...
export const procurement_146_2_definition = {
  domain: "procurement",
  sequence: 148,
  capability: "service",
  enabled: true,
...
export const procurement_146_3_definition = {
  domain: "procurement",
  sequence: 149,
  capability: "service",
  enabled: true,
...
export const procurement_146_4_definition = {
  domain: "procurement",
  sequence: 150,
  capability: "service",
  enabled: true,
...
export const procurement_146_5_definition = {
  domain: "procurement",
  sequence: 151,
  capability: "service",
  enabled: true,
...
export const procurement_146_6_definition = {
  domain: "procurement",
  sequence: 152,
  capability: "service",
  enabled: true,
...
export const procurement_146_7_definition = {
  domain: "procurement",
  sequence: 153,
  capability: "service",
  enabled: true,
