...
export const procurement_70_0_definition = {
  domain: "procurement",
  sequence: 70,
  capability: "service",
  enabled: true,
...
export const procurement_70_1_definition = {
  domain: "procurement",
  sequence: 71,
  capability: "service",
  enabled: true,
...
export const procurement_70_2_definition = {
  domain: "procurement",
  sequence: 72,
  capability: "service",
  enabled: true,
...
export const procurement_70_3_definition = {
  domain: "procurement",
  sequence: 73,
  capability: "service",
  enabled: true,
...
export const procurement_70_4_definition = {
  domain: "procurement",
  sequence: 74,
  capability: "service",
  enabled: true,
...
export const procurement_70_5_definition = {
  domain: "procurement",
  sequence: 75,
  capability: "service",
  enabled: true,
...
export const procurement_70_6_definition = {
  domain: "procurement",
  sequence: 76,
  capability: "service",
  enabled: true,
...
export const procurement_70_7_definition = {
  domain: "procurement",
  sequence: 77,
  capability: "service",
  enabled: true,
