...
export const procurement_162_0_definition = {
  domain: "procurement",
  sequence: 162,
  capability: "service",
  enabled: true,
...
export const procurement_162_1_definition = {
  domain: "procurement",
  sequence: 163,
  capability: "service",
  enabled: true,
...
export const procurement_162_2_definition = {
  domain: "procurement",
  sequence: 164,
  capability: "service",
  enabled: true,
...
export const procurement_162_3_definition = {
  domain: "procurement",
  sequence: 165,
  capability: "service",
  enabled: true,
...
export const procurement_162_4_definition = {
  domain: "procurement",
  sequence: 166,
  capability: "service",
  enabled: true,
...
export const procurement_162_5_definition = {
  domain: "procurement",
  sequence: 167,
  capability: "service",
  enabled: true,
...
export const procurement_162_6_definition = {
  domain: "procurement",
  sequence: 168,
  capability: "service",
  enabled: true,
...
export const procurement_162_7_definition = {
  domain: "procurement",
  sequence: 169,
  capability: "service",
  enabled: true,
