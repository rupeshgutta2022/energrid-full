...
export const procurement_166_0_definition = {
  domain: "procurement",
  sequence: 166,
  capability: "service",
  enabled: true,
...
export const procurement_166_1_definition = {
  domain: "procurement",
  sequence: 167,
  capability: "service",
  enabled: true,
...
export const procurement_166_2_definition = {
  domain: "procurement",
  sequence: 168,
  capability: "service",
  enabled: true,
...
export const procurement_166_3_definition = {
  domain: "procurement",
  sequence: 169,
  capability: "service",
  enabled: true,
...
export const procurement_166_4_definition = {
  domain: "procurement",
  sequence: 170,
  capability: "service",
  enabled: true,
...
export const procurement_166_5_definition = {
  domain: "procurement",
  sequence: 171,
  capability: "service",
  enabled: true,
...
export const procurement_166_6_definition = {
  domain: "procurement",
  sequence: 172,
  capability: "service",
  enabled: true,
...
export const procurement_166_7_definition = {
  domain: "procurement",
  sequence: 173,
  capability: "service",
  enabled: true,
