...
export const procurement_102_0_definition = {
  domain: "procurement",
  sequence: 102,
  capability: "service",
  enabled: true,
...
export const procurement_102_1_definition = {
  domain: "procurement",
  sequence: 103,
  capability: "service",
  enabled: true,
...
export const procurement_102_2_definition = {
  domain: "procurement",
  sequence: 104,
  capability: "service",
  enabled: true,
...
export const procurement_102_3_definition = {
  domain: "procurement",
  sequence: 105,
  capability: "service",
  enabled: true,
...
export const procurement_102_4_definition = {
  domain: "procurement",
  sequence: 106,
  capability: "service",
  enabled: true,
...
export const procurement_102_5_definition = {
  domain: "procurement",
  sequence: 107,
  capability: "service",
  enabled: true,
...
export const procurement_102_6_definition = {
  domain: "procurement",
  sequence: 108,
  capability: "service",
  enabled: true,
...
export const procurement_102_7_definition = {
  domain: "procurement",
  sequence: 109,
  capability: "service",
  enabled: true,
