...
export const procurement_86_0_definition = {
  domain: "procurement",
  sequence: 86,
  capability: "service",
  enabled: true,
...
export const procurement_86_1_definition = {
  domain: "procurement",
  sequence: 87,
  capability: "service",
  enabled: true,
...
export const procurement_86_2_definition = {
  domain: "procurement",
  sequence: 88,
  capability: "service",
  enabled: true,
...
export const procurement_86_3_definition = {
  domain: "procurement",
  sequence: 89,
  capability: "service",
  enabled: true,
...
export const procurement_86_4_definition = {
  domain: "procurement",
  sequence: 90,
  capability: "service",
  enabled: true,
...
export const procurement_86_5_definition = {
  domain: "procurement",
  sequence: 91,
  capability: "service",
  enabled: true,
...
export const procurement_86_6_definition = {
  domain: "procurement",
  sequence: 92,
  capability: "service",
  enabled: true,
...
export const procurement_86_7_definition = {
  domain: "procurement",
  sequence: 93,
  capability: "service",
  enabled: true,
