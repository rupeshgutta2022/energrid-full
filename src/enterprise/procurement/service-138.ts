...
export const procurement_138_0_definition = {
  domain: "procurement",
  sequence: 138,
  capability: "service",
  enabled: true,
...
export const procurement_138_1_definition = {
  domain: "procurement",
  sequence: 139,
  capability: "service",
  enabled: true,
...
export const procurement_138_2_definition = {
  domain: "procurement",
  sequence: 140,
  capability: "service",
  enabled: true,
...
export const procurement_138_3_definition = {
  domain: "procurement",
  sequence: 141,
  capability: "service",
  enabled: true,
...
export const procurement_138_4_definition = {
  domain: "procurement",
  sequence: 142,
  capability: "service",
  enabled: true,
...
export const procurement_138_5_definition = {
  domain: "procurement",
  sequence: 143,
  capability: "service",
  enabled: true,
...
export const procurement_138_6_definition = {
  domain: "procurement",
  sequence: 144,
  capability: "service",
  enabled: true,
...
export const procurement_138_7_definition = {
  domain: "procurement",
  sequence: 145,
  capability: "service",
  enabled: true,
