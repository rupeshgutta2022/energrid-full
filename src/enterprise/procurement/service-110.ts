...
export const procurement_110_0_definition = {
  domain: "procurement",
  sequence: 110,
  capability: "service",
  enabled: true,
...
export const procurement_110_1_definition = {
  domain: "procurement",
  sequence: 111,
  capability: "service",
  enabled: true,
...
export const procurement_110_2_definition = {
  domain: "procurement",
  sequence: 112,
  capability: "service",
  enabled: true,
...
export const procurement_110_3_definition = {
  domain: "procurement",
  sequence: 113,
  capability: "service",
  enabled: true,
...
export const procurement_110_4_definition = {
  domain: "procurement",
  sequence: 114,
  capability: "service",
  enabled: true,
...
export const procurement_110_5_definition = {
  domain: "procurement",
  sequence: 115,
  capability: "service",
  enabled: true,
...
export const procurement_110_6_definition = {
  domain: "procurement",
  sequence: 116,
  capability: "service",
  enabled: true,
...
export const procurement_110_7_definition = {
  domain: "procurement",
  sequence: 117,
  capability: "service",
  enabled: true,
