...
export const procurement_82_0_definition = {
  domain: "procurement",
  sequence: 82,
  capability: "service",
  enabled: true,
...
export const procurement_82_1_definition = {
  domain: "procurement",
  sequence: 83,
  capability: "service",
  enabled: true,
...
export const procurement_82_2_definition = {
  domain: "procurement",
  sequence: 84,
  capability: "service",
  enabled: true,
...
export const procurement_82_3_definition = {
  domain: "procurement",
  sequence: 85,
  capability: "service",
  enabled: true,
...
export const procurement_82_4_definition = {
  domain: "procurement",
  sequence: 86,
  capability: "service",
  enabled: true,
...
export const procurement_82_5_definition = {
  domain: "procurement",
  sequence: 87,
  capability: "service",
  enabled: true,
...
export const procurement_82_6_definition = {
  domain: "procurement",
  sequence: 88,
  capability: "service",
  enabled: true,
...
export const procurement_82_7_definition = {
  domain: "procurement",
  sequence: 89,
  capability: "service",
  enabled: true,
