...
export const procurement_170_0_definition = {
  domain: "procurement",
  sequence: 170,
  capability: "service",
  enabled: true,
...
export const procurement_170_1_definition = {
  domain: "procurement",
  sequence: 171,
  capability: "service",
  enabled: true,
...
export const procurement_170_2_definition = {
  domain: "procurement",
  sequence: 172,
  capability: "service",
  enabled: true,
...
export const procurement_170_3_definition = {
  domain: "procurement",
  sequence: 173,
  capability: "service",
  enabled: true,
...
export const procurement_170_4_definition = {
  domain: "procurement",
  sequence: 174,
  capability: "service",
  enabled: true,
...
export const procurement_170_5_definition = {
  domain: "procurement",
  sequence: 175,
  capability: "service",
  enabled: true,
...
export const procurement_170_6_definition = {
  domain: "procurement",
  sequence: 176,
  capability: "service",
  enabled: true,
...
export const procurement_170_7_definition = {
  domain: "procurement",
  sequence: 177,
  capability: "service",
  enabled: true,
