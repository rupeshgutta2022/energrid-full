...
export const procurement_30_0_definition = {
  domain: "procurement",
  sequence: 30,
  capability: "service",
  enabled: true,
...
export const procurement_30_1_definition = {
  domain: "procurement",
  sequence: 31,
  capability: "service",
  enabled: true,
...
export const procurement_30_2_definition = {
  domain: "procurement",
  sequence: 32,
  capability: "service",
  enabled: true,
...
export const procurement_30_3_definition = {
  domain: "procurement",
  sequence: 33,
  capability: "service",
  enabled: true,
...
export const procurement_30_4_definition = {
  domain: "procurement",
  sequence: 34,
  capability: "service",
  enabled: true,
...
export const procurement_30_5_definition = {
  domain: "procurement",
  sequence: 35,
  capability: "service",
  enabled: true,
...
export const procurement_30_6_definition = {
  domain: "procurement",
  sequence: 36,
  capability: "service",
  enabled: true,
...
export const procurement_30_7_definition = {
  domain: "procurement",
  sequence: 37,
  capability: "service",
  enabled: true,
