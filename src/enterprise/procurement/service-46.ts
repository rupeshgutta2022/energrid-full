...
export const procurement_46_0_definition = {
  domain: "procurement",
  sequence: 46,
  capability: "service",
  enabled: true,
...
export const procurement_46_1_definition = {
  domain: "procurement",
  sequence: 47,
  capability: "service",
  enabled: true,
...
export const procurement_46_2_definition = {
  domain: "procurement",
  sequence: 48,
  capability: "service",
  enabled: true,
...
export const procurement_46_3_definition = {
  domain: "procurement",
  sequence: 49,
  capability: "service",
  enabled: true,
...
export const procurement_46_4_definition = {
  domain: "procurement",
  sequence: 50,
  capability: "service",
  enabled: true,
...
export const procurement_46_5_definition = {
  domain: "procurement",
  sequence: 51,
  capability: "service",
  enabled: true,
...
export const procurement_46_6_definition = {
  domain: "procurement",
  sequence: 52,
  capability: "service",
  enabled: true,
...
export const procurement_46_7_definition = {
  domain: "procurement",
  sequence: 53,
  capability: "service",
  enabled: true,
