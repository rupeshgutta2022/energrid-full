...
export const procurement_6_0_definition = {
  domain: "procurement",
  sequence: 6,
  capability: "service",
  enabled: true,
...
export const procurement_6_1_definition = {
  domain: "procurement",
  sequence: 7,
  capability: "service",
  enabled: true,
...
export const procurement_6_2_definition = {
  domain: "procurement",
  sequence: 8,
  capability: "service",
  enabled: true,
...
export const procurement_6_3_definition = {
  domain: "procurement",
  sequence: 9,
  capability: "service",
  enabled: true,
...
export const procurement_6_4_definition = {
  domain: "procurement",
  sequence: 10,
  capability: "service",
  enabled: true,
...
export const procurement_6_5_definition = {
  domain: "procurement",
  sequence: 11,
  capability: "service",
  enabled: true,
...
export const procurement_6_6_definition = {
  domain: "procurement",
  sequence: 12,
  capability: "service",
  enabled: true,
...
export const procurement_6_7_definition = {
  domain: "procurement",
  sequence: 13,
  capability: "service",
  enabled: true,
