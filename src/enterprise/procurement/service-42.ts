...
export const procurement_42_0_definition = {
  domain: "procurement",
  sequence: 42,
  capability: "service",
  enabled: true,
...
export const procurement_42_1_definition = {
  domain: "procurement",
  sequence: 43,
  capability: "service",
  enabled: true,
...
export const procurement_42_2_definition = {
  domain: "procurement",
  sequence: 44,
  capability: "service",
  enabled: true,
...
export const procurement_42_3_definition = {
  domain: "procurement",
  sequence: 45,
  capability: "service",
  enabled: true,
...
export const procurement_42_4_definition = {
  domain: "procurement",
  sequence: 46,
  capability: "service",
  enabled: true,
...
export const procurement_42_5_definition = {
  domain: "procurement",
  sequence: 47,
  capability: "service",
  enabled: true,
...
export const procurement_42_6_definition = {
  domain: "procurement",
  sequence: 48,
  capability: "service",
  enabled: true,
...
export const procurement_42_7_definition = {
  domain: "procurement",
  sequence: 49,
  capability: "service",
  enabled: true,
