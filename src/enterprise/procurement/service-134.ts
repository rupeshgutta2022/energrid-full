...
export const procurement_134_0_definition = {
  domain: "procurement",
  sequence: 134,
  capability: "service",
  enabled: true,
...
export const procurement_134_1_definition = {
  domain: "procurement",
  sequence: 135,
  capability: "service",
  enabled: true,
...
export const procurement_134_2_definition = {
  domain: "procurement",
  sequence: 136,
  capability: "service",
  enabled: true,
...
export const procurement_134_3_definition = {
  domain: "procurement",
  sequence: 137,
  capability: "service",
  enabled: true,
...
export const procurement_134_4_definition = {
  domain: "procurement",
  sequence: 138,
  capability: "service",
  enabled: true,
...
export const procurement_134_5_definition = {
  domain: "procurement",
  sequence: 139,
  capability: "service",
  enabled: true,
...
export const procurement_134_6_definition = {
  domain: "procurement",
  sequence: 140,
  capability: "service",
  enabled: true,
...
export const procurement_134_7_definition = {
  domain: "procurement",
  sequence: 141,
  capability: "service",
  enabled: true,
