...
export const procurement_186_0_definition = {
  domain: "procurement",
  sequence: 186,
  capability: "service",
  enabled: true,
...
export const procurement_186_1_definition = {
  domain: "procurement",
  sequence: 187,
  capability: "service",
  enabled: true,
...
export const procurement_186_2_definition = {
  domain: "procurement",
  sequence: 188,
  capability: "service",
  enabled: true,
...
export const procurement_186_3_definition = {
  domain: "procurement",
  sequence: 189,
  capability: "service",
  enabled: true,
...
export const procurement_186_4_definition = {
  domain: "procurement",
  sequence: 190,
  capability: "service",
  enabled: true,
...
export const procurement_186_5_definition = {
  domain: "procurement",
  sequence: 191,
  capability: "service",
  enabled: true,
...
export const procurement_186_6_definition = {
  domain: "procurement",
  sequence: 192,
  capability: "service",
  enabled: true,
...
export const procurement_186_7_definition = {
  domain: "procurement",
  sequence: 193,
  capability: "service",
  enabled: true,
