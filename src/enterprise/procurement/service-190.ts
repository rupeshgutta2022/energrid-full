...
export const procurement_190_0_definition = {
  domain: "procurement",
  sequence: 190,
  capability: "service",
  enabled: true,
...
export const procurement_190_1_definition = {
  domain: "procurement",
  sequence: 191,
  capability: "service",
  enabled: true,
...
export const procurement_190_2_definition = {
  domain: "procurement",
  sequence: 192,
  capability: "service",
  enabled: true,
...
export const procurement_190_3_definition = {
  domain: "procurement",
  sequence: 193,
  capability: "service",
  enabled: true,
...
export const procurement_190_4_definition = {
  domain: "procurement",
  sequence: 194,
  capability: "service",
  enabled: true,
...
export const procurement_190_5_definition = {
  domain: "procurement",
  sequence: 195,
  capability: "service",
  enabled: true,
...
export const procurement_190_6_definition = {
  domain: "procurement",
  sequence: 196,
  capability: "service",
  enabled: true,
...
export const procurement_190_7_definition = {
  domain: "procurement",
  sequence: 197,
  capability: "service",
  enabled: true,
