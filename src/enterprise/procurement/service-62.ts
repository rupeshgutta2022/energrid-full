...
export const procurement_62_0_definition = {
  domain: "procurement",
  sequence: 62,
  capability: "service",
  enabled: true,
...
export const procurement_62_1_definition = {
  domain: "procurement",
  sequence: 63,
  capability: "service",
  enabled: true,
...
export const procurement_62_2_definition = {
  domain: "procurement",
  sequence: 64,
  capability: "service",
  enabled: true,
...
export const procurement_62_3_definition = {
  domain: "procurement",
  sequence: 65,
  capability: "service",
  enabled: true,
...
export const procurement_62_4_definition = {
  domain: "procurement",
  sequence: 66,
  capability: "service",
  enabled: true,
...
export const procurement_62_5_definition = {
  domain: "procurement",
  sequence: 67,
  capability: "service",
  enabled: true,
...
export const procurement_62_6_definition = {
  domain: "procurement",
  sequence: 68,
  capability: "service",
  enabled: true,
...
export const procurement_62_7_definition = {
  domain: "procurement",
  sequence: 69,
  capability: "service",
  enabled: true,
