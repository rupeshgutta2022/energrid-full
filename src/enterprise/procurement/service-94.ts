...
export const procurement_94_0_definition = {
  domain: "procurement",
  sequence: 94,
  capability: "service",
  enabled: true,
...
export const procurement_94_1_definition = {
  domain: "procurement",
  sequence: 95,
  capability: "service",
  enabled: true,
...
export const procurement_94_2_definition = {
  domain: "procurement",
  sequence: 96,
  capability: "service",
  enabled: true,
...
export const procurement_94_3_definition = {
  domain: "procurement",
  sequence: 97,
  capability: "service",
  enabled: true,
...
export const procurement_94_4_definition = {
  domain: "procurement",
  sequence: 98,
  capability: "service",
  enabled: true,
...
export const procurement_94_5_definition = {
  domain: "procurement",
  sequence: 99,
  capability: "service",
  enabled: true,
...
export const procurement_94_6_definition = {
  domain: "procurement",
  sequence: 100,
  capability: "service",
  enabled: true,
...
export const procurement_94_7_definition = {
  domain: "procurement",
  sequence: 101,
  capability: "service",
  enabled: true,
