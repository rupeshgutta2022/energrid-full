...
export const procurement_122_0_definition = {
  domain: "procurement",
  sequence: 122,
  capability: "service",
  enabled: true,
...
export const procurement_122_1_definition = {
  domain: "procurement",
  sequence: 123,
  capability: "service",
  enabled: true,
...
export const procurement_122_2_definition = {
  domain: "procurement",
  sequence: 124,
  capability: "service",
  enabled: true,
...
export const procurement_122_3_definition = {
  domain: "procurement",
  sequence: 125,
  capability: "service",
  enabled: true,
...
export const procurement_122_4_definition = {
  domain: "procurement",
  sequence: 126,
  capability: "service",
  enabled: true,
...
export const procurement_122_5_definition = {
  domain: "procurement",
  sequence: 127,
  capability: "service",
  enabled: true,
...
export const procurement_122_6_definition = {
  domain: "procurement",
  sequence: 128,
  capability: "service",
  enabled: true,
...
export const procurement_122_7_definition = {
  domain: "procurement",
  sequence: 129,
  capability: "service",
  enabled: true,
