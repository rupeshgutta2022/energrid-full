...
export const procurement_142_0_definition = {
  domain: "procurement",
  sequence: 142,
  capability: "service",
  enabled: true,
...
export const procurement_142_1_definition = {
  domain: "procurement",
  sequence: 143,
  capability: "service",
  enabled: true,
...
export const procurement_142_2_definition = {
  domain: "procurement",
  sequence: 144,
  capability: "service",
  enabled: true,
...
export const procurement_142_3_definition = {
  domain: "procurement",
  sequence: 145,
  capability: "service",
  enabled: true,
...
export const procurement_142_4_definition = {
  domain: "procurement",
  sequence: 146,
  capability: "service",
  enabled: true,
...
export const procurement_142_5_definition = {
  domain: "procurement",
  sequence: 147,
  capability: "service",
  enabled: true,
...
export const procurement_142_6_definition = {
  domain: "procurement",
  sequence: 148,
  capability: "service",
  enabled: true,
...
export const procurement_142_7_definition = {
  domain: "procurement",
  sequence: 149,
  capability: "service",
  enabled: true,
