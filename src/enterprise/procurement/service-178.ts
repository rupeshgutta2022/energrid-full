...
export const procurement_178_0_definition = {
  domain: "procurement",
  sequence: 178,
  capability: "service",
  enabled: true,
...
export const procurement_178_1_definition = {
  domain: "procurement",
  sequence: 179,
  capability: "service",
  enabled: true,
...
export const procurement_178_2_definition = {
  domain: "procurement",
  sequence: 180,
  capability: "service",
  enabled: true,
...
export const procurement_178_3_definition = {
  domain: "procurement",
  sequence: 181,
  capability: "service",
  enabled: true,
...
export const procurement_178_4_definition = {
  domain: "procurement",
  sequence: 182,
  capability: "service",
  enabled: true,
...
export const procurement_178_5_definition = {
  domain: "procurement",
  sequence: 183,
  capability: "service",
  enabled: true,
...
export const procurement_178_6_definition = {
  domain: "procurement",
  sequence: 184,
  capability: "service",
  enabled: true,
...
export const procurement_178_7_definition = {
  domain: "procurement",
  sequence: 185,
  capability: "service",
  enabled: true,
