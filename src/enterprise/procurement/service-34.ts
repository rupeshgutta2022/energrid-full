...
export const procurement_34_0_definition = {
  domain: "procurement",
  sequence: 34,
  capability: "service",
  enabled: true,
...
export const procurement_34_1_definition = {
  domain: "procurement",
  sequence: 35,
  capability: "service",
  enabled: true,
...
export const procurement_34_2_definition = {
  domain: "procurement",
  sequence: 36,
  capability: "service",
  enabled: true,
...
export const procurement_34_3_definition = {
  domain: "procurement",
  sequence: 37,
  capability: "service",
  enabled: true,
...
export const procurement_34_4_definition = {
  domain: "procurement",
  sequence: 38,
  capability: "service",
  enabled: true,
...
export const procurement_34_5_definition = {
  domain: "procurement",
  sequence: 39,
  capability: "service",
  enabled: true,
...
export const procurement_34_6_definition = {
  domain: "procurement",
  sequence: 40,
  capability: "service",
  enabled: true,
...
export const procurement_34_7_definition = {
  domain: "procurement",
  sequence: 41,
  capability: "service",
  enabled: true,
