...
export const procurement_130_0_definition = {
  domain: "procurement",
  sequence: 130,
  capability: "service",
  enabled: true,
...
export const procurement_130_1_definition = {
  domain: "procurement",
  sequence: 131,
  capability: "service",
  enabled: true,
...
export const procurement_130_2_definition = {
  domain: "procurement",
  sequence: 132,
  capability: "service",
  enabled: true,
...
export const procurement_130_3_definition = {
  domain: "procurement",
  sequence: 133,
  capability: "service",
  enabled: true,
...
export const procurement_130_4_definition = {
  domain: "procurement",
  sequence: 134,
  capability: "service",
  enabled: true,
...
export const procurement_130_5_definition = {
  domain: "procurement",
  sequence: 135,
  capability: "service",
  enabled: true,
...
export const procurement_130_6_definition = {
  domain: "procurement",
  sequence: 136,
  capability: "service",
  enabled: true,
...
export const procurement_130_7_definition = {
  domain: "procurement",
  sequence: 137,
  capability: "service",
  enabled: true,
