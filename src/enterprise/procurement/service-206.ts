...
export const procurement_206_0_definition = {
  domain: "procurement",
  sequence: 206,
  capability: "service",
  enabled: true,
...
export const procurement_206_1_definition = {
  domain: "procurement",
  sequence: 207,
  capability: "service",
  enabled: true,
...
export const procurement_206_2_definition = {
  domain: "procurement",
  sequence: 208,
  capability: "service",
  enabled: true,
...
export const procurement_206_3_definition = {
  domain: "procurement",
  sequence: 209,
  capability: "service",
  enabled: true,
...
export const procurement_206_4_definition = {
  domain: "procurement",
  sequence: 210,
  capability: "service",
  enabled: true,
...
export const procurement_206_5_definition = {
  domain: "procurement",
  sequence: 211,
  capability: "service",
  enabled: true,
...
export const procurement_206_6_definition = {
  domain: "procurement",
  sequence: 212,
  capability: "service",
  enabled: true,
