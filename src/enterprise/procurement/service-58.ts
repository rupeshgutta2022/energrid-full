...
export const procurement_58_0_definition = {
  domain: "procurement",
  sequence: 58,
  capability: "service",
  enabled: true,
...
export const procurement_58_1_definition = {
  domain: "procurement",
  sequence: 59,
  capability: "service",
  enabled: true,
...
export const procurement_58_2_definition = {
  domain: "procurement",
  sequence: 60,
  capability: "service",
  enabled: true,
...
export const procurement_58_3_definition = {
  domain: "procurement",
  sequence: 61,
  capability: "service",
  enabled: true,
...
export const procurement_58_4_definition = {
  domain: "procurement",
  sequence: 62,
  capability: "service",
  enabled: true,
...
export const procurement_58_5_definition = {
  domain: "procurement",
  sequence: 63,
  capability: "service",
  enabled: true,
...
export const procurement_58_6_definition = {
  domain: "procurement",
  sequence: 64,
  capability: "service",
  enabled: true,
...
export const procurement_58_7_definition = {
  domain: "procurement",
  sequence: 65,
  capability: "service",
  enabled: true,
