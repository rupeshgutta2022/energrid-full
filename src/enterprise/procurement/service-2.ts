...
export const procurement_2_0_definition = {
  domain: "procurement",
  sequence: 2,
  capability: "service",
  enabled: true,
...
export const procurement_2_1_definition = {
  domain: "procurement",
  sequence: 3,
  capability: "service",
  enabled: true,
...
export const procurement_2_2_definition = {
  domain: "procurement",
  sequence: 4,
  capability: "service",
  enabled: true,
...
export const procurement_2_3_definition = {
  domain: "procurement",
  sequence: 5,
  capability: "service",
  enabled: true,
...
export const procurement_2_4_definition = {
  domain: "procurement",
  sequence: 6,
  capability: "service",
  enabled: true,
...
export const procurement_2_5_definition = {
  domain: "procurement",
  sequence: 7,
  capability: "service",
  enabled: true,
...
export const procurement_2_6_definition = {
  domain: "procurement",
  sequence: 8,
  capability: "service",
  enabled: true,
...
export const procurement_2_7_definition = {
  domain: "procurement",
  sequence: 9,
  capability: "service",
  enabled: true,
