...
export const procurement_14_0_definition = {
  domain: "procurement",
  sequence: 14,
  capability: "service",
  enabled: true,
...
export const procurement_14_1_definition = {
  domain: "procurement",
  sequence: 15,
  capability: "service",
  enabled: true,
...
export const procurement_14_2_definition = {
  domain: "procurement",
  sequence: 16,
  capability: "service",
  enabled: true,
...
export const procurement_14_3_definition = {
  domain: "procurement",
  sequence: 17,
  capability: "service",
  enabled: true,
...
export const procurement_14_4_definition = {
  domain: "procurement",
  sequence: 18,
  capability: "service",
  enabled: true,
...
export const procurement_14_5_definition = {
  domain: "procurement",
  sequence: 19,
  capability: "service",
  enabled: true,
...
export const procurement_14_6_definition = {
  domain: "procurement",
  sequence: 20,
  capability: "service",
  enabled: true,
...
export const procurement_14_7_definition = {
  domain: "procurement",
  sequence: 21,
  capability: "service",
  enabled: true,
