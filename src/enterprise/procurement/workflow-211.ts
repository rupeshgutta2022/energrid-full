...
export const procurement_211_0_definition = {
  domain: "procurement",
  sequence: 211,
  capability: "workflow",
  enabled: true,
...
export const procurement_211_1_definition = {
  domain: "procurement",
  sequence: 212,
  capability: "workflow",
  enabled: true,
...
export const procurement_211_2_definition = {
  domain: "procurement",
  sequence: 213,
  capability: "workflow",
  enabled: true,
...
export const procurement_211_3_definition = {
  domain: "procurement",
  sequence: 214,
  capability: "workflow",
  enabled: true,
...
export const procurement_211_4_definition = {
  domain: "procurement",
  sequence: 215,
  capability: "workflow",
  enabled: true,
...
export const procurement_211_5_definition = {
  domain: "procurement",
  sequence: 216,
  capability: "workflow",
  enabled: true,
