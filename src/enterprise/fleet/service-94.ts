...
export const fleet_94_0_definition = {
  domain: "fleet",
  sequence: 94,
  capability: "service",
  enabled: true,
...
export const fleet_94_1_definition = {
  domain: "fleet",
  sequence: 95,
  capability: "service",
  enabled: true,
...
export const fleet_94_2_definition = {
  domain: "fleet",
  sequence: 96,
  capability: "service",
  enabled: true,
...
export const fleet_94_3_definition = {
  domain: "fleet",
  sequence: 97,
  capability: "service",
  enabled: true,
...
export const fleet_94_4_definition = {
  domain: "fleet",
  sequence: 98,
  capability: "service",
  enabled: true,
...
export const fleet_94_5_definition = {
  domain: "fleet",
  sequence: 99,
  capability: "service",
  enabled: true,
...
export const fleet_94_6_definition = {
  domain: "fleet",
  sequence: 100,
  capability: "service",
  enabled: true,
...
export const fleet_94_7_definition = {
  domain: "fleet",
  sequence: 101,
  capability: "service",
  enabled: true,
