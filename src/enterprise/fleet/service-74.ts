...
export const fleet_74_0_definition = {
  domain: "fleet",
  sequence: 74,
  capability: "service",
  enabled: true,
...
export const fleet_74_1_definition = {
  domain: "fleet",
  sequence: 75,
  capability: "service",
  enabled: true,
...
export const fleet_74_2_definition = {
  domain: "fleet",
  sequence: 76,
  capability: "service",
  enabled: true,
...
export const fleet_74_3_definition = {
  domain: "fleet",
  sequence: 77,
  capability: "service",
  enabled: true,
...
export const fleet_74_4_definition = {
  domain: "fleet",
  sequence: 78,
  capability: "service",
  enabled: true,
...
export const fleet_74_5_definition = {
  domain: "fleet",
  sequence: 79,
  capability: "service",
  enabled: true,
...
export const fleet_74_6_definition = {
  domain: "fleet",
  sequence: 80,
  capability: "service",
  enabled: true,
...
export const fleet_74_7_definition = {
  domain: "fleet",
  sequence: 81,
  capability: "service",
  enabled: true,
