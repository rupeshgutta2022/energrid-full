...
export const fleet_226_0_definition = {
  domain: "fleet",
  sequence: 226,
  capability: "service",
  enabled: true,
...
export const fleet_226_1_definition = {
  domain: "fleet",
  sequence: 227,
  capability: "service",
  enabled: true,
...
export const fleet_226_2_definition = {
  domain: "fleet",
  sequence: 228,
  capability: "service",
  enabled: true,
...
export const fleet_226_3_definition = {
  domain: "fleet",
  sequence: 229,
  capability: "service",
  enabled: true,
...
export const fleet_226_4_definition = {
  domain: "fleet",
  sequence: 230,
  capability: "service",
  enabled: true,
...
export const fleet_226_5_definition = {
  domain: "fleet",
  sequence: 231,
  capability: "service",
  enabled: true,
