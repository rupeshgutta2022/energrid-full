...
export const fleet_38_0_definition = {
  domain: "fleet",
  sequence: 38,
  capability: "service",
  enabled: true,
...
export const fleet_38_1_definition = {
  domain: "fleet",
  sequence: 39,
  capability: "service",
  enabled: true,
...
export const fleet_38_2_definition = {
  domain: "fleet",
  sequence: 40,
  capability: "service",
  enabled: true,
...
export const fleet_38_3_definition = {
  domain: "fleet",
  sequence: 41,
  capability: "service",
  enabled: true,
...
export const fleet_38_4_definition = {
  domain: "fleet",
  sequence: 42,
  capability: "service",
  enabled: true,
...
export const fleet_38_5_definition = {
  domain: "fleet",
  sequence: 43,
  capability: "service",
  enabled: true,
...
export const fleet_38_6_definition = {
  domain: "fleet",
  sequence: 44,
  capability: "service",
  enabled: true,
...
export const fleet_38_7_definition = {
  domain: "fleet",
  sequence: 45,
  capability: "service",
  enabled: true,
