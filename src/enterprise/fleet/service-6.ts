...
export const fleet_6_0_definition = {
  domain: "fleet",
  sequence: 6,
  capability: "service",
  enabled: true,
...
export const fleet_6_1_definition = {
  domain: "fleet",
  sequence: 7,
  capability: "service",
  enabled: true,
...
export const fleet_6_2_definition = {
  domain: "fleet",
  sequence: 8,
  capability: "service",
  enabled: true,
...
export const fleet_6_3_definition = {
  domain: "fleet",
  sequence: 9,
  capability: "service",
  enabled: true,
...
export const fleet_6_4_definition = {
  domain: "fleet",
  sequence: 10,
  capability: "service",
  enabled: true,
...
export const fleet_6_5_definition = {
  domain: "fleet",
  sequence: 11,
  capability: "service",
  enabled: true,
...
export const fleet_6_6_definition = {
  domain: "fleet",
  sequence: 12,
  capability: "service",
  enabled: true,
...
export const fleet_6_7_definition = {
  domain: "fleet",
  sequence: 13,
  capability: "service",
  enabled: true,
