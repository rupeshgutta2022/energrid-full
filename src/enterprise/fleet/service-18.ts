...
export const fleet_18_0_definition = {
  domain: "fleet",
  sequence: 18,
  capability: "service",
  enabled: true,
...
export const fleet_18_1_definition = {
  domain: "fleet",
  sequence: 19,
  capability: "service",
  enabled: true,
...
export const fleet_18_2_definition = {
  domain: "fleet",
  sequence: 20,
  capability: "service",
  enabled: true,
...
export const fleet_18_3_definition = {
  domain: "fleet",
  sequence: 21,
  capability: "service",
  enabled: true,
...
export const fleet_18_4_definition = {
  domain: "fleet",
  sequence: 22,
  capability: "service",
  enabled: true,
...
export const fleet_18_5_definition = {
  domain: "fleet",
  sequence: 23,
  capability: "service",
  enabled: true,
...
export const fleet_18_6_definition = {
  domain: "fleet",
  sequence: 24,
  capability: "service",
  enabled: true,
...
export const fleet_18_7_definition = {
  domain: "fleet",
  sequence: 25,
  capability: "service",
  enabled: true,
