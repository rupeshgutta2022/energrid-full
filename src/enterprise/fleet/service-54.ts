...
export const fleet_54_0_definition = {
  domain: "fleet",
  sequence: 54,
  capability: "service",
  enabled: true,
...
export const fleet_54_1_definition = {
  domain: "fleet",
  sequence: 55,
  capability: "service",
  enabled: true,
...
export const fleet_54_2_definition = {
  domain: "fleet",
  sequence: 56,
  capability: "service",
  enabled: true,
...
export const fleet_54_3_definition = {
  domain: "fleet",
  sequence: 57,
  capability: "service",
  enabled: true,
...
export const fleet_54_4_definition = {
  domain: "fleet",
  sequence: 58,
  capability: "service",
  enabled: true,
...
export const fleet_54_5_definition = {
  domain: "fleet",
  sequence: 59,
  capability: "service",
  enabled: true,
...
export const fleet_54_6_definition = {
  domain: "fleet",
  sequence: 60,
  capability: "service",
  enabled: true,
...
export const fleet_54_7_definition = {
  domain: "fleet",
  sequence: 61,
  capability: "service",
  enabled: true,
