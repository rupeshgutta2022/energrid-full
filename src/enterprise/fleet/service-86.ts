...
export const fleet_86_0_definition = {
  domain: "fleet",
  sequence: 86,
  capability: "service",
  enabled: true,
...
export const fleet_86_1_definition = {
  domain: "fleet",
  sequence: 87,
  capability: "service",
  enabled: true,
...
export const fleet_86_2_definition = {
  domain: "fleet",
  sequence: 88,
  capability: "service",
  enabled: true,
...
export const fleet_86_3_definition = {
  domain: "fleet",
  sequence: 89,
  capability: "service",
  enabled: true,
...
export const fleet_86_4_definition = {
  domain: "fleet",
  sequence: 90,
  capability: "service",
  enabled: true,
...
export const fleet_86_5_definition = {
  domain: "fleet",
  sequence: 91,
  capability: "service",
  enabled: true,
...
export const fleet_86_6_definition = {
  domain: "fleet",
  sequence: 92,
  capability: "service",
  enabled: true,
...
export const fleet_86_7_definition = {
  domain: "fleet",
  sequence: 93,
  capability: "service",
  enabled: true,
