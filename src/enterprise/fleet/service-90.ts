...
export const fleet_90_0_definition = {
  domain: "fleet",
  sequence: 90,
  capability: "service",
  enabled: true,
...
export const fleet_90_1_definition = {
  domain: "fleet",
  sequence: 91,
  capability: "service",
  enabled: true,
...
export const fleet_90_2_definition = {
  domain: "fleet",
  sequence: 92,
  capability: "service",
  enabled: true,
...
export const fleet_90_3_definition = {
  domain: "fleet",
  sequence: 93,
  capability: "service",
  enabled: true,
...
export const fleet_90_4_definition = {
  domain: "fleet",
  sequence: 94,
  capability: "service",
  enabled: true,
...
export const fleet_90_5_definition = {
  domain: "fleet",
  sequence: 95,
  capability: "service",
  enabled: true,
...
export const fleet_90_6_definition = {
  domain: "fleet",
  sequence: 96,
  capability: "service",
  enabled: true,
...
export const fleet_90_7_definition = {
  domain: "fleet",
  sequence: 97,
  capability: "service",
  enabled: true,
