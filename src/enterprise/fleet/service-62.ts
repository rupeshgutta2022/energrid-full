...
export const fleet_62_0_definition = {
  domain: "fleet",
  sequence: 62,
  capability: "service",
  enabled: true,
...
export const fleet_62_1_definition = {
  domain: "fleet",
  sequence: 63,
  capability: "service",
  enabled: true,
...
export const fleet_62_2_definition = {
  domain: "fleet",
  sequence: 64,
  capability: "service",
  enabled: true,
...
export const fleet_62_3_definition = {
  domain: "fleet",
  sequence: 65,
  capability: "service",
  enabled: true,
...
export const fleet_62_4_definition = {
  domain: "fleet",
  sequence: 66,
  capability: "service",
  enabled: true,
...
export const fleet_62_5_definition = {
  domain: "fleet",
  sequence: 67,
  capability: "service",
  enabled: true,
...
export const fleet_62_6_definition = {
  domain: "fleet",
  sequence: 68,
  capability: "service",
  enabled: true,
...
export const fleet_62_7_definition = {
  domain: "fleet",
  sequence: 69,
  capability: "service",
  enabled: true,
