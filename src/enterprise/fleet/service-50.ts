...
export const fleet_50_0_definition = {
  domain: "fleet",
  sequence: 50,
  capability: "service",
  enabled: true,
...
export const fleet_50_1_definition = {
  domain: "fleet",
  sequence: 51,
  capability: "service",
  enabled: true,
...
export const fleet_50_2_definition = {
  domain: "fleet",
  sequence: 52,
  capability: "service",
  enabled: true,
...
export const fleet_50_3_definition = {
  domain: "fleet",
  sequence: 53,
  capability: "service",
  enabled: true,
...
export const fleet_50_4_definition = {
  domain: "fleet",
  sequence: 54,
  capability: "service",
  enabled: true,
...
export const fleet_50_5_definition = {
  domain: "fleet",
  sequence: 55,
  capability: "service",
  enabled: true,
...
export const fleet_50_6_definition = {
  domain: "fleet",
  sequence: 56,
  capability: "service",
  enabled: true,
...
export const fleet_50_7_definition = {
  domain: "fleet",
  sequence: 57,
  capability: "service",
  enabled: true,
