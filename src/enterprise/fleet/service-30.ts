...
export const fleet_30_0_definition = {
  domain: "fleet",
  sequence: 30,
  capability: "service",
  enabled: true,
...
export const fleet_30_1_definition = {
  domain: "fleet",
  sequence: 31,
  capability: "service",
  enabled: true,
...
export const fleet_30_2_definition = {
  domain: "fleet",
  sequence: 32,
  capability: "service",
  enabled: true,
...
export const fleet_30_3_definition = {
  domain: "fleet",
  sequence: 33,
  capability: "service",
  enabled: true,
...
export const fleet_30_4_definition = {
  domain: "fleet",
  sequence: 34,
  capability: "service",
  enabled: true,
...
export const fleet_30_5_definition = {
  domain: "fleet",
  sequence: 35,
  capability: "service",
  enabled: true,
...
export const fleet_30_6_definition = {
  domain: "fleet",
  sequence: 36,
  capability: "service",
  enabled: true,
...
export const fleet_30_7_definition = {
  domain: "fleet",
  sequence: 37,
  capability: "service",
  enabled: true,
