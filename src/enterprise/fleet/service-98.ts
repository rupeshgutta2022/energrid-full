...
export const fleet_98_0_definition = {
  domain: "fleet",
  sequence: 98,
  capability: "service",
  enabled: true,
...
export const fleet_98_1_definition = {
  domain: "fleet",
  sequence: 99,
  capability: "service",
  enabled: true,
...
export const fleet_98_2_definition = {
  domain: "fleet",
  sequence: 100,
  capability: "service",
  enabled: true,
...
export const fleet_98_3_definition = {
  domain: "fleet",
  sequence: 101,
  capability: "service",
  enabled: true,
...
export const fleet_98_4_definition = {
  domain: "fleet",
  sequence: 102,
  capability: "service",
  enabled: true,
...
export const fleet_98_5_definition = {
  domain: "fleet",
  sequence: 103,
  capability: "service",
  enabled: true,
...
export const fleet_98_6_definition = {
  domain: "fleet",
  sequence: 104,
  capability: "service",
  enabled: true,
...
export const fleet_98_7_definition = {
  domain: "fleet",
  sequence: 105,
  capability: "service",
  enabled: true,
