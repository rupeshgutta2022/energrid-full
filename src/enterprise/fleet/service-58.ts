...
export const fleet_58_0_definition = {
  domain: "fleet",
  sequence: 58,
  capability: "service",
  enabled: true,
...
export const fleet_58_1_definition = {
  domain: "fleet",
  sequence: 59,
  capability: "service",
  enabled: true,
...
export const fleet_58_2_definition = {
  domain: "fleet",
  sequence: 60,
  capability: "service",
  enabled: true,
...
export const fleet_58_3_definition = {
  domain: "fleet",
  sequence: 61,
  capability: "service",
  enabled: true,
...
export const fleet_58_4_definition = {
  domain: "fleet",
  sequence: 62,
  capability: "service",
  enabled: true,
...
export const fleet_58_5_definition = {
  domain: "fleet",
  sequence: 63,
  capability: "service",
  enabled: true,
...
export const fleet_58_6_definition = {
  domain: "fleet",
  sequence: 64,
  capability: "service",
  enabled: true,
...
export const fleet_58_7_definition = {
  domain: "fleet",
  sequence: 65,
  capability: "service",
  enabled: true,
