...
export const fleet_70_0_definition = {
  domain: "fleet",
  sequence: 70,
  capability: "service",
  enabled: true,
...
export const fleet_70_1_definition = {
  domain: "fleet",
  sequence: 71,
  capability: "service",
  enabled: true,
...
export const fleet_70_2_definition = {
  domain: "fleet",
  sequence: 72,
  capability: "service",
  enabled: true,
...
export const fleet_70_3_definition = {
  domain: "fleet",
  sequence: 73,
  capability: "service",
  enabled: true,
...
export const fleet_70_4_definition = {
  domain: "fleet",
  sequence: 74,
  capability: "service",
  enabled: true,
...
export const fleet_70_5_definition = {
  domain: "fleet",
  sequence: 75,
  capability: "service",
  enabled: true,
...
export const fleet_70_6_definition = {
  domain: "fleet",
  sequence: 76,
  capability: "service",
  enabled: true,
...
export const fleet_70_7_definition = {
  domain: "fleet",
  sequence: 77,
  capability: "service",
  enabled: true,
