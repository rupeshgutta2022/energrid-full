...
export const fleet_10_0_definition = {
  domain: "fleet",
  sequence: 10,
  capability: "service",
  enabled: true,
...
export const fleet_10_1_definition = {
  domain: "fleet",
  sequence: 11,
  capability: "service",
  enabled: true,
...
export const fleet_10_2_definition = {
  domain: "fleet",
  sequence: 12,
  capability: "service",
  enabled: true,
...
export const fleet_10_3_definition = {
  domain: "fleet",
  sequence: 13,
  capability: "service",
  enabled: true,
...
export const fleet_10_4_definition = {
  domain: "fleet",
  sequence: 14,
  capability: "service",
  enabled: true,
...
export const fleet_10_5_definition = {
  domain: "fleet",
  sequence: 15,
  capability: "service",
  enabled: true,
...
export const fleet_10_6_definition = {
  domain: "fleet",
  sequence: 16,
  capability: "service",
  enabled: true,
...
export const fleet_10_7_definition = {
  domain: "fleet",
  sequence: 17,
  capability: "service",
  enabled: true,
