...
export const fleet_82_0_definition = {
  domain: "fleet",
  sequence: 82,
  capability: "service",
  enabled: true,
...
export const fleet_82_1_definition = {
  domain: "fleet",
  sequence: 83,
  capability: "service",
  enabled: true,
...
export const fleet_82_2_definition = {
  domain: "fleet",
  sequence: 84,
  capability: "service",
  enabled: true,
...
export const fleet_82_3_definition = {
  domain: "fleet",
  sequence: 85,
  capability: "service",
  enabled: true,
...
export const fleet_82_4_definition = {
  domain: "fleet",
  sequence: 86,
  capability: "service",
  enabled: true,
...
export const fleet_82_5_definition = {
  domain: "fleet",
  sequence: 87,
  capability: "service",
  enabled: true,
...
export const fleet_82_6_definition = {
  domain: "fleet",
  sequence: 88,
  capability: "service",
  enabled: true,
...
export const fleet_82_7_definition = {
  domain: "fleet",
  sequence: 89,
  capability: "service",
  enabled: true,
