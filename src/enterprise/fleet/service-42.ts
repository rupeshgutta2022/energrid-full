...
export const fleet_42_0_definition = {
  domain: "fleet",
  sequence: 42,
  capability: "service",
  enabled: true,
...
export const fleet_42_1_definition = {
  domain: "fleet",
  sequence: 43,
  capability: "service",
  enabled: true,
...
export const fleet_42_2_definition = {
  domain: "fleet",
  sequence: 44,
  capability: "service",
  enabled: true,
...
export const fleet_42_3_definition = {
  domain: "fleet",
  sequence: 45,
  capability: "service",
  enabled: true,
...
export const fleet_42_4_definition = {
  domain: "fleet",
  sequence: 46,
  capability: "service",
  enabled: true,
...
export const fleet_42_5_definition = {
  domain: "fleet",
  sequence: 47,
  capability: "service",
  enabled: true,
...
export const fleet_42_6_definition = {
  domain: "fleet",
  sequence: 48,
  capability: "service",
  enabled: true,
...
export const fleet_42_7_definition = {
  domain: "fleet",
  sequence: 49,
  capability: "service",
  enabled: true,
