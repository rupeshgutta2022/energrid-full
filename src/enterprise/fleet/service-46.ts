...
export const fleet_46_0_definition = {
  domain: "fleet",
  sequence: 46,
  capability: "service",
  enabled: true,
...
export const fleet_46_1_definition = {
  domain: "fleet",
  sequence: 47,
  capability: "service",
  enabled: true,
...
export const fleet_46_2_definition = {
  domain: "fleet",
  sequence: 48,
  capability: "service",
  enabled: true,
...
export const fleet_46_3_definition = {
  domain: "fleet",
  sequence: 49,
  capability: "service",
  enabled: true,
...
export const fleet_46_4_definition = {
  domain: "fleet",
  sequence: 50,
  capability: "service",
  enabled: true,
...
export const fleet_46_5_definition = {
  domain: "fleet",
  sequence: 51,
  capability: "service",
  enabled: true,
...
export const fleet_46_6_definition = {
  domain: "fleet",
  sequence: 52,
  capability: "service",
  enabled: true,
...
export const fleet_46_7_definition = {
  domain: "fleet",
  sequence: 53,
  capability: "service",
  enabled: true,
