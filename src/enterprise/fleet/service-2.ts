...
export const fleet_2_0_definition = {
  domain: "fleet",
  sequence: 2,
  capability: "service",
  enabled: true,
...
export const fleet_2_1_definition = {
  domain: "fleet",
  sequence: 3,
  capability: "service",
  enabled: true,
...
export const fleet_2_2_definition = {
  domain: "fleet",
  sequence: 4,
  capability: "service",
  enabled: true,
...
export const fleet_2_3_definition = {
  domain: "fleet",
  sequence: 5,
  capability: "service",
  enabled: true,
...
export const fleet_2_4_definition = {
  domain: "fleet",
  sequence: 6,
  capability: "service",
  enabled: true,
...
export const fleet_2_5_definition = {
  domain: "fleet",
  sequence: 7,
  capability: "service",
  enabled: true,
...
export const fleet_2_6_definition = {
  domain: "fleet",
  sequence: 8,
  capability: "service",
  enabled: true,
...
export const fleet_2_7_definition = {
  domain: "fleet",
  sequence: 9,
  capability: "service",
  enabled: true,
