...
export const fleet_22_0_definition = {
  domain: "fleet",
  sequence: 22,
  capability: "service",
  enabled: true,
...
export const fleet_22_1_definition = {
  domain: "fleet",
  sequence: 23,
  capability: "service",
  enabled: true,
...
export const fleet_22_2_definition = {
  domain: "fleet",
  sequence: 24,
  capability: "service",
  enabled: true,
...
export const fleet_22_3_definition = {
  domain: "fleet",
  sequence: 25,
  capability: "service",
  enabled: true,
...
export const fleet_22_4_definition = {
  domain: "fleet",
  sequence: 26,
  capability: "service",
  enabled: true,
...
export const fleet_22_5_definition = {
  domain: "fleet",
  sequence: 27,
  capability: "service",
  enabled: true,
...
export const fleet_22_6_definition = {
  domain: "fleet",
  sequence: 28,
  capability: "service",
  enabled: true,
...
export const fleet_22_7_definition = {
  domain: "fleet",
  sequence: 29,
  capability: "service",
  enabled: true,
