...
export const fleet_231_0_definition = {
  domain: "fleet",
  sequence: 231,
  capability: "workflow",
  enabled: true,
...
export const fleet_231_1_definition = {
  domain: "fleet",
  sequence: 232,
  capability: "workflow",
  enabled: true,
...
export const fleet_231_2_definition = {
  domain: "fleet",
  sequence: 233,
  capability: "workflow",
  enabled: true,
...
export const fleet_231_3_definition = {
  domain: "fleet",
  sequence: 234,
  capability: "workflow",
  enabled: true,
...
export const fleet_231_4_definition = {
  domain: "fleet",
  sequence: 235,
  capability: "workflow",
  enabled: true,
