...
export const fleet_26_0_definition = {
  domain: "fleet",
  sequence: 26,
  capability: "service",
  enabled: true,
...
export const fleet_26_1_definition = {
  domain: "fleet",
  sequence: 27,
  capability: "service",
  enabled: true,
...
export const fleet_26_2_definition = {
  domain: "fleet",
  sequence: 28,
  capability: "service",
  enabled: true,
...
export const fleet_26_3_definition = {
  domain: "fleet",
  sequence: 29,
  capability: "service",
  enabled: true,
...
export const fleet_26_4_definition = {
  domain: "fleet",
  sequence: 30,
  capability: "service",
  enabled: true,
...
export const fleet_26_5_definition = {
  domain: "fleet",
  sequence: 31,
  capability: "service",
  enabled: true,
...
export const fleet_26_6_definition = {
  domain: "fleet",
  sequence: 32,
  capability: "service",
  enabled: true,
...
export const fleet_26_7_definition = {
  domain: "fleet",
  sequence: 33,
  capability: "service",
  enabled: true,
