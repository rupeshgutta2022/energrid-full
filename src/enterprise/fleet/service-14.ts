...
export const fleet_14_0_definition = {
  domain: "fleet",
  sequence: 14,
  capability: "service",
  enabled: true,
...
export const fleet_14_1_definition = {
  domain: "fleet",
  sequence: 15,
  capability: "service",
  enabled: true,
...
export const fleet_14_2_definition = {
  domain: "fleet",
  sequence: 16,
  capability: "service",
  enabled: true,
...
export const fleet_14_3_definition = {
  domain: "fleet",
  sequence: 17,
  capability: "service",
  enabled: true,
...
export const fleet_14_4_definition = {
  domain: "fleet",
  sequence: 18,
  capability: "service",
  enabled: true,
...
export const fleet_14_5_definition = {
  domain: "fleet",
  sequence: 19,
  capability: "service",
  enabled: true,
...
export const fleet_14_6_definition = {
  domain: "fleet",
  sequence: 20,
  capability: "service",
  enabled: true,
...
export const fleet_14_7_definition = {
  domain: "fleet",
  sequence: 21,
  capability: "service",
  enabled: true,
