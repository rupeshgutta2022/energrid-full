...
export const shared_2_0_definition = {
  domain: "shared",
  sequence: 2,
  capability: "service",
  enabled: true,
...
export const shared_2_1_definition = {
  domain: "shared",
  sequence: 3,
  capability: "service",
  enabled: true,
...
export const shared_2_2_definition = {
  domain: "shared",
  sequence: 4,
  capability: "service",
  enabled: true,
...
export const shared_2_3_definition = {
  domain: "shared",
  sequence: 5,
  capability: "service",
  enabled: true,
...
export const shared_2_4_definition = {
  domain: "shared",
  sequence: 6,
  capability: "service",
  enabled: true,
...
export const shared_2_5_definition = {
  domain: "shared",
  sequence: 7,
  capability: "service",
  enabled: true,
...
export const shared_2_6_definition = {
  domain: "shared",
  sequence: 8,
  capability: "service",
  enabled: true,
...
export const shared_2_7_definition = {
  domain: "shared",
  sequence: 9,
  capability: "service",
  enabled: true,
