...
export const shared_174_0_definition = {
  domain: "shared",
  sequence: 174,
  capability: "service",
  enabled: true,
...
export const shared_174_1_definition = {
  domain: "shared",
  sequence: 175,
  capability: "service",
  enabled: true,
...
export const shared_174_2_definition = {
  domain: "shared",
  sequence: 176,
  capability: "service",
  enabled: true,
...
export const shared_174_3_definition = {
  domain: "shared",
  sequence: 177,
  capability: "service",
  enabled: true,
...
export const shared_174_4_definition = {
  domain: "shared",
  sequence: 178,
  capability: "service",
  enabled: true,
...
export const shared_174_5_definition = {
  domain: "shared",
  sequence: 179,
  capability: "service",
  enabled: true,
...
export const shared_174_6_definition = {
  domain: "shared",
  sequence: 180,
  capability: "service",
  enabled: true,
...
export const shared_174_7_definition = {
  domain: "shared",
  sequence: 181,
  capability: "service",
  enabled: true,
