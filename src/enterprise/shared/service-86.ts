...
export const shared_86_0_definition = {
  domain: "shared",
  sequence: 86,
  capability: "service",
  enabled: true,
...
export const shared_86_1_definition = {
  domain: "shared",
  sequence: 87,
  capability: "service",
  enabled: true,
...
export const shared_86_2_definition = {
  domain: "shared",
  sequence: 88,
  capability: "service",
  enabled: true,
...
export const shared_86_3_definition = {
  domain: "shared",
  sequence: 89,
  capability: "service",
  enabled: true,
...
export const shared_86_4_definition = {
  domain: "shared",
  sequence: 90,
  capability: "service",
  enabled: true,
...
export const shared_86_5_definition = {
  domain: "shared",
  sequence: 91,
  capability: "service",
  enabled: true,
...
export const shared_86_6_definition = {
  domain: "shared",
  sequence: 92,
  capability: "service",
  enabled: true,
...
export const shared_86_7_definition = {
  domain: "shared",
  sequence: 93,
  capability: "service",
  enabled: true,
