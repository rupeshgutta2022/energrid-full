...
export const shared_46_0_definition = {
  domain: "shared",
  sequence: 46,
  capability: "service",
  enabled: true,
...
export const shared_46_1_definition = {
  domain: "shared",
  sequence: 47,
  capability: "service",
  enabled: true,
...
export const shared_46_2_definition = {
  domain: "shared",
  sequence: 48,
  capability: "service",
  enabled: true,
...
export const shared_46_3_definition = {
  domain: "shared",
  sequence: 49,
  capability: "service",
  enabled: true,
...
export const shared_46_4_definition = {
  domain: "shared",
  sequence: 50,
  capability: "service",
  enabled: true,
...
export const shared_46_5_definition = {
  domain: "shared",
  sequence: 51,
  capability: "service",
  enabled: true,
...
export const shared_46_6_definition = {
  domain: "shared",
  sequence: 52,
  capability: "service",
  enabled: true,
...
export const shared_46_7_definition = {
  domain: "shared",
  sequence: 53,
  capability: "service",
  enabled: true,
