...
export const shared_22_0_definition = {
  domain: "shared",
  sequence: 22,
  capability: "service",
  enabled: true,
...
export const shared_22_1_definition = {
  domain: "shared",
  sequence: 23,
  capability: "service",
  enabled: true,
...
export const shared_22_2_definition = {
  domain: "shared",
  sequence: 24,
  capability: "service",
  enabled: true,
...
export const shared_22_3_definition = {
  domain: "shared",
  sequence: 25,
  capability: "service",
  enabled: true,
...
export const shared_22_4_definition = {
  domain: "shared",
  sequence: 26,
  capability: "service",
  enabled: true,
...
export const shared_22_5_definition = {
  domain: "shared",
  sequence: 27,
  capability: "service",
  enabled: true,
...
export const shared_22_6_definition = {
  domain: "shared",
  sequence: 28,
  capability: "service",
  enabled: true,
...
export const shared_22_7_definition = {
  domain: "shared",
  sequence: 29,
  capability: "service",
  enabled: true,
