...
export const shared_186_0_definition = {
  domain: "shared",
  sequence: 186,
  capability: "service",
  enabled: true,
...
export const shared_186_1_definition = {
  domain: "shared",
  sequence: 187,
  capability: "service",
  enabled: true,
...
export const shared_186_2_definition = {
  domain: "shared",
  sequence: 188,
  capability: "service",
  enabled: true,
...
export const shared_186_3_definition = {
  domain: "shared",
  sequence: 189,
  capability: "service",
  enabled: true,
...
export const shared_186_4_definition = {
  domain: "shared",
  sequence: 190,
  capability: "service",
  enabled: true,
...
export const shared_186_5_definition = {
  domain: "shared",
  sequence: 191,
  capability: "service",
  enabled: true,
...
export const shared_186_6_definition = {
  domain: "shared",
  sequence: 192,
  capability: "service",
  enabled: true,
...
export const shared_186_7_definition = {
  domain: "shared",
  sequence: 193,
  capability: "service",
  enabled: true,
