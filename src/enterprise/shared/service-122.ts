...
export const shared_122_0_definition = {
  domain: "shared",
  sequence: 122,
  capability: "service",
  enabled: true,
...
export const shared_122_1_definition = {
  domain: "shared",
  sequence: 123,
  capability: "service",
  enabled: true,
...
export const shared_122_2_definition = {
  domain: "shared",
  sequence: 124,
  capability: "service",
  enabled: true,
...
export const shared_122_3_definition = {
  domain: "shared",
  sequence: 125,
  capability: "service",
  enabled: true,
...
export const shared_122_4_definition = {
  domain: "shared",
  sequence: 126,
  capability: "service",
  enabled: true,
...
export const shared_122_5_definition = {
  domain: "shared",
  sequence: 127,
  capability: "service",
  enabled: true,
...
export const shared_122_6_definition = {
  domain: "shared",
  sequence: 128,
  capability: "service",
  enabled: true,
...
export const shared_122_7_definition = {
  domain: "shared",
  sequence: 129,
  capability: "service",
  enabled: true,
