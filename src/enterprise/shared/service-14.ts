...
export const shared_14_0_definition = {
  domain: "shared",
  sequence: 14,
  capability: "service",
  enabled: true,
...
export const shared_14_1_definition = {
  domain: "shared",
  sequence: 15,
  capability: "service",
  enabled: true,
...
export const shared_14_2_definition = {
  domain: "shared",
  sequence: 16,
  capability: "service",
  enabled: true,
...
export const shared_14_3_definition = {
  domain: "shared",
  sequence: 17,
  capability: "service",
  enabled: true,
...
export const shared_14_4_definition = {
  domain: "shared",
  sequence: 18,
  capability: "service",
  enabled: true,
...
export const shared_14_5_definition = {
  domain: "shared",
  sequence: 19,
  capability: "service",
  enabled: true,
...
export const shared_14_6_definition = {
  domain: "shared",
  sequence: 20,
  capability: "service",
  enabled: true,
...
export const shared_14_7_definition = {
  domain: "shared",
  sequence: 21,
  capability: "service",
  enabled: true,
