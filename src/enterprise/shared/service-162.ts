...
export const shared_162_0_definition = {
  domain: "shared",
  sequence: 162,
  capability: "service",
  enabled: true,
...
export const shared_162_1_definition = {
  domain: "shared",
  sequence: 163,
  capability: "service",
  enabled: true,
...
export const shared_162_2_definition = {
  domain: "shared",
  sequence: 164,
  capability: "service",
  enabled: true,
...
export const shared_162_3_definition = {
  domain: "shared",
  sequence: 165,
  capability: "service",
  enabled: true,
...
export const shared_162_4_definition = {
  domain: "shared",
  sequence: 166,
  capability: "service",
  enabled: true,
...
export const shared_162_5_definition = {
  domain: "shared",
  sequence: 167,
  capability: "service",
  enabled: true,
...
export const shared_162_6_definition = {
  domain: "shared",
  sequence: 168,
  capability: "service",
  enabled: true,
...
export const shared_162_7_definition = {
  domain: "shared",
  sequence: 169,
  capability: "service",
  enabled: true,
