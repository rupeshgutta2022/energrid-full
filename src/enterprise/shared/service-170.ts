...
export const shared_170_0_definition = {
  domain: "shared",
  sequence: 170,
  capability: "service",
  enabled: true,
...
export const shared_170_1_definition = {
  domain: "shared",
  sequence: 171,
  capability: "service",
  enabled: true,
...
export const shared_170_2_definition = {
  domain: "shared",
  sequence: 172,
  capability: "service",
  enabled: true,
...
export const shared_170_3_definition = {
  domain: "shared",
  sequence: 173,
  capability: "service",
  enabled: true,
...
export const shared_170_4_definition = {
  domain: "shared",
  sequence: 174,
  capability: "service",
  enabled: true,
...
export const shared_170_5_definition = {
  domain: "shared",
  sequence: 175,
  capability: "service",
  enabled: true,
...
export const shared_170_6_definition = {
  domain: "shared",
  sequence: 176,
  capability: "service",
  enabled: true,
...
export const shared_170_7_definition = {
  domain: "shared",
  sequence: 177,
  capability: "service",
  enabled: true,
