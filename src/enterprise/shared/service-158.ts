...
export const shared_158_0_definition = {
  domain: "shared",
  sequence: 158,
  capability: "service",
  enabled: true,
...
export const shared_158_1_definition = {
  domain: "shared",
  sequence: 159,
  capability: "service",
  enabled: true,
...
export const shared_158_2_definition = {
  domain: "shared",
  sequence: 160,
  capability: "service",
  enabled: true,
...
export const shared_158_3_definition = {
  domain: "shared",
  sequence: 161,
  capability: "service",
  enabled: true,
...
export const shared_158_4_definition = {
  domain: "shared",
  sequence: 162,
  capability: "service",
  enabled: true,
...
export const shared_158_5_definition = {
  domain: "shared",
  sequence: 163,
  capability: "service",
  enabled: true,
...
export const shared_158_6_definition = {
  domain: "shared",
  sequence: 164,
  capability: "service",
  enabled: true,
...
export const shared_158_7_definition = {
  domain: "shared",
  sequence: 165,
  capability: "service",
  enabled: true,
