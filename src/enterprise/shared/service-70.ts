...
export const shared_70_0_definition = {
  domain: "shared",
  sequence: 70,
  capability: "service",
  enabled: true,
...
export const shared_70_1_definition = {
  domain: "shared",
  sequence: 71,
  capability: "service",
  enabled: true,
...
export const shared_70_2_definition = {
  domain: "shared",
  sequence: 72,
  capability: "service",
  enabled: true,
...
export const shared_70_3_definition = {
  domain: "shared",
  sequence: 73,
  capability: "service",
  enabled: true,
...
export const shared_70_4_definition = {
  domain: "shared",
  sequence: 74,
  capability: "service",
  enabled: true,
...
export const shared_70_5_definition = {
  domain: "shared",
  sequence: 75,
  capability: "service",
  enabled: true,
...
export const shared_70_6_definition = {
  domain: "shared",
  sequence: 76,
  capability: "service",
  enabled: true,
...
export const shared_70_7_definition = {
  domain: "shared",
  sequence: 77,
  capability: "service",
  enabled: true,
