...
export const shared_182_0_definition = {
  domain: "shared",
  sequence: 182,
  capability: "service",
  enabled: true,
...
export const shared_182_1_definition = {
  domain: "shared",
  sequence: 183,
  capability: "service",
  enabled: true,
...
export const shared_182_2_definition = {
  domain: "shared",
  sequence: 184,
  capability: "service",
  enabled: true,
...
export const shared_182_3_definition = {
  domain: "shared",
  sequence: 185,
  capability: "service",
  enabled: true,
...
export const shared_182_4_definition = {
  domain: "shared",
  sequence: 186,
  capability: "service",
  enabled: true,
...
export const shared_182_5_definition = {
  domain: "shared",
  sequence: 187,
  capability: "service",
  enabled: true,
...
export const shared_182_6_definition = {
  domain: "shared",
  sequence: 188,
  capability: "service",
  enabled: true,
...
export const shared_182_7_definition = {
  domain: "shared",
  sequence: 189,
  capability: "service",
  enabled: true,
