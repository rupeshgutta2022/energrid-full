...
export const shared_106_0_definition = {
  domain: "shared",
  sequence: 106,
  capability: "service",
  enabled: true,
...
export const shared_106_1_definition = {
  domain: "shared",
  sequence: 107,
  capability: "service",
  enabled: true,
...
export const shared_106_2_definition = {
  domain: "shared",
  sequence: 108,
  capability: "service",
  enabled: true,
...
export const shared_106_3_definition = {
  domain: "shared",
  sequence: 109,
  capability: "service",
  enabled: true,
...
export const shared_106_4_definition = {
  domain: "shared",
  sequence: 110,
  capability: "service",
  enabled: true,
...
export const shared_106_5_definition = {
  domain: "shared",
  sequence: 111,
  capability: "service",
  enabled: true,
...
export const shared_106_6_definition = {
  domain: "shared",
  sequence: 112,
  capability: "service",
  enabled: true,
...
export const shared_106_7_definition = {
  domain: "shared",
  sequence: 113,
  capability: "service",
  enabled: true,
