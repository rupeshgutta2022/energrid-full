...
export const shared_150_0_definition = {
  domain: "shared",
  sequence: 150,
  capability: "service",
  enabled: true,
...
export const shared_150_1_definition = {
  domain: "shared",
  sequence: 151,
  capability: "service",
  enabled: true,
...
export const shared_150_2_definition = {
  domain: "shared",
  sequence: 152,
  capability: "service",
  enabled: true,
...
export const shared_150_3_definition = {
  domain: "shared",
  sequence: 153,
  capability: "service",
  enabled: true,
...
export const shared_150_4_definition = {
  domain: "shared",
  sequence: 154,
  capability: "service",
  enabled: true,
...
export const shared_150_5_definition = {
  domain: "shared",
  sequence: 155,
  capability: "service",
  enabled: true,
...
export const shared_150_6_definition = {
  domain: "shared",
  sequence: 156,
  capability: "service",
  enabled: true,
...
export const shared_150_7_definition = {
  domain: "shared",
  sequence: 157,
  capability: "service",
  enabled: true,
