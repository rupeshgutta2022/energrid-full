...
export const shared_30_0_definition = {
  domain: "shared",
  sequence: 30,
  capability: "service",
  enabled: true,
...
export const shared_30_1_definition = {
  domain: "shared",
  sequence: 31,
  capability: "service",
  enabled: true,
...
export const shared_30_2_definition = {
  domain: "shared",
  sequence: 32,
  capability: "service",
  enabled: true,
...
export const shared_30_3_definition = {
  domain: "shared",
  sequence: 33,
  capability: "service",
  enabled: true,
...
export const shared_30_4_definition = {
  domain: "shared",
  sequence: 34,
  capability: "service",
  enabled: true,
...
export const shared_30_5_definition = {
  domain: "shared",
  sequence: 35,
  capability: "service",
  enabled: true,
...
export const shared_30_6_definition = {
  domain: "shared",
  sequence: 36,
  capability: "service",
  enabled: true,
...
export const shared_30_7_definition = {
  domain: "shared",
  sequence: 37,
  capability: "service",
  enabled: true,
