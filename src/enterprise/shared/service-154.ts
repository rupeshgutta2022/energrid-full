...
export const shared_154_0_definition = {
  domain: "shared",
  sequence: 154,
  capability: "service",
  enabled: true,
...
export const shared_154_1_definition = {
  domain: "shared",
  sequence: 155,
  capability: "service",
  enabled: true,
...
export const shared_154_2_definition = {
  domain: "shared",
  sequence: 156,
  capability: "service",
  enabled: true,
...
export const shared_154_3_definition = {
  domain: "shared",
  sequence: 157,
  capability: "service",
  enabled: true,
...
export const shared_154_4_definition = {
  domain: "shared",
  sequence: 158,
  capability: "service",
  enabled: true,
...
export const shared_154_5_definition = {
  domain: "shared",
  sequence: 159,
  capability: "service",
  enabled: true,
...
export const shared_154_6_definition = {
  domain: "shared",
  sequence: 160,
  capability: "service",
  enabled: true,
...
export const shared_154_7_definition = {
  domain: "shared",
  sequence: 161,
  capability: "service",
  enabled: true,
