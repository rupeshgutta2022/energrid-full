...
export const shared_82_0_definition = {
  domain: "shared",
  sequence: 82,
  capability: "service",
  enabled: true,
...
export const shared_82_1_definition = {
  domain: "shared",
  sequence: 83,
  capability: "service",
  enabled: true,
...
export const shared_82_2_definition = {
  domain: "shared",
  sequence: 84,
  capability: "service",
  enabled: true,
...
export const shared_82_3_definition = {
  domain: "shared",
  sequence: 85,
  capability: "service",
  enabled: true,
...
export const shared_82_4_definition = {
  domain: "shared",
  sequence: 86,
  capability: "service",
  enabled: true,
...
export const shared_82_5_definition = {
  domain: "shared",
  sequence: 87,
  capability: "service",
  enabled: true,
...
export const shared_82_6_definition = {
  domain: "shared",
  sequence: 88,
  capability: "service",
  enabled: true,
...
export const shared_82_7_definition = {
  domain: "shared",
  sequence: 89,
  capability: "service",
  enabled: true,
