...
export const shared_138_0_definition = {
  domain: "shared",
  sequence: 138,
  capability: "service",
  enabled: true,
...
export const shared_138_1_definition = {
  domain: "shared",
  sequence: 139,
  capability: "service",
  enabled: true,
...
export const shared_138_2_definition = {
  domain: "shared",
  sequence: 140,
  capability: "service",
  enabled: true,
...
export const shared_138_3_definition = {
  domain: "shared",
  sequence: 141,
  capability: "service",
  enabled: true,
...
export const shared_138_4_definition = {
  domain: "shared",
  sequence: 142,
  capability: "service",
  enabled: true,
...
export const shared_138_5_definition = {
  domain: "shared",
  sequence: 143,
  capability: "service",
  enabled: true,
...
export const shared_138_6_definition = {
  domain: "shared",
  sequence: 144,
  capability: "service",
  enabled: true,
...
export const shared_138_7_definition = {
  domain: "shared",
  sequence: 145,
  capability: "service",
  enabled: true,
