...
export const shared_26_0_definition = {
  domain: "shared",
  sequence: 26,
  capability: "service",
  enabled: true,
...
export const shared_26_1_definition = {
  domain: "shared",
  sequence: 27,
  capability: "service",
  enabled: true,
...
export const shared_26_2_definition = {
  domain: "shared",
  sequence: 28,
  capability: "service",
  enabled: true,
...
export const shared_26_3_definition = {
  domain: "shared",
  sequence: 29,
  capability: "service",
  enabled: true,
...
export const shared_26_4_definition = {
  domain: "shared",
  sequence: 30,
  capability: "service",
  enabled: true,
...
export const shared_26_5_definition = {
  domain: "shared",
  sequence: 31,
  capability: "service",
  enabled: true,
...
export const shared_26_6_definition = {
  domain: "shared",
  sequence: 32,
  capability: "service",
  enabled: true,
...
export const shared_26_7_definition = {
  domain: "shared",
  sequence: 33,
  capability: "service",
  enabled: true,
