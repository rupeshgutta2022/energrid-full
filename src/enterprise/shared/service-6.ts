...
export const shared_6_0_definition = {
  domain: "shared",
  sequence: 6,
  capability: "service",
  enabled: true,
...
export const shared_6_1_definition = {
  domain: "shared",
  sequence: 7,
  capability: "service",
  enabled: true,
...
export const shared_6_2_definition = {
  domain: "shared",
  sequence: 8,
  capability: "service",
  enabled: true,
...
export const shared_6_3_definition = {
  domain: "shared",
  sequence: 9,
  capability: "service",
  enabled: true,
...
export const shared_6_4_definition = {
  domain: "shared",
  sequence: 10,
  capability: "service",
  enabled: true,
...
export const shared_6_5_definition = {
  domain: "shared",
  sequence: 11,
  capability: "service",
  enabled: true,
...
export const shared_6_6_definition = {
  domain: "shared",
  sequence: 12,
  capability: "service",
  enabled: true,
...
export const shared_6_7_definition = {
  domain: "shared",
  sequence: 13,
  capability: "service",
  enabled: true,
