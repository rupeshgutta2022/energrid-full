...
export const shared_90_0_definition = {
  domain: "shared",
  sequence: 90,
  capability: "service",
  enabled: true,
...
export const shared_90_1_definition = {
  domain: "shared",
  sequence: 91,
  capability: "service",
  enabled: true,
...
export const shared_90_2_definition = {
  domain: "shared",
  sequence: 92,
  capability: "service",
  enabled: true,
...
export const shared_90_3_definition = {
  domain: "shared",
  sequence: 93,
  capability: "service",
  enabled: true,
...
export const shared_90_4_definition = {
  domain: "shared",
  sequence: 94,
  capability: "service",
  enabled: true,
...
export const shared_90_5_definition = {
  domain: "shared",
  sequence: 95,
  capability: "service",
  enabled: true,
...
export const shared_90_6_definition = {
  domain: "shared",
  sequence: 96,
  capability: "service",
  enabled: true,
...
export const shared_90_7_definition = {
  domain: "shared",
  sequence: 97,
  capability: "service",
  enabled: true,
