...
export const shared_98_0_definition = {
  domain: "shared",
  sequence: 98,
  capability: "service",
  enabled: true,
...
export const shared_98_1_definition = {
  domain: "shared",
  sequence: 99,
  capability: "service",
  enabled: true,
...
export const shared_98_2_definition = {
  domain: "shared",
  sequence: 100,
  capability: "service",
  enabled: true,
...
export const shared_98_3_definition = {
  domain: "shared",
  sequence: 101,
  capability: "service",
  enabled: true,
...
export const shared_98_4_definition = {
  domain: "shared",
  sequence: 102,
  capability: "service",
  enabled: true,
...
export const shared_98_5_definition = {
  domain: "shared",
  sequence: 103,
  capability: "service",
  enabled: true,
...
export const shared_98_6_definition = {
  domain: "shared",
  sequence: 104,
  capability: "service",
  enabled: true,
...
export const shared_98_7_definition = {
  domain: "shared",
  sequence: 105,
  capability: "service",
  enabled: true,
