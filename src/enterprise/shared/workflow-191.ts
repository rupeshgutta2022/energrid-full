...
export const shared_191_0_definition = {
  domain: "shared",
  sequence: 191,
  capability: "workflow",
  enabled: true,
...
export const shared_191_1_definition = {
  domain: "shared",
  sequence: 192,
  capability: "workflow",
  enabled: true,
...
export const shared_191_2_definition = {
  domain: "shared",
  sequence: 193,
  capability: "workflow",
  enabled: true,
...
export const shared_191_3_definition = {
  domain: "shared",
  sequence: 194,
  capability: "workflow",
  enabled: true,
...
export const shared_191_4_definition = {
  domain: "shared",
  sequence: 195,
  capability: "workflow",
  enabled: true,
...
export const shared_191_5_definition = {
  domain: "shared",
  sequence: 196,
  capability: "workflow",
  enabled: true,
...
export const shared_191_6_definition = {
  domain: "shared",
  sequence: 197,
  capability: "workflow",
  enabled: true,
