...
export const shared_102_0_definition = {
  domain: "shared",
  sequence: 102,
  capability: "service",
  enabled: true,
...
export const shared_102_1_definition = {
  domain: "shared",
  sequence: 103,
  capability: "service",
  enabled: true,
...
export const shared_102_2_definition = {
  domain: "shared",
  sequence: 104,
  capability: "service",
  enabled: true,
...
export const shared_102_3_definition = {
  domain: "shared",
  sequence: 105,
  capability: "service",
  enabled: true,
...
export const shared_102_4_definition = {
  domain: "shared",
  sequence: 106,
  capability: "service",
  enabled: true,
...
export const shared_102_5_definition = {
  domain: "shared",
  sequence: 107,
  capability: "service",
  enabled: true,
...
export const shared_102_6_definition = {
  domain: "shared",
  sequence: 108,
  capability: "service",
  enabled: true,
...
export const shared_102_7_definition = {
  domain: "shared",
  sequence: 109,
  capability: "service",
  enabled: true,
