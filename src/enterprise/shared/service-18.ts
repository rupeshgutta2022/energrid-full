...
export const shared_18_0_definition = {
  domain: "shared",
  sequence: 18,
  capability: "service",
  enabled: true,
...
export const shared_18_1_definition = {
  domain: "shared",
  sequence: 19,
  capability: "service",
  enabled: true,
...
export const shared_18_2_definition = {
  domain: "shared",
  sequence: 20,
  capability: "service",
  enabled: true,
...
export const shared_18_3_definition = {
  domain: "shared",
  sequence: 21,
  capability: "service",
  enabled: true,
...
export const shared_18_4_definition = {
  domain: "shared",
  sequence: 22,
  capability: "service",
  enabled: true,
...
export const shared_18_5_definition = {
  domain: "shared",
  sequence: 23,
  capability: "service",
  enabled: true,
...
export const shared_18_6_definition = {
  domain: "shared",
  sequence: 24,
  capability: "service",
  enabled: true,
...
export const shared_18_7_definition = {
  domain: "shared",
  sequence: 25,
  capability: "service",
  enabled: true,
