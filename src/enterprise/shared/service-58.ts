...
export const shared_58_0_definition = {
  domain: "shared",
  sequence: 58,
  capability: "service",
  enabled: true,
...
export const shared_58_1_definition = {
  domain: "shared",
  sequence: 59,
  capability: "service",
  enabled: true,
...
export const shared_58_2_definition = {
  domain: "shared",
  sequence: 60,
  capability: "service",
  enabled: true,
...
export const shared_58_3_definition = {
  domain: "shared",
  sequence: 61,
  capability: "service",
  enabled: true,
...
export const shared_58_4_definition = {
  domain: "shared",
  sequence: 62,
  capability: "service",
  enabled: true,
...
export const shared_58_5_definition = {
  domain: "shared",
  sequence: 63,
  capability: "service",
  enabled: true,
...
export const shared_58_6_definition = {
  domain: "shared",
  sequence: 64,
  capability: "service",
  enabled: true,
...
export const shared_58_7_definition = {
  domain: "shared",
  sequence: 65,
  capability: "service",
  enabled: true,
