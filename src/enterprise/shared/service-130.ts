...
export const shared_130_0_definition = {
  domain: "shared",
  sequence: 130,
  capability: "service",
  enabled: true,
...
export const shared_130_1_definition = {
  domain: "shared",
  sequence: 131,
  capability: "service",
  enabled: true,
...
export const shared_130_2_definition = {
  domain: "shared",
  sequence: 132,
  capability: "service",
  enabled: true,
...
export const shared_130_3_definition = {
  domain: "shared",
  sequence: 133,
  capability: "service",
  enabled: true,
...
export const shared_130_4_definition = {
  domain: "shared",
  sequence: 134,
  capability: "service",
  enabled: true,
...
export const shared_130_5_definition = {
  domain: "shared",
  sequence: 135,
  capability: "service",
  enabled: true,
...
export const shared_130_6_definition = {
  domain: "shared",
  sequence: 136,
  capability: "service",
  enabled: true,
...
export const shared_130_7_definition = {
  domain: "shared",
  sequence: 137,
  capability: "service",
  enabled: true,
