...
export const shared_146_0_definition = {
  domain: "shared",
  sequence: 146,
  capability: "service",
  enabled: true,
...
export const shared_146_1_definition = {
  domain: "shared",
  sequence: 147,
  capability: "service",
  enabled: true,
...
export const shared_146_2_definition = {
  domain: "shared",
  sequence: 148,
  capability: "service",
  enabled: true,
...
export const shared_146_3_definition = {
  domain: "shared",
  sequence: 149,
  capability: "service",
  enabled: true,
...
export const shared_146_4_definition = {
  domain: "shared",
  sequence: 150,
  capability: "service",
  enabled: true,
...
export const shared_146_5_definition = {
  domain: "shared",
  sequence: 151,
  capability: "service",
  enabled: true,
...
export const shared_146_6_definition = {
  domain: "shared",
  sequence: 152,
  capability: "service",
  enabled: true,
...
export const shared_146_7_definition = {
  domain: "shared",
  sequence: 153,
  capability: "service",
  enabled: true,
