...
export const shared_134_0_definition = {
  domain: "shared",
  sequence: 134,
  capability: "service",
  enabled: true,
...
export const shared_134_1_definition = {
  domain: "shared",
  sequence: 135,
  capability: "service",
  enabled: true,
...
export const shared_134_2_definition = {
  domain: "shared",
  sequence: 136,
  capability: "service",
  enabled: true,
...
export const shared_134_3_definition = {
  domain: "shared",
  sequence: 137,
  capability: "service",
  enabled: true,
...
export const shared_134_4_definition = {
  domain: "shared",
  sequence: 138,
  capability: "service",
  enabled: true,
...
export const shared_134_5_definition = {
  domain: "shared",
  sequence: 139,
  capability: "service",
  enabled: true,
...
export const shared_134_6_definition = {
  domain: "shared",
  sequence: 140,
  capability: "service",
  enabled: true,
...
export const shared_134_7_definition = {
  domain: "shared",
  sequence: 141,
  capability: "service",
  enabled: true,
