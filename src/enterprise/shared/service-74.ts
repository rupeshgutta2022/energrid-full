...
export const shared_74_0_definition = {
  domain: "shared",
  sequence: 74,
  capability: "service",
  enabled: true,
...
export const shared_74_1_definition = {
  domain: "shared",
  sequence: 75,
  capability: "service",
  enabled: true,
...
export const shared_74_2_definition = {
  domain: "shared",
  sequence: 76,
  capability: "service",
  enabled: true,
...
export const shared_74_3_definition = {
  domain: "shared",
  sequence: 77,
  capability: "service",
  enabled: true,
...
export const shared_74_4_definition = {
  domain: "shared",
  sequence: 78,
  capability: "service",
  enabled: true,
...
export const shared_74_5_definition = {
  domain: "shared",
  sequence: 79,
  capability: "service",
  enabled: true,
...
export const shared_74_6_definition = {
  domain: "shared",
  sequence: 80,
  capability: "service",
  enabled: true,
...
export const shared_74_7_definition = {
  domain: "shared",
  sequence: 81,
  capability: "service",
  enabled: true,
