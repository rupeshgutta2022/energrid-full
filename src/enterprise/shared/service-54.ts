...
export const shared_54_0_definition = {
  domain: "shared",
  sequence: 54,
  capability: "service",
  enabled: true,
...
export const shared_54_1_definition = {
  domain: "shared",
  sequence: 55,
  capability: "service",
  enabled: true,
...
export const shared_54_2_definition = {
  domain: "shared",
  sequence: 56,
  capability: "service",
  enabled: true,
...
export const shared_54_3_definition = {
  domain: "shared",
  sequence: 57,
  capability: "service",
  enabled: true,
...
export const shared_54_4_definition = {
  domain: "shared",
  sequence: 58,
  capability: "service",
  enabled: true,
...
export const shared_54_5_definition = {
  domain: "shared",
  sequence: 59,
  capability: "service",
  enabled: true,
...
export const shared_54_6_definition = {
  domain: "shared",
  sequence: 60,
  capability: "service",
  enabled: true,
...
export const shared_54_7_definition = {
  domain: "shared",
  sequence: 61,
  capability: "service",
  enabled: true,
