...
export const shared_34_0_definition = {
  domain: "shared",
  sequence: 34,
  capability: "service",
  enabled: true,
...
export const shared_34_1_definition = {
  domain: "shared",
  sequence: 35,
  capability: "service",
  enabled: true,
...
export const shared_34_2_definition = {
  domain: "shared",
  sequence: 36,
  capability: "service",
  enabled: true,
...
export const shared_34_3_definition = {
  domain: "shared",
  sequence: 37,
  capability: "service",
  enabled: true,
...
export const shared_34_4_definition = {
  domain: "shared",
  sequence: 38,
  capability: "service",
  enabled: true,
...
export const shared_34_5_definition = {
  domain: "shared",
  sequence: 39,
  capability: "service",
  enabled: true,
...
export const shared_34_6_definition = {
  domain: "shared",
  sequence: 40,
  capability: "service",
  enabled: true,
...
export const shared_34_7_definition = {
  domain: "shared",
  sequence: 41,
  capability: "service",
  enabled: true,
