...
export const shared_10_0_definition = {
  domain: "shared",
  sequence: 10,
  capability: "service",
  enabled: true,
...
export const shared_10_1_definition = {
  domain: "shared",
  sequence: 11,
  capability: "service",
  enabled: true,
...
export const shared_10_2_definition = {
  domain: "shared",
  sequence: 12,
  capability: "service",
  enabled: true,
...
export const shared_10_3_definition = {
  domain: "shared",
  sequence: 13,
  capability: "service",
  enabled: true,
...
export const shared_10_4_definition = {
  domain: "shared",
  sequence: 14,
  capability: "service",
  enabled: true,
...
export const shared_10_5_definition = {
  domain: "shared",
  sequence: 15,
  capability: "service",
  enabled: true,
...
export const shared_10_6_definition = {
  domain: "shared",
  sequence: 16,
  capability: "service",
  enabled: true,
...
export const shared_10_7_definition = {
  domain: "shared",
  sequence: 17,
  capability: "service",
  enabled: true,
