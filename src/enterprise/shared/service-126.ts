...
export const shared_126_0_definition = {
  domain: "shared",
  sequence: 126,
  capability: "service",
  enabled: true,
...
export const shared_126_1_definition = {
  domain: "shared",
  sequence: 127,
  capability: "service",
  enabled: true,
...
export const shared_126_2_definition = {
  domain: "shared",
  sequence: 128,
  capability: "service",
  enabled: true,
...
export const shared_126_3_definition = {
  domain: "shared",
  sequence: 129,
  capability: "service",
  enabled: true,
...
export const shared_126_4_definition = {
  domain: "shared",
  sequence: 130,
  capability: "service",
  enabled: true,
...
export const shared_126_5_definition = {
  domain: "shared",
  sequence: 131,
  capability: "service",
  enabled: true,
...
export const shared_126_6_definition = {
  domain: "shared",
  sequence: 132,
  capability: "service",
  enabled: true,
...
export const shared_126_7_definition = {
  domain: "shared",
  sequence: 133,
  capability: "service",
  enabled: true,
