...
export const shared_78_0_definition = {
  domain: "shared",
  sequence: 78,
  capability: "service",
  enabled: true,
...
export const shared_78_1_definition = {
  domain: "shared",
  sequence: 79,
  capability: "service",
  enabled: true,
...
export const shared_78_2_definition = {
  domain: "shared",
  sequence: 80,
  capability: "service",
  enabled: true,
...
export const shared_78_3_definition = {
  domain: "shared",
  sequence: 81,
  capability: "service",
  enabled: true,
...
export const shared_78_4_definition = {
  domain: "shared",
  sequence: 82,
  capability: "service",
  enabled: true,
...
export const shared_78_5_definition = {
  domain: "shared",
  sequence: 83,
  capability: "service",
  enabled: true,
...
export const shared_78_6_definition = {
  domain: "shared",
  sequence: 84,
  capability: "service",
  enabled: true,
...
export const shared_78_7_definition = {
  domain: "shared",
  sequence: 85,
  capability: "service",
  enabled: true,
