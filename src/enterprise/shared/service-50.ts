...
export const shared_50_0_definition = {
  domain: "shared",
  sequence: 50,
  capability: "service",
  enabled: true,
...
export const shared_50_1_definition = {
  domain: "shared",
  sequence: 51,
  capability: "service",
  enabled: true,
...
export const shared_50_2_definition = {
  domain: "shared",
  sequence: 52,
  capability: "service",
  enabled: true,
...
export const shared_50_3_definition = {
  domain: "shared",
  sequence: 53,
  capability: "service",
  enabled: true,
...
export const shared_50_4_definition = {
  domain: "shared",
  sequence: 54,
  capability: "service",
  enabled: true,
...
export const shared_50_5_definition = {
  domain: "shared",
  sequence: 55,
  capability: "service",
  enabled: true,
...
export const shared_50_6_definition = {
  domain: "shared",
  sequence: 56,
  capability: "service",
  enabled: true,
...
export const shared_50_7_definition = {
  domain: "shared",
  sequence: 57,
  capability: "service",
  enabled: true,
