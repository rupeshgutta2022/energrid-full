...
export const shared_118_0_definition = {
  domain: "shared",
  sequence: 118,
  capability: "service",
  enabled: true,
...
export const shared_118_1_definition = {
  domain: "shared",
  sequence: 119,
  capability: "service",
  enabled: true,
...
export const shared_118_2_definition = {
  domain: "shared",
  sequence: 120,
  capability: "service",
  enabled: true,
...
export const shared_118_3_definition = {
  domain: "shared",
  sequence: 121,
  capability: "service",
  enabled: true,
...
export const shared_118_4_definition = {
  domain: "shared",
  sequence: 122,
  capability: "service",
  enabled: true,
...
export const shared_118_5_definition = {
  domain: "shared",
  sequence: 123,
  capability: "service",
  enabled: true,
...
export const shared_118_6_definition = {
  domain: "shared",
  sequence: 124,
  capability: "service",
  enabled: true,
...
export const shared_118_7_definition = {
  domain: "shared",
  sequence: 125,
  capability: "service",
  enabled: true,
