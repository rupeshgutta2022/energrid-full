...
export const shared_166_0_definition = {
  domain: "shared",
  sequence: 166,
  capability: "service",
  enabled: true,
...
export const shared_166_1_definition = {
  domain: "shared",
  sequence: 167,
  capability: "service",
  enabled: true,
...
export const shared_166_2_definition = {
  domain: "shared",
  sequence: 168,
  capability: "service",
  enabled: true,
...
export const shared_166_3_definition = {
  domain: "shared",
  sequence: 169,
  capability: "service",
  enabled: true,
...
export const shared_166_4_definition = {
  domain: "shared",
  sequence: 170,
  capability: "service",
  enabled: true,
...
export const shared_166_5_definition = {
  domain: "shared",
  sequence: 171,
  capability: "service",
  enabled: true,
...
export const shared_166_6_definition = {
  domain: "shared",
  sequence: 172,
  capability: "service",
  enabled: true,
...
export const shared_166_7_definition = {
  domain: "shared",
  sequence: 173,
  capability: "service",
  enabled: true,
