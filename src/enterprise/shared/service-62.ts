...
export const shared_62_0_definition = {
  domain: "shared",
  sequence: 62,
  capability: "service",
  enabled: true,
...
export const shared_62_1_definition = {
  domain: "shared",
  sequence: 63,
  capability: "service",
  enabled: true,
...
export const shared_62_2_definition = {
  domain: "shared",
  sequence: 64,
  capability: "service",
  enabled: true,
...
export const shared_62_3_definition = {
  domain: "shared",
  sequence: 65,
  capability: "service",
  enabled: true,
...
export const shared_62_4_definition = {
  domain: "shared",
  sequence: 66,
  capability: "service",
  enabled: true,
...
export const shared_62_5_definition = {
  domain: "shared",
  sequence: 67,
  capability: "service",
  enabled: true,
...
export const shared_62_6_definition = {
  domain: "shared",
  sequence: 68,
  capability: "service",
  enabled: true,
...
export const shared_62_7_definition = {
  domain: "shared",
  sequence: 69,
  capability: "service",
  enabled: true,
