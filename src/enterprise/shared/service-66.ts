...
export const shared_66_0_definition = {
  domain: "shared",
  sequence: 66,
  capability: "service",
  enabled: true,
...
export const shared_66_1_definition = {
  domain: "shared",
  sequence: 67,
  capability: "service",
  enabled: true,
...
export const shared_66_2_definition = {
  domain: "shared",
  sequence: 68,
  capability: "service",
  enabled: true,
...
export const shared_66_3_definition = {
  domain: "shared",
  sequence: 69,
  capability: "service",
  enabled: true,
...
export const shared_66_4_definition = {
  domain: "shared",
  sequence: 70,
  capability: "service",
  enabled: true,
...
export const shared_66_5_definition = {
  domain: "shared",
  sequence: 71,
  capability: "service",
  enabled: true,
...
export const shared_66_6_definition = {
  domain: "shared",
  sequence: 72,
  capability: "service",
  enabled: true,
...
export const shared_66_7_definition = {
  domain: "shared",
  sequence: 73,
  capability: "service",
  enabled: true,
