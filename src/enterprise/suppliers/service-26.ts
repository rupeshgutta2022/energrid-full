...
export const suppliers_26_0_definition = {
  domain: "suppliers",
  sequence: 26,
  capability: "service",
  enabled: true,
...
export const suppliers_26_1_definition = {
  domain: "suppliers",
  sequence: 27,
  capability: "service",
  enabled: true,
...
export const suppliers_26_2_definition = {
  domain: "suppliers",
  sequence: 28,
  capability: "service",
  enabled: true,
...
export const suppliers_26_3_definition = {
  domain: "suppliers",
  sequence: 29,
  capability: "service",
  enabled: true,
...
export const suppliers_26_4_definition = {
  domain: "suppliers",
  sequence: 30,
  capability: "service",
  enabled: true,
...
export const suppliers_26_5_definition = {
  domain: "suppliers",
  sequence: 31,
  capability: "service",
  enabled: true,
...
export const suppliers_26_6_definition = {
  domain: "suppliers",
  sequence: 32,
  capability: "service",
  enabled: true,
...
export const suppliers_26_7_definition = {
  domain: "suppliers",
  sequence: 33,
  capability: "service",
  enabled: true,
