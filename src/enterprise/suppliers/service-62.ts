...
export const suppliers_62_0_definition = {
  domain: "suppliers",
  sequence: 62,
  capability: "service",
  enabled: true,
...
export const suppliers_62_1_definition = {
  domain: "suppliers",
  sequence: 63,
  capability: "service",
  enabled: true,
...
export const suppliers_62_2_definition = {
  domain: "suppliers",
  sequence: 64,
  capability: "service",
  enabled: true,
...
export const suppliers_62_3_definition = {
  domain: "suppliers",
  sequence: 65,
  capability: "service",
  enabled: true,
...
export const suppliers_62_4_definition = {
  domain: "suppliers",
  sequence: 66,
  capability: "service",
  enabled: true,
...
export const suppliers_62_5_definition = {
  domain: "suppliers",
  sequence: 67,
  capability: "service",
  enabled: true,
...
export const suppliers_62_6_definition = {
  domain: "suppliers",
  sequence: 68,
  capability: "service",
  enabled: true,
...
export const suppliers_62_7_definition = {
  domain: "suppliers",
  sequence: 69,
  capability: "service",
  enabled: true,
