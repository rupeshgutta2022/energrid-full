...
export const suppliers_18_0_definition = {
  domain: "suppliers",
  sequence: 18,
  capability: "service",
  enabled: true,
...
export const suppliers_18_1_definition = {
  domain: "suppliers",
  sequence: 19,
  capability: "service",
  enabled: true,
...
export const suppliers_18_2_definition = {
  domain: "suppliers",
  sequence: 20,
  capability: "service",
  enabled: true,
...
export const suppliers_18_3_definition = {
  domain: "suppliers",
  sequence: 21,
  capability: "service",
  enabled: true,
...
export const suppliers_18_4_definition = {
  domain: "suppliers",
  sequence: 22,
  capability: "service",
  enabled: true,
...
export const suppliers_18_5_definition = {
  domain: "suppliers",
  sequence: 23,
  capability: "service",
  enabled: true,
...
export const suppliers_18_6_definition = {
  domain: "suppliers",
  sequence: 24,
  capability: "service",
  enabled: true,
...
export const suppliers_18_7_definition = {
  domain: "suppliers",
  sequence: 25,
  capability: "service",
  enabled: true,
