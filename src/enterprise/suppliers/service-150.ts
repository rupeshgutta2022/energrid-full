...
export const suppliers_150_0_definition = {
  domain: "suppliers",
  sequence: 150,
  capability: "service",
  enabled: true,
...
export const suppliers_150_1_definition = {
  domain: "suppliers",
  sequence: 151,
  capability: "service",
  enabled: true,
...
export const suppliers_150_2_definition = {
  domain: "suppliers",
  sequence: 152,
  capability: "service",
  enabled: true,
...
export const suppliers_150_3_definition = {
  domain: "suppliers",
  sequence: 153,
  capability: "service",
  enabled: true,
...
export const suppliers_150_4_definition = {
  domain: "suppliers",
  sequence: 154,
  capability: "service",
  enabled: true,
...
export const suppliers_150_5_definition = {
  domain: "suppliers",
  sequence: 155,
  capability: "service",
  enabled: true,
...
export const suppliers_150_6_definition = {
  domain: "suppliers",
  sequence: 156,
  capability: "service",
  enabled: true,
...
export const suppliers_150_7_definition = {
  domain: "suppliers",
  sequence: 157,
  capability: "service",
  enabled: true,
