...
export const suppliers_58_0_definition = {
  domain: "suppliers",
  sequence: 58,
  capability: "service",
  enabled: true,
...
export const suppliers_58_1_definition = {
  domain: "suppliers",
  sequence: 59,
  capability: "service",
  enabled: true,
...
export const suppliers_58_2_definition = {
  domain: "suppliers",
  sequence: 60,
  capability: "service",
  enabled: true,
...
export const suppliers_58_3_definition = {
  domain: "suppliers",
  sequence: 61,
  capability: "service",
  enabled: true,
...
export const suppliers_58_4_definition = {
  domain: "suppliers",
  sequence: 62,
  capability: "service",
  enabled: true,
...
export const suppliers_58_5_definition = {
  domain: "suppliers",
  sequence: 63,
  capability: "service",
  enabled: true,
...
export const suppliers_58_6_definition = {
  domain: "suppliers",
  sequence: 64,
  capability: "service",
  enabled: true,
...
export const suppliers_58_7_definition = {
  domain: "suppliers",
  sequence: 65,
  capability: "service",
  enabled: true,
