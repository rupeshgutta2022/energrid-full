...
export const suppliers_22_0_definition = {
  domain: "suppliers",
  sequence: 22,
  capability: "service",
  enabled: true,
...
export const suppliers_22_1_definition = {
  domain: "suppliers",
  sequence: 23,
  capability: "service",
  enabled: true,
...
export const suppliers_22_2_definition = {
  domain: "suppliers",
  sequence: 24,
  capability: "service",
  enabled: true,
...
export const suppliers_22_3_definition = {
  domain: "suppliers",
  sequence: 25,
  capability: "service",
  enabled: true,
...
export const suppliers_22_4_definition = {
  domain: "suppliers",
  sequence: 26,
  capability: "service",
  enabled: true,
...
export const suppliers_22_5_definition = {
  domain: "suppliers",
  sequence: 27,
  capability: "service",
  enabled: true,
...
export const suppliers_22_6_definition = {
  domain: "suppliers",
  sequence: 28,
  capability: "service",
  enabled: true,
...
export const suppliers_22_7_definition = {
  domain: "suppliers",
  sequence: 29,
  capability: "service",
  enabled: true,
