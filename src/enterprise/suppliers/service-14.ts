...
export const suppliers_14_0_definition = {
  domain: "suppliers",
  sequence: 14,
  capability: "service",
  enabled: true,
...
export const suppliers_14_1_definition = {
  domain: "suppliers",
  sequence: 15,
  capability: "service",
  enabled: true,
...
export const suppliers_14_2_definition = {
  domain: "suppliers",
  sequence: 16,
  capability: "service",
  enabled: true,
...
export const suppliers_14_3_definition = {
  domain: "suppliers",
  sequence: 17,
  capability: "service",
  enabled: true,
...
export const suppliers_14_4_definition = {
  domain: "suppliers",
  sequence: 18,
  capability: "service",
  enabled: true,
...
export const suppliers_14_5_definition = {
  domain: "suppliers",
  sequence: 19,
  capability: "service",
  enabled: true,
...
export const suppliers_14_6_definition = {
  domain: "suppliers",
  sequence: 20,
  capability: "service",
  enabled: true,
...
export const suppliers_14_7_definition = {
  domain: "suppliers",
  sequence: 21,
  capability: "service",
  enabled: true,
