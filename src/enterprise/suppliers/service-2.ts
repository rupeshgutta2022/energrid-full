...
export const suppliers_2_0_definition = {
  domain: "suppliers",
  sequence: 2,
  capability: "service",
  enabled: true,
...
export const suppliers_2_1_definition = {
  domain: "suppliers",
  sequence: 3,
  capability: "service",
  enabled: true,
...
export const suppliers_2_2_definition = {
  domain: "suppliers",
  sequence: 4,
  capability: "service",
  enabled: true,
...
export const suppliers_2_3_definition = {
  domain: "suppliers",
  sequence: 5,
  capability: "service",
  enabled: true,
...
export const suppliers_2_4_definition = {
  domain: "suppliers",
  sequence: 6,
  capability: "service",
  enabled: true,
...
export const suppliers_2_5_definition = {
  domain: "suppliers",
  sequence: 7,
  capability: "service",
  enabled: true,
...
export const suppliers_2_6_definition = {
  domain: "suppliers",
  sequence: 8,
  capability: "service",
  enabled: true,
...
export const suppliers_2_7_definition = {
  domain: "suppliers",
  sequence: 9,
  capability: "service",
  enabled: true,
