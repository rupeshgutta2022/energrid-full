...
export const suppliers_158_0_definition = {
  domain: "suppliers",
  sequence: 158,
  capability: "service",
  enabled: true,
...
export const suppliers_158_1_definition = {
  domain: "suppliers",
  sequence: 159,
  capability: "service",
  enabled: true,
...
export const suppliers_158_2_definition = {
  domain: "suppliers",
  sequence: 160,
  capability: "service",
  enabled: true,
...
export const suppliers_158_3_definition = {
  domain: "suppliers",
  sequence: 161,
  capability: "service",
  enabled: true,
