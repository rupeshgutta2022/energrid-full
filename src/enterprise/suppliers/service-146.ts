...
export const suppliers_146_0_definition = {
  domain: "suppliers",
  sequence: 146,
  capability: "service",
  enabled: true,
...
export const suppliers_146_1_definition = {
  domain: "suppliers",
  sequence: 147,
  capability: "service",
  enabled: true,
...
export const suppliers_146_2_definition = {
  domain: "suppliers",
  sequence: 148,
  capability: "service",
  enabled: true,
...
export const suppliers_146_3_definition = {
  domain: "suppliers",
  sequence: 149,
  capability: "service",
  enabled: true,
...
export const suppliers_146_4_definition = {
  domain: "suppliers",
  sequence: 150,
  capability: "service",
  enabled: true,
...
export const suppliers_146_5_definition = {
  domain: "suppliers",
  sequence: 151,
  capability: "service",
  enabled: true,
...
export const suppliers_146_6_definition = {
  domain: "suppliers",
  sequence: 152,
  capability: "service",
  enabled: true,
...
export const suppliers_146_7_definition = {
  domain: "suppliers",
  sequence: 153,
  capability: "service",
  enabled: true,
