...
export const suppliers_42_0_definition = {
  domain: "suppliers",
  sequence: 42,
  capability: "service",
  enabled: true,
...
export const suppliers_42_1_definition = {
  domain: "suppliers",
  sequence: 43,
  capability: "service",
  enabled: true,
...
export const suppliers_42_2_definition = {
  domain: "suppliers",
  sequence: 44,
  capability: "service",
  enabled: true,
...
export const suppliers_42_3_definition = {
  domain: "suppliers",
  sequence: 45,
  capability: "service",
  enabled: true,
...
export const suppliers_42_4_definition = {
  domain: "suppliers",
  sequence: 46,
  capability: "service",
  enabled: true,
...
export const suppliers_42_5_definition = {
  domain: "suppliers",
  sequence: 47,
  capability: "service",
  enabled: true,
...
export const suppliers_42_6_definition = {
  domain: "suppliers",
  sequence: 48,
  capability: "service",
  enabled: true,
...
export const suppliers_42_7_definition = {
  domain: "suppliers",
  sequence: 49,
  capability: "service",
  enabled: true,
