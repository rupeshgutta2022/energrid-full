...
export const suppliers_106_0_definition = {
  domain: "suppliers",
  sequence: 106,
  capability: "service",
  enabled: true,
...
export const suppliers_106_1_definition = {
  domain: "suppliers",
  sequence: 107,
  capability: "service",
  enabled: true,
...
export const suppliers_106_2_definition = {
  domain: "suppliers",
  sequence: 108,
  capability: "service",
  enabled: true,
...
export const suppliers_106_3_definition = {
  domain: "suppliers",
  sequence: 109,
  capability: "service",
  enabled: true,
...
export const suppliers_106_4_definition = {
  domain: "suppliers",
  sequence: 110,
  capability: "service",
  enabled: true,
...
export const suppliers_106_5_definition = {
  domain: "suppliers",
  sequence: 111,
  capability: "service",
  enabled: true,
...
export const suppliers_106_6_definition = {
  domain: "suppliers",
  sequence: 112,
  capability: "service",
  enabled: true,
...
export const suppliers_106_7_definition = {
  domain: "suppliers",
  sequence: 113,
  capability: "service",
  enabled: true,
