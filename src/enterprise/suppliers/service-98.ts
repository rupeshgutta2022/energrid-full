...
export const suppliers_98_0_definition = {
  domain: "suppliers",
  sequence: 98,
  capability: "service",
  enabled: true,
...
export const suppliers_98_1_definition = {
  domain: "suppliers",
  sequence: 99,
  capability: "service",
  enabled: true,
...
export const suppliers_98_2_definition = {
  domain: "suppliers",
  sequence: 100,
  capability: "service",
  enabled: true,
...
export const suppliers_98_3_definition = {
  domain: "suppliers",
  sequence: 101,
  capability: "service",
  enabled: true,
...
export const suppliers_98_4_definition = {
  domain: "suppliers",
  sequence: 102,
  capability: "service",
  enabled: true,
...
export const suppliers_98_5_definition = {
  domain: "suppliers",
  sequence: 103,
  capability: "service",
  enabled: true,
...
export const suppliers_98_6_definition = {
  domain: "suppliers",
  sequence: 104,
  capability: "service",
  enabled: true,
...
export const suppliers_98_7_definition = {
  domain: "suppliers",
  sequence: 105,
  capability: "service",
  enabled: true,
