...
export const suppliers_134_0_definition = {
  domain: "suppliers",
  sequence: 134,
  capability: "service",
  enabled: true,
...
export const suppliers_134_1_definition = {
  domain: "suppliers",
  sequence: 135,
  capability: "service",
  enabled: true,
...
export const suppliers_134_2_definition = {
  domain: "suppliers",
  sequence: 136,
  capability: "service",
  enabled: true,
...
export const suppliers_134_3_definition = {
  domain: "suppliers",
  sequence: 137,
  capability: "service",
  enabled: true,
...
export const suppliers_134_4_definition = {
  domain: "suppliers",
  sequence: 138,
  capability: "service",
  enabled: true,
...
export const suppliers_134_5_definition = {
  domain: "suppliers",
  sequence: 139,
  capability: "service",
  enabled: true,
...
export const suppliers_134_6_definition = {
  domain: "suppliers",
  sequence: 140,
  capability: "service",
  enabled: true,
...
export const suppliers_134_7_definition = {
  domain: "suppliers",
  sequence: 141,
  capability: "service",
  enabled: true,
