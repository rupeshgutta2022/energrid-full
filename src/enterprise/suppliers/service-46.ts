...
export const suppliers_46_0_definition = {
  domain: "suppliers",
  sequence: 46,
  capability: "service",
  enabled: true,
...
export const suppliers_46_1_definition = {
  domain: "suppliers",
  sequence: 47,
  capability: "service",
  enabled: true,
...
export const suppliers_46_2_definition = {
  domain: "suppliers",
  sequence: 48,
  capability: "service",
  enabled: true,
...
export const suppliers_46_3_definition = {
  domain: "suppliers",
  sequence: 49,
  capability: "service",
  enabled: true,
...
export const suppliers_46_4_definition = {
  domain: "suppliers",
  sequence: 50,
  capability: "service",
  enabled: true,
...
export const suppliers_46_5_definition = {
  domain: "suppliers",
  sequence: 51,
  capability: "service",
  enabled: true,
...
export const suppliers_46_6_definition = {
  domain: "suppliers",
  sequence: 52,
  capability: "service",
  enabled: true,
...
export const suppliers_46_7_definition = {
  domain: "suppliers",
  sequence: 53,
  capability: "service",
  enabled: true,
