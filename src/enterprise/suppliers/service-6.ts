...
export const suppliers_6_0_definition = {
  domain: "suppliers",
  sequence: 6,
  capability: "service",
  enabled: true,
...
export const suppliers_6_1_definition = {
  domain: "suppliers",
  sequence: 7,
  capability: "service",
  enabled: true,
...
export const suppliers_6_2_definition = {
  domain: "suppliers",
  sequence: 8,
  capability: "service",
  enabled: true,
...
export const suppliers_6_3_definition = {
  domain: "suppliers",
  sequence: 9,
  capability: "service",
  enabled: true,
...
export const suppliers_6_4_definition = {
  domain: "suppliers",
  sequence: 10,
  capability: "service",
  enabled: true,
...
export const suppliers_6_5_definition = {
  domain: "suppliers",
  sequence: 11,
  capability: "service",
  enabled: true,
...
export const suppliers_6_6_definition = {
  domain: "suppliers",
  sequence: 12,
  capability: "service",
  enabled: true,
...
export const suppliers_6_7_definition = {
  domain: "suppliers",
  sequence: 13,
  capability: "service",
  enabled: true,
