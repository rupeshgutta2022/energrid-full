...
export const suppliers_130_0_definition = {
  domain: "suppliers",
  sequence: 130,
  capability: "service",
  enabled: true,
...
export const suppliers_130_1_definition = {
  domain: "suppliers",
  sequence: 131,
  capability: "service",
  enabled: true,
...
export const suppliers_130_2_definition = {
  domain: "suppliers",
  sequence: 132,
  capability: "service",
  enabled: true,
...
export const suppliers_130_3_definition = {
  domain: "suppliers",
  sequence: 133,
  capability: "service",
  enabled: true,
...
export const suppliers_130_4_definition = {
  domain: "suppliers",
  sequence: 134,
  capability: "service",
  enabled: true,
...
export const suppliers_130_5_definition = {
  domain: "suppliers",
  sequence: 135,
  capability: "service",
  enabled: true,
...
export const suppliers_130_6_definition = {
  domain: "suppliers",
  sequence: 136,
  capability: "service",
  enabled: true,
...
export const suppliers_130_7_definition = {
  domain: "suppliers",
  sequence: 137,
  capability: "service",
  enabled: true,
