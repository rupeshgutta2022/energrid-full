...
export const suppliers_114_0_definition = {
  domain: "suppliers",
  sequence: 114,
  capability: "service",
  enabled: true,
...
export const suppliers_114_1_definition = {
  domain: "suppliers",
  sequence: 115,
  capability: "service",
  enabled: true,
...
export const suppliers_114_2_definition = {
  domain: "suppliers",
  sequence: 116,
  capability: "service",
  enabled: true,
...
export const suppliers_114_3_definition = {
  domain: "suppliers",
  sequence: 117,
  capability: "service",
  enabled: true,
...
export const suppliers_114_4_definition = {
  domain: "suppliers",
  sequence: 118,
  capability: "service",
  enabled: true,
...
export const suppliers_114_5_definition = {
  domain: "suppliers",
  sequence: 119,
  capability: "service",
  enabled: true,
...
export const suppliers_114_6_definition = {
  domain: "suppliers",
  sequence: 120,
  capability: "service",
  enabled: true,
...
export const suppliers_114_7_definition = {
  domain: "suppliers",
  sequence: 121,
  capability: "service",
  enabled: true,
