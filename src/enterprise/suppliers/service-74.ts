...
export const suppliers_74_0_definition = {
  domain: "suppliers",
  sequence: 74,
  capability: "service",
  enabled: true,
...
export const suppliers_74_1_definition = {
  domain: "suppliers",
  sequence: 75,
  capability: "service",
  enabled: true,
...
export const suppliers_74_2_definition = {
  domain: "suppliers",
  sequence: 76,
  capability: "service",
  enabled: true,
...
export const suppliers_74_3_definition = {
  domain: "suppliers",
  sequence: 77,
  capability: "service",
  enabled: true,
...
export const suppliers_74_4_definition = {
  domain: "suppliers",
  sequence: 78,
  capability: "service",
  enabled: true,
...
export const suppliers_74_5_definition = {
  domain: "suppliers",
  sequence: 79,
  capability: "service",
  enabled: true,
...
export const suppliers_74_6_definition = {
  domain: "suppliers",
  sequence: 80,
  capability: "service",
  enabled: true,
...
export const suppliers_74_7_definition = {
  domain: "suppliers",
  sequence: 81,
  capability: "service",
  enabled: true,
