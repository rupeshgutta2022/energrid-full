...
export const suppliers_138_0_definition = {
  domain: "suppliers",
  sequence: 138,
  capability: "service",
  enabled: true,
...
export const suppliers_138_1_definition = {
  domain: "suppliers",
  sequence: 139,
  capability: "service",
  enabled: true,
...
export const suppliers_138_2_definition = {
  domain: "suppliers",
  sequence: 140,
  capability: "service",
  enabled: true,
...
export const suppliers_138_3_definition = {
  domain: "suppliers",
  sequence: 141,
  capability: "service",
  enabled: true,
...
export const suppliers_138_4_definition = {
  domain: "suppliers",
  sequence: 142,
  capability: "service",
  enabled: true,
...
export const suppliers_138_5_definition = {
  domain: "suppliers",
  sequence: 143,
  capability: "service",
  enabled: true,
...
export const suppliers_138_6_definition = {
  domain: "suppliers",
  sequence: 144,
  capability: "service",
  enabled: true,
...
export const suppliers_138_7_definition = {
  domain: "suppliers",
  sequence: 145,
  capability: "service",
  enabled: true,
