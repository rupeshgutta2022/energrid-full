...
export const suppliers_118_0_definition = {
  domain: "suppliers",
  sequence: 118,
  capability: "service",
  enabled: true,
...
export const suppliers_118_1_definition = {
  domain: "suppliers",
  sequence: 119,
  capability: "service",
  enabled: true,
...
export const suppliers_118_2_definition = {
  domain: "suppliers",
  sequence: 120,
  capability: "service",
  enabled: true,
...
export const suppliers_118_3_definition = {
  domain: "suppliers",
  sequence: 121,
  capability: "service",
  enabled: true,
...
export const suppliers_118_4_definition = {
  domain: "suppliers",
  sequence: 122,
  capability: "service",
  enabled: true,
...
export const suppliers_118_5_definition = {
  domain: "suppliers",
  sequence: 123,
  capability: "service",
  enabled: true,
...
export const suppliers_118_6_definition = {
  domain: "suppliers",
  sequence: 124,
  capability: "service",
  enabled: true,
...
export const suppliers_118_7_definition = {
  domain: "suppliers",
  sequence: 125,
  capability: "service",
  enabled: true,
