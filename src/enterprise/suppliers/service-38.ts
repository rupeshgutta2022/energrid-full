...
export const suppliers_38_0_definition = {
  domain: "suppliers",
  sequence: 38,
  capability: "service",
  enabled: true,
...
export const suppliers_38_1_definition = {
  domain: "suppliers",
  sequence: 39,
  capability: "service",
  enabled: true,
...
export const suppliers_38_2_definition = {
  domain: "suppliers",
  sequence: 40,
  capability: "service",
  enabled: true,
...
export const suppliers_38_3_definition = {
  domain: "suppliers",
  sequence: 41,
  capability: "service",
  enabled: true,
...
export const suppliers_38_4_definition = {
  domain: "suppliers",
  sequence: 42,
  capability: "service",
  enabled: true,
...
export const suppliers_38_5_definition = {
  domain: "suppliers",
  sequence: 43,
  capability: "service",
  enabled: true,
...
export const suppliers_38_6_definition = {
  domain: "suppliers",
  sequence: 44,
  capability: "service",
  enabled: true,
...
export const suppliers_38_7_definition = {
  domain: "suppliers",
  sequence: 45,
  capability: "service",
  enabled: true,
