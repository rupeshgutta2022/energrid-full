...
export const suppliers_122_0_definition = {
  domain: "suppliers",
  sequence: 122,
  capability: "service",
  enabled: true,
...
export const suppliers_122_1_definition = {
  domain: "suppliers",
  sequence: 123,
  capability: "service",
  enabled: true,
...
export const suppliers_122_2_definition = {
  domain: "suppliers",
  sequence: 124,
  capability: "service",
  enabled: true,
...
export const suppliers_122_3_definition = {
  domain: "suppliers",
  sequence: 125,
  capability: "service",
  enabled: true,
...
export const suppliers_122_4_definition = {
  domain: "suppliers",
  sequence: 126,
  capability: "service",
  enabled: true,
...
export const suppliers_122_5_definition = {
  domain: "suppliers",
  sequence: 127,
  capability: "service",
  enabled: true,
...
export const suppliers_122_6_definition = {
  domain: "suppliers",
  sequence: 128,
  capability: "service",
  enabled: true,
...
export const suppliers_122_7_definition = {
  domain: "suppliers",
  sequence: 129,
  capability: "service",
  enabled: true,
