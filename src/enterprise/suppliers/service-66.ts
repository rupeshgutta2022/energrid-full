...
export const suppliers_66_0_definition = {
  domain: "suppliers",
  sequence: 66,
  capability: "service",
  enabled: true,
...
export const suppliers_66_1_definition = {
  domain: "suppliers",
  sequence: 67,
  capability: "service",
  enabled: true,
...
export const suppliers_66_2_definition = {
  domain: "suppliers",
  sequence: 68,
  capability: "service",
  enabled: true,
...
export const suppliers_66_3_definition = {
  domain: "suppliers",
  sequence: 69,
  capability: "service",
  enabled: true,
...
export const suppliers_66_4_definition = {
  domain: "suppliers",
  sequence: 70,
  capability: "service",
  enabled: true,
...
export const suppliers_66_5_definition = {
  domain: "suppliers",
  sequence: 71,
  capability: "service",
  enabled: true,
...
export const suppliers_66_6_definition = {
  domain: "suppliers",
  sequence: 72,
  capability: "service",
  enabled: true,
...
export const suppliers_66_7_definition = {
  domain: "suppliers",
  sequence: 73,
  capability: "service",
  enabled: true,
