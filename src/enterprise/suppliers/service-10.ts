...
export const suppliers_10_0_definition = {
  domain: "suppliers",
  sequence: 10,
  capability: "service",
  enabled: true,
...
export const suppliers_10_1_definition = {
  domain: "suppliers",
  sequence: 11,
  capability: "service",
  enabled: true,
...
export const suppliers_10_2_definition = {
  domain: "suppliers",
  sequence: 12,
  capability: "service",
  enabled: true,
...
export const suppliers_10_3_definition = {
  domain: "suppliers",
  sequence: 13,
  capability: "service",
  enabled: true,
...
export const suppliers_10_4_definition = {
  domain: "suppliers",
  sequence: 14,
  capability: "service",
  enabled: true,
...
export const suppliers_10_5_definition = {
  domain: "suppliers",
  sequence: 15,
  capability: "service",
  enabled: true,
...
export const suppliers_10_6_definition = {
  domain: "suppliers",
  sequence: 16,
  capability: "service",
  enabled: true,
...
export const suppliers_10_7_definition = {
  domain: "suppliers",
  sequence: 17,
  capability: "service",
  enabled: true,
