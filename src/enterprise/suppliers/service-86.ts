...
export const suppliers_86_0_definition = {
  domain: "suppliers",
  sequence: 86,
  capability: "service",
  enabled: true,
...
export const suppliers_86_1_definition = {
  domain: "suppliers",
  sequence: 87,
  capability: "service",
  enabled: true,
...
export const suppliers_86_2_definition = {
  domain: "suppliers",
  sequence: 88,
  capability: "service",
  enabled: true,
...
export const suppliers_86_3_definition = {
  domain: "suppliers",
  sequence: 89,
  capability: "service",
  enabled: true,
...
export const suppliers_86_4_definition = {
  domain: "suppliers",
  sequence: 90,
  capability: "service",
  enabled: true,
...
export const suppliers_86_5_definition = {
  domain: "suppliers",
  sequence: 91,
  capability: "service",
  enabled: true,
...
export const suppliers_86_6_definition = {
  domain: "suppliers",
  sequence: 92,
  capability: "service",
  enabled: true,
...
export const suppliers_86_7_definition = {
  domain: "suppliers",
  sequence: 93,
  capability: "service",
  enabled: true,
