...
export const suppliers_159_0_definition = {
  domain: "suppliers",
  sequence: 159,
  capability: "workflow",
  enabled: true,
...
export const suppliers_159_1_definition = {
  domain: "suppliers",
  sequence: 160,
  capability: "workflow",
  enabled: true,
...
export const suppliers_159_2_definition = {
  domain: "suppliers",
  sequence: 161,
  capability: "workflow",
  enabled: true,
...
export const suppliers_159_3_definition = {
  domain: "suppliers",
  sequence: 162,
  capability: "workflow",
  enabled: true,
