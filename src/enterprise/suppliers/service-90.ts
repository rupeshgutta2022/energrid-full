...
export const suppliers_90_0_definition = {
  domain: "suppliers",
  sequence: 90,
  capability: "service",
  enabled: true,
...
export const suppliers_90_1_definition = {
  domain: "suppliers",
  sequence: 91,
  capability: "service",
  enabled: true,
...
export const suppliers_90_2_definition = {
  domain: "suppliers",
  sequence: 92,
  capability: "service",
  enabled: true,
...
export const suppliers_90_3_definition = {
  domain: "suppliers",
  sequence: 93,
  capability: "service",
  enabled: true,
...
export const suppliers_90_4_definition = {
  domain: "suppliers",
  sequence: 94,
  capability: "service",
  enabled: true,
...
export const suppliers_90_5_definition = {
  domain: "suppliers",
  sequence: 95,
  capability: "service",
  enabled: true,
...
export const suppliers_90_6_definition = {
  domain: "suppliers",
  sequence: 96,
  capability: "service",
  enabled: true,
...
export const suppliers_90_7_definition = {
  domain: "suppliers",
  sequence: 97,
  capability: "service",
  enabled: true,
