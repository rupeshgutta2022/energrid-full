...
export const suppliers_54_0_definition = {
  domain: "suppliers",
  sequence: 54,
  capability: "service",
  enabled: true,
...
export const suppliers_54_1_definition = {
  domain: "suppliers",
  sequence: 55,
  capability: "service",
  enabled: true,
...
export const suppliers_54_2_definition = {
  domain: "suppliers",
  sequence: 56,
  capability: "service",
  enabled: true,
...
export const suppliers_54_3_definition = {
  domain: "suppliers",
  sequence: 57,
  capability: "service",
  enabled: true,
...
export const suppliers_54_4_definition = {
  domain: "suppliers",
  sequence: 58,
  capability: "service",
  enabled: true,
...
export const suppliers_54_5_definition = {
  domain: "suppliers",
  sequence: 59,
  capability: "service",
  enabled: true,
...
export const suppliers_54_6_definition = {
  domain: "suppliers",
  sequence: 60,
  capability: "service",
  enabled: true,
...
export const suppliers_54_7_definition = {
  domain: "suppliers",
  sequence: 61,
  capability: "service",
  enabled: true,
