...
export const suppliers_126_0_definition = {
  domain: "suppliers",
  sequence: 126,
  capability: "service",
  enabled: true,
...
export const suppliers_126_1_definition = {
  domain: "suppliers",
  sequence: 127,
  capability: "service",
  enabled: true,
...
export const suppliers_126_2_definition = {
  domain: "suppliers",
  sequence: 128,
  capability: "service",
  enabled: true,
...
export const suppliers_126_3_definition = {
  domain: "suppliers",
  sequence: 129,
  capability: "service",
  enabled: true,
...
export const suppliers_126_4_definition = {
  domain: "suppliers",
  sequence: 130,
  capability: "service",
  enabled: true,
...
export const suppliers_126_5_definition = {
  domain: "suppliers",
  sequence: 131,
  capability: "service",
  enabled: true,
...
export const suppliers_126_6_definition = {
  domain: "suppliers",
  sequence: 132,
  capability: "service",
  enabled: true,
...
export const suppliers_126_7_definition = {
  domain: "suppliers",
  sequence: 133,
  capability: "service",
  enabled: true,
