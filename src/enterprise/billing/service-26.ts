...
export const billing_26_0_definition = {
  domain: "billing",
  sequence: 26,
  capability: "service",
  enabled: true,
...
export const billing_26_1_definition = {
  domain: "billing",
  sequence: 27,
  capability: "service",
  enabled: true,
...
export const billing_26_2_definition = {
  domain: "billing",
  sequence: 28,
  capability: "service",
  enabled: true,
...
export const billing_26_3_definition = {
  domain: "billing",
  sequence: 29,
  capability: "service",
  enabled: true,
...
export const billing_26_4_definition = {
  domain: "billing",
  sequence: 30,
  capability: "service",
  enabled: true,
...
export const billing_26_5_definition = {
  domain: "billing",
  sequence: 31,
  capability: "service",
  enabled: true,
...
export const billing_26_6_definition = {
  domain: "billing",
  sequence: 32,
  capability: "service",
  enabled: true,
...
export const billing_26_7_definition = {
  domain: "billing",
  sequence: 33,
  capability: "service",
  enabled: true,
