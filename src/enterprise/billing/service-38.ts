...
export const billing_38_0_definition = {
  domain: "billing",
  sequence: 38,
  capability: "service",
  enabled: true,
...
export const billing_38_1_definition = {
  domain: "billing",
  sequence: 39,
  capability: "service",
  enabled: true,
...
export const billing_38_2_definition = {
  domain: "billing",
  sequence: 40,
  capability: "service",
  enabled: true,
...
export const billing_38_3_definition = {
  domain: "billing",
  sequence: 41,
  capability: "service",
  enabled: true,
...
export const billing_38_4_definition = {
  domain: "billing",
  sequence: 42,
  capability: "service",
  enabled: true,
...
export const billing_38_5_definition = {
  domain: "billing",
  sequence: 43,
  capability: "service",
  enabled: true,
...
export const billing_38_6_definition = {
  domain: "billing",
  sequence: 44,
  capability: "service",
  enabled: true,
...
export const billing_38_7_definition = {
  domain: "billing",
  sequence: 45,
  capability: "service",
  enabled: true,
