...
export const billing_2_0_definition = {
  domain: "billing",
  sequence: 2,
  capability: "service",
  enabled: true,
...
export const billing_2_1_definition = {
  domain: "billing",
  sequence: 3,
  capability: "service",
  enabled: true,
...
export const billing_2_2_definition = {
  domain: "billing",
  sequence: 4,
  capability: "service",
  enabled: true,
...
export const billing_2_3_definition = {
  domain: "billing",
  sequence: 5,
  capability: "service",
  enabled: true,
...
export const billing_2_4_definition = {
  domain: "billing",
  sequence: 6,
  capability: "service",
  enabled: true,
...
export const billing_2_5_definition = {
  domain: "billing",
  sequence: 7,
  capability: "service",
  enabled: true,
...
export const billing_2_6_definition = {
  domain: "billing",
  sequence: 8,
  capability: "service",
  enabled: true,
...
export const billing_2_7_definition = {
  domain: "billing",
  sequence: 9,
  capability: "service",
  enabled: true,
