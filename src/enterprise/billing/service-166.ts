...
export const billing_166_0_definition = {
  domain: "billing",
  sequence: 166,
  capability: "service",
  enabled: true,
...
export const billing_166_1_definition = {
  domain: "billing",
  sequence: 167,
  capability: "service",
  enabled: true,
...
export const billing_166_2_definition = {
  domain: "billing",
  sequence: 168,
  capability: "service",
  enabled: true,
...
export const billing_166_3_definition = {
  domain: "billing",
  sequence: 169,
  capability: "service",
  enabled: true,
...
export const billing_166_4_definition = {
  domain: "billing",
  sequence: 170,
  capability: "service",
  enabled: true,
...
export const billing_166_5_definition = {
  domain: "billing",
  sequence: 171,
  capability: "service",
  enabled: true,
...
export const billing_166_6_definition = {
  domain: "billing",
  sequence: 172,
  capability: "service",
  enabled: true,
...
export const billing_166_7_definition = {
  domain: "billing",
  sequence: 173,
  capability: "service",
  enabled: true,
