...
export const billing_94_0_definition = {
  domain: "billing",
  sequence: 94,
  capability: "service",
  enabled: true,
...
export const billing_94_1_definition = {
  domain: "billing",
  sequence: 95,
  capability: "service",
  enabled: true,
...
export const billing_94_2_definition = {
  domain: "billing",
  sequence: 96,
  capability: "service",
  enabled: true,
...
export const billing_94_3_definition = {
  domain: "billing",
  sequence: 97,
  capability: "service",
  enabled: true,
...
export const billing_94_4_definition = {
  domain: "billing",
  sequence: 98,
  capability: "service",
  enabled: true,
...
export const billing_94_5_definition = {
  domain: "billing",
  sequence: 99,
  capability: "service",
  enabled: true,
...
export const billing_94_6_definition = {
  domain: "billing",
  sequence: 100,
  capability: "service",
  enabled: true,
...
export const billing_94_7_definition = {
  domain: "billing",
  sequence: 101,
  capability: "service",
  enabled: true,
