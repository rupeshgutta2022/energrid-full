...
export const billing_34_0_definition = {
  domain: "billing",
  sequence: 34,
  capability: "service",
  enabled: true,
...
export const billing_34_1_definition = {
  domain: "billing",
  sequence: 35,
  capability: "service",
  enabled: true,
...
export const billing_34_2_definition = {
  domain: "billing",
  sequence: 36,
  capability: "service",
  enabled: true,
...
export const billing_34_3_definition = {
  domain: "billing",
  sequence: 37,
  capability: "service",
  enabled: true,
...
export const billing_34_4_definition = {
  domain: "billing",
  sequence: 38,
  capability: "service",
  enabled: true,
...
export const billing_34_5_definition = {
  domain: "billing",
  sequence: 39,
  capability: "service",
  enabled: true,
...
export const billing_34_6_definition = {
  domain: "billing",
  sequence: 40,
  capability: "service",
  enabled: true,
...
export const billing_34_7_definition = {
  domain: "billing",
  sequence: 41,
  capability: "service",
  enabled: true,
