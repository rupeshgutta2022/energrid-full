...
export const billing_18_0_definition = {
  domain: "billing",
  sequence: 18,
  capability: "service",
  enabled: true,
...
export const billing_18_1_definition = {
  domain: "billing",
  sequence: 19,
  capability: "service",
  enabled: true,
...
export const billing_18_2_definition = {
  domain: "billing",
  sequence: 20,
  capability: "service",
  enabled: true,
...
export const billing_18_3_definition = {
  domain: "billing",
  sequence: 21,
  capability: "service",
  enabled: true,
...
export const billing_18_4_definition = {
  domain: "billing",
  sequence: 22,
  capability: "service",
  enabled: true,
...
export const billing_18_5_definition = {
  domain: "billing",
  sequence: 23,
  capability: "service",
  enabled: true,
...
export const billing_18_6_definition = {
  domain: "billing",
  sequence: 24,
  capability: "service",
  enabled: true,
...
export const billing_18_7_definition = {
  domain: "billing",
  sequence: 25,
  capability: "service",
  enabled: true,
