...
export const billing_82_0_definition = {
  domain: "billing",
  sequence: 82,
  capability: "service",
  enabled: true,
...
export const billing_82_1_definition = {
  domain: "billing",
  sequence: 83,
  capability: "service",
  enabled: true,
...
export const billing_82_2_definition = {
  domain: "billing",
  sequence: 84,
  capability: "service",
  enabled: true,
...
export const billing_82_3_definition = {
  domain: "billing",
  sequence: 85,
  capability: "service",
  enabled: true,
...
export const billing_82_4_definition = {
  domain: "billing",
  sequence: 86,
  capability: "service",
  enabled: true,
...
export const billing_82_5_definition = {
  domain: "billing",
  sequence: 87,
  capability: "service",
  enabled: true,
...
export const billing_82_6_definition = {
  domain: "billing",
  sequence: 88,
  capability: "service",
  enabled: true,
...
export const billing_82_7_definition = {
  domain: "billing",
  sequence: 89,
  capability: "service",
  enabled: true,
