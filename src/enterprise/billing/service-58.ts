...
export const billing_58_0_definition = {
  domain: "billing",
  sequence: 58,
  capability: "service",
  enabled: true,
...
export const billing_58_1_definition = {
  domain: "billing",
  sequence: 59,
  capability: "service",
  enabled: true,
...
export const billing_58_2_definition = {
  domain: "billing",
  sequence: 60,
  capability: "service",
  enabled: true,
...
export const billing_58_3_definition = {
  domain: "billing",
  sequence: 61,
  capability: "service",
  enabled: true,
...
export const billing_58_4_definition = {
  domain: "billing",
  sequence: 62,
  capability: "service",
  enabled: true,
...
export const billing_58_5_definition = {
  domain: "billing",
  sequence: 63,
  capability: "service",
  enabled: true,
...
export const billing_58_6_definition = {
  domain: "billing",
  sequence: 64,
  capability: "service",
  enabled: true,
...
export const billing_58_7_definition = {
  domain: "billing",
  sequence: 65,
  capability: "service",
  enabled: true,
