...
export const billing_195_0_definition = {
  domain: "billing",
  sequence: 195,
  capability: "workflow",
  enabled: true,
...
export const billing_195_1_definition = {
  domain: "billing",
  sequence: 196,
  capability: "workflow",
  enabled: true,
...
export const billing_195_2_definition = {
  domain: "billing",
  sequence: 197,
  capability: "workflow",
  enabled: true,
...
export const billing_195_3_definition = {
  domain: "billing",
  sequence: 198,
  capability: "workflow",
  enabled: true,
...
export const billing_195_4_definition = {
  domain: "billing",
  sequence: 199,
  capability: "workflow",
  enabled: true,
