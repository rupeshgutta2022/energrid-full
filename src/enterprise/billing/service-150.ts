...
export const billing_150_0_definition = {
  domain: "billing",
  sequence: 150,
  capability: "service",
  enabled: true,
...
export const billing_150_1_definition = {
  domain: "billing",
  sequence: 151,
  capability: "service",
  enabled: true,
...
export const billing_150_2_definition = {
  domain: "billing",
  sequence: 152,
  capability: "service",
  enabled: true,
...
export const billing_150_3_definition = {
  domain: "billing",
  sequence: 153,
  capability: "service",
  enabled: true,
...
export const billing_150_4_definition = {
  domain: "billing",
  sequence: 154,
  capability: "service",
  enabled: true,
...
export const billing_150_5_definition = {
  domain: "billing",
  sequence: 155,
  capability: "service",
  enabled: true,
...
export const billing_150_6_definition = {
  domain: "billing",
  sequence: 156,
  capability: "service",
  enabled: true,
...
export const billing_150_7_definition = {
  domain: "billing",
  sequence: 157,
  capability: "service",
  enabled: true,
