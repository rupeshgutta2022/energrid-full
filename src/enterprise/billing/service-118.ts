...
export const billing_118_0_definition = {
  domain: "billing",
  sequence: 118,
  capability: "service",
  enabled: true,
...
export const billing_118_1_definition = {
  domain: "billing",
  sequence: 119,
  capability: "service",
  enabled: true,
...
export const billing_118_2_definition = {
  domain: "billing",
  sequence: 120,
  capability: "service",
  enabled: true,
...
export const billing_118_3_definition = {
  domain: "billing",
  sequence: 121,
  capability: "service",
  enabled: true,
...
export const billing_118_4_definition = {
  domain: "billing",
  sequence: 122,
  capability: "service",
  enabled: true,
...
export const billing_118_5_definition = {
  domain: "billing",
  sequence: 123,
  capability: "service",
  enabled: true,
...
export const billing_118_6_definition = {
  domain: "billing",
  sequence: 124,
  capability: "service",
  enabled: true,
...
export const billing_118_7_definition = {
  domain: "billing",
  sequence: 125,
  capability: "service",
  enabled: true,
