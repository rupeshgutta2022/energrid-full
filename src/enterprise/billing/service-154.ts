...
export const billing_154_0_definition = {
  domain: "billing",
  sequence: 154,
  capability: "service",
  enabled: true,
...
export const billing_154_1_definition = {
  domain: "billing",
  sequence: 155,
  capability: "service",
  enabled: true,
...
export const billing_154_2_definition = {
  domain: "billing",
  sequence: 156,
  capability: "service",
  enabled: true,
...
export const billing_154_3_definition = {
  domain: "billing",
  sequence: 157,
  capability: "service",
  enabled: true,
...
export const billing_154_4_definition = {
  domain: "billing",
  sequence: 158,
  capability: "service",
  enabled: true,
...
export const billing_154_5_definition = {
  domain: "billing",
  sequence: 159,
  capability: "service",
  enabled: true,
...
export const billing_154_6_definition = {
  domain: "billing",
  sequence: 160,
  capability: "service",
  enabled: true,
...
export const billing_154_7_definition = {
  domain: "billing",
  sequence: 161,
  capability: "service",
  enabled: true,
