...
export const billing_42_0_definition = {
  domain: "billing",
  sequence: 42,
  capability: "service",
  enabled: true,
...
export const billing_42_1_definition = {
  domain: "billing",
  sequence: 43,
  capability: "service",
  enabled: true,
...
export const billing_42_2_definition = {
  domain: "billing",
  sequence: 44,
  capability: "service",
  enabled: true,
...
export const billing_42_3_definition = {
  domain: "billing",
  sequence: 45,
  capability: "service",
  enabled: true,
...
export const billing_42_4_definition = {
  domain: "billing",
  sequence: 46,
  capability: "service",
  enabled: true,
...
export const billing_42_5_definition = {
  domain: "billing",
  sequence: 47,
  capability: "service",
  enabled: true,
...
export const billing_42_6_definition = {
  domain: "billing",
  sequence: 48,
  capability: "service",
  enabled: true,
...
export const billing_42_7_definition = {
  domain: "billing",
  sequence: 49,
  capability: "service",
  enabled: true,
