...
export const billing_54_0_definition = {
  domain: "billing",
  sequence: 54,
  capability: "service",
  enabled: true,
...
export const billing_54_1_definition = {
  domain: "billing",
  sequence: 55,
  capability: "service",
  enabled: true,
...
export const billing_54_2_definition = {
  domain: "billing",
  sequence: 56,
  capability: "service",
  enabled: true,
...
export const billing_54_3_definition = {
  domain: "billing",
  sequence: 57,
  capability: "service",
  enabled: true,
...
export const billing_54_4_definition = {
  domain: "billing",
  sequence: 58,
  capability: "service",
  enabled: true,
...
export const billing_54_5_definition = {
  domain: "billing",
  sequence: 59,
  capability: "service",
  enabled: true,
...
export const billing_54_6_definition = {
  domain: "billing",
  sequence: 60,
  capability: "service",
  enabled: true,
...
export const billing_54_7_definition = {
  domain: "billing",
  sequence: 61,
  capability: "service",
  enabled: true,
