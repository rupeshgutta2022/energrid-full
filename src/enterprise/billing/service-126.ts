...
export const billing_126_0_definition = {
  domain: "billing",
  sequence: 126,
  capability: "service",
  enabled: true,
...
export const billing_126_1_definition = {
  domain: "billing",
  sequence: 127,
  capability: "service",
  enabled: true,
...
export const billing_126_2_definition = {
  domain: "billing",
  sequence: 128,
  capability: "service",
  enabled: true,
...
export const billing_126_3_definition = {
  domain: "billing",
  sequence: 129,
  capability: "service",
  enabled: true,
...
export const billing_126_4_definition = {
  domain: "billing",
  sequence: 130,
  capability: "service",
  enabled: true,
...
export const billing_126_5_definition = {
  domain: "billing",
  sequence: 131,
  capability: "service",
  enabled: true,
...
export const billing_126_6_definition = {
  domain: "billing",
  sequence: 132,
  capability: "service",
  enabled: true,
...
export const billing_126_7_definition = {
  domain: "billing",
  sequence: 133,
  capability: "service",
  enabled: true,
