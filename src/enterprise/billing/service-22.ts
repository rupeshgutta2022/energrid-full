...
export const billing_22_0_definition = {
  domain: "billing",
  sequence: 22,
  capability: "service",
  enabled: true,
...
export const billing_22_1_definition = {
  domain: "billing",
  sequence: 23,
  capability: "service",
  enabled: true,
...
export const billing_22_2_definition = {
  domain: "billing",
  sequence: 24,
  capability: "service",
  enabled: true,
...
export const billing_22_3_definition = {
  domain: "billing",
  sequence: 25,
  capability: "service",
  enabled: true,
...
export const billing_22_4_definition = {
  domain: "billing",
  sequence: 26,
  capability: "service",
  enabled: true,
...
export const billing_22_5_definition = {
  domain: "billing",
  sequence: 27,
  capability: "service",
  enabled: true,
...
export const billing_22_6_definition = {
  domain: "billing",
  sequence: 28,
  capability: "service",
  enabled: true,
...
export const billing_22_7_definition = {
  domain: "billing",
  sequence: 29,
  capability: "service",
  enabled: true,
