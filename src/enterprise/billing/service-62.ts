...
export const billing_62_0_definition = {
  domain: "billing",
  sequence: 62,
  capability: "service",
  enabled: true,
...
export const billing_62_1_definition = {
  domain: "billing",
  sequence: 63,
  capability: "service",
  enabled: true,
...
export const billing_62_2_definition = {
  domain: "billing",
  sequence: 64,
  capability: "service",
  enabled: true,
...
export const billing_62_3_definition = {
  domain: "billing",
  sequence: 65,
  capability: "service",
  enabled: true,
...
export const billing_62_4_definition = {
  domain: "billing",
  sequence: 66,
  capability: "service",
  enabled: true,
...
export const billing_62_5_definition = {
  domain: "billing",
  sequence: 67,
  capability: "service",
  enabled: true,
...
export const billing_62_6_definition = {
  domain: "billing",
  sequence: 68,
  capability: "service",
  enabled: true,
...
export const billing_62_7_definition = {
  domain: "billing",
  sequence: 69,
  capability: "service",
  enabled: true,
