...
export const billing_66_0_definition = {
  domain: "billing",
  sequence: 66,
  capability: "service",
  enabled: true,
...
export const billing_66_1_definition = {
  domain: "billing",
  sequence: 67,
  capability: "service",
  enabled: true,
...
export const billing_66_2_definition = {
  domain: "billing",
  sequence: 68,
  capability: "service",
  enabled: true,
...
export const billing_66_3_definition = {
  domain: "billing",
  sequence: 69,
  capability: "service",
  enabled: true,
...
export const billing_66_4_definition = {
  domain: "billing",
  sequence: 70,
  capability: "service",
  enabled: true,
...
export const billing_66_5_definition = {
  domain: "billing",
  sequence: 71,
  capability: "service",
  enabled: true,
...
export const billing_66_6_definition = {
  domain: "billing",
  sequence: 72,
  capability: "service",
  enabled: true,
...
export const billing_66_7_definition = {
  domain: "billing",
  sequence: 73,
  capability: "service",
  enabled: true,
