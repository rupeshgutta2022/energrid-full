...
export const billing_70_0_definition = {
  domain: "billing",
  sequence: 70,
  capability: "service",
  enabled: true,
...
export const billing_70_1_definition = {
  domain: "billing",
  sequence: 71,
  capability: "service",
  enabled: true,
...
export const billing_70_2_definition = {
  domain: "billing",
  sequence: 72,
  capability: "service",
  enabled: true,
...
export const billing_70_3_definition = {
  domain: "billing",
  sequence: 73,
  capability: "service",
  enabled: true,
...
export const billing_70_4_definition = {
  domain: "billing",
  sequence: 74,
  capability: "service",
  enabled: true,
...
export const billing_70_5_definition = {
  domain: "billing",
  sequence: 75,
  capability: "service",
  enabled: true,
...
export const billing_70_6_definition = {
  domain: "billing",
  sequence: 76,
  capability: "service",
  enabled: true,
...
export const billing_70_7_definition = {
  domain: "billing",
  sequence: 77,
  capability: "service",
  enabled: true,
