...
export const billing_50_0_definition = {
  domain: "billing",
  sequence: 50,
  capability: "service",
  enabled: true,
...
export const billing_50_1_definition = {
  domain: "billing",
  sequence: 51,
  capability: "service",
  enabled: true,
...
export const billing_50_2_definition = {
  domain: "billing",
  sequence: 52,
  capability: "service",
  enabled: true,
...
export const billing_50_3_definition = {
  domain: "billing",
  sequence: 53,
  capability: "service",
  enabled: true,
...
export const billing_50_4_definition = {
  domain: "billing",
  sequence: 54,
  capability: "service",
  enabled: true,
...
export const billing_50_5_definition = {
  domain: "billing",
  sequence: 55,
  capability: "service",
  enabled: true,
...
export const billing_50_6_definition = {
  domain: "billing",
  sequence: 56,
  capability: "service",
  enabled: true,
...
export const billing_50_7_definition = {
  domain: "billing",
  sequence: 57,
  capability: "service",
  enabled: true,
