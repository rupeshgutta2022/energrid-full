...
export const billing_90_0_definition = {
  domain: "billing",
  sequence: 90,
  capability: "service",
  enabled: true,
...
export const billing_90_1_definition = {
  domain: "billing",
  sequence: 91,
  capability: "service",
  enabled: true,
...
export const billing_90_2_definition = {
  domain: "billing",
  sequence: 92,
  capability: "service",
  enabled: true,
...
export const billing_90_3_definition = {
  domain: "billing",
  sequence: 93,
  capability: "service",
  enabled: true,
...
export const billing_90_4_definition = {
  domain: "billing",
  sequence: 94,
  capability: "service",
  enabled: true,
...
export const billing_90_5_definition = {
  domain: "billing",
  sequence: 95,
  capability: "service",
  enabled: true,
...
export const billing_90_6_definition = {
  domain: "billing",
  sequence: 96,
  capability: "service",
  enabled: true,
...
export const billing_90_7_definition = {
  domain: "billing",
  sequence: 97,
  capability: "service",
  enabled: true,
