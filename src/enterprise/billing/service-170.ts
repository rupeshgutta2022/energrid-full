...
export const billing_170_0_definition = {
  domain: "billing",
  sequence: 170,
  capability: "service",
  enabled: true,
...
export const billing_170_1_definition = {
  domain: "billing",
  sequence: 171,
  capability: "service",
  enabled: true,
...
export const billing_170_2_definition = {
  domain: "billing",
  sequence: 172,
  capability: "service",
  enabled: true,
...
export const billing_170_3_definition = {
  domain: "billing",
  sequence: 173,
  capability: "service",
  enabled: true,
...
export const billing_170_4_definition = {
  domain: "billing",
  sequence: 174,
  capability: "service",
  enabled: true,
...
export const billing_170_5_definition = {
  domain: "billing",
  sequence: 175,
  capability: "service",
  enabled: true,
...
export const billing_170_6_definition = {
  domain: "billing",
  sequence: 176,
  capability: "service",
  enabled: true,
...
export const billing_170_7_definition = {
  domain: "billing",
  sequence: 177,
  capability: "service",
  enabled: true,
