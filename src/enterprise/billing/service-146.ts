...
export const billing_146_0_definition = {
  domain: "billing",
  sequence: 146,
  capability: "service",
  enabled: true,
...
export const billing_146_1_definition = {
  domain: "billing",
  sequence: 147,
  capability: "service",
  enabled: true,
...
export const billing_146_2_definition = {
  domain: "billing",
  sequence: 148,
  capability: "service",
  enabled: true,
...
export const billing_146_3_definition = {
  domain: "billing",
  sequence: 149,
  capability: "service",
  enabled: true,
...
export const billing_146_4_definition = {
  domain: "billing",
  sequence: 150,
  capability: "service",
  enabled: true,
...
export const billing_146_5_definition = {
  domain: "billing",
  sequence: 151,
  capability: "service",
  enabled: true,
...
export const billing_146_6_definition = {
  domain: "billing",
  sequence: 152,
  capability: "service",
  enabled: true,
...
export const billing_146_7_definition = {
  domain: "billing",
  sequence: 153,
  capability: "service",
  enabled: true,
