...
export const billing_138_0_definition = {
  domain: "billing",
  sequence: 138,
  capability: "service",
  enabled: true,
...
export const billing_138_1_definition = {
  domain: "billing",
  sequence: 139,
  capability: "service",
  enabled: true,
...
export const billing_138_2_definition = {
  domain: "billing",
  sequence: 140,
  capability: "service",
  enabled: true,
...
export const billing_138_3_definition = {
  domain: "billing",
  sequence: 141,
  capability: "service",
  enabled: true,
...
export const billing_138_4_definition = {
  domain: "billing",
  sequence: 142,
  capability: "service",
  enabled: true,
...
export const billing_138_5_definition = {
  domain: "billing",
  sequence: 143,
  capability: "service",
  enabled: true,
...
export const billing_138_6_definition = {
  domain: "billing",
  sequence: 144,
  capability: "service",
  enabled: true,
...
export const billing_138_7_definition = {
  domain: "billing",
  sequence: 145,
  capability: "service",
  enabled: true,
