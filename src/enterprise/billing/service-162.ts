...
export const billing_162_0_definition = {
  domain: "billing",
  sequence: 162,
  capability: "service",
  enabled: true,
...
export const billing_162_1_definition = {
  domain: "billing",
  sequence: 163,
  capability: "service",
  enabled: true,
...
export const billing_162_2_definition = {
  domain: "billing",
  sequence: 164,
  capability: "service",
  enabled: true,
...
export const billing_162_3_definition = {
  domain: "billing",
  sequence: 165,
  capability: "service",
  enabled: true,
...
export const billing_162_4_definition = {
  domain: "billing",
  sequence: 166,
  capability: "service",
  enabled: true,
...
export const billing_162_5_definition = {
  domain: "billing",
  sequence: 167,
  capability: "service",
  enabled: true,
...
export const billing_162_6_definition = {
  domain: "billing",
  sequence: 168,
  capability: "service",
  enabled: true,
...
export const billing_162_7_definition = {
  domain: "billing",
  sequence: 169,
  capability: "service",
  enabled: true,
