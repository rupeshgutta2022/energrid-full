...
export const billing_86_0_definition = {
  domain: "billing",
  sequence: 86,
  capability: "service",
  enabled: true,
...
export const billing_86_1_definition = {
  domain: "billing",
  sequence: 87,
  capability: "service",
  enabled: true,
...
export const billing_86_2_definition = {
  domain: "billing",
  sequence: 88,
  capability: "service",
  enabled: true,
...
export const billing_86_3_definition = {
  domain: "billing",
  sequence: 89,
  capability: "service",
  enabled: true,
...
export const billing_86_4_definition = {
  domain: "billing",
  sequence: 90,
  capability: "service",
  enabled: true,
...
export const billing_86_5_definition = {
  domain: "billing",
  sequence: 91,
  capability: "service",
  enabled: true,
...
export const billing_86_6_definition = {
  domain: "billing",
  sequence: 92,
  capability: "service",
  enabled: true,
...
export const billing_86_7_definition = {
  domain: "billing",
  sequence: 93,
  capability: "service",
  enabled: true,
