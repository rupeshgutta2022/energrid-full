...
export const billing_102_0_definition = {
  domain: "billing",
  sequence: 102,
  capability: "service",
  enabled: true,
...
export const billing_102_1_definition = {
  domain: "billing",
  sequence: 103,
  capability: "service",
  enabled: true,
...
export const billing_102_2_definition = {
  domain: "billing",
  sequence: 104,
  capability: "service",
  enabled: true,
...
export const billing_102_3_definition = {
  domain: "billing",
  sequence: 105,
  capability: "service",
  enabled: true,
...
export const billing_102_4_definition = {
  domain: "billing",
  sequence: 106,
  capability: "service",
  enabled: true,
...
export const billing_102_5_definition = {
  domain: "billing",
  sequence: 107,
  capability: "service",
  enabled: true,
...
export const billing_102_6_definition = {
  domain: "billing",
  sequence: 108,
  capability: "service",
  enabled: true,
...
export const billing_102_7_definition = {
  domain: "billing",
  sequence: 109,
  capability: "service",
  enabled: true,
