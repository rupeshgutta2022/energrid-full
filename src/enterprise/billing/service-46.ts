...
export const billing_46_0_definition = {
  domain: "billing",
  sequence: 46,
  capability: "service",
  enabled: true,
...
export const billing_46_1_definition = {
  domain: "billing",
  sequence: 47,
  capability: "service",
  enabled: true,
...
export const billing_46_2_definition = {
  domain: "billing",
  sequence: 48,
  capability: "service",
  enabled: true,
...
export const billing_46_3_definition = {
  domain: "billing",
  sequence: 49,
  capability: "service",
  enabled: true,
...
export const billing_46_4_definition = {
  domain: "billing",
  sequence: 50,
  capability: "service",
  enabled: true,
...
export const billing_46_5_definition = {
  domain: "billing",
  sequence: 51,
  capability: "service",
  enabled: true,
...
export const billing_46_6_definition = {
  domain: "billing",
  sequence: 52,
  capability: "service",
  enabled: true,
...
export const billing_46_7_definition = {
  domain: "billing",
  sequence: 53,
  capability: "service",
  enabled: true,
