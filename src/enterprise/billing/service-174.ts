...
export const billing_174_0_definition = {
  domain: "billing",
  sequence: 174,
  capability: "service",
  enabled: true,
...
export const billing_174_1_definition = {
  domain: "billing",
  sequence: 175,
  capability: "service",
  enabled: true,
...
export const billing_174_2_definition = {
  domain: "billing",
  sequence: 176,
  capability: "service",
  enabled: true,
...
export const billing_174_3_definition = {
  domain: "billing",
  sequence: 177,
  capability: "service",
  enabled: true,
...
export const billing_174_4_definition = {
  domain: "billing",
  sequence: 178,
  capability: "service",
  enabled: true,
...
export const billing_174_5_definition = {
  domain: "billing",
  sequence: 179,
  capability: "service",
  enabled: true,
...
export const billing_174_6_definition = {
  domain: "billing",
  sequence: 180,
  capability: "service",
  enabled: true,
...
export const billing_174_7_definition = {
  domain: "billing",
  sequence: 181,
  capability: "service",
  enabled: true,
