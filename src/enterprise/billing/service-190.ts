...
export const billing_190_0_definition = {
  domain: "billing",
  sequence: 190,
  capability: "service",
  enabled: true,
...
export const billing_190_1_definition = {
  domain: "billing",
  sequence: 191,
  capability: "service",
  enabled: true,
...
export const billing_190_2_definition = {
  domain: "billing",
  sequence: 192,
  capability: "service",
  enabled: true,
...
export const billing_190_3_definition = {
  domain: "billing",
  sequence: 193,
  capability: "service",
  enabled: true,
...
export const billing_190_4_definition = {
  domain: "billing",
  sequence: 194,
  capability: "service",
  enabled: true,
...
export const billing_190_5_definition = {
  domain: "billing",
  sequence: 195,
  capability: "service",
  enabled: true,
