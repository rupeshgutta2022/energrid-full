...
export const billing_122_0_definition = {
  domain: "billing",
  sequence: 122,
  capability: "service",
  enabled: true,
...
export const billing_122_1_definition = {
  domain: "billing",
  sequence: 123,
  capability: "service",
  enabled: true,
...
export const billing_122_2_definition = {
  domain: "billing",
  sequence: 124,
  capability: "service",
  enabled: true,
...
export const billing_122_3_definition = {
  domain: "billing",
  sequence: 125,
  capability: "service",
  enabled: true,
...
export const billing_122_4_definition = {
  domain: "billing",
  sequence: 126,
  capability: "service",
  enabled: true,
...
export const billing_122_5_definition = {
  domain: "billing",
  sequence: 127,
  capability: "service",
  enabled: true,
...
export const billing_122_6_definition = {
  domain: "billing",
  sequence: 128,
  capability: "service",
  enabled: true,
...
export const billing_122_7_definition = {
  domain: "billing",
  sequence: 129,
  capability: "service",
  enabled: true,
