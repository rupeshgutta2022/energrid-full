...
export const billing_178_0_definition = {
  domain: "billing",
  sequence: 178,
  capability: "service",
  enabled: true,
...
export const billing_178_1_definition = {
  domain: "billing",
  sequence: 179,
  capability: "service",
  enabled: true,
...
export const billing_178_2_definition = {
  domain: "billing",
  sequence: 180,
  capability: "service",
  enabled: true,
...
export const billing_178_3_definition = {
  domain: "billing",
  sequence: 181,
  capability: "service",
  enabled: true,
...
export const billing_178_4_definition = {
  domain: "billing",
  sequence: 182,
  capability: "service",
  enabled: true,
...
export const billing_178_5_definition = {
  domain: "billing",
  sequence: 183,
  capability: "service",
  enabled: true,
...
export const billing_178_6_definition = {
  domain: "billing",
  sequence: 184,
  capability: "service",
  enabled: true,
...
export const billing_178_7_definition = {
  domain: "billing",
  sequence: 185,
  capability: "service",
  enabled: true,
