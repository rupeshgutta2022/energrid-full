...
export const billing_30_0_definition = {
  domain: "billing",
  sequence: 30,
  capability: "service",
  enabled: true,
...
export const billing_30_1_definition = {
  domain: "billing",
  sequence: 31,
  capability: "service",
  enabled: true,
...
export const billing_30_2_definition = {
  domain: "billing",
  sequence: 32,
  capability: "service",
  enabled: true,
...
export const billing_30_3_definition = {
  domain: "billing",
  sequence: 33,
  capability: "service",
  enabled: true,
...
export const billing_30_4_definition = {
  domain: "billing",
  sequence: 34,
  capability: "service",
  enabled: true,
...
export const billing_30_5_definition = {
  domain: "billing",
  sequence: 35,
  capability: "service",
  enabled: true,
...
export const billing_30_6_definition = {
  domain: "billing",
  sequence: 36,
  capability: "service",
  enabled: true,
...
export const billing_30_7_definition = {
  domain: "billing",
  sequence: 37,
  capability: "service",
  enabled: true,
