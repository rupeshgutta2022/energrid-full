...
export const billing_186_0_definition = {
  domain: "billing",
  sequence: 186,
  capability: "service",
  enabled: true,
...
export const billing_186_1_definition = {
  domain: "billing",
  sequence: 187,
  capability: "service",
  enabled: true,
...
export const billing_186_2_definition = {
  domain: "billing",
  sequence: 188,
  capability: "service",
  enabled: true,
...
export const billing_186_3_definition = {
  domain: "billing",
  sequence: 189,
  capability: "service",
  enabled: true,
...
export const billing_186_4_definition = {
  domain: "billing",
  sequence: 190,
  capability: "service",
  enabled: true,
...
export const billing_186_5_definition = {
  domain: "billing",
  sequence: 191,
  capability: "service",
  enabled: true,
...
export const billing_186_6_definition = {
  domain: "billing",
  sequence: 192,
  capability: "service",
  enabled: true,
...
export const billing_186_7_definition = {
  domain: "billing",
  sequence: 193,
  capability: "service",
  enabled: true,
