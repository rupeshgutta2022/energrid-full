...
export const billing_10_0_definition = {
  domain: "billing",
  sequence: 10,
  capability: "service",
  enabled: true,
...
export const billing_10_1_definition = {
  domain: "billing",
  sequence: 11,
  capability: "service",
  enabled: true,
...
export const billing_10_2_definition = {
  domain: "billing",
  sequence: 12,
  capability: "service",
  enabled: true,
...
export const billing_10_3_definition = {
  domain: "billing",
  sequence: 13,
  capability: "service",
  enabled: true,
...
export const billing_10_4_definition = {
  domain: "billing",
  sequence: 14,
  capability: "service",
  enabled: true,
...
export const billing_10_5_definition = {
  domain: "billing",
  sequence: 15,
  capability: "service",
  enabled: true,
...
export const billing_10_6_definition = {
  domain: "billing",
  sequence: 16,
  capability: "service",
  enabled: true,
...
export const billing_10_7_definition = {
  domain: "billing",
  sequence: 17,
  capability: "service",
  enabled: true,
