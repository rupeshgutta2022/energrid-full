...
export const billing_191_0_definition = {
  domain: "billing",
  sequence: 191,
  capability: "workflow",
  enabled: true,
...
export const billing_191_1_definition = {
  domain: "billing",
  sequence: 192,
  capability: "workflow",
  enabled: true,
...
export const billing_191_2_definition = {
  domain: "billing",
  sequence: 193,
  capability: "workflow",
  enabled: true,
...
export const billing_191_3_definition = {
  domain: "billing",
  sequence: 194,
  capability: "workflow",
  enabled: true,
...
export const billing_191_4_definition = {
  domain: "billing",
  sequence: 195,
  capability: "workflow",
  enabled: true,
...
export const billing_191_5_definition = {
  domain: "billing",
  sequence: 196,
  capability: "workflow",
  enabled: true,
...
export const billing_191_6_definition = {
  domain: "billing",
  sequence: 197,
  capability: "workflow",
  enabled: true,
