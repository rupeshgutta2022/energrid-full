...
export const security_34_0_definition = {
  domain: "security",
  sequence: 34,
  capability: "service",
  enabled: true,
...
export const security_34_1_definition = {
  domain: "security",
  sequence: 35,
  capability: "service",
  enabled: true,
...
export const security_34_2_definition = {
  domain: "security",
  sequence: 36,
  capability: "service",
  enabled: true,
...
export const security_34_3_definition = {
  domain: "security",
  sequence: 37,
  capability: "service",
  enabled: true,
...
export const security_34_4_definition = {
  domain: "security",
  sequence: 38,
  capability: "service",
  enabled: true,
...
export const security_34_5_definition = {
  domain: "security",
  sequence: 39,
  capability: "service",
  enabled: true,
...
export const security_34_6_definition = {
  domain: "security",
  sequence: 40,
  capability: "service",
  enabled: true,
...
export const security_34_7_definition = {
  domain: "security",
  sequence: 41,
  capability: "service",
  enabled: true,
