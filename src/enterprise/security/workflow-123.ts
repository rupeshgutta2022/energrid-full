...
export const security_123_0_definition = {
  domain: "security",
  sequence: 123,
  capability: "workflow",
  enabled: true,
...
export const security_123_1_definition = {
  domain: "security",
  sequence: 124,
  capability: "workflow",
  enabled: true,
...
export const security_123_2_definition = {
  domain: "security",
  sequence: 125,
  capability: "workflow",
  enabled: true,
...
export const security_123_3_definition = {
  domain: "security",
  sequence: 126,
  capability: "workflow",
  enabled: true,
