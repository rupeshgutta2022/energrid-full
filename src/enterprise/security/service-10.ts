...
export const security_10_0_definition = {
  domain: "security",
  sequence: 10,
  capability: "service",
  enabled: true,
...
export const security_10_1_definition = {
  domain: "security",
  sequence: 11,
  capability: "service",
  enabled: true,
...
export const security_10_2_definition = {
  domain: "security",
  sequence: 12,
  capability: "service",
  enabled: true,
...
export const security_10_3_definition = {
  domain: "security",
  sequence: 13,
  capability: "service",
  enabled: true,
...
export const security_10_4_definition = {
  domain: "security",
  sequence: 14,
  capability: "service",
  enabled: true,
...
export const security_10_5_definition = {
  domain: "security",
  sequence: 15,
  capability: "service",
  enabled: true,
...
export const security_10_6_definition = {
  domain: "security",
  sequence: 16,
  capability: "service",
  enabled: true,
...
export const security_10_7_definition = {
  domain: "security",
  sequence: 17,
  capability: "service",
  enabled: true,
