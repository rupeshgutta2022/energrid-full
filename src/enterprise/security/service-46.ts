...
export const security_46_0_definition = {
  domain: "security",
  sequence: 46,
  capability: "service",
  enabled: true,
...
export const security_46_1_definition = {
  domain: "security",
  sequence: 47,
  capability: "service",
  enabled: true,
...
export const security_46_2_definition = {
  domain: "security",
  sequence: 48,
  capability: "service",
  enabled: true,
...
export const security_46_3_definition = {
  domain: "security",
  sequence: 49,
  capability: "service",
  enabled: true,
...
export const security_46_4_definition = {
  domain: "security",
  sequence: 50,
  capability: "service",
  enabled: true,
...
export const security_46_5_definition = {
  domain: "security",
  sequence: 51,
  capability: "service",
  enabled: true,
...
export const security_46_6_definition = {
  domain: "security",
  sequence: 52,
  capability: "service",
  enabled: true,
...
export const security_46_7_definition = {
  domain: "security",
  sequence: 53,
  capability: "service",
  enabled: true,
