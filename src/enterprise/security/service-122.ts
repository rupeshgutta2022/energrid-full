...
export const security_122_0_definition = {
  domain: "security",
  sequence: 122,
  capability: "service",
  enabled: true,
...
export const security_122_1_definition = {
  domain: "security",
  sequence: 123,
  capability: "service",
  enabled: true,
...
export const security_122_2_definition = {
  domain: "security",
  sequence: 124,
  capability: "service",
  enabled: true,
...
export const security_122_3_definition = {
  domain: "security",
  sequence: 125,
  capability: "service",
  enabled: true,
