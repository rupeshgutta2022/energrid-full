...
export const security_78_0_definition = {
  domain: "security",
  sequence: 78,
  capability: "service",
  enabled: true,
...
export const security_78_1_definition = {
  domain: "security",
  sequence: 79,
  capability: "service",
  enabled: true,
...
export const security_78_2_definition = {
  domain: "security",
  sequence: 80,
  capability: "service",
  enabled: true,
...
export const security_78_3_definition = {
  domain: "security",
  sequence: 81,
  capability: "service",
  enabled: true,
...
export const security_78_4_definition = {
  domain: "security",
  sequence: 82,
  capability: "service",
  enabled: true,
...
export const security_78_5_definition = {
  domain: "security",
  sequence: 83,
  capability: "service",
  enabled: true,
...
export const security_78_6_definition = {
  domain: "security",
  sequence: 84,
  capability: "service",
  enabled: true,
...
export const security_78_7_definition = {
  domain: "security",
  sequence: 85,
  capability: "service",
  enabled: true,
