...
export const security_66_0_definition = {
  domain: "security",
  sequence: 66,
  capability: "service",
  enabled: true,
...
export const security_66_1_definition = {
  domain: "security",
  sequence: 67,
  capability: "service",
  enabled: true,
...
export const security_66_2_definition = {
  domain: "security",
  sequence: 68,
  capability: "service",
  enabled: true,
...
export const security_66_3_definition = {
  domain: "security",
  sequence: 69,
  capability: "service",
  enabled: true,
...
export const security_66_4_definition = {
  domain: "security",
  sequence: 70,
  capability: "service",
  enabled: true,
...
export const security_66_5_definition = {
  domain: "security",
  sequence: 71,
  capability: "service",
  enabled: true,
...
export const security_66_6_definition = {
  domain: "security",
  sequence: 72,
  capability: "service",
  enabled: true,
...
export const security_66_7_definition = {
  domain: "security",
  sequence: 73,
  capability: "service",
  enabled: true,
