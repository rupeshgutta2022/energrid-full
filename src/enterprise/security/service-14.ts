...
export const security_14_0_definition = {
  domain: "security",
  sequence: 14,
  capability: "service",
  enabled: true,
...
export const security_14_1_definition = {
  domain: "security",
  sequence: 15,
  capability: "service",
  enabled: true,
...
export const security_14_2_definition = {
  domain: "security",
  sequence: 16,
  capability: "service",
  enabled: true,
...
export const security_14_3_definition = {
  domain: "security",
  sequence: 17,
  capability: "service",
  enabled: true,
...
export const security_14_4_definition = {
  domain: "security",
  sequence: 18,
  capability: "service",
  enabled: true,
...
export const security_14_5_definition = {
  domain: "security",
  sequence: 19,
  capability: "service",
  enabled: true,
...
export const security_14_6_definition = {
  domain: "security",
  sequence: 20,
  capability: "service",
  enabled: true,
...
export const security_14_7_definition = {
  domain: "security",
  sequence: 21,
  capability: "service",
  enabled: true,
