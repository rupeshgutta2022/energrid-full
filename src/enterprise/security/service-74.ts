...
export const security_74_0_definition = {
  domain: "security",
  sequence: 74,
  capability: "service",
  enabled: true,
...
export const security_74_1_definition = {
  domain: "security",
  sequence: 75,
  capability: "service",
  enabled: true,
...
export const security_74_2_definition = {
  domain: "security",
  sequence: 76,
  capability: "service",
  enabled: true,
...
export const security_74_3_definition = {
  domain: "security",
  sequence: 77,
  capability: "service",
  enabled: true,
...
export const security_74_4_definition = {
  domain: "security",
  sequence: 78,
  capability: "service",
  enabled: true,
...
export const security_74_5_definition = {
  domain: "security",
  sequence: 79,
  capability: "service",
  enabled: true,
...
export const security_74_6_definition = {
  domain: "security",
  sequence: 80,
  capability: "service",
  enabled: true,
...
export const security_74_7_definition = {
  domain: "security",
  sequence: 81,
  capability: "service",
  enabled: true,
