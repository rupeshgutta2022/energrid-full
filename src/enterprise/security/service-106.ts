...
export const security_106_0_definition = {
  domain: "security",
  sequence: 106,
  capability: "service",
  enabled: true,
...
export const security_106_1_definition = {
  domain: "security",
  sequence: 107,
  capability: "service",
  enabled: true,
...
export const security_106_2_definition = {
  domain: "security",
  sequence: 108,
  capability: "service",
  enabled: true,
...
export const security_106_3_definition = {
  domain: "security",
  sequence: 109,
  capability: "service",
  enabled: true,
...
export const security_106_4_definition = {
  domain: "security",
  sequence: 110,
  capability: "service",
  enabled: true,
...
export const security_106_5_definition = {
  domain: "security",
  sequence: 111,
  capability: "service",
  enabled: true,
...
export const security_106_6_definition = {
  domain: "security",
  sequence: 112,
  capability: "service",
  enabled: true,
...
export const security_106_7_definition = {
  domain: "security",
  sequence: 113,
  capability: "service",
  enabled: true,
