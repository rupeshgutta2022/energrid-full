...
export const security_82_0_definition = {
  domain: "security",
  sequence: 82,
  capability: "service",
  enabled: true,
...
export const security_82_1_definition = {
  domain: "security",
  sequence: 83,
  capability: "service",
  enabled: true,
...
export const security_82_2_definition = {
  domain: "security",
  sequence: 84,
  capability: "service",
  enabled: true,
...
export const security_82_3_definition = {
  domain: "security",
  sequence: 85,
  capability: "service",
  enabled: true,
...
export const security_82_4_definition = {
  domain: "security",
  sequence: 86,
  capability: "service",
  enabled: true,
...
export const security_82_5_definition = {
  domain: "security",
  sequence: 87,
  capability: "service",
  enabled: true,
...
export const security_82_6_definition = {
  domain: "security",
  sequence: 88,
  capability: "service",
  enabled: true,
...
export const security_82_7_definition = {
  domain: "security",
  sequence: 89,
  capability: "service",
  enabled: true,
