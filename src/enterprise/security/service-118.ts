...
export const security_118_0_definition = {
  domain: "security",
  sequence: 118,
  capability: "service",
  enabled: true,
...
export const security_118_1_definition = {
  domain: "security",
  sequence: 119,
  capability: "service",
  enabled: true,
...
export const security_118_2_definition = {
  domain: "security",
  sequence: 120,
  capability: "service",
  enabled: true,
...
export const security_118_3_definition = {
  domain: "security",
  sequence: 121,
  capability: "service",
  enabled: true,
...
export const security_118_4_definition = {
  domain: "security",
  sequence: 122,
  capability: "service",
  enabled: true,
