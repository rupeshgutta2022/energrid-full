...
export const security_22_0_definition = {
  domain: "security",
  sequence: 22,
  capability: "service",
  enabled: true,
...
export const security_22_1_definition = {
  domain: "security",
  sequence: 23,
  capability: "service",
  enabled: true,
...
export const security_22_2_definition = {
  domain: "security",
  sequence: 24,
  capability: "service",
  enabled: true,
...
export const security_22_3_definition = {
  domain: "security",
  sequence: 25,
  capability: "service",
  enabled: true,
...
export const security_22_4_definition = {
  domain: "security",
  sequence: 26,
  capability: "service",
  enabled: true,
...
export const security_22_5_definition = {
  domain: "security",
  sequence: 27,
  capability: "service",
  enabled: true,
...
export const security_22_6_definition = {
  domain: "security",
  sequence: 28,
  capability: "service",
  enabled: true,
...
export const security_22_7_definition = {
  domain: "security",
  sequence: 29,
  capability: "service",
  enabled: true,
