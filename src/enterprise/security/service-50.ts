...
export const security_50_0_definition = {
  domain: "security",
  sequence: 50,
  capability: "service",
  enabled: true,
...
export const security_50_1_definition = {
  domain: "security",
  sequence: 51,
  capability: "service",
  enabled: true,
...
export const security_50_2_definition = {
  domain: "security",
  sequence: 52,
  capability: "service",
  enabled: true,
...
export const security_50_3_definition = {
  domain: "security",
  sequence: 53,
  capability: "service",
  enabled: true,
...
export const security_50_4_definition = {
  domain: "security",
  sequence: 54,
  capability: "service",
  enabled: true,
...
export const security_50_5_definition = {
  domain: "security",
  sequence: 55,
  capability: "service",
  enabled: true,
...
export const security_50_6_definition = {
  domain: "security",
  sequence: 56,
  capability: "service",
  enabled: true,
...
export const security_50_7_definition = {
  domain: "security",
  sequence: 57,
  capability: "service",
  enabled: true,
