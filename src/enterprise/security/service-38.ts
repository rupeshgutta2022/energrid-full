...
export const security_38_0_definition = {
  domain: "security",
  sequence: 38,
  capability: "service",
  enabled: true,
...
export const security_38_1_definition = {
  domain: "security",
  sequence: 39,
  capability: "service",
  enabled: true,
...
export const security_38_2_definition = {
  domain: "security",
  sequence: 40,
  capability: "service",
  enabled: true,
...
export const security_38_3_definition = {
  domain: "security",
  sequence: 41,
  capability: "service",
  enabled: true,
...
export const security_38_4_definition = {
  domain: "security",
  sequence: 42,
  capability: "service",
  enabled: true,
...
export const security_38_5_definition = {
  domain: "security",
  sequence: 43,
  capability: "service",
  enabled: true,
...
export const security_38_6_definition = {
  domain: "security",
  sequence: 44,
  capability: "service",
  enabled: true,
...
export const security_38_7_definition = {
  domain: "security",
  sequence: 45,
  capability: "service",
  enabled: true,
