...
export const security_114_0_definition = {
  domain: "security",
  sequence: 114,
  capability: "service",
  enabled: true,
...
export const security_114_1_definition = {
  domain: "security",
  sequence: 115,
  capability: "service",
  enabled: true,
...
export const security_114_2_definition = {
  domain: "security",
  sequence: 116,
  capability: "service",
  enabled: true,
...
export const security_114_3_definition = {
  domain: "security",
  sequence: 117,
  capability: "service",
  enabled: true,
...
export const security_114_4_definition = {
  domain: "security",
  sequence: 118,
  capability: "service",
  enabled: true,
...
export const security_114_5_definition = {
  domain: "security",
  sequence: 119,
  capability: "service",
  enabled: true,
...
export const security_114_6_definition = {
  domain: "security",
  sequence: 120,
  capability: "service",
  enabled: true,
...
export const security_114_7_definition = {
  domain: "security",
  sequence: 121,
  capability: "service",
  enabled: true,
