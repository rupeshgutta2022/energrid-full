...
export const security_62_0_definition = {
  domain: "security",
  sequence: 62,
  capability: "service",
  enabled: true,
...
export const security_62_1_definition = {
  domain: "security",
  sequence: 63,
  capability: "service",
  enabled: true,
...
export const security_62_2_definition = {
  domain: "security",
  sequence: 64,
  capability: "service",
  enabled: true,
...
export const security_62_3_definition = {
  domain: "security",
  sequence: 65,
  capability: "service",
  enabled: true,
...
export const security_62_4_definition = {
  domain: "security",
  sequence: 66,
  capability: "service",
  enabled: true,
...
export const security_62_5_definition = {
  domain: "security",
  sequence: 67,
  capability: "service",
  enabled: true,
...
export const security_62_6_definition = {
  domain: "security",
  sequence: 68,
  capability: "service",
  enabled: true,
...
export const security_62_7_definition = {
  domain: "security",
  sequence: 69,
  capability: "service",
  enabled: true,
