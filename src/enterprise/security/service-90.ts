...
export const security_90_0_definition = {
  domain: "security",
  sequence: 90,
  capability: "service",
  enabled: true,
...
export const security_90_1_definition = {
  domain: "security",
  sequence: 91,
  capability: "service",
  enabled: true,
...
export const security_90_2_definition = {
  domain: "security",
  sequence: 92,
  capability: "service",
  enabled: true,
...
export const security_90_3_definition = {
  domain: "security",
  sequence: 93,
  capability: "service",
  enabled: true,
...
export const security_90_4_definition = {
  domain: "security",
  sequence: 94,
  capability: "service",
  enabled: true,
...
export const security_90_5_definition = {
  domain: "security",
  sequence: 95,
  capability: "service",
  enabled: true,
...
export const security_90_6_definition = {
  domain: "security",
  sequence: 96,
  capability: "service",
  enabled: true,
...
export const security_90_7_definition = {
  domain: "security",
  sequence: 97,
  capability: "service",
  enabled: true,
