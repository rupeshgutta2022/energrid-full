...
export const security_110_0_definition = {
  domain: "security",
  sequence: 110,
  capability: "service",
  enabled: true,
...
export const security_110_1_definition = {
  domain: "security",
  sequence: 111,
  capability: "service",
  enabled: true,
...
export const security_110_2_definition = {
  domain: "security",
  sequence: 112,
  capability: "service",
  enabled: true,
...
export const security_110_3_definition = {
  domain: "security",
  sequence: 113,
  capability: "service",
  enabled: true,
...
export const security_110_4_definition = {
  domain: "security",
  sequence: 114,
  capability: "service",
  enabled: true,
...
export const security_110_5_definition = {
  domain: "security",
  sequence: 115,
  capability: "service",
  enabled: true,
...
export const security_110_6_definition = {
  domain: "security",
  sequence: 116,
  capability: "service",
  enabled: true,
...
export const security_110_7_definition = {
  domain: "security",
  sequence: 117,
  capability: "service",
  enabled: true,
