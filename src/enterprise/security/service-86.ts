...
export const security_86_0_definition = {
  domain: "security",
  sequence: 86,
  capability: "service",
  enabled: true,
...
export const security_86_1_definition = {
  domain: "security",
  sequence: 87,
  capability: "service",
  enabled: true,
...
export const security_86_2_definition = {
  domain: "security",
  sequence: 88,
  capability: "service",
  enabled: true,
...
export const security_86_3_definition = {
  domain: "security",
  sequence: 89,
  capability: "service",
  enabled: true,
...
export const security_86_4_definition = {
  domain: "security",
  sequence: 90,
  capability: "service",
  enabled: true,
...
export const security_86_5_definition = {
  domain: "security",
  sequence: 91,
  capability: "service",
  enabled: true,
...
export const security_86_6_definition = {
  domain: "security",
  sequence: 92,
  capability: "service",
  enabled: true,
...
export const security_86_7_definition = {
  domain: "security",
  sequence: 93,
  capability: "service",
  enabled: true,
