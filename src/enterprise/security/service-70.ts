...
export const security_70_0_definition = {
  domain: "security",
  sequence: 70,
  capability: "service",
  enabled: true,
...
export const security_70_1_definition = {
  domain: "security",
  sequence: 71,
  capability: "service",
  enabled: true,
...
export const security_70_2_definition = {
  domain: "security",
  sequence: 72,
  capability: "service",
  enabled: true,
...
export const security_70_3_definition = {
  domain: "security",
  sequence: 73,
  capability: "service",
  enabled: true,
...
export const security_70_4_definition = {
  domain: "security",
  sequence: 74,
  capability: "service",
  enabled: true,
...
export const security_70_5_definition = {
  domain: "security",
  sequence: 75,
  capability: "service",
  enabled: true,
...
export const security_70_6_definition = {
  domain: "security",
  sequence: 76,
  capability: "service",
  enabled: true,
...
export const security_70_7_definition = {
  domain: "security",
  sequence: 77,
  capability: "service",
  enabled: true,
