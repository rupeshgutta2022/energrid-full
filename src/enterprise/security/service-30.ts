...
export const security_30_0_definition = {
  domain: "security",
  sequence: 30,
  capability: "service",
  enabled: true,
...
export const security_30_1_definition = {
  domain: "security",
  sequence: 31,
  capability: "service",
  enabled: true,
...
export const security_30_2_definition = {
  domain: "security",
  sequence: 32,
  capability: "service",
  enabled: true,
...
export const security_30_3_definition = {
  domain: "security",
  sequence: 33,
  capability: "service",
  enabled: true,
...
export const security_30_4_definition = {
  domain: "security",
  sequence: 34,
  capability: "service",
  enabled: true,
...
export const security_30_5_definition = {
  domain: "security",
  sequence: 35,
  capability: "service",
  enabled: true,
...
export const security_30_6_definition = {
  domain: "security",
  sequence: 36,
  capability: "service",
  enabled: true,
...
export const security_30_7_definition = {
  domain: "security",
  sequence: 37,
  capability: "service",
  enabled: true,
