...
export const security_2_0_definition = {
  domain: "security",
  sequence: 2,
  capability: "service",
  enabled: true,
...
export const security_2_1_definition = {
  domain: "security",
  sequence: 3,
  capability: "service",
  enabled: true,
...
export const security_2_2_definition = {
  domain: "security",
  sequence: 4,
  capability: "service",
  enabled: true,
...
export const security_2_3_definition = {
  domain: "security",
  sequence: 5,
  capability: "service",
  enabled: true,
...
export const security_2_4_definition = {
  domain: "security",
  sequence: 6,
  capability: "service",
  enabled: true,
...
export const security_2_5_definition = {
  domain: "security",
  sequence: 7,
  capability: "service",
  enabled: true,
...
export const security_2_6_definition = {
  domain: "security",
  sequence: 8,
  capability: "service",
  enabled: true,
...
export const security_2_7_definition = {
  domain: "security",
  sequence: 9,
  capability: "service",
  enabled: true,
