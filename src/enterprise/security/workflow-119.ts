...
export const security_119_0_definition = {
  domain: "security",
  sequence: 119,
  capability: "workflow",
  enabled: true,
...
export const security_119_1_definition = {
  domain: "security",
  sequence: 120,
  capability: "workflow",
  enabled: true,
...
export const security_119_2_definition = {
  domain: "security",
  sequence: 121,
  capability: "workflow",
  enabled: true,
...
export const security_119_3_definition = {
  domain: "security",
  sequence: 122,
  capability: "workflow",
  enabled: true,
...
export const security_119_4_definition = {
  domain: "security",
  sequence: 123,
  capability: "workflow",
  enabled: true,
...
export const security_119_5_definition = {
  domain: "security",
  sequence: 124,
  capability: "workflow",
  enabled: true,
