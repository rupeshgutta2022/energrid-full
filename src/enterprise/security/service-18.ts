...
export const security_18_0_definition = {
  domain: "security",
  sequence: 18,
  capability: "service",
  enabled: true,
...
export const security_18_1_definition = {
  domain: "security",
  sequence: 19,
  capability: "service",
  enabled: true,
...
export const security_18_2_definition = {
  domain: "security",
  sequence: 20,
  capability: "service",
  enabled: true,
...
export const security_18_3_definition = {
  domain: "security",
  sequence: 21,
  capability: "service",
  enabled: true,
...
export const security_18_4_definition = {
  domain: "security",
  sequence: 22,
  capability: "service",
  enabled: true,
...
export const security_18_5_definition = {
  domain: "security",
  sequence: 23,
  capability: "service",
  enabled: true,
...
export const security_18_6_definition = {
  domain: "security",
  sequence: 24,
  capability: "service",
  enabled: true,
...
export const security_18_7_definition = {
  domain: "security",
  sequence: 25,
  capability: "service",
  enabled: true,
