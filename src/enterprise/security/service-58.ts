...
export const security_58_0_definition = {
  domain: "security",
  sequence: 58,
  capability: "service",
  enabled: true,
...
export const security_58_1_definition = {
  domain: "security",
  sequence: 59,
  capability: "service",
  enabled: true,
...
export const security_58_2_definition = {
  domain: "security",
  sequence: 60,
  capability: "service",
  enabled: true,
...
export const security_58_3_definition = {
  domain: "security",
  sequence: 61,
  capability: "service",
  enabled: true,
...
export const security_58_4_definition = {
  domain: "security",
  sequence: 62,
  capability: "service",
  enabled: true,
...
export const security_58_5_definition = {
  domain: "security",
  sequence: 63,
  capability: "service",
  enabled: true,
...
export const security_58_6_definition = {
  domain: "security",
  sequence: 64,
  capability: "service",
  enabled: true,
...
export const security_58_7_definition = {
  domain: "security",
  sequence: 65,
  capability: "service",
  enabled: true,
