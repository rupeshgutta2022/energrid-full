...
export const security_94_0_definition = {
  domain: "security",
  sequence: 94,
  capability: "service",
  enabled: true,
...
export const security_94_1_definition = {
  domain: "security",
  sequence: 95,
  capability: "service",
  enabled: true,
...
export const security_94_2_definition = {
  domain: "security",
  sequence: 96,
  capability: "service",
  enabled: true,
...
export const security_94_3_definition = {
  domain: "security",
  sequence: 97,
  capability: "service",
  enabled: true,
...
export const security_94_4_definition = {
  domain: "security",
  sequence: 98,
  capability: "service",
  enabled: true,
...
export const security_94_5_definition = {
  domain: "security",
  sequence: 99,
  capability: "service",
  enabled: true,
...
export const security_94_6_definition = {
  domain: "security",
  sequence: 100,
  capability: "service",
  enabled: true,
...
export const security_94_7_definition = {
  domain: "security",
  sequence: 101,
  capability: "service",
  enabled: true,
