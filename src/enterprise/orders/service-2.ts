...
export const orders_2_0_definition = {
  domain: "orders",
  sequence: 2,
  capability: "service",
  enabled: true,
...
export const orders_2_1_definition = {
  domain: "orders",
  sequence: 3,
  capability: "service",
  enabled: true,
...
export const orders_2_2_definition = {
  domain: "orders",
  sequence: 4,
  capability: "service",
  enabled: true,
...
export const orders_2_3_definition = {
  domain: "orders",
  sequence: 5,
  capability: "service",
  enabled: true,
...
export const orders_2_4_definition = {
  domain: "orders",
  sequence: 6,
  capability: "service",
  enabled: true,
...
export const orders_2_5_definition = {
  domain: "orders",
  sequence: 7,
  capability: "service",
  enabled: true,
...
export const orders_2_6_definition = {
  domain: "orders",
  sequence: 8,
  capability: "service",
  enabled: true,
...
export const orders_2_7_definition = {
  domain: "orders",
  sequence: 9,
  capability: "service",
  enabled: true,
