...
export const orders_42_0_definition = {
  domain: "orders",
  sequence: 42,
  capability: "service",
  enabled: true,
...
export const orders_42_1_definition = {
  domain: "orders",
  sequence: 43,
  capability: "service",
  enabled: true,
...
export const orders_42_2_definition = {
  domain: "orders",
  sequence: 44,
  capability: "service",
  enabled: true,
...
export const orders_42_3_definition = {
  domain: "orders",
  sequence: 45,
  capability: "service",
  enabled: true,
...
export const orders_42_4_definition = {
  domain: "orders",
  sequence: 46,
  capability: "service",
  enabled: true,
...
export const orders_42_5_definition = {
  domain: "orders",
  sequence: 47,
  capability: "service",
  enabled: true,
...
export const orders_42_6_definition = {
  domain: "orders",
  sequence: 48,
  capability: "service",
  enabled: true,
...
export const orders_42_7_definition = {
  domain: "orders",
  sequence: 49,
  capability: "service",
  enabled: true,
