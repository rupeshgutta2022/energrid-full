...
export const orders_102_0_definition = {
  domain: "orders",
  sequence: 102,
  capability: "service",
  enabled: true,
...
export const orders_102_1_definition = {
  domain: "orders",
  sequence: 103,
  capability: "service",
  enabled: true,
...
export const orders_102_2_definition = {
  domain: "orders",
  sequence: 104,
  capability: "service",
  enabled: true,
...
export const orders_102_3_definition = {
  domain: "orders",
  sequence: 105,
  capability: "service",
  enabled: true,
...
export const orders_102_4_definition = {
  domain: "orders",
  sequence: 106,
  capability: "service",
  enabled: true,
...
export const orders_102_5_definition = {
  domain: "orders",
  sequence: 107,
  capability: "service",
  enabled: true,
...
export const orders_102_6_definition = {
  domain: "orders",
  sequence: 108,
  capability: "service",
  enabled: true,
...
export const orders_102_7_definition = {
  domain: "orders",
  sequence: 109,
  capability: "service",
  enabled: true,
