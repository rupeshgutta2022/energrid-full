...
export const orders_130_0_definition = {
  domain: "orders",
  sequence: 130,
  capability: "service",
  enabled: true,
...
export const orders_130_1_definition = {
  domain: "orders",
  sequence: 131,
  capability: "service",
  enabled: true,
...
export const orders_130_2_definition = {
  domain: "orders",
  sequence: 132,
  capability: "service",
  enabled: true,
...
export const orders_130_3_definition = {
  domain: "orders",
  sequence: 133,
  capability: "service",
  enabled: true,
...
export const orders_130_4_definition = {
  domain: "orders",
  sequence: 134,
  capability: "service",
  enabled: true,
...
export const orders_130_5_definition = {
  domain: "orders",
  sequence: 135,
  capability: "service",
  enabled: true,
...
export const orders_130_6_definition = {
  domain: "orders",
  sequence: 136,
  capability: "service",
  enabled: true,
...
export const orders_130_7_definition = {
  domain: "orders",
  sequence: 137,
  capability: "service",
  enabled: true,
