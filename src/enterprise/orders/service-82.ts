...
export const orders_82_0_definition = {
  domain: "orders",
  sequence: 82,
  capability: "service",
  enabled: true,
...
export const orders_82_1_definition = {
  domain: "orders",
  sequence: 83,
  capability: "service",
  enabled: true,
...
export const orders_82_2_definition = {
  domain: "orders",
  sequence: 84,
  capability: "service",
  enabled: true,
...
export const orders_82_3_definition = {
  domain: "orders",
  sequence: 85,
  capability: "service",
  enabled: true,
...
export const orders_82_4_definition = {
  domain: "orders",
  sequence: 86,
  capability: "service",
  enabled: true,
...
export const orders_82_5_definition = {
  domain: "orders",
  sequence: 87,
  capability: "service",
  enabled: true,
...
export const orders_82_6_definition = {
  domain: "orders",
  sequence: 88,
  capability: "service",
  enabled: true,
...
export const orders_82_7_definition = {
  domain: "orders",
  sequence: 89,
  capability: "service",
  enabled: true,
