...
export const orders_118_0_definition = {
  domain: "orders",
  sequence: 118,
  capability: "service",
  enabled: true,
...
export const orders_118_1_definition = {
  domain: "orders",
  sequence: 119,
  capability: "service",
  enabled: true,
...
export const orders_118_2_definition = {
  domain: "orders",
  sequence: 120,
  capability: "service",
  enabled: true,
...
export const orders_118_3_definition = {
  domain: "orders",
  sequence: 121,
  capability: "service",
  enabled: true,
...
export const orders_118_4_definition = {
  domain: "orders",
  sequence: 122,
  capability: "service",
  enabled: true,
...
export const orders_118_5_definition = {
  domain: "orders",
  sequence: 123,
  capability: "service",
  enabled: true,
...
export const orders_118_6_definition = {
  domain: "orders",
  sequence: 124,
  capability: "service",
  enabled: true,
...
export const orders_118_7_definition = {
  domain: "orders",
  sequence: 125,
  capability: "service",
  enabled: true,
