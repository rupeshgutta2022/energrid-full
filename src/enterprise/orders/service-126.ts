...
export const orders_126_0_definition = {
  domain: "orders",
  sequence: 126,
  capability: "service",
  enabled: true,
...
export const orders_126_1_definition = {
  domain: "orders",
  sequence: 127,
  capability: "service",
  enabled: true,
...
export const orders_126_2_definition = {
  domain: "orders",
  sequence: 128,
  capability: "service",
  enabled: true,
...
export const orders_126_3_definition = {
  domain: "orders",
  sequence: 129,
  capability: "service",
  enabled: true,
...
export const orders_126_4_definition = {
  domain: "orders",
  sequence: 130,
  capability: "service",
  enabled: true,
...
export const orders_126_5_definition = {
  domain: "orders",
  sequence: 131,
  capability: "service",
  enabled: true,
...
export const orders_126_6_definition = {
  domain: "orders",
  sequence: 132,
  capability: "service",
  enabled: true,
...
export const orders_126_7_definition = {
  domain: "orders",
  sequence: 133,
  capability: "service",
  enabled: true,
