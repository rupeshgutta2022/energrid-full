...
export const orders_18_0_definition = {
  domain: "orders",
  sequence: 18,
  capability: "service",
  enabled: true,
...
export const orders_18_1_definition = {
  domain: "orders",
  sequence: 19,
  capability: "service",
  enabled: true,
...
export const orders_18_2_definition = {
  domain: "orders",
  sequence: 20,
  capability: "service",
  enabled: true,
...
export const orders_18_3_definition = {
  domain: "orders",
  sequence: 21,
  capability: "service",
  enabled: true,
...
export const orders_18_4_definition = {
  domain: "orders",
  sequence: 22,
  capability: "service",
  enabled: true,
...
export const orders_18_5_definition = {
  domain: "orders",
  sequence: 23,
  capability: "service",
  enabled: true,
...
export const orders_18_6_definition = {
  domain: "orders",
  sequence: 24,
  capability: "service",
  enabled: true,
...
export const orders_18_7_definition = {
  domain: "orders",
  sequence: 25,
  capability: "service",
  enabled: true,
