...
export const orders_182_0_definition = {
  domain: "orders",
  sequence: 182,
  capability: "service",
  enabled: true,
...
export const orders_182_1_definition = {
  domain: "orders",
  sequence: 183,
  capability: "service",
  enabled: true,
...
export const orders_182_2_definition = {
  domain: "orders",
  sequence: 184,
  capability: "service",
  enabled: true,
...
export const orders_182_3_definition = {
  domain: "orders",
  sequence: 185,
  capability: "service",
  enabled: true,
...
export const orders_182_4_definition = {
  domain: "orders",
  sequence: 186,
  capability: "service",
  enabled: true,
...
export const orders_182_5_definition = {
  domain: "orders",
  sequence: 187,
  capability: "service",
  enabled: true,
...
export const orders_182_6_definition = {
  domain: "orders",
  sequence: 188,
  capability: "service",
  enabled: true,
...
export const orders_182_7_definition = {
  domain: "orders",
  sequence: 189,
  capability: "service",
  enabled: true,
