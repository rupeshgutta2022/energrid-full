...
export const orders_90_0_definition = {
  domain: "orders",
  sequence: 90,
  capability: "service",
  enabled: true,
...
export const orders_90_1_definition = {
  domain: "orders",
  sequence: 91,
  capability: "service",
  enabled: true,
...
export const orders_90_2_definition = {
  domain: "orders",
  sequence: 92,
  capability: "service",
  enabled: true,
...
export const orders_90_3_definition = {
  domain: "orders",
  sequence: 93,
  capability: "service",
  enabled: true,
...
export const orders_90_4_definition = {
  domain: "orders",
  sequence: 94,
  capability: "service",
  enabled: true,
...
export const orders_90_5_definition = {
  domain: "orders",
  sequence: 95,
  capability: "service",
  enabled: true,
...
export const orders_90_6_definition = {
  domain: "orders",
  sequence: 96,
  capability: "service",
  enabled: true,
...
export const orders_90_7_definition = {
  domain: "orders",
  sequence: 97,
  capability: "service",
  enabled: true,
