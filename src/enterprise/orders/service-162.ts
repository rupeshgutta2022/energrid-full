...
export const orders_162_0_definition = {
  domain: "orders",
  sequence: 162,
  capability: "service",
  enabled: true,
...
export const orders_162_1_definition = {
  domain: "orders",
  sequence: 163,
  capability: "service",
  enabled: true,
...
export const orders_162_2_definition = {
  domain: "orders",
  sequence: 164,
  capability: "service",
  enabled: true,
...
export const orders_162_3_definition = {
  domain: "orders",
  sequence: 165,
  capability: "service",
  enabled: true,
...
export const orders_162_4_definition = {
  domain: "orders",
  sequence: 166,
  capability: "service",
  enabled: true,
...
export const orders_162_5_definition = {
  domain: "orders",
  sequence: 167,
  capability: "service",
  enabled: true,
...
export const orders_162_6_definition = {
  domain: "orders",
  sequence: 168,
  capability: "service",
  enabled: true,
...
export const orders_162_7_definition = {
  domain: "orders",
  sequence: 169,
  capability: "service",
  enabled: true,
