...
export const orders_170_0_definition = {
  domain: "orders",
  sequence: 170,
  capability: "service",
  enabled: true,
...
export const orders_170_1_definition = {
  domain: "orders",
  sequence: 171,
  capability: "service",
  enabled: true,
...
export const orders_170_2_definition = {
  domain: "orders",
  sequence: 172,
  capability: "service",
  enabled: true,
...
export const orders_170_3_definition = {
  domain: "orders",
  sequence: 173,
  capability: "service",
  enabled: true,
...
export const orders_170_4_definition = {
  domain: "orders",
  sequence: 174,
  capability: "service",
  enabled: true,
...
export const orders_170_5_definition = {
  domain: "orders",
  sequence: 175,
  capability: "service",
  enabled: true,
...
export const orders_170_6_definition = {
  domain: "orders",
  sequence: 176,
  capability: "service",
  enabled: true,
...
export const orders_170_7_definition = {
  domain: "orders",
  sequence: 177,
  capability: "service",
  enabled: true,
