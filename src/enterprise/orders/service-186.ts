...
export const orders_186_0_definition = {
  domain: "orders",
  sequence: 186,
  capability: "service",
  enabled: true,
...
export const orders_186_1_definition = {
  domain: "orders",
  sequence: 187,
  capability: "service",
  enabled: true,
...
export const orders_186_2_definition = {
  domain: "orders",
  sequence: 188,
  capability: "service",
  enabled: true,
...
export const orders_186_3_definition = {
  domain: "orders",
  sequence: 189,
  capability: "service",
  enabled: true,
...
export const orders_186_4_definition = {
  domain: "orders",
  sequence: 190,
  capability: "service",
  enabled: true,
...
export const orders_186_5_definition = {
  domain: "orders",
  sequence: 191,
  capability: "service",
  enabled: true,
...
export const orders_186_6_definition = {
  domain: "orders",
  sequence: 192,
  capability: "service",
  enabled: true,
...
export const orders_186_7_definition = {
  domain: "orders",
  sequence: 193,
  capability: "service",
  enabled: true,
