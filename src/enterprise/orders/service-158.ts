...
export const orders_158_0_definition = {
  domain: "orders",
  sequence: 158,
  capability: "service",
  enabled: true,
...
export const orders_158_1_definition = {
  domain: "orders",
  sequence: 159,
  capability: "service",
  enabled: true,
...
export const orders_158_2_definition = {
  domain: "orders",
  sequence: 160,
  capability: "service",
  enabled: true,
...
export const orders_158_3_definition = {
  domain: "orders",
  sequence: 161,
  capability: "service",
  enabled: true,
...
export const orders_158_4_definition = {
  domain: "orders",
  sequence: 162,
  capability: "service",
  enabled: true,
...
export const orders_158_5_definition = {
  domain: "orders",
  sequence: 163,
  capability: "service",
  enabled: true,
...
export const orders_158_6_definition = {
  domain: "orders",
  sequence: 164,
  capability: "service",
  enabled: true,
...
export const orders_158_7_definition = {
  domain: "orders",
  sequence: 165,
  capability: "service",
  enabled: true,
