...
export const orders_34_0_definition = {
  domain: "orders",
  sequence: 34,
  capability: "service",
  enabled: true,
...
export const orders_34_1_definition = {
  domain: "orders",
  sequence: 35,
  capability: "service",
  enabled: true,
...
export const orders_34_2_definition = {
  domain: "orders",
  sequence: 36,
  capability: "service",
  enabled: true,
...
export const orders_34_3_definition = {
  domain: "orders",
  sequence: 37,
  capability: "service",
  enabled: true,
...
export const orders_34_4_definition = {
  domain: "orders",
  sequence: 38,
  capability: "service",
  enabled: true,
...
export const orders_34_5_definition = {
  domain: "orders",
  sequence: 39,
  capability: "service",
  enabled: true,
...
export const orders_34_6_definition = {
  domain: "orders",
  sequence: 40,
  capability: "service",
  enabled: true,
...
export const orders_34_7_definition = {
  domain: "orders",
  sequence: 41,
  capability: "service",
  enabled: true,
