...
export const orders_74_0_definition = {
  domain: "orders",
  sequence: 74,
  capability: "service",
  enabled: true,
...
export const orders_74_1_definition = {
  domain: "orders",
  sequence: 75,
  capability: "service",
  enabled: true,
...
export const orders_74_2_definition = {
  domain: "orders",
  sequence: 76,
  capability: "service",
  enabled: true,
...
export const orders_74_3_definition = {
  domain: "orders",
  sequence: 77,
  capability: "service",
  enabled: true,
...
export const orders_74_4_definition = {
  domain: "orders",
  sequence: 78,
  capability: "service",
  enabled: true,
...
export const orders_74_5_definition = {
  domain: "orders",
  sequence: 79,
  capability: "service",
  enabled: true,
...
export const orders_74_6_definition = {
  domain: "orders",
  sequence: 80,
  capability: "service",
  enabled: true,
...
export const orders_74_7_definition = {
  domain: "orders",
  sequence: 81,
  capability: "service",
  enabled: true,
