...
export const orders_98_0_definition = {
  domain: "orders",
  sequence: 98,
  capability: "service",
  enabled: true,
...
export const orders_98_1_definition = {
  domain: "orders",
  sequence: 99,
  capability: "service",
  enabled: true,
...
export const orders_98_2_definition = {
  domain: "orders",
  sequence: 100,
  capability: "service",
  enabled: true,
...
export const orders_98_3_definition = {
  domain: "orders",
  sequence: 101,
  capability: "service",
  enabled: true,
...
export const orders_98_4_definition = {
  domain: "orders",
  sequence: 102,
  capability: "service",
  enabled: true,
...
export const orders_98_5_definition = {
  domain: "orders",
  sequence: 103,
  capability: "service",
  enabled: true,
...
export const orders_98_6_definition = {
  domain: "orders",
  sequence: 104,
  capability: "service",
  enabled: true,
...
export const orders_98_7_definition = {
  domain: "orders",
  sequence: 105,
  capability: "service",
  enabled: true,
