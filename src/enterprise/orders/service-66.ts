...
export const orders_66_0_definition = {
  domain: "orders",
  sequence: 66,
  capability: "service",
  enabled: true,
...
export const orders_66_1_definition = {
  domain: "orders",
  sequence: 67,
  capability: "service",
  enabled: true,
...
export const orders_66_2_definition = {
  domain: "orders",
  sequence: 68,
  capability: "service",
  enabled: true,
...
export const orders_66_3_definition = {
  domain: "orders",
  sequence: 69,
  capability: "service",
  enabled: true,
...
export const orders_66_4_definition = {
  domain: "orders",
  sequence: 70,
  capability: "service",
  enabled: true,
...
export const orders_66_5_definition = {
  domain: "orders",
  sequence: 71,
  capability: "service",
  enabled: true,
...
export const orders_66_6_definition = {
  domain: "orders",
  sequence: 72,
  capability: "service",
  enabled: true,
...
export const orders_66_7_definition = {
  domain: "orders",
  sequence: 73,
  capability: "service",
  enabled: true,
