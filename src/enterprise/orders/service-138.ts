...
export const orders_138_0_definition = {
  domain: "orders",
  sequence: 138,
  capability: "service",
  enabled: true,
...
export const orders_138_1_definition = {
  domain: "orders",
  sequence: 139,
  capability: "service",
  enabled: true,
...
export const orders_138_2_definition = {
  domain: "orders",
  sequence: 140,
  capability: "service",
  enabled: true,
...
export const orders_138_3_definition = {
  domain: "orders",
  sequence: 141,
  capability: "service",
  enabled: true,
...
export const orders_138_4_definition = {
  domain: "orders",
  sequence: 142,
  capability: "service",
  enabled: true,
...
export const orders_138_5_definition = {
  domain: "orders",
  sequence: 143,
  capability: "service",
  enabled: true,
...
export const orders_138_6_definition = {
  domain: "orders",
  sequence: 144,
  capability: "service",
  enabled: true,
...
export const orders_138_7_definition = {
  domain: "orders",
  sequence: 145,
  capability: "service",
  enabled: true,
