...
export const orders_194_0_definition = {
  domain: "orders",
  sequence: 194,
  capability: "service",
  enabled: true,
...
export const orders_194_1_definition = {
  domain: "orders",
  sequence: 195,
  capability: "service",
  enabled: true,
...
export const orders_194_2_definition = {
  domain: "orders",
  sequence: 196,
  capability: "service",
  enabled: true,
...
export const orders_194_3_definition = {
  domain: "orders",
  sequence: 197,
  capability: "service",
  enabled: true,
...
export const orders_194_4_definition = {
  domain: "orders",
  sequence: 198,
  capability: "service",
  enabled: true,
...
export const orders_194_5_definition = {
  domain: "orders",
  sequence: 199,
  capability: "service",
  enabled: true,
...
export const orders_194_6_definition = {
  domain: "orders",
  sequence: 200,
  capability: "service",
  enabled: true,
...
export const orders_194_7_definition = {
  domain: "orders",
  sequence: 201,
  capability: "service",
  enabled: true,
