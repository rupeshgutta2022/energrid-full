...
export const orders_22_0_definition = {
  domain: "orders",
  sequence: 22,
  capability: "service",
  enabled: true,
...
export const orders_22_1_definition = {
  domain: "orders",
  sequence: 23,
  capability: "service",
  enabled: true,
...
export const orders_22_2_definition = {
  domain: "orders",
  sequence: 24,
  capability: "service",
  enabled: true,
...
export const orders_22_3_definition = {
  domain: "orders",
  sequence: 25,
  capability: "service",
  enabled: true,
...
export const orders_22_4_definition = {
  domain: "orders",
  sequence: 26,
  capability: "service",
  enabled: true,
...
export const orders_22_5_definition = {
  domain: "orders",
  sequence: 27,
  capability: "service",
  enabled: true,
...
export const orders_22_6_definition = {
  domain: "orders",
  sequence: 28,
  capability: "service",
  enabled: true,
...
export const orders_22_7_definition = {
  domain: "orders",
  sequence: 29,
  capability: "service",
  enabled: true,
