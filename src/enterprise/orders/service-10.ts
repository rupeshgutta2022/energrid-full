...
export const orders_10_0_definition = {
  domain: "orders",
  sequence: 10,
  capability: "service",
  enabled: true,
...
export const orders_10_1_definition = {
  domain: "orders",
  sequence: 11,
  capability: "service",
  enabled: true,
...
export const orders_10_2_definition = {
  domain: "orders",
  sequence: 12,
  capability: "service",
  enabled: true,
...
export const orders_10_3_definition = {
  domain: "orders",
  sequence: 13,
  capability: "service",
  enabled: true,
...
export const orders_10_4_definition = {
  domain: "orders",
  sequence: 14,
  capability: "service",
  enabled: true,
...
export const orders_10_5_definition = {
  domain: "orders",
  sequence: 15,
  capability: "service",
  enabled: true,
...
export const orders_10_6_definition = {
  domain: "orders",
  sequence: 16,
  capability: "service",
  enabled: true,
...
export const orders_10_7_definition = {
  domain: "orders",
  sequence: 17,
  capability: "service",
  enabled: true,
