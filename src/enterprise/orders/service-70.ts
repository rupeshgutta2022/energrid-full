...
export const orders_70_0_definition = {
  domain: "orders",
  sequence: 70,
  capability: "service",
  enabled: true,
...
export const orders_70_1_definition = {
  domain: "orders",
  sequence: 71,
  capability: "service",
  enabled: true,
...
export const orders_70_2_definition = {
  domain: "orders",
  sequence: 72,
  capability: "service",
  enabled: true,
...
export const orders_70_3_definition = {
  domain: "orders",
  sequence: 73,
  capability: "service",
  enabled: true,
...
export const orders_70_4_definition = {
  domain: "orders",
  sequence: 74,
  capability: "service",
  enabled: true,
...
export const orders_70_5_definition = {
  domain: "orders",
  sequence: 75,
  capability: "service",
  enabled: true,
...
export const orders_70_6_definition = {
  domain: "orders",
  sequence: 76,
  capability: "service",
  enabled: true,
...
export const orders_70_7_definition = {
  domain: "orders",
  sequence: 77,
  capability: "service",
  enabled: true,
