...
export const orders_226_0_definition = {
  domain: "orders",
  sequence: 226,
  capability: "service",
  enabled: true,
...
export const orders_226_1_definition = {
  domain: "orders",
  sequence: 227,
  capability: "service",
  enabled: true,
...
export const orders_226_2_definition = {
  domain: "orders",
  sequence: 228,
  capability: "service",
  enabled: true,
...
export const orders_226_3_definition = {
  domain: "orders",
  sequence: 229,
  capability: "service",
  enabled: true,
...
export const orders_226_4_definition = {
  domain: "orders",
  sequence: 230,
  capability: "service",
  enabled: true,
...
export const orders_226_5_definition = {
  domain: "orders",
  sequence: 231,
  capability: "service",
  enabled: true,
...
export const orders_226_6_definition = {
  domain: "orders",
  sequence: 232,
  capability: "service",
  enabled: true,
...
export const orders_226_7_definition = {
  domain: "orders",
  sequence: 233,
  capability: "service",
  enabled: true,
