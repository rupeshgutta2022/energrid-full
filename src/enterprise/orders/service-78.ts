...
export const orders_78_0_definition = {
  domain: "orders",
  sequence: 78,
  capability: "service",
  enabled: true,
...
export const orders_78_1_definition = {
  domain: "orders",
  sequence: 79,
  capability: "service",
  enabled: true,
...
export const orders_78_2_definition = {
  domain: "orders",
  sequence: 80,
  capability: "service",
  enabled: true,
...
export const orders_78_3_definition = {
  domain: "orders",
  sequence: 81,
  capability: "service",
  enabled: true,
...
export const orders_78_4_definition = {
  domain: "orders",
  sequence: 82,
  capability: "service",
  enabled: true,
...
export const orders_78_5_definition = {
  domain: "orders",
  sequence: 83,
  capability: "service",
  enabled: true,
...
export const orders_78_6_definition = {
  domain: "orders",
  sequence: 84,
  capability: "service",
  enabled: true,
...
export const orders_78_7_definition = {
  domain: "orders",
  sequence: 85,
  capability: "service",
  enabled: true,
