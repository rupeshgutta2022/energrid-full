...
export const orders_214_0_definition = {
  domain: "orders",
  sequence: 214,
  capability: "service",
  enabled: true,
...
export const orders_214_1_definition = {
  domain: "orders",
  sequence: 215,
  capability: "service",
  enabled: true,
...
export const orders_214_2_definition = {
  domain: "orders",
  sequence: 216,
  capability: "service",
  enabled: true,
...
export const orders_214_3_definition = {
  domain: "orders",
  sequence: 217,
  capability: "service",
  enabled: true,
...
export const orders_214_4_definition = {
  domain: "orders",
  sequence: 218,
  capability: "service",
  enabled: true,
...
export const orders_214_5_definition = {
  domain: "orders",
  sequence: 219,
  capability: "service",
  enabled: true,
...
export const orders_214_6_definition = {
  domain: "orders",
  sequence: 220,
  capability: "service",
  enabled: true,
...
export const orders_214_7_definition = {
  domain: "orders",
  sequence: 221,
  capability: "service",
  enabled: true,
