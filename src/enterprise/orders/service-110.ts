...
export const orders_110_0_definition = {
  domain: "orders",
  sequence: 110,
  capability: "service",
  enabled: true,
...
export const orders_110_1_definition = {
  domain: "orders",
  sequence: 111,
  capability: "service",
  enabled: true,
...
export const orders_110_2_definition = {
  domain: "orders",
  sequence: 112,
  capability: "service",
  enabled: true,
...
export const orders_110_3_definition = {
  domain: "orders",
  sequence: 113,
  capability: "service",
  enabled: true,
...
export const orders_110_4_definition = {
  domain: "orders",
  sequence: 114,
  capability: "service",
  enabled: true,
...
export const orders_110_5_definition = {
  domain: "orders",
  sequence: 115,
  capability: "service",
  enabled: true,
...
export const orders_110_6_definition = {
  domain: "orders",
  sequence: 116,
  capability: "service",
  enabled: true,
...
export const orders_110_7_definition = {
  domain: "orders",
  sequence: 117,
  capability: "service",
  enabled: true,
