...
export const orders_174_0_definition = {
  domain: "orders",
  sequence: 174,
  capability: "service",
  enabled: true,
...
export const orders_174_1_definition = {
  domain: "orders",
  sequence: 175,
  capability: "service",
  enabled: true,
...
export const orders_174_2_definition = {
  domain: "orders",
  sequence: 176,
  capability: "service",
  enabled: true,
...
export const orders_174_3_definition = {
  domain: "orders",
  sequence: 177,
  capability: "service",
  enabled: true,
...
export const orders_174_4_definition = {
  domain: "orders",
  sequence: 178,
  capability: "service",
  enabled: true,
...
export const orders_174_5_definition = {
  domain: "orders",
  sequence: 179,
  capability: "service",
  enabled: true,
...
export const orders_174_6_definition = {
  domain: "orders",
  sequence: 180,
  capability: "service",
  enabled: true,
...
export const orders_174_7_definition = {
  domain: "orders",
  sequence: 181,
  capability: "service",
  enabled: true,
