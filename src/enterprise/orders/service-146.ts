...
export const orders_146_0_definition = {
  domain: "orders",
  sequence: 146,
  capability: "service",
  enabled: true,
...
export const orders_146_1_definition = {
  domain: "orders",
  sequence: 147,
  capability: "service",
  enabled: true,
...
export const orders_146_2_definition = {
  domain: "orders",
  sequence: 148,
  capability: "service",
  enabled: true,
...
export const orders_146_3_definition = {
  domain: "orders",
  sequence: 149,
  capability: "service",
  enabled: true,
...
export const orders_146_4_definition = {
  domain: "orders",
  sequence: 150,
  capability: "service",
  enabled: true,
...
export const orders_146_5_definition = {
  domain: "orders",
  sequence: 151,
  capability: "service",
  enabled: true,
...
export const orders_146_6_definition = {
  domain: "orders",
  sequence: 152,
  capability: "service",
  enabled: true,
...
export const orders_146_7_definition = {
  domain: "orders",
  sequence: 153,
  capability: "service",
  enabled: true,
