...
export const orders_198_0_definition = {
  domain: "orders",
  sequence: 198,
  capability: "service",
  enabled: true,
...
export const orders_198_1_definition = {
  domain: "orders",
  sequence: 199,
  capability: "service",
  enabled: true,
...
export const orders_198_2_definition = {
  domain: "orders",
  sequence: 200,
  capability: "service",
  enabled: true,
...
export const orders_198_3_definition = {
  domain: "orders",
  sequence: 201,
  capability: "service",
  enabled: true,
...
export const orders_198_4_definition = {
  domain: "orders",
  sequence: 202,
  capability: "service",
  enabled: true,
...
export const orders_198_5_definition = {
  domain: "orders",
  sequence: 203,
  capability: "service",
  enabled: true,
...
export const orders_198_6_definition = {
  domain: "orders",
  sequence: 204,
  capability: "service",
  enabled: true,
...
export const orders_198_7_definition = {
  domain: "orders",
  sequence: 205,
  capability: "service",
  enabled: true,
