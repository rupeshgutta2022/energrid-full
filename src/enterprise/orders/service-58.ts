...
export const orders_58_0_definition = {
  domain: "orders",
  sequence: 58,
  capability: "service",
  enabled: true,
...
export const orders_58_1_definition = {
  domain: "orders",
  sequence: 59,
  capability: "service",
  enabled: true,
...
export const orders_58_2_definition = {
  domain: "orders",
  sequence: 60,
  capability: "service",
  enabled: true,
...
export const orders_58_3_definition = {
  domain: "orders",
  sequence: 61,
  capability: "service",
  enabled: true,
...
export const orders_58_4_definition = {
  domain: "orders",
  sequence: 62,
  capability: "service",
  enabled: true,
...
export const orders_58_5_definition = {
  domain: "orders",
  sequence: 63,
  capability: "service",
  enabled: true,
...
export const orders_58_6_definition = {
  domain: "orders",
  sequence: 64,
  capability: "service",
  enabled: true,
...
export const orders_58_7_definition = {
  domain: "orders",
  sequence: 65,
  capability: "service",
  enabled: true,
