...
export const orders_234_0_definition = {
  domain: "orders",
  sequence: 234,
  capability: "service",
  enabled: true,
...
export const orders_234_1_definition = {
  domain: "orders",
  sequence: 235,
  capability: "service",
  enabled: true,
...
export const orders_234_2_definition = {
  domain: "orders",
  sequence: 236,
  capability: "service",
  enabled: true,
...
export const orders_234_3_definition = {
  domain: "orders",
  sequence: 237,
  capability: "service",
  enabled: true,
...
export const orders_234_4_definition = {
  domain: "orders",
  sequence: 238,
  capability: "service",
  enabled: true,
...
export const orders_234_5_definition = {
  domain: "orders",
  sequence: 239,
  capability: "service",
  enabled: true,
...
export const orders_234_6_definition = {
  domain: "orders",
  sequence: 240,
  capability: "service",
  enabled: true,
...
export const orders_234_7_definition = {
  domain: "orders",
  sequence: 241,
  capability: "service",
  enabled: true,
