...
export const orders_154_0_definition = {
  domain: "orders",
  sequence: 154,
  capability: "service",
  enabled: true,
...
export const orders_154_1_definition = {
  domain: "orders",
  sequence: 155,
  capability: "service",
  enabled: true,
...
export const orders_154_2_definition = {
  domain: "orders",
  sequence: 156,
  capability: "service",
  enabled: true,
...
export const orders_154_3_definition = {
  domain: "orders",
  sequence: 157,
  capability: "service",
  enabled: true,
...
export const orders_154_4_definition = {
  domain: "orders",
  sequence: 158,
  capability: "service",
  enabled: true,
...
export const orders_154_5_definition = {
  domain: "orders",
  sequence: 159,
  capability: "service",
  enabled: true,
...
export const orders_154_6_definition = {
  domain: "orders",
  sequence: 160,
  capability: "service",
  enabled: true,
...
export const orders_154_7_definition = {
  domain: "orders",
  sequence: 161,
  capability: "service",
  enabled: true,
