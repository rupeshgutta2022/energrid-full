...
export const orders_54_0_definition = {
  domain: "orders",
  sequence: 54,
  capability: "service",
  enabled: true,
...
export const orders_54_1_definition = {
  domain: "orders",
  sequence: 55,
  capability: "service",
  enabled: true,
...
export const orders_54_2_definition = {
  domain: "orders",
  sequence: 56,
  capability: "service",
  enabled: true,
...
export const orders_54_3_definition = {
  domain: "orders",
  sequence: 57,
  capability: "service",
  enabled: true,
...
export const orders_54_4_definition = {
  domain: "orders",
  sequence: 58,
  capability: "service",
  enabled: true,
...
export const orders_54_5_definition = {
  domain: "orders",
  sequence: 59,
  capability: "service",
  enabled: true,
...
export const orders_54_6_definition = {
  domain: "orders",
  sequence: 60,
  capability: "service",
  enabled: true,
...
export const orders_54_7_definition = {
  domain: "orders",
  sequence: 61,
  capability: "service",
  enabled: true,
