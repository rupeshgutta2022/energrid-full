...
export const orders_106_0_definition = {
  domain: "orders",
  sequence: 106,
  capability: "service",
  enabled: true,
...
export const orders_106_1_definition = {
  domain: "orders",
  sequence: 107,
  capability: "service",
  enabled: true,
...
export const orders_106_2_definition = {
  domain: "orders",
  sequence: 108,
  capability: "service",
  enabled: true,
...
export const orders_106_3_definition = {
  domain: "orders",
  sequence: 109,
  capability: "service",
  enabled: true,
...
export const orders_106_4_definition = {
  domain: "orders",
  sequence: 110,
  capability: "service",
  enabled: true,
...
export const orders_106_5_definition = {
  domain: "orders",
  sequence: 111,
  capability: "service",
  enabled: true,
...
export const orders_106_6_definition = {
  domain: "orders",
  sequence: 112,
  capability: "service",
  enabled: true,
...
export const orders_106_7_definition = {
  domain: "orders",
  sequence: 113,
  capability: "service",
  enabled: true,
