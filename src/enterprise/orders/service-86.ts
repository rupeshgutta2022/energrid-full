...
export const orders_86_0_definition = {
  domain: "orders",
  sequence: 86,
  capability: "service",
  enabled: true,
...
export const orders_86_1_definition = {
  domain: "orders",
  sequence: 87,
  capability: "service",
  enabled: true,
...
export const orders_86_2_definition = {
  domain: "orders",
  sequence: 88,
  capability: "service",
  enabled: true,
...
export const orders_86_3_definition = {
  domain: "orders",
  sequence: 89,
  capability: "service",
  enabled: true,
...
export const orders_86_4_definition = {
  domain: "orders",
  sequence: 90,
  capability: "service",
  enabled: true,
...
export const orders_86_5_definition = {
  domain: "orders",
  sequence: 91,
  capability: "service",
  enabled: true,
...
export const orders_86_6_definition = {
  domain: "orders",
  sequence: 92,
  capability: "service",
  enabled: true,
...
export const orders_86_7_definition = {
  domain: "orders",
  sequence: 93,
  capability: "service",
  enabled: true,
