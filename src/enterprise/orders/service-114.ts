...
export const orders_114_0_definition = {
  domain: "orders",
  sequence: 114,
  capability: "service",
  enabled: true,
...
export const orders_114_1_definition = {
  domain: "orders",
  sequence: 115,
  capability: "service",
  enabled: true,
...
export const orders_114_2_definition = {
  domain: "orders",
  sequence: 116,
  capability: "service",
  enabled: true,
...
export const orders_114_3_definition = {
  domain: "orders",
  sequence: 117,
  capability: "service",
  enabled: true,
...
export const orders_114_4_definition = {
  domain: "orders",
  sequence: 118,
  capability: "service",
  enabled: true,
...
export const orders_114_5_definition = {
  domain: "orders",
  sequence: 119,
  capability: "service",
  enabled: true,
...
export const orders_114_6_definition = {
  domain: "orders",
  sequence: 120,
  capability: "service",
  enabled: true,
...
export const orders_114_7_definition = {
  domain: "orders",
  sequence: 121,
  capability: "service",
  enabled: true,
