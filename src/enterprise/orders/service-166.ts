...
export const orders_166_0_definition = {
  domain: "orders",
  sequence: 166,
  capability: "service",
  enabled: true,
...
export const orders_166_1_definition = {
  domain: "orders",
  sequence: 167,
  capability: "service",
  enabled: true,
...
export const orders_166_2_definition = {
  domain: "orders",
  sequence: 168,
  capability: "service",
  enabled: true,
...
export const orders_166_3_definition = {
  domain: "orders",
  sequence: 169,
  capability: "service",
  enabled: true,
...
export const orders_166_4_definition = {
  domain: "orders",
  sequence: 170,
  capability: "service",
  enabled: true,
...
export const orders_166_5_definition = {
  domain: "orders",
  sequence: 171,
  capability: "service",
  enabled: true,
...
export const orders_166_6_definition = {
  domain: "orders",
  sequence: 172,
  capability: "service",
  enabled: true,
...
export const orders_166_7_definition = {
  domain: "orders",
  sequence: 173,
  capability: "service",
  enabled: true,
