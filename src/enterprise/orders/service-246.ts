...
export const orders_246_0_definition = {
  domain: "orders",
  sequence: 246,
  capability: "service",
  enabled: true,
...
export const orders_246_1_definition = {
  domain: "orders",
  sequence: 247,
  capability: "service",
  enabled: true,
...
export const orders_246_2_definition = {
  domain: "orders",
  sequence: 248,
  capability: "service",
  enabled: true,
...
export const orders_246_3_definition = {
  domain: "orders",
  sequence: 249,
  capability: "service",
  enabled: true,
...
export const orders_246_4_definition = {
  domain: "orders",
  sequence: 250,
  capability: "service",
  enabled: true,
