...
export const orders_206_0_definition = {
  domain: "orders",
  sequence: 206,
  capability: "service",
  enabled: true,
...
export const orders_206_1_definition = {
  domain: "orders",
  sequence: 207,
  capability: "service",
  enabled: true,
...
export const orders_206_2_definition = {
  domain: "orders",
  sequence: 208,
  capability: "service",
  enabled: true,
...
export const orders_206_3_definition = {
  domain: "orders",
  sequence: 209,
  capability: "service",
  enabled: true,
...
export const orders_206_4_definition = {
  domain: "orders",
  sequence: 210,
  capability: "service",
  enabled: true,
...
export const orders_206_5_definition = {
  domain: "orders",
  sequence: 211,
  capability: "service",
  enabled: true,
...
export const orders_206_6_definition = {
  domain: "orders",
  sequence: 212,
  capability: "service",
  enabled: true,
...
export const orders_206_7_definition = {
  domain: "orders",
  sequence: 213,
  capability: "service",
  enabled: true,
