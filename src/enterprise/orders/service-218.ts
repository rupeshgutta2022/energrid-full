...
export const orders_218_0_definition = {
  domain: "orders",
  sequence: 218,
  capability: "service",
  enabled: true,
...
export const orders_218_1_definition = {
  domain: "orders",
  sequence: 219,
  capability: "service",
  enabled: true,
...
export const orders_218_2_definition = {
  domain: "orders",
  sequence: 220,
  capability: "service",
  enabled: true,
...
export const orders_218_3_definition = {
  domain: "orders",
  sequence: 221,
  capability: "service",
  enabled: true,
...
export const orders_218_4_definition = {
  domain: "orders",
  sequence: 222,
  capability: "service",
  enabled: true,
...
export const orders_218_5_definition = {
  domain: "orders",
  sequence: 223,
  capability: "service",
  enabled: true,
...
export const orders_218_6_definition = {
  domain: "orders",
  sequence: 224,
  capability: "service",
  enabled: true,
...
export const orders_218_7_definition = {
  domain: "orders",
  sequence: 225,
  capability: "service",
  enabled: true,
