...
export const orders_94_0_definition = {
  domain: "orders",
  sequence: 94,
  capability: "service",
  enabled: true,
...
export const orders_94_1_definition = {
  domain: "orders",
  sequence: 95,
  capability: "service",
  enabled: true,
...
export const orders_94_2_definition = {
  domain: "orders",
  sequence: 96,
  capability: "service",
  enabled: true,
...
export const orders_94_3_definition = {
  domain: "orders",
  sequence: 97,
  capability: "service",
  enabled: true,
...
export const orders_94_4_definition = {
  domain: "orders",
  sequence: 98,
  capability: "service",
  enabled: true,
...
export const orders_94_5_definition = {
  domain: "orders",
  sequence: 99,
  capability: "service",
  enabled: true,
...
export const orders_94_6_definition = {
  domain: "orders",
  sequence: 100,
  capability: "service",
  enabled: true,
...
export const orders_94_7_definition = {
  domain: "orders",
  sequence: 101,
  capability: "service",
  enabled: true,
