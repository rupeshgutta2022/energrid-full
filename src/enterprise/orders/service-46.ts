...
export const orders_46_0_definition = {
  domain: "orders",
  sequence: 46,
  capability: "service",
  enabled: true,
...
export const orders_46_1_definition = {
  domain: "orders",
  sequence: 47,
  capability: "service",
  enabled: true,
...
export const orders_46_2_definition = {
  domain: "orders",
  sequence: 48,
  capability: "service",
  enabled: true,
...
export const orders_46_3_definition = {
  domain: "orders",
  sequence: 49,
  capability: "service",
  enabled: true,
...
export const orders_46_4_definition = {
  domain: "orders",
  sequence: 50,
  capability: "service",
  enabled: true,
...
export const orders_46_5_definition = {
  domain: "orders",
  sequence: 51,
  capability: "service",
  enabled: true,
...
export const orders_46_6_definition = {
  domain: "orders",
  sequence: 52,
  capability: "service",
  enabled: true,
...
export const orders_46_7_definition = {
  domain: "orders",
  sequence: 53,
  capability: "service",
  enabled: true,
