...
export const orders_222_0_definition = {
  domain: "orders",
  sequence: 222,
  capability: "service",
  enabled: true,
...
export const orders_222_1_definition = {
  domain: "orders",
  sequence: 223,
  capability: "service",
  enabled: true,
...
export const orders_222_2_definition = {
  domain: "orders",
  sequence: 224,
  capability: "service",
  enabled: true,
...
export const orders_222_3_definition = {
  domain: "orders",
  sequence: 225,
  capability: "service",
  enabled: true,
...
export const orders_222_4_definition = {
  domain: "orders",
  sequence: 226,
  capability: "service",
  enabled: true,
...
export const orders_222_5_definition = {
  domain: "orders",
  sequence: 227,
  capability: "service",
  enabled: true,
...
export const orders_222_6_definition = {
  domain: "orders",
  sequence: 228,
  capability: "service",
  enabled: true,
...
export const orders_222_7_definition = {
  domain: "orders",
  sequence: 229,
  capability: "service",
  enabled: true,
