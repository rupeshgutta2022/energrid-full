...
export const orders_142_0_definition = {
  domain: "orders",
  sequence: 142,
  capability: "service",
  enabled: true,
...
export const orders_142_1_definition = {
  domain: "orders",
  sequence: 143,
  capability: "service",
  enabled: true,
...
export const orders_142_2_definition = {
  domain: "orders",
  sequence: 144,
  capability: "service",
  enabled: true,
...
export const orders_142_3_definition = {
  domain: "orders",
  sequence: 145,
  capability: "service",
  enabled: true,
...
export const orders_142_4_definition = {
  domain: "orders",
  sequence: 146,
  capability: "service",
  enabled: true,
...
export const orders_142_5_definition = {
  domain: "orders",
  sequence: 147,
  capability: "service",
  enabled: true,
...
export const orders_142_6_definition = {
  domain: "orders",
  sequence: 148,
  capability: "service",
  enabled: true,
...
export const orders_142_7_definition = {
  domain: "orders",
  sequence: 149,
  capability: "service",
  enabled: true,
