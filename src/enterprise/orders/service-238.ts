...
export const orders_238_0_definition = {
  domain: "orders",
  sequence: 238,
  capability: "service",
  enabled: true,
...
export const orders_238_1_definition = {
  domain: "orders",
  sequence: 239,
  capability: "service",
  enabled: true,
...
export const orders_238_2_definition = {
  domain: "orders",
  sequence: 240,
  capability: "service",
  enabled: true,
...
export const orders_238_3_definition = {
  domain: "orders",
  sequence: 241,
  capability: "service",
  enabled: true,
...
export const orders_238_4_definition = {
  domain: "orders",
  sequence: 242,
  capability: "service",
  enabled: true,
...
export const orders_238_5_definition = {
  domain: "orders",
  sequence: 243,
  capability: "service",
  enabled: true,
...
export const orders_238_6_definition = {
  domain: "orders",
  sequence: 244,
  capability: "service",
  enabled: true,
...
export const orders_238_7_definition = {
  domain: "orders",
  sequence: 245,
  capability: "service",
  enabled: true,
