...
export const orders_62_0_definition = {
  domain: "orders",
  sequence: 62,
  capability: "service",
  enabled: true,
...
export const orders_62_1_definition = {
  domain: "orders",
  sequence: 63,
  capability: "service",
  enabled: true,
...
export const orders_62_2_definition = {
  domain: "orders",
  sequence: 64,
  capability: "service",
  enabled: true,
...
export const orders_62_3_definition = {
  domain: "orders",
  sequence: 65,
  capability: "service",
  enabled: true,
...
export const orders_62_4_definition = {
  domain: "orders",
  sequence: 66,
  capability: "service",
  enabled: true,
...
export const orders_62_5_definition = {
  domain: "orders",
  sequence: 67,
  capability: "service",
  enabled: true,
...
export const orders_62_6_definition = {
  domain: "orders",
  sequence: 68,
  capability: "service",
  enabled: true,
...
export const orders_62_7_definition = {
  domain: "orders",
  sequence: 69,
  capability: "service",
  enabled: true,
