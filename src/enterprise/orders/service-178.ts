...
export const orders_178_0_definition = {
  domain: "orders",
  sequence: 178,
  capability: "service",
  enabled: true,
...
export const orders_178_1_definition = {
  domain: "orders",
  sequence: 179,
  capability: "service",
  enabled: true,
...
export const orders_178_2_definition = {
  domain: "orders",
  sequence: 180,
  capability: "service",
  enabled: true,
...
export const orders_178_3_definition = {
  domain: "orders",
  sequence: 181,
  capability: "service",
  enabled: true,
...
export const orders_178_4_definition = {
  domain: "orders",
  sequence: 182,
  capability: "service",
  enabled: true,
...
export const orders_178_5_definition = {
  domain: "orders",
  sequence: 183,
  capability: "service",
  enabled: true,
...
export const orders_178_6_definition = {
  domain: "orders",
  sequence: 184,
  capability: "service",
  enabled: true,
...
export const orders_178_7_definition = {
  domain: "orders",
  sequence: 185,
  capability: "service",
  enabled: true,
