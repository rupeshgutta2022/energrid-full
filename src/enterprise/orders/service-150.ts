...
export const orders_150_0_definition = {
  domain: "orders",
  sequence: 150,
  capability: "service",
  enabled: true,
...
export const orders_150_1_definition = {
  domain: "orders",
  sequence: 151,
  capability: "service",
  enabled: true,
...
export const orders_150_2_definition = {
  domain: "orders",
  sequence: 152,
  capability: "service",
  enabled: true,
...
export const orders_150_3_definition = {
  domain: "orders",
  sequence: 153,
  capability: "service",
  enabled: true,
...
export const orders_150_4_definition = {
  domain: "orders",
  sequence: 154,
  capability: "service",
  enabled: true,
...
export const orders_150_5_definition = {
  domain: "orders",
  sequence: 155,
  capability: "service",
  enabled: true,
...
export const orders_150_6_definition = {
  domain: "orders",
  sequence: 156,
  capability: "service",
  enabled: true,
...
export const orders_150_7_definition = {
  domain: "orders",
  sequence: 157,
  capability: "service",
  enabled: true,
