...
export const orders_230_0_definition = {
  domain: "orders",
  sequence: 230,
  capability: "service",
  enabled: true,
...
export const orders_230_1_definition = {
  domain: "orders",
  sequence: 231,
  capability: "service",
  enabled: true,
...
export const orders_230_2_definition = {
  domain: "orders",
  sequence: 232,
  capability: "service",
  enabled: true,
...
export const orders_230_3_definition = {
  domain: "orders",
  sequence: 233,
  capability: "service",
  enabled: true,
...
export const orders_230_4_definition = {
  domain: "orders",
  sequence: 234,
  capability: "service",
  enabled: true,
...
export const orders_230_5_definition = {
  domain: "orders",
  sequence: 235,
  capability: "service",
  enabled: true,
...
export const orders_230_6_definition = {
  domain: "orders",
  sequence: 236,
  capability: "service",
  enabled: true,
...
export const orders_230_7_definition = {
  domain: "orders",
  sequence: 237,
  capability: "service",
  enabled: true,
