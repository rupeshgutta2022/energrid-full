...
export const orders_26_0_definition = {
  domain: "orders",
  sequence: 26,
  capability: "service",
  enabled: true,
...
export const orders_26_1_definition = {
  domain: "orders",
  sequence: 27,
  capability: "service",
  enabled: true,
...
export const orders_26_2_definition = {
  domain: "orders",
  sequence: 28,
  capability: "service",
  enabled: true,
...
export const orders_26_3_definition = {
  domain: "orders",
  sequence: 29,
  capability: "service",
  enabled: true,
...
export const orders_26_4_definition = {
  domain: "orders",
  sequence: 30,
  capability: "service",
  enabled: true,
...
export const orders_26_5_definition = {
  domain: "orders",
  sequence: 31,
  capability: "service",
  enabled: true,
...
export const orders_26_6_definition = {
  domain: "orders",
  sequence: 32,
  capability: "service",
  enabled: true,
...
export const orders_26_7_definition = {
  domain: "orders",
  sequence: 33,
  capability: "service",
  enabled: true,
