...
export const orders_50_0_definition = {
  domain: "orders",
  sequence: 50,
  capability: "service",
  enabled: true,
...
export const orders_50_1_definition = {
  domain: "orders",
  sequence: 51,
  capability: "service",
  enabled: true,
...
export const orders_50_2_definition = {
  domain: "orders",
  sequence: 52,
  capability: "service",
  enabled: true,
...
export const orders_50_3_definition = {
  domain: "orders",
  sequence: 53,
  capability: "service",
  enabled: true,
...
export const orders_50_4_definition = {
  domain: "orders",
  sequence: 54,
  capability: "service",
  enabled: true,
...
export const orders_50_5_definition = {
  domain: "orders",
  sequence: 55,
  capability: "service",
  enabled: true,
...
export const orders_50_6_definition = {
  domain: "orders",
  sequence: 56,
  capability: "service",
  enabled: true,
...
export const orders_50_7_definition = {
  domain: "orders",
  sequence: 57,
  capability: "service",
  enabled: true,
