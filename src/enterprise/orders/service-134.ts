...
export const orders_134_0_definition = {
  domain: "orders",
  sequence: 134,
  capability: "service",
  enabled: true,
...
export const orders_134_1_definition = {
  domain: "orders",
  sequence: 135,
  capability: "service",
  enabled: true,
...
export const orders_134_2_definition = {
  domain: "orders",
  sequence: 136,
  capability: "service",
  enabled: true,
...
export const orders_134_3_definition = {
  domain: "orders",
  sequence: 137,
  capability: "service",
  enabled: true,
...
export const orders_134_4_definition = {
  domain: "orders",
  sequence: 138,
  capability: "service",
  enabled: true,
...
export const orders_134_5_definition = {
  domain: "orders",
  sequence: 139,
  capability: "service",
  enabled: true,
...
export const orders_134_6_definition = {
  domain: "orders",
  sequence: 140,
  capability: "service",
  enabled: true,
...
export const orders_134_7_definition = {
  domain: "orders",
  sequence: 141,
  capability: "service",
  enabled: true,
