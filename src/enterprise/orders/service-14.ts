...
export const orders_14_0_definition = {
  domain: "orders",
  sequence: 14,
  capability: "service",
  enabled: true,
...
export const orders_14_1_definition = {
  domain: "orders",
  sequence: 15,
  capability: "service",
  enabled: true,
...
export const orders_14_2_definition = {
  domain: "orders",
  sequence: 16,
  capability: "service",
  enabled: true,
...
export const orders_14_3_definition = {
  domain: "orders",
  sequence: 17,
  capability: "service",
  enabled: true,
...
export const orders_14_4_definition = {
  domain: "orders",
  sequence: 18,
  capability: "service",
  enabled: true,
...
export const orders_14_5_definition = {
  domain: "orders",
  sequence: 19,
  capability: "service",
  enabled: true,
...
export const orders_14_6_definition = {
  domain: "orders",
  sequence: 20,
  capability: "service",
  enabled: true,
...
export const orders_14_7_definition = {
  domain: "orders",
  sequence: 21,
  capability: "service",
  enabled: true,
